...
## Soft inventory / honesty stamps (Wave 126)

Greppable soft inventory comments and honesty ledgers in headers/docs are **bring-up observability only** (e.g. `*: soft inventory …`). They do **not** light product lamps, close Steam **bar3**, or promote Deck Top 50 rows. Continuum high-water **makefile_max=26800** is CREATE-ONLY soft graph parent wire (Wave 126 soft deepen surfaces **retgradientangle**/**retblendangle**; CREATE-ONLY TUs pre-generated through **96000**) — **soft ≠ product complete**.
