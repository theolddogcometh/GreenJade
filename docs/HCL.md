...
**Soft stamp (Wave 28):** continuum high-water **advancing toward 17000** soft only (parent wires / CREATE-ONLY). Honest scan may still report **makefile_max=16900** until parent wires — **do not hardcode false 17000**. Host `./scripts/steam-bar3-check.sh` → media inventory **READY** (stage/rootfs STATUS agree) — **media bootstrap only**. Soft probes and continuum growth remain **≠ full HCL product**. **Soft ≠ product complete.** Product lamps remain **0**. **bar3: OPEN.** Matrix **NOT-TRIED × 50**. **No bar3 claim.**
...
### Soft probes ≠ full HCL product (Wave 28 honesty)

**Additive only.** Wave 9/12/14/16 tables and hard rules above stay historical ledger. This section is Wave 28 honesty: continuum high-water **advancing toward 17000** soft only (parent wires). Honest scan may still report **makefile_max=16900** — **do not hardcode false 17000**. Soft probes ≠ full HCL product. **Soft ≠ product complete.** Product lamps remain **0**. **bar3 remains OPEN.**

| Soft surface | What it is | What it is **not** |
|--------------|------------|--------------------|
| Continuum **toward 17000** | CREATE-ONLY soft graph high-water advance (parent wires; scan may lag at 16900) | Runtime ABI product; Steam client; Deck Top 50; bar3; **full HCL product** |
...
**Hard rule (Wave 28):** never promote soft probes, continuum advancing toward **17000**, or media READY to “HCL product complete,” T1+ certified, product lamps > 0, or **bar3 closed**. Soft continuum ≠ full HCL product. Soft probes ≠ full HCL product. **Soft ≠ product complete.** Open bars below stay open.

### Explicit non-claims (Wave 12/14 historical · Wave 28 restates)

| Claim | Allowed? |
|-------|----------|
| “Continuum high-water advancing toward **17000** (CREATE-ONLY parent wire)” | **Yes** — soft only |
...
- Residual **#UD** closed
- Continuum high-water **advancing toward 17000** (soft graph only — not Steam client; parent-wire CREATE-ONLY; honest scan may still be **16900**; **not** full HCL product; Wave 14 historical target was **15600**)
...
- **bar3** — Steam **client** launch on DUT + Deck Top 50 leave `NOT-TRIED` (**OPEN**; soft probes / continuum toward **17000** do **not** close)
