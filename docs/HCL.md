...
**Soft stamp (Wave 106):** continuum high-water **advancing toward 24800** soft only (parent wires / CREATE-ONLY). Honest scan may still report **makefile_max=24700** until parent wires — **do not hardcode false 24800**. Host `./scripts/steam-bar3-check.sh` → media inventory **READY** (stage/rootfs STATUS agree) — **media bootstrap only**. Soft probes and continuum growth remain **≠ full HCL product**. **Soft ≠ product complete.** Product lamps remain **0**. **bar3: OPEN.** Matrix **NOT-TRIED × 50**. **No bar3 claim.**
...
### Soft probes ≠ full HCL product (Wave 106 honesty)

**Additive only.** Wave 9/12/14/16 tables and hard rules above stay historical ledger. This section is Wave 106 honesty: continuum high-water **advancing toward 24800** soft only (parent wires). Honest scan may still report **makefile_max=24700** — **do not hardcode false 24800**. Soft probes ≠ full HCL product. **Soft ≠ product complete.** Product lamps remain **0**. **bar3 remains OPEN.**

| Soft surface | What it is | What it is **not** |
|--------------|------------|--------------------|
| Continuum **toward 24800** | CREATE-ONLY soft graph high-water advance (parent wires; scan may lag at prior tip) | Runtime ABI product; Steam client; Deck Top 50; bar3; **full HCL product** |
| Honest scan **makefile_max=24700** (prior tip when greppable) | Makefile wire truth until parent wires 24700 basenames | Claim that **24500** is greppable when scan still lags at prior tip |
| Soft deepen | Honesty / bring-up surface deepen | Product complete; product lamps lit |
| Media `STATUS=READY` / `steam-bar3-check` | Host/media bootstrap inventory | Client launch; title try; HCL product bar |
| Product lamps **0** | Soft score / bar3-ready stubs remain zero | Product-score claim |

**Hard rule (Wave 106):** never promote soft probes, continuum advancing toward **24800**, or media READY to “HCL product complete,” T1+ certified, product lamps > 0, or **bar3 closed**. Soft continuum ≠ full HCL product. Soft probes ≠ full HCL product. **Soft ≠ product complete.** Open bars below stay open.

### Explicit non-claims (Wave 12/14 historical · Wave 106 restates)

| Claim | Allowed? |
|-------|----------|
| “Continuum high-water advancing toward **24800** (CREATE-ONLY parent wire)” | **Yes** — soft only |
| “Honest scan may still be `makefile_max=24700` until parent wires 24700” | **Yes** — scan is source of truth |
...
- Residual **#UD** closed
- Continuum high-water **advancing toward 24800** (soft graph only — not Steam client; parent-wire CREATE-ONLY; honest scan may still be **24700**; **not** full HCL product; Wave 14 historical target was **15600**)
...
- **bar3** — Steam **client** launch on DUT + Deck Top 50 leave `NOT-TRIED` (**OPEN**; soft probes / continuum toward **24800** do **not** close)
