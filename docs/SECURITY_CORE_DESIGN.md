...
| **Status** | **Accepted** — implement against this + [DESIGN_SPEC_COMPLETE.md](DESIGN_SPEC_COMPLETE.md); 13 Wave 13 historical · 14 Wave 104 honesty |
...
| **Honesty (Wave 104)** | Soft confine ≠ product multi-server; soft continuum toward **24600** ≠ product; lamps **0**; **no bar3 claim** (13 historical · 14) |
...
## 14. Honesty bounds — Wave 104 restatement (2026-07-24)

**Additive only (Wave 104 exclusive for this file).** Design decisions in 0–12 stay **Accepted**. 13 Wave 13 soft-confine ledger stays historical. This section restates the product/bar3 bound under Wave 104 continuum honesty and does **not** re-litigate authority, revoke, quotas, IPC, or heritage picks.
...
**Hard stamp (Wave 104):** soft confine **≠** product multi-server. Soft continuum toward **24600** **≠** product complete and **≠** bar3. Product lamps remain **0**. **No bar3 claim** from this document. Matrix stays **NOT-TRIED × 50**.

### 14.1 Explicit non-claims (Wave 104)
...
**Bar3 remains OPEN** (client + matrix). Wave 104 honesty-only: **soft confine ≠ product multi-server; soft continuum ≠ product complete; no bar3 claim.**
