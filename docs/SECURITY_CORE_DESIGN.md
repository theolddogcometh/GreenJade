...
| **Status** | **Accepted** — implement against this + [DESIGN_SPEC_COMPLETE.md](DESIGN_SPEC_COMPLETE.md); 13 Wave 13 historical · 14 Wave 51 honesty |
...
| **Honesty (Wave 51)** | Soft confine ≠ product multi-server; soft continuum toward **19300** ≠ product; lamps **0**; **no bar3 claim** (13 historical · 14) |
...
## 14. Honesty bounds — Wave 51 restatement (2026-07-23)

**Additive only (Wave 51 exclusive for this file).** Design decisions in 0–12 stay **Accepted**. 13 Wave 13 soft-confine ledger stays historical. This section restates the product/bar3 bound under Wave 51 continuum honesty and does **not** re-litigate authority, revoke, quotas, IPC, or heritage picks.

| Term | Meaning in this document |
|------|--------------------------|
| **Soft confine** | 13 greppable confine / promise surface — **not** product multi-server seal |
| **Soft continuum** | CREATE-ONLY libcgj graph parent wire **advancing toward 19300**; honest scan may still report **makefile_max=19200** until parent wires — **not** product complete |
...
**Hard stamp (Wave 51):** soft confine **≠** product multi-server. Soft continuum toward **19300** **≠** product complete and **≠** bar3. Product lamps remain **0**. **No bar3 claim** from this document. Matrix stays **NOT-TRIED × 50**.

### 14.1 Explicit non-claims (Wave 51)

| Claim | Allowed? |
|-------|----------|
| “Security core design **Accepted**” | **Yes** — this document 0–12 |
| “Soft confine / soft cap / doors greppable” | **Yes** — with soft bound in 13.1 |
| “Soft continuum high-water advancing toward **19300** (scan may still be 18400)” | **Yes** — soft only; scan is source of truth |
| “Soft confine = product multi-server closed” | **No** |
...
**Bar3 remains OPEN** (client + matrix). Wave 51 honesty-only: **soft confine ≠ product multi-server; soft continuum ≠ product complete; no bar3 claim.**
...
*14 Wave 51 honesty (2026-07-23): soft confine ≠ product multi-server; continuum toward **19300** soft only (scan may still be **19200**); product lamps **0**; **soft ≠ product complete**; **no bar3 claim**.*  
