...
| **Honesty** | **2026-07-24 Wave 72** — soft vs product IOMMU/platform open (14); continuum **toward 21400** soft only; product lamps **0**; **no product claim**; **no bar3 claim** |
...
**Soft stamp (Wave 72):** same soft-vs-product platform bound restated under Wave 72 exclusive ownership of this file’s honesty ledger. Continuum high-water **advancing toward 21400** soft only (CREATE-ONLY parent wire). Product lamps remain **0**. Soft platform ≠ product complete ≠ bar3. See 14.
...
## 14. Honesty refresh — soft vs product (Wave 72 · 2026-07-24)

**Additive only (Wave 72 exclusive for this file).** Profile rules in 1–13 stay **Accepted** (normative platform contract). This section is a Wave 72 honesty ledger: what is **soft** on the tree vs what remains **open** for product IOMMU / platform. It does **not** re-litigate architecture or weaken P-DMA production defaults. Wave 72 14 ledger text is superseded here as the same honesty formula under Wave 72 exclusive ownership of this file.
...
| Continuum high-water **toward 21400** CREATE-ONLY | **No** | **No** | **No** |
...
### 14.4 Explicit non-claims (Wave 72)
...
| “Wave 72 honesty closes bar3 or platform product” | **No** — honesty refresh only |
...
- [HCL.md](HCL.md) — T0 VT-d soft row; continuum toward 21400; open bars  
...
- [CAP_ADDRESSING.md](CAP_ADDRESSING.md) 9.5 — continuum toward 21400 soft  

---

*Normative x86_64 Intel-class platform profile for Project GreenJade.*  
*Wave 72 honesty (14): soft IOMMU/platform ≠ product close; continuum **toward 21400 soft only**; product lamps **0**; production no open bus-master still **open**; **soft ≠ product complete**; **bar3 remains OPEN**.*
