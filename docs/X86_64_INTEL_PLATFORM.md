...
| **Honesty** | **2026-07-23 Wave 29** — soft vs product IOMMU/platform open (§14); continuum **toward 17100** soft only; product lamps **0**; **no product claim**; **no bar3 claim** |
...
**Soft stamp (Wave 29):** same soft-vs-product platform bound restated under Wave 29 exclusive ownership of this file’s honesty ledger. Continuum high-water **advancing toward 17100** soft only (CREATE-ONLY parent wire). Product lamps remain **0**. Soft platform ≠ product complete ≠ bar3. See §14.
...
| Continuum high-water **toward 17100** CREATE-ONLY | **No** | **No** | **No** |
...
### 14.4 Explicit non-claims (Wave 29)
...
| “Wave 29 honesty closes bar3 or platform product” | **No** — honesty refresh only |
...
- [HCL.md](HCL.md) — T0 VT-d soft row; continuum toward 17100; open bars  
...
- [CAP_ADDRESSING.md](CAP_ADDRESSING.md) §9.5 — continuum toward 17100 soft  

---

*Normative x86_64 Intel-class platform profile for Project GreenJade.*  
*Wave 29 honesty (§14): soft IOMMU/platform ≠ product close; continuum **toward 17100 soft only**; product lamps **0**; production no open bus-master still **open**; **soft ≠ product complete**; **bar3 remains OPEN**.*
