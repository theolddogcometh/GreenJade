 ...
 *   aarch64: cpu soft inventory wave=32 …
 *   aarch64: cpu soft surf …
 *   aarch64: cpu soft deepen wave=32 areas=…
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: cpu: soft retbulwark — Wave 32 return-bulwark honesty */
...
/* Grep: aarch64: cpu: soft retpanoply — Wave 32 exclusive panoply stamp */
...
aarch64_uart_puts(" (retpanoply stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: cpu soft exclusive — Wave 32 exclusive deepen */
