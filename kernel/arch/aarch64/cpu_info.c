 ...
 *   aarch64: cpu soft inventory wave=19 …
 *   aarch64: cpu soft surf …
 *   aarch64: cpu soft deepen wave=19 areas=…
...
cpu_soft_inventory(const struct cpu_soft_snap *pSnap)
{
     ...
     */
    /* Grep: aarch64: cpu: soft retclass — Wave 19 return-class taxonomy */
    ...
    /* Grep: aarch64: cpu: soft retlane — Wave 19 return-lane catalog */
    ...
    /* Grep: aarch64: cpu soft exclusive — Wave 19 exclusive deepen */
