 ...
 *   aarch64: cpu soft inventory wave=20 …
 *   aarch64: cpu soft surf …
 *   aarch64: cpu soft deepen wave=20 areas=…
...
cpu_soft_inventory(const struct cpu_soft_snap *pSnap)
{
     ...
     * Soft!=product; not bar3.
     */
    /* Grep: aarch64: cpu: soft retbound — Wave 20 return-bound honesty */
    ...
    /* Grep: aarch64: cpu: soft retseal — Wave 20 exclusive seal stamp */
    ...
    /* Grep: aarch64: cpu soft exclusive — Wave 20 exclusive deepen */
