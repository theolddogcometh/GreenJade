 ...
 *   aarch64: cpu soft inventory wave=31 …
 *   aarch64: cpu soft surf …
 *   aarch64: cpu soft deepen wave=31 areas=…
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: cpu: soft retaegis — Wave 31 return-aegis honesty */
...
/* Grep: aarch64: cpu: soft retmantle — Wave 31 exclusive mantle stamp */
...
aarch64_uart_puts(" (retmantle stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: cpu soft exclusive — Wave 31 exclusive deepen */
