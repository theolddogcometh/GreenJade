 ...
 *   aarch64: cpu soft inventory wave=21 …
 *   aarch64: cpu soft surf …
 *   aarch64: cpu soft deepen wave=21 areas=…
...
cpu_soft_inventory(const struct cpu_soft_snap *pSnap)
{
     ...
     * Soft!=product; not bar3.
     */
    /* Grep: aarch64: cpu: soft retpulse — Wave 21 return-pulse honesty */
    ...
    /* Grep: aarch64: cpu: soft retmark — Wave 21 exclusive mark stamp */
    ...
    /* Grep: aarch64: cpu soft exclusive — Wave 21 exclusive deepen */
