 ...
 *   aarch64: cpu soft inventory wave=33 …
 *   aarch64: cpu soft surf …
 *   aarch64: cpu soft deepen wave=33 areas=…
 ...
 * Soft≠product; not bar3.
 */
/* Grep: aarch64: cpu: soft retbastion — Wave 33 return-bastion honesty */
...
/* Grep: aarch64: cpu: soft retcitadel — Wave 33 exclusive citadel stamp */
...
aarch64_uart_puts(" (retcitadel stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: cpu soft exclusive — Wave 33 exclusive deepen */
