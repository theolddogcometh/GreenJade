 ...
 *   aarch64: cpu soft inventory wave=16 …
 *   aarch64: cpu soft surf …
 *   aarch64: cpu soft deepen wave=16 areas=…
 ...
 * print legacy "features soft" detail lines, fill Wave 16 snap.
...
/*
 * Wave 16 soft inventory emission — greppable "aarch64: cpu soft …".
...
cpu_soft_inventory(const struct cpu_soft_snap *pSnap)
{
    ...
    /* Grep: aarch64: cpu soft inventory — Wave 16 rollup */
    ...
    /* Grep: aarch64: cpu soft surf — Wave 16 inv gate lamps */
    ...
    /* Grep: aarch64: cpu soft return — Wave 16 return surfaces */
...
aarch64_cpu_probe(void)
{
    ...
    /* Soft feature deepen (ID regs + decode) → fills Wave 16 snap. */
    ...
    /*
     * Wave 16 combined soft inventory under "aarch64: cpu soft …".
