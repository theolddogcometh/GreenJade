...
/* Soft PPI INTIDs (local; Wave 17 inventory lamps). */
...
/*
 * Soft SPI/IAR peeks captured by gic_spi_soft_observe for Wave 17 inventory.
...
gic_spi_soft_observe(unsigned uTyper, unsigned cIrqLines)
{
    ...
    /* Wave 17: capture SPI/IAR soft peeks for inventory emission. */
...
/*
 * Soft GIC inventory deepen (Wave 17): re-read distributor + CPU interface
...
gic_soft_inventory(unsigned uTyper, unsigned cIrqLines, unsigned uIsen0)
{
    ...
    /* Grep: aarch64: gic soft surf — Wave 17 gate bit lamps */
