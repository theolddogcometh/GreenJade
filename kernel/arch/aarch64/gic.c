...
/* Soft PPI INTIDs (local; Wave 16 inventory lamps). */
...
/*
 * Soft SPI/IAR peeks captured by gic_spi_soft_observe for Wave 16 inventory.
...
gic_spi_soft_observe(unsigned uTyper, unsigned cIrqLines)
{
    ...
    /* Wave 16: capture SPI/IAR soft peeks for inventory emission. */
...
/*
 * Soft GIC inventory deepen (Wave 16): re-read distributor + CPU interface
...
gic_soft_inventory(unsigned uTyper, unsigned cIrqLines, unsigned uIsen0)
{
    ...
    /* Grep: aarch64: gic soft surf — Wave 16 gate bit lamps */
    ...
    /* Grep: aarch64: gic soft return — Wave 16 return surfaces */
