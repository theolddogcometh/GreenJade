...
#define GIC_SOFT_WAVE 32u
#define GIC_SOFT_AREAS 38u
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: gic: soft retbulwark — Wave 32 return-bulwark honesty */
...
/* Grep: aarch64: gic: soft retpanoply — Wave 32 exclusive panoply stamp */
...
aarch64_uart_puts(" (retpanoply stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: gic soft exclusive — Wave 32 exclusive deepen */
