...
#define GIC_SOFT_WAVE 33u
#define GIC_SOFT_AREAS 40u
 ...
 * Soft≠product; not bar3.
 */
/* Grep: aarch64: gic: soft retbastion — Wave 33 return-bastion honesty */
...
/* Grep: aarch64: gic: soft retcitadel — Wave 33 exclusive citadel stamp */
...
aarch64_uart_puts(" (retcitadel stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: gic soft exclusive — Wave 33 exclusive deepen */
