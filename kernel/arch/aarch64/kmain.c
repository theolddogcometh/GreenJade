 ...
 *   aarch64: kmain soft inventory wave=25 phases=… soft_ok=… soft_fail=…
 ...
 *   aarch64: kmain soft deepen wave=25 areas=… logs=…
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: aarch64: kmain: soft retledger — Wave 25 return-ledger honesty */
            kprintf("aarch64: kmain: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)KMAIN_SOFT_WAVE);
            /* Grep: aarch64: kmain: soft retbeacon — Wave 25 exclusive beacon stamp */
    ...
    /*
     * Grep: aarch64: kmain soft exclusive — Wave 25 exclusive deepen.
