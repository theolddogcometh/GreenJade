 ...
 *   aarch64: kmain soft inventory wave=101 phases=… soft_ok=… soft_fail=…
 ...
 *   aarch64: kmain soft deepen wave=101 areas=… logs=…
...
kprintf("aarch64: kmain: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("aarch64: kmain: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: kmain: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("aarch64: kmain: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: kmain: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("aarch64: kmain: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("aarch64: kmain: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("aarch64: kmain: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retbastionangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("aarch64: kmain: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("aarch64: kmain: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retparapetangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("aarch64: kmain: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("aarch64: kmain: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retowerangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("aarch64: kmain: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("aarch64: kmain: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retwallangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("aarch64: kmain: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("aarch64: kmain: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retholdangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("aarch64: kmain: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("aarch64: kmain: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retfortressangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("aarch64: kmain: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("aarch64: kmain: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("aarch64: kmain: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("aarch64: kmain: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("aarch64: kmain: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("aarch64: kmain: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("aarch64: kmain: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("aarch64: kmain: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retaegisangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("aarch64: kmain: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("aarch64: kmain: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retsigilangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("aarch64: kmain: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("aarch64: kmain: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retglyphangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("aarch64: kmain: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("aarch64: kmain: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retshardangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("aarch64: kmain: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("aarch64: kmain: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retprismangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("aarch64: kmain: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("aarch64: kmain: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retcipherangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("aarch64: kmain: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("aarch64: kmain: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retledgerangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("aarch64: kmain: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("aarch64: kmain: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retvaultangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("aarch64: kmain: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("aarch64: kmain: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (rettokenangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("aarch64: kmain: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("aarch64: kmain: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retphaseangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("aarch64: kmain: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("aarch64: kmain: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retpulseangle stamp; Soft≠product)\n");

/* Grep: aarch64: kmain: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("aarch64: kmain: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("aarch64: kmain: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retboundangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("aarch64: kmain: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("aarch64: kmain: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retbladeangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("aarch64: kmain: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("aarch64: kmain: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retarcangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("aarch64: kmain: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("aarch64: kmain: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("aarch64: kmain: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("aarch64: kmain: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("aarch64: kmain: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("aarch64: kmain: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retellipseangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("aarch64: kmain: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("aarch64: kmain: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("aarch64: kmain: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("aarch64: kmain: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (rethelixangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("aarch64: kmain: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("aarch64: kmain: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retknotangle stamp; Soft≠product)\n");
