 ...
 *   aarch64: kmain soft inventory wave=19 phases=… soft_ok=… soft_fail=…
 ...
 *   aarch64: kmain soft deepen wave=19 areas=… logs=…
...
kmain_soft_inventory(void)
{
     ...
     */
    /* Grep: aarch64: kmain: soft retclass — Wave 19 return-class taxonomy */
    kprintf("aarch64: kmain: soft retclass ok|fail|inval|nodev|busy|nomem "
            "soft_only=1 product_gate=0 wave=%u "
            "(retclass taxonomy; Soft≠product; not bar3)\n",
            (unsigned)KMAIN_SOFT_WAVE);
    /* Grep: aarch64: kmain: soft retlane — Wave 19 return-lane catalog */
    ...
    /*
     * Grep: aarch64: kmain soft exclusive — Wave 19 exclusive deepen.
