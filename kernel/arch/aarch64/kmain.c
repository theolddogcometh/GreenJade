 ...
 *   aarch64: kmain soft inventory wave=96 phases=… soft_ok=… soft_fail=…
 ...
 *   aarch64: kmain soft deepen wave=96 areas=… logs=…
...
kprintf("aarch64: kmain: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("aarch64: kmain: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: kmain: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("aarch64: kmain: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: kmain: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("aarch64: kmain: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("aarch64: kmain: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("aarch64: kmain: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbastionangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("aarch64: kmain: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("aarch64: kmain: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retparapetangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("aarch64: kmain: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("aarch64: kmain: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retowerangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("aarch64: kmain: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("aarch64: kmain: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retwallangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("aarch64: kmain: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("aarch64: kmain: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retholdangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("aarch64: kmain: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("aarch64: kmain: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retfortressangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("aarch64: kmain: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("aarch64: kmain: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("aarch64: kmain: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("aarch64: kmain: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("aarch64: kmain: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("aarch64: kmain: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("aarch64: kmain: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("aarch64: kmain: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retaegisangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("aarch64: kmain: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("aarch64: kmain: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retsigilangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("aarch64: kmain: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("aarch64: kmain: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retglyphangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("aarch64: kmain: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("aarch64: kmain: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retshardangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("aarch64: kmain: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("aarch64: kmain: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retprismangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("aarch64: kmain: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("aarch64: kmain: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retcipherangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("aarch64: kmain: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("aarch64: kmain: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retledgerangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("aarch64: kmain: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("aarch64: kmain: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retvaultangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("aarch64: kmain: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("aarch64: kmain: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (rettokenangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("aarch64: kmain: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("aarch64: kmain: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retphaseangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("aarch64: kmain: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("aarch64: kmain: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retpulseangle stamp; Soft≠product)\n");

/* Grep: aarch64: kmain: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("aarch64: kmain: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("aarch64: kmain: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retboundangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("aarch64: kmain: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("aarch64: kmain: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbladeangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("aarch64: kmain: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("aarch64: kmain: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retarcangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("aarch64: kmain: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("aarch64: kmain: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retwedgeangle stamp; Soft≠product)\n");
