 ...
 *   aarch64: kmain soft inventory wave=22 phases=… soft_ok=… soft_fail=…
 ...
 *   aarch64: kmain soft deepen wave=22 areas=… logs=…
...
kmain_soft_inventory(void)
{
    ...
    kprintf("aarch64: kmain: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: aarch64: kmain: soft retphase — Wave 22 return-phase honesty */
            kprintf("aarch64: kmain: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)KMAIN_SOFT_WAVE);
            /* Grep: aarch64: kmain: soft retbadge — Wave 22 exclusive badge stamp */
    ...
    /*
     * Grep: aarch64: kmain soft exclusive — Wave 22 exclusive deepen.
