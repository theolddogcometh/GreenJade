 ...
 *   aarch64: kmain soft inventory wave=108 phases=… soft_ok=… soft_fail=…
 ...
 *   aarch64: kmain soft deepen wave=108 areas=… logs=…
...
kprintf("aarch64: kmain: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("aarch64: kmain: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: kmain: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("aarch64: kmain: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: kmain: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("aarch64: kmain: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("aarch64: kmain: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("aarch64: kmain: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("aarch64: kmain: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("aarch64: kmain: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparapetangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("aarch64: kmain: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("aarch64: kmain: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retowerangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("aarch64: kmain: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("aarch64: kmain: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwallangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("aarch64: kmain: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("aarch64: kmain: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retholdangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("aarch64: kmain: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("aarch64: kmain: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retfortressangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("aarch64: kmain: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("aarch64: kmain: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("aarch64: kmain: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("aarch64: kmain: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("aarch64: kmain: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("aarch64: kmain: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("aarch64: kmain: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("aarch64: kmain: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaegisangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("aarch64: kmain: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("aarch64: kmain: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retsigilangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("aarch64: kmain: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("aarch64: kmain: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retglyphangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("aarch64: kmain: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("aarch64: kmain: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retshardangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("aarch64: kmain: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("aarch64: kmain: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retprismangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("aarch64: kmain: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("aarch64: kmain: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcipherangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("aarch64: kmain: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("aarch64: kmain: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retledgerangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("aarch64: kmain: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("aarch64: kmain: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retvaultangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("aarch64: kmain: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("aarch64: kmain: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rettokenangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("aarch64: kmain: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("aarch64: kmain: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retphaseangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("aarch64: kmain: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("aarch64: kmain: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retpulseangle stamp; Soft≠product)\n");

/* Grep: aarch64: kmain: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("aarch64: kmain: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("aarch64: kmain: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retboundangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("aarch64: kmain: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("aarch64: kmain: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbladeangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("aarch64: kmain: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("aarch64: kmain: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retarcangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("aarch64: kmain: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("aarch64: kmain: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("aarch64: kmain: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("aarch64: kmain: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("aarch64: kmain: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("aarch64: kmain: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retellipseangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("aarch64: kmain: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("aarch64: kmain: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("aarch64: kmain: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("aarch64: kmain: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rethelixangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("aarch64: kmain: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("aarch64: kmain: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retknotangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("aarch64: kmain: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("aarch64: kmain: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retkleinangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("aarch64: kmain: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("aarch64: kmain: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaffineangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("aarch64: kmain: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("aarch64: kmain: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("aarch64: kmain: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("aarch64: kmain: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcubicangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("aarch64: kmain: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("aarch64: kmain: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retquinticangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("aarch64: kmain: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("aarch64: kmain: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbezierangle stamp; Soft≠product)\n");
/* Grep: aarch64: kmain: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("aarch64: kmain: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: kmain: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("aarch64: kmain: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcatmullangle stamp; Soft≠product)\n");
