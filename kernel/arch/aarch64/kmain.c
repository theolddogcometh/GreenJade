 ...
 *   aarch64: kmain soft inventory wave=26 phases=… soft_ok=… soft_fail=…
 ...
 *   aarch64: kmain soft deepen wave=26 areas=… logs=…
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: aarch64: kmain: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("aarch64: kmain: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)KMAIN_SOFT_WAVE);
            /* Grep: aarch64: kmain: soft retflame — Wave 26 exclusive flame stamp */
    ...
    /*
     * Grep: aarch64: kmain soft exclusive — Wave 26 exclusive deepen.
