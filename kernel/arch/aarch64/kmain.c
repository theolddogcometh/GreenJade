 ...
 *   aarch64: kmain soft inventory wave=31 phases=… soft_ok=… soft_fail=…
 ...
 *   aarch64: kmain soft deepen wave=31 areas=… logs=…
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("aarch64: kmain: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("aarch64: kmain: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: aarch64: kmain: soft retaegis — Wave 31 return-aegis honesty */
                            ...
                            kprintf("aarch64: kmain: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    ...
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)KMAIN_SOFT_WAVE);
                            /* Grep: aarch64: kmain: soft retmantle — Wave 31 exclusive mantle stamp */
    ...
    /*
     * Grep: aarch64: kmain soft exclusive — Wave 31 exclusive deepen.
