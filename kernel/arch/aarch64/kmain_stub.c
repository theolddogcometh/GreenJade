 ...
 *
 * -------------------------------------------------------------------------
 * Soft product surface (Wave 26 exclusive deepen; never hard-fails M0)
 * -------------------------------------------------------------------------
 ...
 *   aarch64: kmain_stub soft inventory wave=26 …
 *   aarch64: kmain_stub soft surf …
 *   aarch64: kmain_stub soft deepen wave=26 areas=…
...
#define KMAIN_STUB_SOFT_WAVE  26u
/* Areas: enter,gic,timer,inventory,surf,return,path,honesty,deepen */
#define KMAIN_STUB_SOFT_AREAS 25u
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: soft retcipher — Wave 26 return-cipher honesty */
...
/* Grep: aarch64: soft retflame — Wave 26 exclusive flame stamp */
...
/* Grep: aarch64: kmain_stub soft deepen */
    ...
    /* Grep: aarch64: kmain_stub soft exclusive — Wave 26 exclusive deepen */
