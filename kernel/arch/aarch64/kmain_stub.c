 ...
 *
 * -------------------------------------------------------------------------
 * Soft product surface (Wave 33 exclusive deepen; never hard-fails M0)
 * -------------------------------------------------------------------------
 ...
 *   aarch64: kmain_stub soft inventory wave=33 …
 *   aarch64: kmain_stub soft surf …
 *   aarch64: kmain_stub soft deepen wave=33 areas=…
...
#define KMAIN_STUB_SOFT_WAVE 33u
/* Areas: enter,gic,timer,inventory,surf,return,path,honesty,deepen */
#define KMAIN_STUB_SOFT_AREAS 37u
 ...
 * Soft≠product; not bar3.
 */
/* Grep: aarch64: soft retbastion — Wave 33 return-bastion honesty */
...
/* Grep: aarch64: soft retcitadel — Wave 33 exclusive citadel stamp */
...
/* Grep: aarch64: kmain_stub soft deepen */
    ...
    /* Grep: aarch64: kmain_stub soft exclusive — Wave 33 exclusive deepen */
