 ...
 *
 * -------------------------------------------------------------------------
 * Soft product surface (Wave 34 exclusive deepen; never hard-fails M0)
 * -------------------------------------------------------------------------
 ...
 *   aarch64: kmain_stub soft inventory wave=34 …
 *   aarch64: kmain_stub soft surf …
 *   aarch64: kmain_stub soft deepen wave=34 areas=…
...
#define KMAIN_STUB_SOFT_WAVE 34u
/* Areas: enter,gic,timer,inventory,surf,return,path,honesty,deepen */
#define KMAIN_STUB_SOFT_AREAS 39u
...
/* Grep: aarch64: kmain_stub soft deepen */
    ...
    /* Grep: aarch64: kmain_stub soft exclusive — Wave 34 exclusive deepen */
