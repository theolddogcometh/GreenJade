 ...
 * Soft deepen: area catalog + wave=67 stamp
 ...
 *   aarch64: mmu soft inventory wave=67 …
 *   aarch64: mmu soft deepen wave=67 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=67
