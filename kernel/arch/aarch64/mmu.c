 ...
 * Soft deepen: area catalog + wave=43 stamp
 ...
 *   aarch64: mmu soft inventory wave=43 …
 *   aarch64: mmu soft deepen wave=43 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=43
