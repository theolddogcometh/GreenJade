 ...
 * Soft deepen: area catalog + wave=23 stamp
 ...
 *   aarch64: mmu soft inventory wave=23 …
 *   aarch64: mmu soft deepen wave=23 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=23
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: mmu: soft rettoken — Wave 23 return-token honesty */
...
/* Grep: aarch64: mmu: soft retcrest — Wave 23 exclusive crest stamp */
...
aarch64_uart_puts("aarch64: mmu soft deepen wave=");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 23 exclusive deepen */
