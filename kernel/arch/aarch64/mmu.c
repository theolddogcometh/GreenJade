 ...
 * Soft deepen: area catalog + wave=37 stamp
 ...
 *   aarch64: mmu soft inventory wave=37 …
 *   aarch64: mmu soft deepen wave=37 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=37
