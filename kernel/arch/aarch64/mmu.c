 ...
 * Soft deepen: area catalog + wave=50 stamp
 ...
 *   aarch64: mmu soft inventory wave=50 …
 *   aarch64: mmu soft deepen wave=50 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=50
