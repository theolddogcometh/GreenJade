 ...
 * Soft deepen: area catalog + wave=69 stamp
 ...
 *   aarch64: mmu soft inventory wave=69 …
 *   aarch64: mmu soft deepen wave=69 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=69
