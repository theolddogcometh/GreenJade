 ...
 * Soft deepen: area catalog + wave=45 stamp
 ...
 *   aarch64: mmu soft inventory wave=45 …
 *   aarch64: mmu soft deepen wave=45 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=45
