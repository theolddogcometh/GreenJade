 ...
 * Soft deepen: area catalog + wave=47 stamp
 ...
 *   aarch64: mmu soft inventory wave=47 …
 *   aarch64: mmu soft deepen wave=47 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=47
