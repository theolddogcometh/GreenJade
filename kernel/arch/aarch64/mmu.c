 ...
 * Soft deepen: area catalog + wave=58 stamp
 ...
 *   aarch64: mmu soft inventory wave=58 …
 *   aarch64: mmu soft deepen wave=58 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=58
