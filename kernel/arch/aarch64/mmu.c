 ...
 * Soft deepen: area catalog + wave=44 stamp
 ...
 *   aarch64: mmu soft inventory wave=44 …
 *   aarch64: mmu soft deepen wave=44 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=44
