 ...
 * Soft deepen: area catalog + wave=40 stamp
 ...
 *   aarch64: mmu soft inventory wave=40 …
 *   aarch64: mmu soft deepen wave=40 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=40
