 ...
 * Soft deepen: area catalog + wave=34 stamp
 ...
 *   aarch64: mmu soft inventory wave=34 …
 *   aarch64: mmu soft deepen wave=34 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=34
...
aarch64_uart_puts(" (retkeep stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 34 exclusive deepen */
