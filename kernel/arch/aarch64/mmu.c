 ...
 * Soft deepen: area catalog + wave=35 stamp
 ...
 *   aarch64: mmu soft inventory wave=35 …
 *   aarch64: mmu soft deepen wave=35 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=35
