 ...
 * Soft deepen: area catalog + wave=32 stamp
 ...
 *   aarch64: mmu soft inventory wave=32 …
 *   aarch64: mmu soft deepen wave=32 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=32
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: mmu: soft retbulwark — Wave 32 return-bulwark honesty */
...
/* Grep: aarch64: mmu: soft retpanoply — Wave 32 exclusive panoply stamp */
...
aarch64_uart_puts(" (retpanoply stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 32 exclusive deepen */
