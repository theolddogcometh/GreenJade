 ...
 * Soft deepen: area catalog + wave=25 stamp
 ...
 *   aarch64: mmu soft inventory wave=25 …
 *   aarch64: mmu soft deepen wave=25 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=25
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: mmu: soft retledger — Wave 25 return-ledger honesty */
...
/* Grep: aarch64: mmu: soft retbeacon — Wave 25 exclusive beacon stamp */
...
aarch64_uart_puts("aarch64: mmu soft deepen wave=");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 25 exclusive deepen */
