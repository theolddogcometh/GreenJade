 ...
 * Soft deepen: area catalog + wave=36 stamp
 ...
 *   aarch64: mmu soft inventory wave=36 …
 *   aarch64: mmu soft deepen wave=36 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=36
