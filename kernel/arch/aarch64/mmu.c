 ...
 * Soft deepen: area catalog + wave=61 stamp
 ...
 *   aarch64: mmu soft inventory wave=61 …
 *   aarch64: mmu soft deepen wave=61 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=61
