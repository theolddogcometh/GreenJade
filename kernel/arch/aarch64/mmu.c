 ...
 * Soft deepen: area catalog + wave=60 stamp
 ...
 *   aarch64: mmu soft inventory wave=60 …
 *   aarch64: mmu soft deepen wave=60 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=60
