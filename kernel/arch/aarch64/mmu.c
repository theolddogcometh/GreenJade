 ...
 * Soft deepen: area catalog + wave=42 stamp
 ...
 *   aarch64: mmu soft inventory wave=42 …
 *   aarch64: mmu soft deepen wave=42 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=42
