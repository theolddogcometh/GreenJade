 ...
 * Soft deepen: area catalog + wave=68 stamp
 ...
 *   aarch64: mmu soft inventory wave=68 …
 *   aarch64: mmu soft deepen wave=68 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=68
