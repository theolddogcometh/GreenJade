 ...
 * Soft deepen: area catalog + wave=64 stamp
 ...
 *   aarch64: mmu soft inventory wave=64 …
 *   aarch64: mmu soft deepen wave=64 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=64
