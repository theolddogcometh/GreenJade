 ...
 * Soft deepen: area catalog + wave=31 stamp
 ...
 *   aarch64: mmu soft inventory wave=31 …
 *   aarch64: mmu soft deepen wave=31 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=31
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: mmu: soft retaegis — Wave 31 return-aegis honesty */
...
/* Grep: aarch64: mmu: soft retmantle — Wave 31 exclusive mantle stamp */
...
aarch64_uart_puts(" (retmantle stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 31 exclusive deepen */
