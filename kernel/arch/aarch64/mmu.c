 ...
 * Soft deepen: area catalog + wave=33 stamp
 ...
 *   aarch64: mmu soft inventory wave=33 …
 *   aarch64: mmu soft deepen wave=33 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=33
 ...
 * Soft≠product; not bar3.
 */
/* Grep: aarch64: mmu: soft retbastion — Wave 33 return-bastion honesty */
...
/* Grep: aarch64: mmu: soft retcitadel — Wave 33 exclusive citadel stamp */
...
aarch64_uart_puts(" (retcitadel stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 33 exclusive deepen */
