 ...
 * Soft deepen: area catalog + wave=52 stamp
 ...
 *   aarch64: mmu soft inventory wave=52 …
 *   aarch64: mmu soft deepen wave=52 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=52
