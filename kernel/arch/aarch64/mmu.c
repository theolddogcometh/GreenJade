 ...
 * Soft deepen: area catalog + wave=62 stamp
 ...
 *   aarch64: mmu soft inventory wave=62 …
 *   aarch64: mmu soft deepen wave=62 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=62
