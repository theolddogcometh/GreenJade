 ...
 * Soft deepen: area catalog + wave=59 stamp
 ...
 *   aarch64: mmu soft inventory wave=59 …
 *   aarch64: mmu soft deepen wave=59 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=59
