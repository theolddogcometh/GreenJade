 ...
 * Soft deepen: area catalog + wave=27 stamp
 ...
 *   aarch64: mmu soft inventory wave=27 …
 *   aarch64: mmu soft deepen wave=27 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=27
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: mmu: soft retprism — Wave 27 return-prism honesty */
...
/* Grep: aarch64: mmu: soft retforge — Wave 27 exclusive forge stamp */
...
aarch64_uart_puts("aarch64: mmu soft deepen wave=");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 27 exclusive deepen */
