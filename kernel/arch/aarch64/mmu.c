 ...
 * Soft deepen: area catalog + wave=41 stamp
 ...
 *   aarch64: mmu soft inventory wave=41 …
 *   aarch64: mmu soft deepen wave=41 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=41
