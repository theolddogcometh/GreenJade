 ...
 * Soft deepen: area catalog + wave=66 stamp
 ...
 *   aarch64: mmu soft inventory wave=66 …
 *   aarch64: mmu soft deepen wave=66 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=66
