 ...
 * Soft deepen: area catalog + wave=49 stamp
 ...
 *   aarch64: mmu soft inventory wave=49 …
 *   aarch64: mmu soft deepen wave=49 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=49
