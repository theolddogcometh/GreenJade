 ...
 * Soft deepen: area catalog + wave=26 stamp
 ...
 *   aarch64: mmu soft inventory wave=26 …
 *   aarch64: mmu soft deepen wave=26 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=26
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: mmu: soft retcipher — Wave 26 return-cipher honesty */
...
/* Grep: aarch64: mmu: soft retflame — Wave 26 exclusive flame stamp */
...
aarch64_uart_puts("aarch64: mmu soft deepen wave=");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 26 exclusive deepen */
