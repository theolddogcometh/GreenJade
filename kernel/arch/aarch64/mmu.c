 ...
 * Soft deepen: area catalog + wave=65 stamp
 ...
 *   aarch64: mmu soft inventory wave=65 …
 *   aarch64: mmu soft deepen wave=65 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=65
