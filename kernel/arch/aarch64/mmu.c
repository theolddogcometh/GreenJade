 ...
 * Soft deepen: area catalog + wave=53 stamp
 ...
 *   aarch64: mmu soft inventory wave=53 …
 *   aarch64: mmu soft deepen wave=53 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=53
