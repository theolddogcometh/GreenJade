 ...
 * Soft deepen: area catalog + wave=24 stamp
 ...
 *   aarch64: mmu soft inventory wave=24 …
 *   aarch64: mmu soft deepen wave=24 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=24
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: mmu: soft retvault — Wave 24 return-vault honesty */
...
/* Grep: aarch64: mmu: soft retbanner — Wave 24 exclusive banner stamp */
...
aarch64_uart_puts("aarch64: mmu soft deepen wave=");
    ...
    /* Grep: aarch64: mmu soft exclusive — Wave 24 exclusive deepen */
