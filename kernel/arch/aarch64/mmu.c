 ...
 * Soft deepen: area catalog + wave=63 stamp
 ...
 *   aarch64: mmu soft inventory wave=63 …
 *   aarch64: mmu soft deepen wave=63 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=63
