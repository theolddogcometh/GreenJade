 ...
 * Soft deepen: area catalog + wave=48 stamp
 ...
 *   aarch64: mmu soft inventory wave=48 …
 *   aarch64: mmu soft deepen wave=48 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=48
