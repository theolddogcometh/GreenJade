 ...
 * Soft deepen: area catalog + wave=46 stamp
 ...
 *   aarch64: mmu soft inventory wave=46 …
 *   aarch64: mmu soft deepen wave=46 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=46
