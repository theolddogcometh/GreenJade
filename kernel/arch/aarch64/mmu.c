 ...
 * Soft deepen: area catalog + wave=51 stamp
 ...
 *   aarch64: mmu soft inventory wave=51 …
 *   aarch64: mmu soft deepen wave=51 areas=…
 *   aarch64: mmu soft path identity=1 product_kernel=OPEN wave=51
