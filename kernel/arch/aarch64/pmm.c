 ...
 * Soft deepen: area catalog stamp wave=47.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=47
 *   aarch64: pmm soft inventory wave=47 …
 *   aarch64: pmm soft deepen wave=47 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=47
...
/* Wave 45 soft inventory stamp (greppable wave=47). */
#define PMM_SOFT_WAVE 47u

/* Soft deepen areas: pool,multi,lifo,step,inv,stats,path,surf,return,honesty,deepen. */
#define PMM_SOFT_AREAS 63u
