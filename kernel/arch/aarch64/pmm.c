 ...
 * Soft deepen: area catalog stamp wave=55.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=55
 *   aarch64: pmm soft inventory wave=55 …
 *   aarch64: pmm soft deepen wave=55 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=55
