 ...
 * Soft deepen: area catalog stamp wave=61.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=61
 *   aarch64: pmm soft inventory wave=61 …
 *   aarch64: pmm soft deepen wave=61 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=61
 *   aarch64: pmm soft path order0=1 hier=0 neon=0 tib_bar=0 core=1
 *             product_kernel=OPEN wave=61
...
/* Wave 45 soft inventory stamp (greppable wave=61). */
#define PMM_SOFT_WAVE 61u

/* Soft deepen areas: pool,multi,lifo,step,inv,stats,path,surf,return,honesty,deepen. */
#define PMM_SOFT_AREAS 91u
