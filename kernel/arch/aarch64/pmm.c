 ...
 * Soft deepen: area catalog stamp wave=72.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=72
 *   aarch64: pmm soft inventory wave=72 …
 *   aarch64: pmm soft deepen wave=72 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=72
 *   aarch64: pmm soft path order0=1 hier=0 neon=0 tib_bar=0 core=1
 *             product_kernel=OPEN wave=72
...
/* Wave 45 soft inventory stamp (greppable wave=72). */
#define PMM_SOFT_WAVE 72u

/* Soft deepen areas: pool,multi,lifo,step,inv,stats,path,surf,return,honesty,deepen. */
#define PMM_SOFT_AREAS 113u
...
kprintf("aarch64: pmm: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=72 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("aarch64: pmm: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=72 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: pmm: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=72 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("aarch64: pmm: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=72 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: pmm: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=72 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("aarch64: pmm: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=72 (retdoubletenailleangle stamp; Soft≠product)\n");
