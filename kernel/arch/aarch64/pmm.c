 ...
 *   aarch64: pmm soft deepen wave=124 areas=…
...
kprintf("aarch64: pmm: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("aarch64: pmm: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: pmm: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("aarch64: pmm: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: pmm: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("aarch64: pmm: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("aarch64: pmm: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("aarch64: pmm: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retbastionangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("aarch64: pmm: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("aarch64: pmm: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retparapetangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("aarch64: pmm: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("aarch64: pmm: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retowerangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("aarch64: pmm: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("aarch64: pmm: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retwallangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("aarch64: pmm: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("aarch64: pmm: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retholdangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("aarch64: pmm: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("aarch64: pmm: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retfortressangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("aarch64: pmm: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("aarch64: pmm: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("aarch64: pmm: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("aarch64: pmm: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("aarch64: pmm: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("aarch64: pmm: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("aarch64: pmm: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("aarch64: pmm: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retaegisangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("aarch64: pmm: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("aarch64: pmm: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retsigilangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("aarch64: pmm: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("aarch64: pmm: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retglyphangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("aarch64: pmm: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("aarch64: pmm: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retshardangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("aarch64: pmm: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("aarch64: pmm: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retprismangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("aarch64: pmm: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("aarch64: pmm: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retcipherangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("aarch64: pmm: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("aarch64: pmm: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retledgerangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("aarch64: pmm: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("aarch64: pmm: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retvaultangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("aarch64: pmm: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("aarch64: pmm: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (rettokenangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("aarch64: pmm: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("aarch64: pmm: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retphaseangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("aarch64: pmm: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("aarch64: pmm: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retpulseangle stamp; Soft≠product)\n");

/* Grep: aarch64: pmm: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("aarch64: pmm: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("aarch64: pmm: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retboundangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("aarch64: pmm: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("aarch64: pmm: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retbladeangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("aarch64: pmm: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("aarch64: pmm: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retarcangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("aarch64: pmm: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("aarch64: pmm: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("aarch64: pmm: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("aarch64: pmm: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("aarch64: pmm: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("aarch64: pmm: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retellipseangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("aarch64: pmm: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("aarch64: pmm: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("aarch64: pmm: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("aarch64: pmm: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (rethelixangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("aarch64: pmm: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("aarch64: pmm: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retknotangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("aarch64: pmm: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("aarch64: pmm: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retkleinangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("aarch64: pmm: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("aarch64: pmm: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retaffineangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("aarch64: pmm: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("aarch64: pmm: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("aarch64: pmm: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("aarch64: pmm: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retcubicangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("aarch64: pmm: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("aarch64: pmm: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retquinticangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("aarch64: pmm: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("aarch64: pmm: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retbezierangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("aarch64: pmm: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("aarch64: pmm: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("aarch64: pmm: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("aarch64: pmm: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("aarch64: pmm: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("aarch64: pmm: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retgridangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("aarch64: pmm: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("aarch64: pmm: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (rettexelangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("aarch64: pmm: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("aarch64: pmm: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retvertexangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retshaderangle — Wave 113 return-shaderangle honesty */
kprintf("aarch64: pmm: soft retshaderangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retshaderangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retpipelineangle — Wave 113 exclusive pipelineangle stamp */
kprintf("aarch64: pmm: soft retpipelineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retpipelineangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retframebufferangle — Wave 114 return-framebufferangle honesty */
kprintf("aarch64: pmm: soft retframebufferangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retframebufferangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retswapchainangle — Wave 114 exclusive swapchainangle stamp */
kprintf("aarch64: pmm: soft retswapchainangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retswapchainangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retpresentangle — Wave 115 return-presentangle honesty */
kprintf("aarch64: pmm: soft retpresentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retpresentangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retvsyncangle — Wave 115 exclusive vsyncangle stamp */
kprintf("aarch64: pmm: soft retvsyncangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retvsyncangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retfenceangle — Wave 116 return-fenceangle honesty */
kprintf("aarch64: pmm: soft retfenceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retfenceangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retsemaphoreangle — Wave 116 exclusive semaphoreangle stamp */
kprintf("aarch64: pmm: soft retsemaphoreangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retsemaphoreangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retmutexangle — Wave 117 return-mutexangle honesty */
kprintf("aarch64: pmm: soft retmutexangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retmutexangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcondangle — Wave 117 exclusive condangle stamp */
kprintf("aarch64: pmm: soft retcondangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retcondangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retbarrierangle — Wave 118 return-barrierangle honesty */
kprintf("aarch64: pmm: soft retbarrierangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=118 (retbarrierangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retatomicangle — Wave 118 exclusive atomicangle stamp */
kprintf("aarch64: pmm: soft retatomicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=118 (retatomicangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retqueueangle — Wave 119 return-queueangle honesty */
kprintf("aarch64: pmm: soft retqueueangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=119 (retqueueangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft reteventangle — Wave 119 exclusive eventangle stamp */
kprintf("aarch64: pmm: soft reteventangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=119 (reteventangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retchannelangle — Wave 120 return-channelangle honesty */
kprintf("aarch64: pmm: soft retchannelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=120 (retchannelangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retmailboxangle — Wave 120 exclusive mailboxangle stamp */
kprintf("aarch64: pmm: soft retmailboxangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=120 (retmailboxangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retstreamangle — Wave 121 return-streamangle honesty */
kprintf("aarch64: pmm: soft retstreamangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=121 (retstreamangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retpacketangle — Wave 121 exclusive packetangle stamp */
kprintf("aarch64: pmm: soft retpacketangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=121 (retpacketangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retframeangle — Wave 122 return-frameangle honesty */
kprintf("aarch64: pmm: soft retframeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=122 (retframeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retwindowangle — Wave 122 exclusive windowangle stamp */
kprintf("aarch64: pmm: soft retwindowangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=122 (retwindowangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retlayerangle — Wave 123 return-layerangle honesty */
kprintf("aarch64: pmm: soft retlayerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=123 (retlayerangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcanvasangle — Wave 123 exclusive canvasangle stamp */
kprintf("aarch64: pmm: soft retcanvasangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=123 (retcanvasangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retbrushangle — Wave 124 return-brushangle honesty */
kprintf("aarch64: pmm: soft retbrushangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=124 (retbrushangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retinkangle — Wave 124 exclusive inkangle stamp */
kprintf("aarch64: pmm: soft retinkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=124 (retinkangle stamp; Soft≠product)\n");
