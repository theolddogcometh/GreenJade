 ...
 * Soft deepen: area catalog stamp wave=53.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=53
 *   aarch64: pmm soft inventory wave=53 …
 *   aarch64: pmm soft deepen wave=53 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=53
...
/* Wave 45 soft inventory stamp (greppable wave=53). */
#define PMM_SOFT_WAVE 53u

/* Soft deepen areas: pool,multi,lifo,step,inv,stats,path,surf,return,honesty,deepen. */
#define PMM_SOFT_AREAS 75u
