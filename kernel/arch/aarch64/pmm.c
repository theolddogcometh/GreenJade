 ...
 * Soft deepen: area catalog stamp wave=50.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=50
 *   aarch64: pmm soft inventory wave=50 …
 *   aarch64: pmm soft deepen wave=50 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=50
