 ...
 * Soft deepen: area catalog stamp wave=66.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=66
 *   aarch64: pmm soft inventory wave=66 …
 *   aarch64: pmm soft deepen wave=66 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=66
 *   aarch64: pmm soft path order0=1 hier=0 neon=0 tib_bar=0 core=1
 *             product_kernel=OPEN wave=66
...
/* Wave 45 soft inventory stamp (greppable wave=66). */
#define PMM_SOFT_WAVE 66u

/* Soft deepen areas: pool,multi,lifo,step,inv,stats,path,surf,return,honesty,deepen. */
#define PMM_SOFT_AREAS 101u
