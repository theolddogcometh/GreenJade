 ...
 * Soft deepen: area catalog stamp wave=56.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=56
 *   aarch64: pmm soft inventory wave=56 …
 *   aarch64: pmm soft deepen wave=56 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=56
