 ...
 * Soft deepen: area catalog stamp wave=58.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=58
 *   aarch64: pmm soft inventory wave=58 …
 *   aarch64: pmm soft deepen wave=58 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=58
