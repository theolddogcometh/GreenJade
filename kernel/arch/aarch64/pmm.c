 ...
 * Soft deepen: area catalog stamp wave=54.
 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=54
 *   aarch64: pmm soft inventory wave=54 …
 *   aarch64: pmm soft deepen wave=54 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=54
