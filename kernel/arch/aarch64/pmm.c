 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=45
 *   aarch64: pmm soft inventory wave=45 …
 *   aarch64: pmm soft deepen wave=45 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=45
