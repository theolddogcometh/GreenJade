 ...
 *             lifo=… step=… null=… inv=…
 *   aarch64: pmm soft stats gates=… free=… total=… ratio=… logs=… wave=89
 *   aarch64: pmm soft inventory wave=89 …
 *   aarch64: pmm soft deepen wave=89 areas=…
 *   aarch64: pmm soft return inv_ret=… product_kernel=OPEN wave=89
...
kprintf("aarch64: pmm: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("aarch64: pmm: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: pmm: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("aarch64: pmm: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("aarch64: pmm: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("aarch64: pmm: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("aarch64: pmm: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("aarch64: pmm: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbastionangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("aarch64: pmm: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("aarch64: pmm: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retparapetangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("aarch64: pmm: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("aarch64: pmm: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retowerangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("aarch64: pmm: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("aarch64: pmm: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retwallangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("aarch64: pmm: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("aarch64: pmm: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retholdangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("aarch64: pmm: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("aarch64: pmm: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retfortressangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("aarch64: pmm: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("aarch64: pmm: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("aarch64: pmm: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("aarch64: pmm: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("aarch64: pmm: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("aarch64: pmm: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("aarch64: pmm: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("aarch64: pmm: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retaegisangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("aarch64: pmm: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("aarch64: pmm: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retsigilangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("aarch64: pmm: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("aarch64: pmm: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retglyphangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("aarch64: pmm: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("aarch64: pmm: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retshardangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("aarch64: pmm: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("aarch64: pmm: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retprismangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("aarch64: pmm: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("aarch64: pmm: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retcipherangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("aarch64: pmm: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("aarch64: pmm: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retledgerangle stamp; Soft≠product)\n");
/* Grep: aarch64: pmm: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("aarch64: pmm: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: aarch64: pmm: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("aarch64: pmm: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retvaultangle stamp; Soft≠product)\n");
