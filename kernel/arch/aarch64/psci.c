...
#define PSCI_SOFT_WAVE 33u
#define PSCI_SOFT_AREAS 39u
 ...
 * Soft≠product; not bar3.
 */
/* Grep: aarch64: psci: soft retbastion — Wave 33 return-bastion honesty */
...
/* Grep: aarch64: psci: soft retcitadel — Wave 33 exclusive citadel stamp */
...
aarch64_uart_puts(" (retcitadel stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: psci soft exclusive — Wave 33 exclusive deepen */
