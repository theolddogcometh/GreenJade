...
#define PSCI_SOFT_WAVE 32u
#define PSCI_SOFT_AREAS 37u
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: psci: soft retbulwark — Wave 32 return-bulwark honesty */
...
/* Grep: aarch64: psci: soft retpanoply — Wave 32 exclusive panoply stamp */
...
aarch64_uart_puts(" (retpanoply stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: psci soft exclusive — Wave 32 exclusive deepen */
