...
#define SVC_SOFT_WAVE   20u
#define SVC_SOFT_AREAS  15u
...
/*
 * Soft SVC inventory (Wave 9 base + Wave 20 exclusive deepen).
...
svc_soft_inventory(int fSvcCountOk, int fStubOk, int fDeepOk, int fGetpidOk)
{
     ...
     * Soft!=product; not bar3.
     */
    /* Grep: aarch64: svc: soft retbound — Wave 20 return-bound honesty */
    ...
    /* Grep: aarch64: svc: soft retseal — Wave 20 exclusive seal stamp */
    ...
    /* Grep: aarch64: svc soft exclusive — Wave 20 exclusive deepen */
