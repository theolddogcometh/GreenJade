 ...
 *
 * Soft inventory deepen (Wave 31 exclusive; this unit only):
...
#define SVC_SOFT_WAVE 31u
#define SVC_SOFT_AREAS 35u
...
/*
 * Soft SVC inventory (Wave 9 base + Wave 31 exclusive deepen).
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: svc: soft retaegis — Wave 31 return-aegis honesty */
...
/* Grep: aarch64: svc: soft retmantle — Wave 31 exclusive mantle stamp */
...
aarch64_uart_puts(" (retmantle stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: svc soft exclusive — Wave 31 exclusive deepen */
