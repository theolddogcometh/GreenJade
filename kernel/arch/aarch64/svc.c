...
#define SVC_SOFT_WAVE   30u
#define SVC_SOFT_AREAS 33u
...
/*
 * Soft SVC inventory (Wave 9 base + Wave 30 exclusive deepen).
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: svc: soft retsigil — Wave 30 return-sigil honesty */
...
/* Grep: aarch64: svc: soft retemblem — Wave 30 exclusive emblem stamp */
...
aarch64_uart_puts(" (retemblem stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: svc soft exclusive — Wave 30 exclusive deepen */
