...
#define SVC_SOFT_WAVE   19u
#define SVC_SOFT_AREAS  13u
...
/*
 * Soft SVC inventory (Wave 9 base + Wave 19 exclusive deepen).
...
svc_soft_inventory(int fSvcCountOk, int fStubOk, int fDeepOk, int fGetpidOk)
{
     ...
     */
    /* Grep: aarch64: svc: soft retclass — Wave 19 return-class taxonomy */
    ...
    /* Grep: aarch64: svc: soft retlane — Wave 19 return-lane catalog */
    ...
    /* Grep: aarch64: svc soft exclusive — Wave 19 exclusive deepen */
