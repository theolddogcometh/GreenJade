 ...
 *   6. Soft inventory deepen — Wave 18 multi-area inventory (this unit only)
 *
...
/*
 * Soft SVC inventory (Wave 9 base + Wave 18 exclusive deepen).
...
svc_soft_inventory(int fSvcCountOk, int fStubOk, int fDeepOk, int fGetpidOk)
{
    ...
    /* Grep: aarch64: svc soft surf — Wave 18 gate bit lamps */
