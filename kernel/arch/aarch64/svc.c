...
#define SVC_SOFT_WAVE   25u
#define SVC_SOFT_AREAS 25u
...
/*
 * Soft SVC inventory (Wave 9 base + Wave 25 exclusive deepen).
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: svc: soft retledger — Wave 25 return-ledger honesty */
...
/* Grep: aarch64: svc: soft retbeacon — Wave 25 exclusive beacon stamp */
...
aarch64_uart_puts("aarch64: svc soft deepen wave=");
    ...
    /* Grep: aarch64: svc soft exclusive — Wave 25 exclusive deepen */
