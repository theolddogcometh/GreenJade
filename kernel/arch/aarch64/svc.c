 ...
 *
 * Soft inventory deepen (Wave 32 exclusive; this unit only):
...
#define SVC_SOFT_WAVE 32u
#define SVC_SOFT_AREAS 37u
...
/*
 * Soft SVC inventory (Wave 9 base + Wave 32 exclusive deepen).
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: svc: soft retbulwark — Wave 32 return-bulwark honesty */
...
/* Grep: aarch64: svc: soft retpanoply — Wave 32 exclusive panoply stamp */
...
aarch64_uart_puts(" (retpanoply stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: svc soft exclusive — Wave 32 exclusive deepen */
