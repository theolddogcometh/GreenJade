 ...
 *
 * Soft inventory deepen (Wave 33 exclusive; this unit only):
...
#define SVC_SOFT_WAVE 33u
#define SVC_SOFT_AREAS 39u
...
/*
 * Soft SVC inventory (Wave 9 base + Wave 33 exclusive deepen).
 ...
 * Soft≠product; not bar3.
 */
/* Grep: aarch64: svc: soft retbastion — Wave 33 return-bastion honesty */
...
/* Grep: aarch64: svc: soft retcitadel — Wave 33 exclusive citadel stamp */
...
aarch64_uart_puts(" (retcitadel stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: svc soft exclusive — Wave 33 exclusive deepen */
