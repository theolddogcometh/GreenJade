 ...
 *
 * -------------------------------------------------------------------------
 * Soft UART inventory (Wave 20 exclusive deepen — no IRQ / no RX product path)
 * -------------------------------------------------------------------------
 ...
 *   aarch64: uart soft inventory wave=20 …
 *   aarch64: uart soft program base=… peri=… cell=… spin_cap=…
 *   aarch64: uart soft stats …
 *   aarch64: uart soft deepen wave=20 areas=…
 *   aarch64: uart soft path polled=1 irq=0 product_kernel=OPEN wave=20
...
uart_soft_inventory(void)
{
     ...
     * Soft!=product; not bar3.
     */
    /* Grep: aarch64: uart: soft retbound — Wave 20 return-bound honesty */
    ...
    /* Grep: aarch64: uart: soft retseal — Wave 20 exclusive seal stamp */
    ...
    /* Grep: aarch64: uart soft exclusive — Wave 20 exclusive deepen */
