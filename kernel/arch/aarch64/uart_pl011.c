 ...
 *
 * -------------------------------------------------------------------------
 * Soft UART inventory (Wave 34 exclusive deepen — no IRQ / no RX product path)
 * -------------------------------------------------------------------------
 ...
 *   aarch64: uart soft inventory wave=34 …
 *   aarch64: uart soft program base=… peri=… cell=… spin_cap=…
 *   aarch64: uart soft stats …
 *   aarch64: uart soft deepen wave=34 areas=…
 *   aarch64: uart soft path polled=1 irq=0 product_kernel=OPEN wave=34
...
aarch64_uart_puts(" (retkeep stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: uart soft exclusive — Wave 34 exclusive deepen */
