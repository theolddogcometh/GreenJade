 ...
 *
 * -------------------------------------------------------------------------
 * Soft UART inventory (Wave 28 exclusive deepen — no IRQ / no RX product path)
 * -------------------------------------------------------------------------
 ...
 * Soft deepen: area catalog stamp wave=28.
 ...
 *   aarch64: uart soft inventory wave=28 …
 *   aarch64: uart soft program base=… peri=… cell=… spin_cap=…
 *   aarch64: uart soft stats …
 *   aarch64: uart soft deepen wave=28 areas=…
 *   aarch64: uart soft path polled=1 irq=0 product_kernel=OPEN wave=28
...
/* Wave 28 soft inventory stamp (greppable wave=28). */
#define PL011_SOFT_WAVE 28u

/* Soft deepen areas: chars,fr,lamps,ctrl,id,program,stats,path,honesty. */
#define PL011_SOFT_AREAS 32u
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: uart: soft retshard — Wave 28 return-shard honesty */
...
/* Grep: aarch64: uart: soft retcrown — Wave 28 exclusive crown stamp */
...
aarch64_uart_puts("aarch64: uart soft deepen wave=");
    ...
    /* Grep: aarch64: uart soft exclusive — Wave 28 exclusive deepen */
