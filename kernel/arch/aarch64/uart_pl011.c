 ...
 *
 * -------------------------------------------------------------------------
 * Soft UART inventory (Wave 27 exclusive deepen — no IRQ / no RX product path)
 * -------------------------------------------------------------------------
 ...
 * Soft deepen: area catalog stamp wave=27.
 ...
 *   aarch64: uart soft inventory wave=27 …
 *   aarch64: uart soft program base=… peri=… cell=… spin_cap=…
 *   aarch64: uart soft stats …
 *   aarch64: uart soft deepen wave=27 areas=…
 *   aarch64: uart soft path polled=1 irq=0 product_kernel=OPEN wave=27
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: uart: soft retprism — Wave 27 return-prism honesty */
...
/* Grep: aarch64: uart: soft retforge — Wave 27 exclusive forge stamp */
...
aarch64_uart_puts("aarch64: uart soft deepen wave=");
    ...
    /* Grep: aarch64: uart soft exclusive — Wave 27 exclusive deepen */
