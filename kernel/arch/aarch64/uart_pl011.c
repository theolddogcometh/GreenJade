 ...
 *
 * -------------------------------------------------------------------------
 * Soft UART inventory (Wave 21 exclusive deepen — no IRQ / no RX product path)
 * -------------------------------------------------------------------------
 ...
 *   aarch64: uart soft inventory wave=21 …
 *   aarch64: uart soft program base=… peri=… cell=… spin_cap=…
 *   aarch64: uart soft stats …
 *   aarch64: uart soft deepen wave=21 areas=…
 *   aarch64: uart soft path polled=1 irq=0 product_kernel=OPEN wave=21
...
uart_soft_inventory(void)
{
     ...
     * Soft!=product; not bar3.
     */
    /* Grep: aarch64: uart: soft retpulse — Wave 21 return-pulse honesty */
    ...
    /* Grep: aarch64: uart: soft retmark — Wave 21 exclusive mark stamp */
    ...
    /* Grep: aarch64: uart soft exclusive — Wave 21 exclusive deepen */
