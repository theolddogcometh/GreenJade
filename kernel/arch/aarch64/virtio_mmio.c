...
#define VIRTIO_SOFT_WAVE   25u
#define VIRTIO_SOFT_AREAS 27u
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: virtio: soft retledger — Wave 25 return-ledger honesty */
...
/* Grep: aarch64: virtio: soft retbeacon — Wave 25 exclusive beacon stamp */
...
aarch64_uart_puts("aarch64: virtio soft deepen wave=");
    ...
    /* Grep: aarch64: virtio soft exclusive — Wave 25 exclusive deepen */
