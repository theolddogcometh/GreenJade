...
#define VIRTIO_SOFT_WAVE   29u
#define VIRTIO_SOFT_AREAS 33u
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: virtio: soft retglyph — Wave 29 return-glyph honesty */
...
/* Grep: aarch64: virtio: soft retscepter — Wave 29 exclusive scepter stamp */
...
aarch64_uart_puts(" (retscepter stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: virtio soft exclusive — Wave 29 exclusive deepen */
