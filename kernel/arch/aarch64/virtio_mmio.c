...
#define VIRTIO_SOFT_WAVE   30u
#define VIRTIO_SOFT_AREAS 35u
 ...
 * Soft!=product; not bar3.
 */
/* Grep: aarch64: virtio: soft retsigil — Wave 30 return-sigil honesty */
...
/* Grep: aarch64: virtio: soft retemblem — Wave 30 exclusive emblem stamp */
...
aarch64_uart_puts(" (retemblem stamp; Soft!=product)\n");
    ...
    /* Grep: aarch64: virtio soft exclusive — Wave 30 exclusive deepen */
