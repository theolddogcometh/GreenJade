 ...
 *   apic: soft deepen …                     — wave=95 areas stamp
...
kprintf("apic: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("apic: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("apic: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("apic: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("apic: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("apic: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("apic: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("apic: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionangle stamp; Soft≠product)\n");
/* Grep: apic: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("apic: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("apic: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retparapetangle stamp; Soft≠product)\n");
/* Grep: apic: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("apic: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("apic: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retowerangle stamp; Soft≠product)\n");
/* Grep: apic: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("apic: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("apic: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retwallangle stamp; Soft≠product)\n");
/* Grep: apic: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("apic: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("apic: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retholdangle stamp; Soft≠product)\n");
/* Grep: apic: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("apic: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("apic: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retfortressangle stamp; Soft≠product)\n");
/* Grep: apic: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("apic: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("apic: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("apic: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("apic: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: apic: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("apic: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("apic: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: apic: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("apic: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("apic: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retaegisangle stamp; Soft≠product)\n");
/* Grep: apic: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("apic: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("apic: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retsigilangle stamp; Soft≠product)\n");
/* Grep: apic: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("apic: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("apic: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retglyphangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("apic: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("apic: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retshardangle stamp; Soft≠product)\n");
/* Grep: apic: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("apic: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("apic: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retprismangle stamp; Soft≠product)\n");
/* Grep: apic: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("apic: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("apic: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcipherangle stamp; Soft≠product)\n");
/* Grep: apic: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("apic: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("apic: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retledgerangle stamp; Soft≠product)\n");
/* Grep: apic: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("apic: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("apic: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retvaultangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("apic: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("apic: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (rettokenangle stamp; Soft≠product)\n");
/* Grep: apic: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("apic: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("apic: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retphaseangle stamp; Soft≠product)\n");
/* Grep: apic: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("apic: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("apic: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retpulseangle stamp; Soft≠product)\n");

/* Grep: apic: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("apic: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("apic: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retboundangle stamp; Soft≠product)\n");
/* Grep: apic: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("apic: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("apic: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbladeangle stamp; Soft≠product)\n");
/* Grep: apic: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("apic: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("apic: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retarcangle stamp; Soft≠product)\n");
