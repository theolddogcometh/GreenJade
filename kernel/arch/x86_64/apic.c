 ...
 *   apic: soft deepen …                     — wave=114 areas stamp
...
kprintf("apic: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("apic: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("apic: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("apic: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("apic: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("apic: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("apic: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("apic: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbastionangle stamp; Soft≠product)\n");
/* Grep: apic: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("apic: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("apic: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retparapetangle stamp; Soft≠product)\n");
/* Grep: apic: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("apic: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("apic: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retowerangle stamp; Soft≠product)\n");
/* Grep: apic: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("apic: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("apic: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retwallangle stamp; Soft≠product)\n");
/* Grep: apic: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("apic: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("apic: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retholdangle stamp; Soft≠product)\n");
/* Grep: apic: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("apic: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("apic: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retfortressangle stamp; Soft≠product)\n");
/* Grep: apic: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("apic: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("apic: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("apic: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("apic: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: apic: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("apic: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("apic: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: apic: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("apic: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("apic: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retaegisangle stamp; Soft≠product)\n");
/* Grep: apic: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("apic: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("apic: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retsigilangle stamp; Soft≠product)\n");
/* Grep: apic: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("apic: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("apic: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retglyphangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("apic: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("apic: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retshardangle stamp; Soft≠product)\n");
/* Grep: apic: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("apic: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("apic: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retprismangle stamp; Soft≠product)\n");
/* Grep: apic: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("apic: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("apic: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retcipherangle stamp; Soft≠product)\n");
/* Grep: apic: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("apic: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("apic: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retledgerangle stamp; Soft≠product)\n");
/* Grep: apic: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("apic: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("apic: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retvaultangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("apic: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("apic: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (rettokenangle stamp; Soft≠product)\n");
/* Grep: apic: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("apic: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("apic: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retphaseangle stamp; Soft≠product)\n");
/* Grep: apic: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("apic: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("apic: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retpulseangle stamp; Soft≠product)\n");

/* Grep: apic: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("apic: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("apic: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retboundangle stamp; Soft≠product)\n");
/* Grep: apic: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("apic: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("apic: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbladeangle stamp; Soft≠product)\n");
/* Grep: apic: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("apic: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("apic: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retarcangle stamp; Soft≠product)\n");
/* Grep: apic: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("apic: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("apic: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: apic: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("apic: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("apic: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: apic: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("apic: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("apic: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retellipseangle stamp; Soft≠product)\n");
/* Grep: apic: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("apic: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("apic: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: apic: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("apic: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("apic: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (rethelixangle stamp; Soft≠product)\n");
/* Grep: apic: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("apic: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("apic: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retknotangle stamp; Soft≠product)\n");
/* Grep: apic: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("apic: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("apic: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retkleinangle stamp; Soft≠product)\n");
/* Grep: apic: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("apic: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("apic: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retaffineangle stamp; Soft≠product)\n");
/* Grep: apic: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("apic: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("apic: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: apic: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("apic: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("apic: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retcubicangle stamp; Soft≠product)\n");
/* Grep: apic: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("apic: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("apic: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retquinticangle stamp; Soft≠product)\n");
/* Grep: apic: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("apic: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("apic: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbezierangle stamp; Soft≠product)\n");
/* Grep: apic: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("apic: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("apic: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: apic: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("apic: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("apic: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: apic: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("apic: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("apic: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retgridangle stamp; Soft≠product)\n");
/* Grep: apic: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("apic: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("apic: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (rettexelangle stamp; Soft≠product)\n");
/* Grep: apic: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("apic: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("apic: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retvertexangle stamp; Soft≠product)\n");
/* Grep: apic: soft retshaderangle — Wave 113 return-shaderangle honesty */
kprintf("apic: soft retshaderangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retshaderangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retpipelineangle — Wave 113 exclusive pipelineangle stamp */
kprintf("apic: soft retpipelineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retpipelineangle stamp; Soft≠product)\n");
/* Grep: apic: soft retframebufferangle — Wave 114 return-framebufferangle honesty */
kprintf("apic: soft retframebufferangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retframebufferangle honesty; Soft≠product; not bar3)\n");
/* Grep: apic: soft retswapchainangle — Wave 114 exclusive swapchainangle stamp */
kprintf("apic: soft retswapchainangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retswapchainangle stamp; Soft≠product)\n");
