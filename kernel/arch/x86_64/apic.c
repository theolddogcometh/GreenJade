 ...
 *
 * Soft APIC inventory (Wave 10 base + Wave 12 path + Wave 25 exclusive deepen;
 ...
 *   apic: soft deepen …                     — wave=25 areas stamp
 ...
 * Wave 10 base + Wave 12 path + Wave 25 exclusive deepen.
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: apic: soft retledger — Wave 25 return-ledger honesty */
            kprintf("apic: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)APIC_SOFT_WAVE);
            /* Grep: apic: soft retbeacon — Wave 25 exclusive beacon stamp */
