 ...
 *
 * Soft APIC inventory (Wave 10 base + Wave 12 path + Wave 24 exclusive deepen;
 ...
 *   apic: soft deepen …                     — wave=24 areas stamp
 ...
 * Wave 10 base + Wave 12 path + Wave 24 exclusive deepen.
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: apic: soft retvault — Wave 24 return-vault honesty */
            kprintf("apic: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)APIC_SOFT_WAVE);
            /* Grep: apic: soft retbanner — Wave 24 exclusive banner stamp */
