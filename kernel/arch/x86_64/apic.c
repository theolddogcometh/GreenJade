 ...
 *
 * Soft APIC inventory (Wave 10 base + Wave 12 path + Wave 28 exclusive deepen;
 ...
 *   apic: soft deepen …                     — wave=28 areas stamp
 ...
 * Wave 10 base + Wave 12 path + Wave 28 exclusive deepen.
            ...
            */
            ...
            kprintf("apic: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("apic: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: apic: soft retshard — Wave 28 return-shard honesty */
                            kprintf("apic: soft retshard soft_only=1 product_gate=0 soft_ne_product=1 "
                                "never_blocks_m0=1 wave=%u "
                                "(retshard honesty; Soft≠product; not bar3)\n",
                                (unsigned)APIC_SOFT_WAVE);
                            /* Grep: apic: soft retcrown — Wave 28 exclusive crown stamp */
