 ...
 *
 * Soft APIC inventory (Wave 10 base + Wave 12 path + Wave 34 exclusive deepen;
 ...
 *   apic: soft deepen …                     — wave=34 areas stamp
 ...
 * Wave 10 base + Wave 12 path + Wave 34 exclusive deepen.
