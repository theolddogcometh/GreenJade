...
#define GJ_CPU_SYSCALL_SOFT_WAVE 108u
...
kprintf("cpu: syscall: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("cpu: syscall: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("cpu: syscall: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("cpu: syscall: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("cpu: syscall: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("cpu: syscall: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("cpu: syscall: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("cpu: syscall: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("cpu: syscall: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("cpu: syscall: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparapetangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("cpu: syscall: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("cpu: syscall: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retowerangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("cpu: syscall: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("cpu: syscall: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwallangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("cpu: syscall: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("cpu: syscall: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retholdangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("cpu: syscall: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("cpu: syscall: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retfortressangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("cpu: syscall: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("cpu: syscall: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("cpu: syscall: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("cpu: syscall: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("cpu: syscall: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("cpu: syscall: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("cpu: syscall: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("cpu: syscall: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaegisangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("cpu: syscall: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("cpu: syscall: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retsigilangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("cpu: syscall: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("cpu: syscall: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retglyphangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("cpu: syscall: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("cpu: syscall: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retshardangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("cpu: syscall: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("cpu: syscall: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retprismangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("cpu: syscall: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("cpu: syscall: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcipherangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("cpu: syscall: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("cpu: syscall: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retledgerangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("cpu: syscall: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("cpu: syscall: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retvaultangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("cpu: syscall: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("cpu: syscall: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rettokenangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("cpu: syscall: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("cpu: syscall: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retphaseangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("cpu: syscall: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("cpu: syscall: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retpulseangle stamp; Soft≠product)\n");

/* Grep: cpu: syscall: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("cpu: syscall: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("cpu: syscall: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retboundangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("cpu: syscall: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("cpu: syscall: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbladeangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("cpu: syscall: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("cpu: syscall: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retarcangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("cpu: syscall: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("cpu: syscall: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("cpu: syscall: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("cpu: syscall: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("cpu: syscall: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("cpu: syscall: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retellipseangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("cpu: syscall: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("cpu: syscall: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("cpu: syscall: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("cpu: syscall: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rethelixangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("cpu: syscall: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("cpu: syscall: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retknotangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("cpu: syscall: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("cpu: syscall: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retkleinangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("cpu: syscall: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("cpu: syscall: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaffineangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("cpu: syscall: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("cpu: syscall: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("cpu: syscall: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("cpu: syscall: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcubicangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("cpu: syscall: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("cpu: syscall: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retquinticangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("cpu: syscall: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("cpu: syscall: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbezierangle stamp; Soft≠product)\n");
/* Grep: cpu: syscall: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("cpu: syscall: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: cpu: syscall: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("cpu: syscall: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcatmullangle stamp; Soft≠product)\n");
