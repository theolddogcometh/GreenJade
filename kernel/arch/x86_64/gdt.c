 ...
 *   "gdt: soft deepen …"   — wave=25 areas stamp
...
#define GJ_GDT_SOFT_WAVE     25u   /* Wave 25 exclusive deepen stamp */
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: gdt: soft retledger — Wave 25 return-ledger honesty */
            kprintf("gdt: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_GDT_SOFT_WAVE);
            /* Grep: gdt: soft retbeacon — Wave 25 exclusive beacon stamp */
