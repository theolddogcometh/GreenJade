 ...
 *   "gdt: soft deepen …"   — wave=32 areas stamp
...
#define GJ_GDT_SOFT_WAVE 32u   /* Wave 32 exclusive deepen stamp */
 ...
 * Soft≠product; not bar3.
 */
/* Grep: gdt: soft retbulwark — Wave 32 return-bulwark honesty */
kprintf("gdt: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbulwark honesty; Soft≠product; not bar3)\n",
        (unsigned)GJ_GDT_SOFT_WAVE);
/* Grep: gdt: soft retpanoply — Wave 32 exclusive panoply stamp */
