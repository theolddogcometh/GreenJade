 ...
 *   "gdt: soft deepen …"   — wave=26 areas stamp
...
#define GJ_GDT_SOFT_WAVE     26u   /* Wave 26 exclusive deepen stamp */
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: gdt: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("gdt: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_GDT_SOFT_WAVE);
            /* Grep: gdt: soft retflame — Wave 26 exclusive flame stamp */
