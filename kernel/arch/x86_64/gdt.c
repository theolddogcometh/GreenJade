 ...
 *   "gdt: soft deepen …"   — wave=102 areas stamp
...
#define GJ_GDT_SOFT_WAVE 102u   /* Wave 37 exclusive deepen stamp */
...
kprintf("gdt: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("gdt: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("gdt: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("gdt: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("gdt: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("gdt: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("gdt: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("gdt: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbastionangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("gdt: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("gdt: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retparapetangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("gdt: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("gdt: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retowerangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("gdt: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("gdt: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retwallangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("gdt: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("gdt: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retholdangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("gdt: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("gdt: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retfortressangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("gdt: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("gdt: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("gdt: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("gdt: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: gdt: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("gdt: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("gdt: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("gdt: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("gdt: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retaegisangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("gdt: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("gdt: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retsigilangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("gdt: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("gdt: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retglyphangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("gdt: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("gdt: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retshardangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("gdt: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("gdt: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retprismangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("gdt: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("gdt: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retcipherangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("gdt: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("gdt: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retledgerangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("gdt: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("gdt: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retvaultangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("gdt: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("gdt: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (rettokenangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("gdt: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("gdt: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retphaseangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("gdt: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("gdt: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retpulseangle stamp; Soft≠product)\n");

/* Grep: gdt: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("gdt: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("gdt: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retboundangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("gdt: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("gdt: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbladeangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("gdt: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("gdt: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retarcangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("gdt: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("gdt: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("gdt: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("gdt: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("gdt: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("gdt: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retellipseangle stamp; Soft≠product)\n");
/* Grep: gdt: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("gdt: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("gdt: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("gdt: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("gdt: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (rethelixangle stamp; Soft≠product)\n");
/* Grep: gdt: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("gdt: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("gdt: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retknotangle stamp; Soft≠product)\n");
/* Grep: gdt: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("gdt: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: gdt: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("gdt: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retkleinangle stamp; Soft≠product)\n");
