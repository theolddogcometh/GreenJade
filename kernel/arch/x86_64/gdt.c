 ...
 *   "gdt: soft deepen …"   — wave=27 areas stamp
...
#define GJ_GDT_SOFT_WAVE     27u   /* Wave 27 exclusive deepen stamp */
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("gdt: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: gdt: soft retprism — Wave 27 return-prism honesty */
                    kprintf("gdt: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)GJ_GDT_SOFT_WAVE);
                    /* Grep: gdt: soft retforge — Wave 27 exclusive forge stamp */
