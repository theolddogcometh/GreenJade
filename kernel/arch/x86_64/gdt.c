 ...
 *   "gdt: soft deepen …"   — wave=33 areas stamp
...
#define GJ_GDT_SOFT_WAVE 33u   /* Wave 33 exclusive deepen stamp */
 ...
 * Soft≠product; not bar3.
 */
/* Grep: gdt: soft retbastion — Wave 33 return-bastion honesty */
kprintf("gdt: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbastion honesty; Soft≠product; not bar3)\n",
        (unsigned)GJ_GDT_SOFT_WAVE);
/* Grep: gdt: soft retcitadel — Wave 33 exclusive citadel stamp */
