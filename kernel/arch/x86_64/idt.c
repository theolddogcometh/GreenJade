 ...
 *   idt: soft deepen …    — wave=24 areas stamp
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: idt: soft retvault — Wave 24 return-vault honesty */
            kprintf("idt: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)IDT_SOFT_WAVE);
            /* Grep: idt: soft retbanner — Wave 24 exclusive banner stamp */
