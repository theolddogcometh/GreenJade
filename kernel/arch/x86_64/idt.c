 ...
 *   idt: soft deepen …    — wave=116 areas stamp
...
kprintf("idt: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("idt: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("idt: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("idt: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("idt: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("idt: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("idt: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("idt: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbastionangle stamp; Soft≠product)\n");
/* Grep: idt: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("idt: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("idt: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retparapetangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("idt: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("idt: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retowerangle stamp; Soft≠product)\n");
/* Grep: idt: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("idt: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("idt: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retwallangle stamp; Soft≠product)\n");
/* Grep: idt: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("idt: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("idt: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retholdangle stamp; Soft≠product)\n");
/* Grep: idt: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("idt: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("idt: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retfortressangle stamp; Soft≠product)\n");
/* Grep: idt: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("idt: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("idt: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("idt: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("idt: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: idt: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("idt: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("idt: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("idt: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("idt: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retaegisangle stamp; Soft≠product)\n");
/* Grep: idt: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("idt: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("idt: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retsigilangle stamp; Soft≠product)\n");
/* Grep: idt: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("idt: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("idt: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retglyphangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("idt: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("idt: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retshardangle stamp; Soft≠product)\n");
/* Grep: idt: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("idt: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("idt: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retprismangle stamp; Soft≠product)\n");
/* Grep: idt: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("idt: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("idt: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retcipherangle stamp; Soft≠product)\n");
/* Grep: idt: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("idt: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("idt: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retledgerangle stamp; Soft≠product)\n");
/* Grep: idt: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("idt: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("idt: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retvaultangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("idt: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("idt: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (rettokenangle stamp; Soft≠product)\n");
/* Grep: idt: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("idt: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("idt: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retphaseangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("idt: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("idt: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retpulseangle stamp; Soft≠product)\n");

/* Grep: idt: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("idt: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("idt: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retboundangle stamp; Soft≠product)\n");
/* Grep: idt: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("idt: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("idt: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbladeangle stamp; Soft≠product)\n");
/* Grep: idt: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("idt: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("idt: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retarcangle stamp; Soft≠product)\n");
/* Grep: idt: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("idt: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("idt: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: idt: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("idt: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("idt: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("idt: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("idt: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retellipseangle stamp; Soft≠product)\n");
/* Grep: idt: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("idt: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("idt: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: idt: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("idt: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("idt: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (rethelixangle stamp; Soft≠product)\n");
/* Grep: idt: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("idt: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("idt: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retknotangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("idt: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("idt: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retkleinangle stamp; Soft≠product)\n");
/* Grep: idt: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("idt: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("idt: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retaffineangle stamp; Soft≠product)\n");
/* Grep: idt: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("idt: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("idt: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: idt: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("idt: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("idt: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retcubicangle stamp; Soft≠product)\n");
/* Grep: idt: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("idt: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("idt: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retquinticangle stamp; Soft≠product)\n");
/* Grep: idt: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("idt: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("idt: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbezierangle stamp; Soft≠product)\n");
/* Grep: idt: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("idt: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("idt: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: idt: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("idt: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("idt: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("idt: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("idt: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retgridangle stamp; Soft≠product)\n");
/* Grep: idt: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("idt: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("idt: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (rettexelangle stamp; Soft≠product)\n");
/* Grep: idt: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("idt: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("idt: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retvertexangle stamp; Soft≠product)\n");
/* Grep: idt: soft retshaderangle — Wave 113 return-shaderangle honesty */
kprintf("idt: soft retshaderangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retshaderangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retpipelineangle — Wave 113 exclusive pipelineangle stamp */
kprintf("idt: soft retpipelineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retpipelineangle stamp; Soft≠product)\n");
/* Grep: idt: soft retframebufferangle — Wave 114 return-framebufferangle honesty */
kprintf("idt: soft retframebufferangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retframebufferangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retswapchainangle — Wave 114 exclusive swapchainangle stamp */
kprintf("idt: soft retswapchainangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retswapchainangle stamp; Soft≠product)\n");
/* Grep: idt: soft retpresentangle — Wave 115 return-presentangle honesty */
kprintf("idt: soft retpresentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retpresentangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retvsyncangle — Wave 115 exclusive vsyncangle stamp */
kprintf("idt: soft retvsyncangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retvsyncangle stamp; Soft≠product)\n");
/* Grep: idt: soft retfenceangle — Wave 116 return-fenceangle honesty */
kprintf("idt: soft retfenceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retfenceangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retsemaphoreangle — Wave 116 exclusive semaphoreangle stamp */
kprintf("idt: soft retsemaphoreangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retsemaphoreangle stamp; Soft≠product)\n");
