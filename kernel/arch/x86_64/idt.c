 ...
 *   idt: soft deepen …    — wave=23 areas stamp
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: idt: soft rettoken — Wave 23 return-token honesty */
            kprintf("idt: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)IDT_SOFT_WAVE);
            /* Grep: idt: soft retcrest — Wave 23 exclusive crest stamp */
