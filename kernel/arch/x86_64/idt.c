 ...
 *   idt: soft deepen …    — wave=102 areas stamp
...
kprintf("idt: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("idt: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("idt: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("idt: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("idt: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("idt: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("idt: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("idt: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbastionangle stamp; Soft≠product)\n");
/* Grep: idt: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("idt: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("idt: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retparapetangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("idt: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("idt: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retowerangle stamp; Soft≠product)\n");
/* Grep: idt: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("idt: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("idt: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retwallangle stamp; Soft≠product)\n");
/* Grep: idt: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("idt: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("idt: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retholdangle stamp; Soft≠product)\n");
/* Grep: idt: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("idt: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("idt: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retfortressangle stamp; Soft≠product)\n");
/* Grep: idt: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("idt: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("idt: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("idt: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("idt: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: idt: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("idt: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("idt: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("idt: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("idt: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retaegisangle stamp; Soft≠product)\n");
/* Grep: idt: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("idt: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("idt: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retsigilangle stamp; Soft≠product)\n");
/* Grep: idt: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("idt: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("idt: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retglyphangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("idt: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("idt: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retshardangle stamp; Soft≠product)\n");
/* Grep: idt: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("idt: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("idt: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retprismangle stamp; Soft≠product)\n");
/* Grep: idt: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("idt: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("idt: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retcipherangle stamp; Soft≠product)\n");
/* Grep: idt: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("idt: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("idt: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retledgerangle stamp; Soft≠product)\n");
/* Grep: idt: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("idt: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("idt: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retvaultangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("idt: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("idt: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (rettokenangle stamp; Soft≠product)\n");
/* Grep: idt: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("idt: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("idt: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retphaseangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("idt: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("idt: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retpulseangle stamp; Soft≠product)\n");

/* Grep: idt: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("idt: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("idt: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retboundangle stamp; Soft≠product)\n");
/* Grep: idt: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("idt: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("idt: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbladeangle stamp; Soft≠product)\n");
/* Grep: idt: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("idt: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("idt: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retarcangle stamp; Soft≠product)\n");
/* Grep: idt: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("idt: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("idt: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: idt: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("idt: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("idt: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: idt: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("idt: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("idt: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retellipseangle stamp; Soft≠product)\n");
/* Grep: idt: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("idt: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("idt: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: idt: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("idt: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("idt: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (rethelixangle stamp; Soft≠product)\n");
/* Grep: idt: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("idt: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("idt: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retknotangle stamp; Soft≠product)\n");
/* Grep: idt: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("idt: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: idt: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("idt: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retkleinangle stamp; Soft≠product)\n");
