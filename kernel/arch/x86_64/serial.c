 ...
 * Wave 27 exclusive deepen, prefix-stable):
 *   serial: soft inventory … wave=27
 ...
 *   serial: soft deepen …     — wave=27 areas stamp
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("serial: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: serial: soft retprism — Wave 27 return-prism honesty */
                    kprintf("serial: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)UART_SOFT_WAVE);
                    /* Grep: serial: soft retforge — Wave 27 exclusive forge stamp */
