 ...
 *   serial: soft deepen …     — wave=99 areas stamp
...
kprintf("serial: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("serial: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("serial: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("serial: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("serial: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("serial: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("serial: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("serial: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbastionangle stamp; Soft≠product)\n");
/* Grep: serial: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("serial: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("serial: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retparapetangle stamp; Soft≠product)\n");
/* Grep: serial: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("serial: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("serial: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retowerangle stamp; Soft≠product)\n");
/* Grep: serial: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("serial: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("serial: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retwallangle stamp; Soft≠product)\n");
/* Grep: serial: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("serial: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("serial: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retholdangle stamp; Soft≠product)\n");
/* Grep: serial: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("serial: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("serial: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retfortressangle stamp; Soft≠product)\n");
/* Grep: serial: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("serial: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("serial: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("serial: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("serial: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: serial: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("serial: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("serial: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: serial: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("serial: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("serial: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retaegisangle stamp; Soft≠product)\n");
/* Grep: serial: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("serial: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("serial: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retsigilangle stamp; Soft≠product)\n");
/* Grep: serial: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("serial: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("serial: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retglyphangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("serial: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("serial: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retshardangle stamp; Soft≠product)\n");
/* Grep: serial: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("serial: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("serial: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retprismangle stamp; Soft≠product)\n");
/* Grep: serial: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("serial: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("serial: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retcipherangle stamp; Soft≠product)\n");
/* Grep: serial: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("serial: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("serial: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retledgerangle stamp; Soft≠product)\n");
/* Grep: serial: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("serial: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("serial: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retvaultangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("serial: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("serial: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (rettokenangle stamp; Soft≠product)\n");
/* Grep: serial: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("serial: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("serial: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retphaseangle stamp; Soft≠product)\n");
/* Grep: serial: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("serial: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("serial: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retpulseangle stamp; Soft≠product)\n");

/* Grep: serial: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("serial: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("serial: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retboundangle stamp; Soft≠product)\n");
/* Grep: serial: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("serial: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("serial: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbladeangle stamp; Soft≠product)\n");
/* Grep: serial: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("serial: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("serial: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retarcangle stamp; Soft≠product)\n");
/* Grep: serial: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("serial: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("serial: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: serial: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("serial: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("serial: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("serial: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("serial: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retellipseangle stamp; Soft≠product)\n");
/* Grep: serial: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("serial: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("serial: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retparabolaangle stamp; Soft≠product)\n");
