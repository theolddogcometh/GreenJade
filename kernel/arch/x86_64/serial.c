 ...
 *   serial: soft inventory … wave=106
 ...
 *   serial: soft deepen …     — wave=106 areas stamp
...
kprintf("serial: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("serial: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("serial: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("serial: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("serial: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("serial: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("serial: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("serial: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbastionangle stamp; Soft≠product)\n");
/* Grep: serial: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("serial: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("serial: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retparapetangle stamp; Soft≠product)\n");
/* Grep: serial: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("serial: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("serial: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retowerangle stamp; Soft≠product)\n");
/* Grep: serial: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("serial: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("serial: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retwallangle stamp; Soft≠product)\n");
/* Grep: serial: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("serial: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("serial: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retholdangle stamp; Soft≠product)\n");
/* Grep: serial: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("serial: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("serial: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retfortressangle stamp; Soft≠product)\n");
/* Grep: serial: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("serial: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("serial: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("serial: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("serial: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: serial: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("serial: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("serial: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: serial: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("serial: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("serial: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retaegisangle stamp; Soft≠product)\n");
/* Grep: serial: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("serial: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("serial: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retsigilangle stamp; Soft≠product)\n");
/* Grep: serial: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("serial: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("serial: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retglyphangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("serial: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("serial: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retshardangle stamp; Soft≠product)\n");
/* Grep: serial: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("serial: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("serial: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retprismangle stamp; Soft≠product)\n");
/* Grep: serial: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("serial: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("serial: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retcipherangle stamp; Soft≠product)\n");
/* Grep: serial: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("serial: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("serial: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retledgerangle stamp; Soft≠product)\n");
/* Grep: serial: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("serial: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("serial: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retvaultangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("serial: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("serial: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (rettokenangle stamp; Soft≠product)\n");
/* Grep: serial: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("serial: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("serial: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retphaseangle stamp; Soft≠product)\n");
/* Grep: serial: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("serial: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("serial: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retpulseangle stamp; Soft≠product)\n");

/* Grep: serial: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("serial: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("serial: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retboundangle stamp; Soft≠product)\n");
/* Grep: serial: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("serial: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("serial: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbladeangle stamp; Soft≠product)\n");
/* Grep: serial: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("serial: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("serial: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retarcangle stamp; Soft≠product)\n");
/* Grep: serial: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("serial: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("serial: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: serial: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("serial: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("serial: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: serial: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("serial: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("serial: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retellipseangle stamp; Soft≠product)\n");
/* Grep: serial: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("serial: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("serial: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: serial: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("serial: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("serial: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (rethelixangle stamp; Soft≠product)\n");
/* Grep: serial: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("serial: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("serial: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retknotangle stamp; Soft≠product)\n");
/* Grep: serial: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("serial: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("serial: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retkleinangle stamp; Soft≠product)\n");
/* Grep: serial: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("serial: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("serial: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retaffineangle stamp; Soft≠product)\n");
/* Grep: serial: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("serial: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("serial: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: serial: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("serial: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("serial: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retcubicangle stamp; Soft≠product)\n");
/* Grep: serial: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("serial: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: serial: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("serial: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retquinticangle stamp; Soft≠product)\n");
