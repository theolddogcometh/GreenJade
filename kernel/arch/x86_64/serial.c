 ...
 * Wave 20 exclusive deepen, prefix-stable):
 *   serial: soft inventory … wave=20
 ...
 *   serial: soft deepen …     — wave=20 areas stamp
...
serial_soft_log(void)
{
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: serial: soft retbound — Wave 20 return-bound honesty */
    kprintf("serial: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)UART_SOFT_WAVE);
    /* Grep: serial: soft retseal — Wave 20 exclusive seal stamp */
