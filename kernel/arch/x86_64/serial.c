 ...
 * Wave 30 exclusive deepen, prefix-stable):
 *   serial: soft inventory … wave=30
 ...
 *   serial: soft deepen …     — wave=30 areas stamp
            ...
            */
            ...
            kprintf("serial: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("serial: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: serial: soft retsigil — Wave 30 return-sigil honesty */
                            kprintf("serial: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)UART_SOFT_WAVE);
                            /* Grep: serial: soft retemblem — Wave 30 exclusive emblem stamp */
