...
kprintf("trap: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("trap: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("trap: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("trap: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("trap: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("trap: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: trap: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("trap: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("trap: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionangle stamp; Soft≠product)\n");
/* Grep: trap: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("trap: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("trap: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retparapetangle stamp; Soft≠product)\n");
/* Grep: trap: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("trap: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("trap: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retowerangle stamp; Soft≠product)\n");
/* Grep: trap: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("trap: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("trap: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retwallangle stamp; Soft≠product)\n");
/* Grep: trap: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("trap: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("trap: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retholdangle stamp; Soft≠product)\n");
/* Grep: trap: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("trap: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("trap: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retfortressangle stamp; Soft≠product)\n");
/* Grep: trap: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("trap: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("trap: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: trap: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("trap: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("trap: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: trap: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("trap: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("trap: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: trap: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("trap: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("trap: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retaegisangle stamp; Soft≠product)\n");
/* Grep: trap: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("trap: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("trap: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retsigilangle stamp; Soft≠product)\n");
/* Grep: trap: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("trap: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("trap: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retglyphangle stamp; Soft≠product)\n");
/* Grep: trap: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("trap: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("trap: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retshardangle stamp; Soft≠product)\n");
/* Grep: trap: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("trap: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("trap: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retprismangle stamp; Soft≠product)\n");
/* Grep: trap: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("trap: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("trap: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcipherangle stamp; Soft≠product)\n");
/* Grep: trap: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("trap: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("trap: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retledgerangle stamp; Soft≠product)\n");
/* Grep: trap: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("trap: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("trap: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retvaultangle stamp; Soft≠product)\n");
/* Grep: trap: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("trap: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("trap: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (rettokenangle stamp; Soft≠product)\n");
/* Grep: trap: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("trap: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("trap: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retphaseangle stamp; Soft≠product)\n");
/* Grep: trap: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("trap: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("trap: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retpulseangle stamp; Soft≠product)\n");

/* Grep: trap: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("trap: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("trap: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retboundangle stamp; Soft≠product)\n");
/* Grep: trap: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("trap: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("trap: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbladeangle stamp; Soft≠product)\n");
/* Grep: trap: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("trap: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: trap: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("trap: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retarcangle stamp; Soft≠product)\n");
