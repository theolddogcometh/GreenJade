 ...
 *   x2apic: soft deepen      — wave=47 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=47). */
#define X2APIC_SOFT_DEEPEN_WAVE 47u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 73u
