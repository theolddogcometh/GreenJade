 ...
 *
 * -------------------------------------------------------------------------
 * Soft inventory (Wave 25 exclusive deepen) — greppable "x2apic: soft …"
 * -------------------------------------------------------------------------
 ...
 *   x2apic: soft deepen      — wave=25 areas stamp
...
#define X2APIC_SOFT_DEEPEN_WAVE  24u
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: x2apic: soft retledger — Wave 25 return-ledger honesty */
            kprintf("x2apic: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)X2APIC_SOFT_DEEPEN_WAVE);
            /* Grep: x2apic: soft retbeacon — Wave 25 exclusive beacon stamp */
