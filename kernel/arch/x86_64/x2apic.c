 ...
 *
 * -------------------------------------------------------------------------
 * Soft inventory (Wave 36 exclusive deepen) — greppable "x2apic: soft …"
 * -------------------------------------------------------------------------
 ...
 *   x2apic: soft deepen      — wave=36 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=36). */
#define X2APIC_SOFT_DEEPEN_WAVE 36u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 59u
