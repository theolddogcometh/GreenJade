 ...
 *   x2apic: soft deepen      — wave=60 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=60). */
#define X2APIC_SOFT_DEEPEN_WAVE 60u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 93u
