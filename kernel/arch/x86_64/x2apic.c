 ...
 *   x2apic: soft deepen      — wave=95 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=95). */
...
kprintf("x2apic: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("x2apic: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("x2apic: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("x2apic: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("x2apic: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("x2apic: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("x2apic: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("x2apic: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("x2apic: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("x2apic: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retparapetangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("x2apic: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("x2apic: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retowerangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("x2apic: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("x2apic: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retwallangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("x2apic: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("x2apic: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retholdangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("x2apic: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("x2apic: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retfortressangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("x2apic: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("x2apic: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("x2apic: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("x2apic: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: x2apic: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("x2apic: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("x2apic: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("x2apic: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("x2apic: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retaegisangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("x2apic: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("x2apic: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retsigilangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("x2apic: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("x2apic: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retglyphangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("x2apic: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("x2apic: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retshardangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("x2apic: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("x2apic: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retprismangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("x2apic: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("x2apic: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcipherangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("x2apic: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("x2apic: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retledgerangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("x2apic: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("x2apic: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retvaultangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("x2apic: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("x2apic: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (rettokenangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("x2apic: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("x2apic: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retphaseangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("x2apic: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("x2apic: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retpulseangle stamp; Soft≠product)\n");

/* Grep: x2apic: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("x2apic: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("x2apic: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retboundangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("x2apic: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("x2apic: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbladeangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("x2apic: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("x2apic: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retarcangle stamp; Soft≠product)\n");
