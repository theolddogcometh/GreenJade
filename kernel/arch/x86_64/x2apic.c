 ...
 *
 * -------------------------------------------------------------------------
 * Soft inventory (Wave 26 exclusive deepen) — greppable "x2apic: soft …"
 * -------------------------------------------------------------------------
 ...
 *   x2apic: soft deepen      — wave=26 areas stamp
...
#define X2APIC_SOFT_DEEPEN_WAVE  26u
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: x2apic: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("x2apic: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)X2APIC_SOFT_DEEPEN_WAVE);
            /* Grep: x2apic: soft retflame — Wave 26 exclusive flame stamp */
