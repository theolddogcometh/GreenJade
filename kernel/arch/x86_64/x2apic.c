 ...
 *
 * -------------------------------------------------------------------------
 * Soft inventory (Wave 20 exclusive deepen) — greppable "x2apic: soft …"
 * -------------------------------------------------------------------------
 ...
 *   x2apic: soft deepen      — wave=20 areas stamp
...
#define X2APIC_SOFT_DEEPEN_WAVE  20u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 37u
...
x2apic_soft_inventory(void)
{
    ...
    /* Grep: x2apic: soft deepen wave (Wave 20 stamp) */
    /*
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: x2apic: soft retbound — Wave 20 return-bound honesty */
    kprintf("x2apic: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)X2APIC_SOFT_DEEPEN_WAVE);
    /* Grep: x2apic: soft retseal — Wave 20 exclusive seal stamp */
