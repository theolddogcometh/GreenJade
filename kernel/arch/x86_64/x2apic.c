 ...
 *   x2apic: soft deepen      — wave=102 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=102). */
#define X2APIC_SOFT_DEEPEN_WAVE 102u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 153u
            ...
            kprintf("x2apic: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("x2apic: soft retforge exclusive=1 soft_ne_product=1 "
                            ...
                            kprintf("x2apic: soft retscepter exclusive=1 soft_ne_product=1 "
                                    "product_kernel=OPEN bar3=0 wave=102 "
...
kprintf("x2apic: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("x2apic: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("x2apic: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("x2apic: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("x2apic: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("x2apic: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("x2apic: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("x2apic: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbastionangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("x2apic: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("x2apic: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retparapetangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("x2apic: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("x2apic: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retowerangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("x2apic: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("x2apic: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retwallangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("x2apic: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("x2apic: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retholdangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("x2apic: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("x2apic: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retfortressangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("x2apic: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("x2apic: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("x2apic: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("x2apic: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: x2apic: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("x2apic: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("x2apic: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("x2apic: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("x2apic: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retaegisangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("x2apic: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("x2apic: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retsigilangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("x2apic: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("x2apic: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retglyphangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("x2apic: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("x2apic: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retshardangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("x2apic: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("x2apic: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retprismangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("x2apic: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("x2apic: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retcipherangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("x2apic: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("x2apic: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retledgerangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("x2apic: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("x2apic: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retvaultangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("x2apic: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("x2apic: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (rettokenangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("x2apic: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("x2apic: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retphaseangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("x2apic: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("x2apic: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retpulseangle stamp; Soft≠product)\n");

/* Grep: x2apic: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("x2apic: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("x2apic: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retboundangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("x2apic: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("x2apic: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retbladeangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("x2apic: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("x2apic: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retarcangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("x2apic: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("x2apic: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("x2apic: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("x2apic: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("x2apic: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("x2apic: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retellipseangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("x2apic: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("x2apic: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("x2apic: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("x2apic: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (rethelixangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("x2apic: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("x2apic: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retknotangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("x2apic: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=102 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("x2apic: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=102 (retkleinangle stamp; Soft≠product)\n");
