 ...
 *   x2apic: soft deepen      — wave=54 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=54). */
#define X2APIC_SOFT_DEEPEN_WAVE 54u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 83u
