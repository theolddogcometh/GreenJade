 ...
 *   x2apic: soft deepen      — wave=70 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=70). */
...
kprintf("x2apic: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=70 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("x2apic: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=70 (retcounterscarple stamp; Soft≠product)\n");
