 ...
 *   x2apic: soft deepen      — wave=53 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=53). */
#define X2APIC_SOFT_DEEPEN_WAVE 48u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 79u
