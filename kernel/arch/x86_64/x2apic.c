 ...
 *   x2apic: soft deepen      — wave=59 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=59). */
#define X2APIC_SOFT_DEEPEN_WAVE 59u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 91u
