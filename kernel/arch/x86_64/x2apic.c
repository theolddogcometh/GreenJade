 ...
 *   x2apic: soft deepen      — wave=79 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=79). */
#define X2APIC_SOFT_DEEPEN_WAVE 77u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 111u
...
kprintf("x2apic: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("x2apic: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("x2apic: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("x2apic: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("x2apic: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("x2apic: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("x2apic: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("x2apic: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retbastionangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("x2apic: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("x2apic: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retparapetangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("x2apic: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("x2apic: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retowerangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("x2apic: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("x2apic: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retwallangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("x2apic: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("x2apic: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retholdangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("x2apic: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("x2apic: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retfortressangle stamp; Soft≠product)\n");
/* Grep: x2apic: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("x2apic: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: x2apic: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("x2apic: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retredoubtangle stamp; Soft≠product)\n");
