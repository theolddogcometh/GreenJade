 ...
 *   x2apic: soft deepen      — wave=46 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=46). */
#define X2APIC_SOFT_DEEPEN_WAVE 46u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 71u
