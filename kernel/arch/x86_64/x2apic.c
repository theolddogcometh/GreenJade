 ...
 *   x2apic: soft deepen      — wave=58 areas stamp
...
/* Wave 35 exclusive soft deepen stamp (greppable wave=58). */
#define X2APIC_SOFT_DEEPEN_WAVE 57u
/* Fixed greppable categories emitted under "x2apic: soft …". */
#define X2APIC_SOFT_DEEPEN_AREAS 89u
