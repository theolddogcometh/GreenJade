 ...
 *
 * Wave 25 exclusive soft deepen — greppable prefix-stable "boot: soft …"
 ...
 *   boot: soft deepen        — wave=25 stamp + area count
...
/* Wave 25 exclusive soft deepen stamp (this unit only). */
#define BI_SOFT_WAVE 25u
                        ...
                        const char *szHandoff)
{
    ...
    kprintf("boot: soft note milestone=wave25 exclusive=1 "
    ...
    kprintf("boot: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=25\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: boot: soft retledger — Wave 25 return-ledger honesty */
            kprintf("boot: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)BI_SOFT_WAVE);
            /* Grep: boot: soft retbeacon — Wave 25 exclusive beacon stamp */
