 ...
 *
 * Wave 34 exclusive soft deepen — greppable prefix-stable "boot: soft …"
 ...
 *   boot: soft deepen        — wave=34 stamp + area count
...
/* Wave 34 exclusive soft deepen stamp (this unit only). */
#define BI_SOFT_WAVE 34u
                        ...
                        const char *szHandoff)
{
    ...
    kprintf("boot: soft note milestone=wave34 exclusive=1 "
    ...
    kprintf("boot: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=34\n");
