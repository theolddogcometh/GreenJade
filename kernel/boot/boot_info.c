 ...
 *
 * Wave 26 exclusive soft deepen — greppable prefix-stable "boot: soft …"
 ...
 *   boot: soft deepen        — wave=26 stamp + area count
...
/* Wave 26 exclusive soft deepen stamp (this unit only). */
#define BI_SOFT_WAVE 26u
                        ...
                        const char *szHandoff)
{
    ...
    kprintf("boot: soft note milestone=wave26 exclusive=1 "
    ...
    kprintf("boot: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=26\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: boot: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("boot: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)BI_SOFT_WAVE);
            /* Grep: boot: soft retflame — Wave 26 exclusive flame stamp */
