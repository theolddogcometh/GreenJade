 ...
 *
 * Wave 29 exclusive soft deepen — greppable prefix-stable "boot: soft …"
 ...
 *   boot: soft deepen        — wave=29 stamp + area count
...
/* Wave 29 exclusive soft deepen stamp (this unit only). */
#define BI_SOFT_WAVE 29u
                        ...
                        const char *szHandoff)
{
    ...
    kprintf("boot: soft note milestone=wave29 exclusive=1 "
    ...
    kprintf("boot: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=29\n");
            ...
            */
            ...
            kprintf("boot: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("boot: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: boot: soft retglyph — Wave 29 return-glyph honesty */
                            kprintf("boot: soft retglyph soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retglyph honesty; Soft≠product; not bar3)\n",
                                    (unsigned)BI_SOFT_WAVE);
                            /* Grep: boot: soft retscepter — Wave 29 exclusive scepter stamp */
