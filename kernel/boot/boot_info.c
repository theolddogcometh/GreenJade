 ...
 *
 * Wave 31 exclusive soft deepen — greppable prefix-stable "boot: soft …"
 ...
 *   boot: soft deepen        — wave=31 stamp + area count
...
/* Wave 31 exclusive soft deepen stamp (this unit only). */
#define BI_SOFT_WAVE 31u
                        ...
                        const char *szHandoff)
{
    ...
    kprintf("boot: soft note milestone=wave31 exclusive=1 "
    ...
    kprintf("boot: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=31\n");
            ...
            */
            ...
            kprintf("boot: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("boot: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: boot: soft retaegis — Wave 31 return-aegis honesty */
                            ...
                            kprintf("boot: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    ...
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)BI_SOFT_WAVE);
                            /* Grep: boot: soft retmantle — Wave 31 exclusive mantle stamp */
