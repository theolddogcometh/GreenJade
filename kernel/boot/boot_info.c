 ...
 *
 * Wave 33 exclusive soft deepen — greppable prefix-stable "boot: soft …"
 ...
 *   boot: soft deepen        — wave=33 stamp + area count
...
/* Wave 33 exclusive soft deepen stamp (this unit only). */
#define BI_SOFT_WAVE 33u
                        ...
                        const char *szHandoff)
{
    ...
    kprintf("boot: soft note milestone=wave33 exclusive=1 "
    ...
    kprintf("boot: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=33\n");
 ...
 * Soft≠product; not bar3.
 */
/* Grep: boot: soft retbastion — Wave 33 return-bastion honesty */
kprintf("boot: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbastion honesty; Soft≠product; not bar3)\n",
        (unsigned)BI_SOFT_WAVE);
/* Grep: boot: soft retcitadel — Wave 33 exclusive citadel stamp */
