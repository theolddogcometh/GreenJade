 ...
 *
 * Wave 24 exclusive soft deepen — greppable prefix-stable "boot: soft …"
 ...
 *   boot: soft deepen        — wave=24 stamp + area count
...
/* Wave 24 exclusive soft deepen stamp (this unit only). */
#define BI_SOFT_WAVE 24u
                        ...
                        const char *szHandoff)
{
    ...
    kprintf("boot: soft note milestone=wave24 exclusive=1 "
    ...
    kprintf("boot: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=24\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: boot: soft retvault — Wave 24 return-vault honesty */
            kprintf("boot: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)BI_SOFT_WAVE);
            /* Grep: boot: soft retbanner — Wave 24 exclusive banner stamp */
