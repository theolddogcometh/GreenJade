 ...
 *
 * Wave 26 exclusive soft deepen (this unit only — greppable "identity: soft …"):
 ...
 *   identity: soft deepen     — wave=26 stamp + area count
...
#define IDMAP_SOFT_WAVE     26u /* Wave 26 exclusive soft deepen stamp */
 ...
 *
 * Wave 26 exclusive soft deepen — prefix-stable greppable markers:
...
identity_soft_inventory(u64 u64Cr3Expect, u64 u64Cr3Read, u32 cLeavesBuilt)
{
    ...
    kprintf("identity: soft note milestone=wave26 exclusive=1 "
    ...
    kprintf("identity: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=26\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: identity: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("identity: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)IDMAP_SOFT_WAVE);
            /* Grep: identity: soft retflame — Wave 26 exclusive flame stamp */
