 ...
 *
 * Wave 42 exclusive soft deepen (this unit only — greppable "identity: soft …"):
 ...
 *   identity: soft deepen     — wave=42 stamp + area count
...
#define IDMAP_SOFT_WAVE 42u /* Wave 42 exclusive soft deepen stamp */
...
identity_soft_inventory(u64 u64Cr3Expect, u64 u64Cr3Read, u32 cLeavesBuilt)
{
    ...
    kprintf("identity: soft note milestone=wave42 exclusive=1 "
    ...
    kprintf("identity: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=42\n");
