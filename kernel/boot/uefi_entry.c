 ...
 *   GJUEFI1: soft deepen     — wave=65 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 65u
#define GJ_UEFI_SOFT_AREAS 110u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=65 areas=54 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=65 areas=106 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=65 hdr=present entry=stamped "
