 ...
 *   GJUEFI1: soft deepen     — wave=96 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 96u
#define GJ_UEFI_SOFT_AREAS 172u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=96 areas=96 "
...
const char g_szGjUefiSoftRetfosseangle[] =
    "GJUEFI1: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retfosseangle honesty; Soft≠product; not bar3)";

/* Grep: GJUEFI1: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetcounterscarple[] =
    "GJUEFI1: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retcounterscarple stamp; Soft≠product)";
...
const char g_szGjUefiSoftRetsallyportangle[] =
    "GJUEFI1: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsallyportangle honesty; Soft≠product; not bar3)";

/* Grep: GJUEFI1: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetreentrantangle[] =
    "GJUEFI1: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retreentrantangle stamp; Soft≠product)";
...
const char g_szGjUefiSoftRetplaceofarmsangle[] =
    "GJUEFI1: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retplaceofarmsangle honesty; Soft≠product; not bar3)";
...
const char g_szGjUefiSoftRetdoubletenailleangle[] =
    "GJUEFI1: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retdoubletenailleangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retcurtainface — Wave 73 return-curtainface honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetcurtainface[] =
    "GJUEFI1: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcurtainface honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetbastionangle[] =
    "GJUEFI1: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbastionangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retglacisangle — Wave 74 return-glacisangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetglacisangle[] =
    "GJUEFI1: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retglacisangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetparapetangle[] =
    "GJUEFI1: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retparapetangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retmoatangle — Wave 75 return-moatangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetmoatangle[] =
    "GJUEFI1: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmoatangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retowerangle — Wave 75 exclusive towerangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetowerangle[] =
    "GJUEFI1: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retowerangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retgateangle — Wave 76 return-gateangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetgateangle[] =
    "GJUEFI1: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retgateangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retwallangle — Wave 76 exclusive wallangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetwallangle[] =
    "GJUEFI1: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retwallangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retspireangle — Wave 77 return-spireangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetspireangle[] =
    "GJUEFI1: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retspireangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retholdangle — Wave 77 exclusive holdangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetholdangle[] =
    "GJUEFI1: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retholdangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retpalaceangle — Wave 78 return-palaceangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetpalaceangle[] =
    "GJUEFI1: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retpalaceangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetfortressangle[] =
    "GJUEFI1: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retfortressangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retkeepangle — Wave 79 return-keepangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetkeepangle[] =
    "GJUEFI1: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retkeepangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetredoubtangle[] =
    "GJUEFI1: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retredoubtangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retcitadelangle — Wave 80 return-citadelangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetcitadelangle[] =
    "GJUEFI1: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcitadelangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetbastionkeep[] =
    "GJUEFI1: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbastionkeep stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetpanoplyangle[] =
    "GJUEFI1: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retpanoplyangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetbulwarkangle[] =
    "GJUEFI1: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbulwarkangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retmantleangle — Wave 82 return-mantleangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetmantleangle[] =
    "GJUEFI1: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmantleangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetaegisangle[] =
    "GJUEFI1: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retaegisangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retemblemangle — Wave 83 return-emblemangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetemblemangle[] =
    "GJUEFI1: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retemblemangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetsigilangle[] =
    "GJUEFI1: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retsigilangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retscepterangle — Wave 84 return-scepterangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetscepterangle[] =
    "GJUEFI1: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retscepterangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetglyphangle[] =
    "GJUEFI1: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retglyphangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retcrownangle — Wave 85 return-crownangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetcrownangle[] =
    "GJUEFI1: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcrownangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retshardangle — Wave 85 exclusive shardangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetshardangle[] =
    "GJUEFI1: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retshardangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retforgeangle — Wave 86 return-forgeangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetforgeangle[] =
    "GJUEFI1: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retforgeangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retprismangle — Wave 86 exclusive prismangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetprismangle[] =
    "GJUEFI1: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retprismangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retflameangle — Wave 87 return-flameangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetflameangle[] =
    "GJUEFI1: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retflameangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetcipherangle[] =
    "GJUEFI1: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retcipherangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retbeaconangle — Wave 88 return-beaconangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetbeaconangle[] =
    "GJUEFI1: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbeaconangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetledgerangle[] =
    "GJUEFI1: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retledgerangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retbannerangle — Wave 89 return-bannerangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetbannerangle[] =
    "GJUEFI1: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbannerangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetvaultangle[] =
    "GJUEFI1: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retvaultangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retcrestangle — Wave 90 return-crestangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetcrestangle[] =
    "GJUEFI1: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcrestangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRettokenangle[] =
    "GJUEFI1: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (rettokenangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retbadgeangle — Wave 91 return-badgeangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetbadgeangle[] =
    "GJUEFI1: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbadgeangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetphaseangle[] =
    "GJUEFI1: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retphaseangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retmarkangle — Wave 92 return-markangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetmarkangle[] =
    "GJUEFI1: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmarkangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetpulseangle[] =
    "GJUEFI1: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retpulseangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retsealangle — Wave 93 return-sealangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetsealangle[] =
    "GJUEFI1: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsealangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retboundangle — Wave 93 exclusive boundangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetboundangle[] =
    "GJUEFI1: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retboundangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retstemangle — Wave 94 return-stemangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetstemangle[] =
    "GJUEFI1: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retstemangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetbladeangle[] =
    "GJUEFI1: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbladeangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retchordangle — Wave 95 return-chordangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetchordangle[] =
    "GJUEFI1: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retchordangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retarcangle — Wave 95 exclusive arcangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetarcangle[] =
    "GJUEFI1: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retarcangle stamp; Soft≠product)";
/* Grep: GJUEFI1: soft retsectorangle — Wave 96 return-sectorangle honesty */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetsectorangle[] =
    "GJUEFI1: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsectorangle honesty; Soft≠product; not bar3)";
/* Grep: GJUEFI1: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetwedgeangle[] =
    "GJUEFI1: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retwedgeangle stamp; Soft≠product)";
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=96 areas=156 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=96 hdr=present entry=stamped "
