 ...
 *   GJUEFI1: soft deepen     — wave=56 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 56u
#define GJ_UEFI_SOFT_AREAS 92u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=56 areas=36 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=56 areas=88 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=56 hdr=present entry=stamped "
