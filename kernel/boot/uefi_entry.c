 ...
 *   GJUEFI1: soft deepen     — wave=63 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 63u
#define GJ_UEFI_SOFT_AREAS 106u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=63 areas=50 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=63 areas=102 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=63 hdr=present entry=stamped "
