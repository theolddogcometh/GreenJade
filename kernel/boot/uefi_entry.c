 ...
 *   GJUEFI1: soft deepen     — wave=67 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 67u
#define GJ_UEFI_SOFT_AREAS 114u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=67 areas=56 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=67 areas=110 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=67 hdr=present entry=stamped "
