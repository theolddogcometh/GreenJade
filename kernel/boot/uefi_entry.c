 ...
 *   GJUEFI1: soft deepen     — wave=69 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 69u
#define GJ_UEFI_SOFT_AREAS 118u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=69 areas=56 "
...
const char g_szGjUefiSoftCatalog[] =
    ...
    "wave=69 areas_expect=56 soft PASS";

__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftSurfaces[] =
    "GJUEFI1: soft surfaces count=24 wave=69 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=69 areas=114 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=69 hdr=present entry=stamped "
