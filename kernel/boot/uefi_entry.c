 ...
 *
 * Wave 55 exclusive soft deepen (this unit only — greppable "GJUEFI1: soft …"):
 ...
 *   GJUEFI1: soft deepen     — wave=55 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 55u
#define GJ_UEFI_SOFT_AREAS 90u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=55 areas=34 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=55 areas=86 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=55 hdr=present entry=stamped "
