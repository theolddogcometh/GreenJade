 ...
 *
 * Wave 37 exclusive soft deepen (this unit only — greppable "GJUEFI1: soft …"):
 ...
 *   GJUEFI1: soft deepen     — wave=37 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 37u
#define GJ_UEFI_SOFT_AREAS 56u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=37 areas=32 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=37 areas=50 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=37 hdr=present entry=stamped "
