 ...
 *   GJUEFI1: soft deepen     — wave=59 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 59u
#define GJ_UEFI_SOFT_AREAS 98u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=59 areas=42 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=59 areas=94 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=59 hdr=present entry=stamped "
