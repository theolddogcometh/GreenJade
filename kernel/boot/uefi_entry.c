 ...
 *   GJUEFI1: soft deepen     — wave=62 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 62u
#define GJ_UEFI_SOFT_AREAS 104u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=62 areas=48 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=62 areas=100 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=62 hdr=present entry=stamped "
