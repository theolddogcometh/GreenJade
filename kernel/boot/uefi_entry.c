 ...
 *   GJUEFI1: soft deepen     — wave=64 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 64u
#define GJ_UEFI_SOFT_AREAS 108u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=64 areas=52 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=64 areas=104 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=64 hdr=present entry=stamped "
