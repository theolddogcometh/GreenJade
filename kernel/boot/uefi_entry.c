 ...
 *
 * Wave 54 exclusive soft deepen (this unit only — greppable "GJUEFI1: soft …"):
 ...
 *   GJUEFI1: soft deepen     — wave=54 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 54u
#define GJ_UEFI_SOFT_AREAS 88u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=54 areas=34 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=54 areas=84 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=54 hdr=present entry=stamped "
