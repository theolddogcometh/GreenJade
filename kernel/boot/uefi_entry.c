 ...
 *   GJUEFI1: soft deepen     — wave=72 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 72u
#define GJ_UEFI_SOFT_AREAS 124u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=72 areas=60 "
...
const char g_szGjUefiSoftRetfosseangle[] =
    "GJUEFI1: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=72 (retfosseangle honesty; Soft≠product; not bar3)";

/* Grep: GJUEFI1: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetcounterscarple[] =
    "GJUEFI1: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=72 (retcounterscarple stamp; Soft≠product)";
...
const char g_szGjUefiSoftRetsallyportangle[] =
    "GJUEFI1: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=72 (retsallyportangle honesty; Soft≠product; not bar3)";

/* Grep: GJUEFI1: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftRetreentrantangle[] =
    "GJUEFI1: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=72 (retreentrantangle stamp; Soft≠product)";
...
const char g_szGjUefiSoftRetplaceofarmsangle[] =
    "GJUEFI1: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=72 (retplaceofarmsangle honesty; Soft≠product; not bar3)";
...
const char g_szGjUefiSoftRetdoubletenailleangle[] =
    "GJUEFI1: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=72 (retdoubletenailleangle stamp; Soft≠product)";
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=72 areas=120 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=72 hdr=present entry=stamped "
