 ...
 *   GJUEFI1: soft deepen     — wave=60 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 60u
#define GJ_UEFI_SOFT_AREAS 100u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=60 areas=44 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=60 areas=96 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=60 hdr=present entry=stamped "
