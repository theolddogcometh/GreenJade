 ...
 *
 * Wave 49 exclusive soft deepen (this unit only — greppable "GJUEFI1: soft …"):
 ...
 *   GJUEFI1: soft deepen     — wave=49 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 49u
#define GJ_UEFI_SOFT_AREAS 76u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=49 areas=34 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=49 areas=74 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=49 hdr=present entry=stamped "
