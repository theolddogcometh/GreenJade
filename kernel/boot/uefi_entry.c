 ...
 *   GJUEFI1: soft deepen     — wave=66 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 66u
#define GJ_UEFI_SOFT_AREAS 112u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=66 areas=56 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=66 areas=108 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=66 hdr=present entry=stamped "
