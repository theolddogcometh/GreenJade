 ...
 *
 * Wave 43 exclusive soft deepen (this unit only — greppable "GJUEFI1: soft …"):
 ...
 *   GJUEFI1: soft deepen     — wave=43 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 43u
#define GJ_UEFI_SOFT_AREAS 64u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=43 areas=34 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=43 areas=60 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=43 hdr=present entry=stamped "
