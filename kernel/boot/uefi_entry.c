 ...
 *   GJUEFI1: soft deepen     — wave=61 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 61u
#define GJ_UEFI_SOFT_AREAS 102u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=61 areas=46 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=61 areas=98 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=61 hdr=present entry=stamped "
