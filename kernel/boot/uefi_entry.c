 ...
 *   GJUEFI1: soft deepen     — wave=68 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 68u
#define GJ_UEFI_SOFT_AREAS 116u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=68 areas=56 "
...
const char g_szGjUefiSoftCatalog[] =
    ...
    "wave=68 areas_expect=56 soft PASS";

__attribute__((section(".rodata.gj_uefi"), used, aligned(8)))
const char g_szGjUefiSoftSurfaces[] =
    "GJUEFI1: soft surfaces count=24 wave=68 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=68 areas=112 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=68 hdr=present entry=stamped "
