 ...
 *   GJUEFI1: soft deepen     — wave=58 stamp + area catalog
...
#define GJ_UEFI_SOFT_WAVE 58u
#define GJ_UEFI_SOFT_AREAS 96u /* inventory,path,hdr,entry,honesty,magic,
...
const char g_szGjUefiSoftInventory[] =
    "GJUEFI1: soft inventory wave=58 areas=40 "
...
const char g_szGjUefiSoftDeepen[] =
    "GJUEFI1: soft deepen wave=58 areas=92 "
...
const char g_szGjUefiSoftPass[] =
    "GJUEFI1: soft PASS wave=58 hdr=present entry=stamped "
