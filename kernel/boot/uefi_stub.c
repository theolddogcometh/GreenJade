 ...
 *
 * Wave 29 exclusive soft deepen (this unit only — greppable "GJ-EFI: soft …"):
 ...
 *   GJ-EFI: soft deepen     — wave=29 stamp + area catalog
...
soft_wave14_inventory(u64 u64Entry)
{
    ...
    com1_puts("GJ-EFI: soft note milestone=wave29 exclusive=1 "
 ...
 * Soft!=product; not bar3.
 */
/* Grep: GJ-EFI: soft retglyph — Wave 29 return-glyph honesty */
com1_puts("GJ-EFI: soft retglyph soft_only=1 product_gate=0 soft_ne_product=1 "
          "never_blocks_m0=1 wave=29 "
          "(retglyph honesty; Soft!=product; not bar3)\n");
/* Grep: GJ-EFI: soft retscepter — Wave 29 exclusive scepter stamp */
