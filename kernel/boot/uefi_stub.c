 ...
 *
 * Wave 55 exclusive soft deepen (this unit only — greppable "GJ-EFI: soft …"):
 ...
 *   GJ-EFI: soft deepen     — wave=55 stamp + area catalog
...
soft_wave14_inventory(u64 u64Entry)
{
    ...
    com1_puts("GJ-EFI: soft note milestone=wave55 exclusive=1 "
    ...
    com1_put_u64_dec((u64)GJ_EFI_SOFT_WAVE);
    com1_puts(" areas_expect=25 soft PASS\n");
    cAreas++;
