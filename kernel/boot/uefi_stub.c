 ...
 *
 * Wave 32 exclusive soft deepen (this unit only — greppable "GJ-EFI: soft …"):
 ...
 *   GJ-EFI: soft deepen     — wave=32 stamp + area catalog
...
soft_wave14_inventory(u64 u64Entry)
{
    ...
    com1_puts("GJ-EFI: soft note milestone=wave32 exclusive=1 "
 ...
 * Soft!=product; not bar3.
 */
/* Grep: GJ-EFI: soft retbulwark — Wave 32 return-bulwark honesty */
com1_puts("GJ-EFI: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
          "never_blocks_m0=1 wave=32 "
          "(retbulwark honesty; Soft!=product; not bar3)\n");
cAreas++;
/* Grep: GJ-EFI: soft retpanoply — Wave 32 exclusive panoply stamp */
