 ...
 *
 * Wave 28 exclusive soft deepen (this unit only — greppable "GJ-EFI: soft …"):
 ...
 *   GJ-EFI: soft deepen     — wave=28 stamp + area catalog
...
soft_wave14_inventory(u64 u64Entry)
{
    ...
    com1_puts("GJ-EFI: soft note milestone=wave28 exclusive=1 "
 ...
 * Soft!=product; not bar3.
 */
/* Grep: GJ-EFI: soft retshard — Wave 28 return-shard honesty */
com1_puts("GJ-EFI: soft retshard soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=28 "
        "(retshard honesty; Soft!=product; not bar3)\n");
/* Grep: GJ-EFI: soft retcrown — Wave 28 exclusive crown stamp */
