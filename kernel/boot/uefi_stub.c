 ...
 *
 * Wave 33 exclusive soft deepen (this unit only — greppable "GJ-EFI: soft …"):
 ...
 *   GJ-EFI: soft deepen     — wave=33 stamp + area catalog
...
soft_wave14_inventory(u64 u64Entry)
{
    ...
    com1_puts("GJ-EFI: soft note milestone=wave33 exclusive=1 "
 ...
 * Soft≠product; not bar3.
 */
/* Grep: GJ-EFI: soft retbastion — Wave 33 return-bastion honesty */
com1_puts("GJ-EFI: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
          "never_blocks_m0=1 wave=33 "
          "(retbastion honesty; Soft!=product; not bar3)\n");
cAreas++;
/* Grep: GJ-EFI: soft retcitadel — Wave 33 exclusive citadel stamp */
