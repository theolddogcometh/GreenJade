 ...
 *   cap: cdt soft deepen     — wave=24 areas stamp
...
#define GJ_CDT_SOFT_WAVE  24u
/* +return selftest|retmap over Wave 17 return rate|retcode */
#define GJ_CDT_SOFT_AREAS 30u
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: cap: cdt: soft retvault — Wave 24 return-vault honesty */
            kprintf("cap: cdt: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_CDT_SOFT_WAVE);
            /* Grep: cap: cdt: soft retbanner — Wave 24 exclusive banner stamp */
