 ...
 *   cap: cdt soft deepen     — wave=23 areas stamp
...
#define GJ_CDT_SOFT_WAVE  23u
/* +return selftest|retmap over Wave 17 return rate|retcode */
#define GJ_CDT_SOFT_AREAS 28u
...
cdt_soft_inventory_log(void)
{
    ...
    /* Grep: cap: cdt soft deepen wave (Wave 23 stamp) */
    /*
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: cap: cdt: soft rettoken — Wave 23 return-token honesty */
            kprintf("cap: cdt: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_CDT_SOFT_WAVE);
            /* Grep: cap: cdt: soft retcrest — Wave 23 exclusive crest stamp */
