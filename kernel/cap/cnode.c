 ...
 *   cap: cdt soft deepen     — wave=99 areas stamp
...
#define GJ_CDT_SOFT_WAVE 99u
/* +return selftest|retmap over Wave 17 return rate|retcode */
#define GJ_CDT_SOFT_AREAS 174u
...
kprintf("cap: cdt: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("cap: cdt: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("cap: cdt: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("cap: cdt: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("cap: cdt: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("cap: cdt: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("cap: cdt: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("cap: cdt: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbastionangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("cap: cdt: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("cap: cdt: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retparapetangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("cap: cdt: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("cap: cdt: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retowerangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("cap: cdt: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("cap: cdt: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retwallangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("cap: cdt: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("cap: cdt: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retholdangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("cap: cdt: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("cap: cdt: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retfortressangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("cap: cdt: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("cap: cdt: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("cap: cdt: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("cap: cdt: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("cap: cdt: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("cap: cdt: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("cap: cdt: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("cap: cdt: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retaegisangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("cap: cdt: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("cap: cdt: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retsigilangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("cap: cdt: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("cap: cdt: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retglyphangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("cap: cdt: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("cap: cdt: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retshardangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("cap: cdt: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("cap: cdt: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retprismangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("cap: cdt: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("cap: cdt: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retcipherangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("cap: cdt: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("cap: cdt: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retledgerangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("cap: cdt: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("cap: cdt: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retvaultangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("cap: cdt: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("cap: cdt: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (rettokenangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("cap: cdt: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("cap: cdt: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retphaseangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("cap: cdt: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("cap: cdt: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retpulseangle stamp; Soft≠product)\n");

/* Grep: cap: cdt: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("cap: cdt: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("cap: cdt: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retboundangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("cap: cdt: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("cap: cdt: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbladeangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("cap: cdt: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("cap: cdt: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retarcangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("cap: cdt: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("cap: cdt: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("cap: cdt: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("cap: cdt: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("cap: cdt: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("cap: cdt: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retellipseangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("cap: cdt: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("cap: cdt: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retparabolaangle stamp; Soft≠product)\n");
