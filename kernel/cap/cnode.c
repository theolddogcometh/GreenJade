 ...
 *   cap: cdt soft deepen     — wave=76 areas stamp
...
#define GJ_CDT_SOFT_WAVE 76u
/* +return selftest|retmap over Wave 17 return rate|retcode */
#define GJ_CDT_SOFT_AREAS 128u
...
kprintf("cap: cdt: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=76 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("cap: cdt: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=76 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("cap: cdt: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=76 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("cap: cdt: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=76 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("cap: cdt: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=76 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("cap: cdt: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=76 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("cap: cdt: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=76 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("cap: cdt: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=76 (retbastionangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("cap: cdt: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=76 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("cap: cdt: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=76 (retparapetangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("cap: cdt: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=76 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("cap: cdt: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=76 (retowerangle stamp; Soft≠product)\n");
/* Grep: cap: cdt: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("cap: cdt: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=76 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: cdt: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("cap: cdt: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=76 (retwallangle stamp; Soft≠product)\n");
