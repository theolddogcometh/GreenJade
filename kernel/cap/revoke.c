...
#define GJ_REVOKE_SOFT_WAVE  21u
/* +return selftest|retmap over Wave 17 return rate|retcode */
#define GJ_REVOKE_SOFT_AREAS 24u
...
/*
 * Wave 21 exclusive soft deepen counters (file-local; wrap OK; never hard-gate).
...
soft_revoke_inventory_log(void)
{
    ...
    /* Grep: cap: revoke soft deepen wave (Wave 21 stamp) */
    /*
    ...
    kprintf("cap: revoke: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: cap: revoke: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("cap: revoke: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_REVOKE_SOFT_WAVE);
            /* Grep: cap: revoke: soft retmark — Wave 21 exclusive mark stamp */
