...
#define GJ_REVOKE_SOFT_WAVE 81u
/* +return selftest|retmap over Wave 17 return rate|retcode */
#define GJ_REVOKE_SOFT_AREAS 138u
...
kprintf("cap: revoke: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("cap: revoke: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("cap: revoke: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("cap: revoke: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("cap: revoke: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("cap: revoke: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("cap: revoke: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("cap: revoke: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retbastionangle stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("cap: revoke: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("cap: revoke: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retparapetangle stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("cap: revoke: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("cap: revoke: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retowerangle stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("cap: revoke: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("cap: revoke: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retwallangle stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("cap: revoke: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("cap: revoke: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retholdangle stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("cap: revoke: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("cap: revoke: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retfortressangle stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("cap: revoke: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("cap: revoke: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("cap: revoke: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("cap: revoke: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: cap: revoke: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("cap: revoke: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=81 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: cap: revoke: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("cap: revoke: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=81 (retbulwarkangle stamp; Soft≠product)\n");
