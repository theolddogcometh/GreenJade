 ...
 *
 * Wave 27 exclusive soft deepen (this unit only — greppable "smp: soft …"):
...
smp_bringup_soft_log(void)
{
    ...
    kprintf("smp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=27\n");
 ...
 * Soft≠product; not bar3.
                */
                ...
                kprintf("smp: soft retflame exclusive=1 soft_ne_product=1 "
                         ...
                         * Soft≠product; not bar3.
                         */
                        /* Grep: smp: soft retprism — Wave 27 return-prism honesty */
                        kprintf("smp: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                                "never_blocks_m0=1 wave=27 "
                                "(retprism honesty; Soft≠product; not bar3)\n");
                        /* Grep: smp: soft retforge — Wave 27 exclusive forge stamp */
                        kprintf("smp: soft retforge exclusive=1 soft_ne_product=1 "
                                "product_kernel=OPEN bar3=0 wave=27 "
                                "(retforge stamp; Soft≠product)\n");
        kprintf("smp: soft deepen wave=27 areas=21 verdict=%s tried=%u "
        ...
        kprintf("smp: soft ret_surface bringup=ok|timeout|skip|status_fail "
                ...
                "skip=dis|bsp|cap product_kernel=OPEN areas=19 wave=27\n");
        ...
        kprintf("smp: soft surface deepen,verdict,handshake,online,sipi,"
                ...
                "PASS,inventory,ap_run areas=19 wave=27\n");
