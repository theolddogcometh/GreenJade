 ...
 *
 * Wave 26 exclusive soft deepen (this unit only — greppable "smp: soft …"):
...
smp_bringup_soft_log(void)
{
    ...
    kprintf("smp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=26\n");
 ...
 * Soft≠product; not bar3.
                */
                 ...
                 * Soft≠product; not bar3.
                 */
                /* Grep: smp: soft retcipher — Wave 26 return-cipher honesty */
                kprintf("smp: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                        "never_blocks_m0=1 wave=26 "
                        "(retcipher honesty; Soft≠product; not bar3)\n");
                /* Grep: smp: soft retflame — Wave 26 exclusive flame stamp */
                kprintf("smp: soft retflame exclusive=1 soft_ne_product=1 "
                        "product_kernel=OPEN bar3=0 wave=26 "
                        "(retflame stamp; Soft≠product)\n");
        kprintf("smp: soft deepen wave=26 areas=19 verdict=%s tried=%u "
        ...
        kprintf("smp: soft ret_surface bringup=ok|timeout|skip|status_fail "
                ...
                "skip=dis|bsp|cap product_kernel=OPEN areas=17 wave=26\n");
        ...
        kprintf("smp: soft surface deepen,verdict,handshake,online,sipi,"
                ...
                "PASS,inventory,ap_run areas=17 wave=26\n");
