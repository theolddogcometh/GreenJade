 ...
 *
 * Wave 21 exclusive soft deepen (this unit only — greppable "smp: soft …"):
...
smp_bringup_soft_log(void)
{
    ...
    kprintf("smp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=21\n");
    ...
    /* Grep: smp: soft deepen */
        ...
        kprintf("smp: soft retseal exclusive=1 soft_ne_product=1 "
                 ...
                 * Soft≠product; not bar3.
                */
                /* Grep: smp: soft retpulse — Wave 21 return-pulse honesty */
                kprintf("smp: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                        "never_blocks_m0=1 wave=21 "
                        "(retpulse honesty; Soft≠product; not bar3)\n");
                /* Grep: smp: soft retmark — Wave 21 exclusive mark stamp */
                kprintf("smp: soft retmark exclusive=1 soft_ne_product=1 "
                        "product_kernel=OPEN bar3=0 wave=21 "
                        "(retmark stamp; Soft≠product)\n");
        kprintf("smp: soft deepen wave=21 areas=19 verdict=%s tried=%u "
        ...
        kprintf("smp: soft ret_surface bringup=ok|timeout|skip|status_fail "
                ...
                "skip=dis|bsp|cap product_kernel=OPEN areas=17 wave=21\n");
        ...
        kprintf("smp: soft surface deepen,verdict,handshake,online,sipi,"
                ...
                "PASS,inventory,ap_run areas=17 wave=21\n");
