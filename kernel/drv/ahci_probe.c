 ...
 *   ahci: soft deepen     — wave=84 areas stamp
...
#define AHCI_SOFT_DEEPEN_AREAS 114u
...
kprintf("ahci: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("ahci: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("ahci: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("ahci: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("ahci: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("ahci: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("ahci: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("ahci: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retbastionangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("ahci: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("ahci: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retparapetangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("ahci: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("ahci: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retowerangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("ahci: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("ahci: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retwallangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("ahci: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("ahci: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retholdangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("ahci: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("ahci: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retfortressangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("ahci: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("ahci: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("ahci: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("ahci: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: ahci: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("ahci: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("ahci: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("ahci: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("ahci: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retaegisangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("ahci: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("ahci: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retsigilangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("ahci: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=84 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("ahci: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=84 (retglyphangle stamp; Soft≠product)\n");
