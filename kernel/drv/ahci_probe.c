 ...
 *   ahci: soft deepen     — wave=86 areas stamp
...
#define AHCI_SOFT_DEEPEN_AREAS 118u
...
kprintf("ahci: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("ahci: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("ahci: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("ahci: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("ahci: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("ahci: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("ahci: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("ahci: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retbastionangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("ahci: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("ahci: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retparapetangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("ahci: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("ahci: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retowerangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("ahci: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("ahci: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retwallangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("ahci: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("ahci: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retholdangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("ahci: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("ahci: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retfortressangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("ahci: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("ahci: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("ahci: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("ahci: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: ahci: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("ahci: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("ahci: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("ahci: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("ahci: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retaegisangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("ahci: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("ahci: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retsigilangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("ahci: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("ahci: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retglyphangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("ahci: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("ahci: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retshardangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("ahci: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("ahci: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retprismangle stamp; Soft≠product)\n");
