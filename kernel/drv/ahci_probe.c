 ...
 *   ahci: soft deepen     — wave=112 areas stamp
...
#define AHCI_SOFT_DEEPEN_WAVE 112u
...
kprintf("ahci: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("ahci: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("ahci: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("ahci: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("ahci: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("ahci: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("ahci: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("ahci: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbastionangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("ahci: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("ahci: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retparapetangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("ahci: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("ahci: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retowerangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("ahci: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("ahci: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retwallangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("ahci: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("ahci: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retholdangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("ahci: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("ahci: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retfortressangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("ahci: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("ahci: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("ahci: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("ahci: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: ahci: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("ahci: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("ahci: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("ahci: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("ahci: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retaegisangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("ahci: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("ahci: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retsigilangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("ahci: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("ahci: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retglyphangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("ahci: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("ahci: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retshardangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("ahci: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("ahci: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retprismangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("ahci: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("ahci: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retcipherangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("ahci: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("ahci: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retledgerangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("ahci: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("ahci: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retvaultangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("ahci: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("ahci: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (rettokenangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("ahci: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("ahci: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retphaseangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("ahci: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("ahci: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retpulseangle stamp; Soft≠product)\n");

/* Grep: ahci: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("ahci: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("ahci: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retboundangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("ahci: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("ahci: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbladeangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("ahci: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("ahci: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retarcangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("ahci: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("ahci: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("ahci: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("ahci: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("ahci: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("ahci: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retellipseangle stamp; Soft≠product)\n");
/* Grep: ahci: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("ahci: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("ahci: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("ahci: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("ahci: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (rethelixangle stamp; Soft≠product)\n");
/* Grep: ahci: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("ahci: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("ahci: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retknotangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("ahci: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("ahci: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retkleinangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("ahci: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("ahci: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retaffineangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("ahci: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("ahci: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("ahci: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("ahci: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retcubicangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("ahci: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("ahci: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retquinticangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("ahci: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("ahci: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbezierangle stamp; Soft≠product)\n");
/* Grep: ahci: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("ahci: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("ahci: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("ahci: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("ahci: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("ahci: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("ahci: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retgridangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("ahci: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("ahci: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (rettexelangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("ahci: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("ahci: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retvertexangle stamp; Soft≠product)\n");
