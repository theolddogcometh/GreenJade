 ...
 *   ahci: soft deepen     — wave=74 areas stamp
...
#define AHCI_SOFT_DEEPEN_AREAS 94u
#define AHCI_SOFT_DEEPEN_WAVE 74u
...
kprintf("ahci: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("ahci: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("ahci: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("ahci: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("ahci: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("ahci: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("ahci: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("ahci: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retbastionangle stamp; Soft≠product)\n");
/* Grep: ahci: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("ahci: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: ahci: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("ahci: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retparapetangle stamp; Soft≠product)\n");
