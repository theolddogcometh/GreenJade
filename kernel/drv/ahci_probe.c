 ...
 *   ahci: soft deepen     — wave=31 areas stamp
...
#define AHCI_SOFT_DEEPEN_AREAS 44u
#define AHCI_SOFT_DEEPEN_WAVE 31u
            ...
            */
            ...
            kprintf("ahci: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("ahci: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: ahci: soft retaegis — Wave 31 return-aegis honesty */
                            ...
                            kprintf("ahci: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=31 "
                                    "(retsigil honesty; Soft≠product; not bar3)\n");
                            /* Grep: ahci: soft retmantle — Wave 31 exclusive mantle stamp */
