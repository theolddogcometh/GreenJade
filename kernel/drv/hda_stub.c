 ...
 *   hda: soft deepen      — wave=89 areas stamp
...
#define HDA_SOFT_DEEPEN_AREAS 127u
...
kprintf("hda: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("hda: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("hda: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("hda: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("hda: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("hda: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: hda: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("hda: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("hda: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbastionangle stamp; Soft≠product)\n");
/* Grep: hda: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("hda: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("hda: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retparapetangle stamp; Soft≠product)\n");
/* Grep: hda: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("hda: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("hda: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retowerangle stamp; Soft≠product)\n");
/* Grep: hda: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("hda: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("hda: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retwallangle stamp; Soft≠product)\n");
/* Grep: hda: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("hda: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("hda: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retholdangle stamp; Soft≠product)\n");
/* Grep: hda: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("hda: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("hda: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retfortressangle stamp; Soft≠product)\n");
/* Grep: hda: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("hda: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("hda: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: hda: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("hda: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("hda: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: hda: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("hda: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("hda: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: hda: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("hda: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("hda: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retaegisangle stamp; Soft≠product)\n");
/* Grep: hda: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("hda: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("hda: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retsigilangle stamp; Soft≠product)\n");
/* Grep: hda: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("hda: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("hda: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retglyphangle stamp; Soft≠product)\n");
/* Grep: hda: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("hda: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("hda: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retshardangle stamp; Soft≠product)\n");
/* Grep: hda: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("hda: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("hda: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retprismangle stamp; Soft≠product)\n");
/* Grep: hda: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("hda: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("hda: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retcipherangle stamp; Soft≠product)\n");
/* Grep: hda: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("hda: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("hda: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retledgerangle stamp; Soft≠product)\n");
/* Grep: hda: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("hda: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("hda: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retvaultangle stamp; Soft≠product)\n");
