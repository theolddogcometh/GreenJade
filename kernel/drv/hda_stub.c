 ...
 *   hda: soft deepen      — wave=74 areas stamp
...
#define HDA_SOFT_DEEPEN_AREAS 99u
#define HDA_SOFT_DEEPEN_WAVE 74u
...
kprintf("hda: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("hda: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("hda: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("hda: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("hda: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("hda: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: hda: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("hda: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("hda: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retbastionangle stamp; Soft≠product)\n");
/* Grep: hda: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("hda: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=74 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: hda: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("hda: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=74 (retparapetangle stamp; Soft≠product)\n");
