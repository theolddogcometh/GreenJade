 ...
 *
 * Soft inventory (Wave 14/15 base; Wave 20 exclusive deepen; this unit only):
 ...
 *   irq: soft deepen    / irq_msix: soft deepen     — wave=20 areas stamp
...
#define IRQ_MSIX_SOFT_DEEPEN_AREAS 28u
#define IRQ_MSIX_SOFT_DEEPEN_WAVE  20u
...
irq_msix_soft_inventory_log(const char *szVia)
{
    ...
    /* Grep: irq: soft deepen wave (Wave 20 stamp) */
    /*
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: irq: soft retbound — Wave 20 return-bound honesty */
    kprintf("irq: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)IRQ_MSIX_SOFT_DEEPEN_WAVE);
    /* Grep: irq: soft retseal — Wave 20 exclusive seal stamp */
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: irq_msix: soft retbound — Wave 20 return-bound honesty */
    kprintf("irq_msix: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)IRQ_MSIX_SOFT_DEEPEN_WAVE);
    /* Grep: irq_msix: soft retseal — Wave 20 exclusive seal stamp */
