 ...
 *
 * Soft inventory (Wave 14/15 base; Wave 21 exclusive deepen; this unit only):
 ...
 *   irq: soft deepen    / irq_msix: soft deepen     — wave=21 areas stamp
...
#define IRQ_MSIX_SOFT_DEEPEN_AREAS 30u
#define IRQ_MSIX_SOFT_DEEPEN_WAVE  21u
...
irq_msix_soft_inventory_log(const char *szVia)
{
    ...
    /* Grep: irq: soft deepen wave (Wave 21 stamp) */
    /*
    ...
    kprintf("irq: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: irq: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("irq: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)IRQ_MSIX_SOFT_DEEPEN_WAVE);
            /* Grep: irq: soft retmark — Wave 21 exclusive mark stamp */
    ...
    kprintf("irq_msix: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: irq_msix: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("irq_msix: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)IRQ_MSIX_SOFT_DEEPEN_WAVE);
            /* Grep: irq_msix: soft retmark — Wave 21 exclusive mark stamp */
