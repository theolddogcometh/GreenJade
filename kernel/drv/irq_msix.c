 ...
 *
 * Soft inventory (Wave 14/15 base; Wave 22 exclusive deepen; this unit only):
 ...
 *   irq: soft deepen    / irq_msix: soft deepen     — wave=22 areas stamp
...
#define IRQ_MSIX_SOFT_DEEPEN_AREAS 32u
#define IRQ_MSIX_SOFT_DEEPEN_WAVE  22u
...
irq_msix_soft_inventory_log(const char *szVia)
{
    ...
    /* Grep: irq: soft deepen wave (Wave 22 stamp) */
    /*
    ...
    kprintf("irq: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: irq: soft retphase — Wave 22 return-phase honesty */
            kprintf("irq: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)IRQ_MSIX_SOFT_DEEPEN_WAVE);
            /* Grep: irq: soft retbadge — Wave 22 exclusive badge stamp */
    ...
    kprintf("irq_msix: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: irq_msix: soft retphase — Wave 22 return-phase honesty */
            kprintf("irq_msix: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)IRQ_MSIX_SOFT_DEEPEN_WAVE);
            /* Grep: irq_msix: soft retbadge — Wave 22 exclusive badge stamp */
