 ...
 *
 * Soft inventory (Wave 14/15 base; Wave 33 exclusive deepen; this unit only):
 ...
 *   irq: soft deepen    / irq_msix: soft deepen     — wave=33 areas stamp
...
#define IRQ_MSIX_SOFT_DEEPEN_AREAS 44u
#define IRQ_MSIX_SOFT_DEEPEN_WAVE 32u
 ...
 * Soft≠product; not bar3.
 */
/* Grep: irq_msix: soft retbastion — Wave 33 return-bastion honesty */
kprintf("irq_msix: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=33 "
        "(retbastion honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retcitadel — Wave 33 exclusive citadel stamp */
