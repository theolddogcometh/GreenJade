 ...
 *   irq: soft deepen    / irq_msix: soft deepen     — wave=23 areas stamp
...
#define IRQ_MSIX_SOFT_DEEPEN_WAVE  23u
...
irq_msix_soft_inventory_log(const char *szVia)
{
    ...
    /* Grep: irq: soft deepen wave (Wave 23 stamp) */
    /*
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: irq: soft rettoken — Wave 23 return-token honesty */
            kprintf("irq: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)IRQ_MSIX_SOFT_DEEPEN_WAVE);
            /* Grep: irq: soft retcrest — Wave 23 exclusive crest stamp */
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: irq_msix: soft rettoken — Wave 23 return-token honesty */
            kprintf("irq_msix: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)IRQ_MSIX_SOFT_DEEPEN_WAVE);
            /* Grep: irq_msix: soft retcrest — Wave 23 exclusive crest stamp */
