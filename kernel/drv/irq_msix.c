 ...
 *   irq: soft deepen    / irq_msix: soft deepen     — wave=95 areas stamp
...
kprintf("irq_msix: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("irq_msix: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("irq_msix: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("irq_msix: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("irq_msix: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("irq_msix: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("irq_msix: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("irq_msix: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("irq_msix: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("irq_msix: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retparapetangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("irq_msix: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("irq_msix: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retowerangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("irq_msix: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("irq_msix: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retwallangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("irq_msix: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("irq_msix: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retholdangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("irq_msix: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("irq_msix: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retfortressangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("irq_msix: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("irq_msix: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("irq_msix: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("irq_msix: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("irq_msix: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("irq_msix: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("irq_msix: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("irq_msix: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retaegisangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("irq_msix: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("irq_msix: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retsigilangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("irq_msix: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("irq_msix: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retglyphangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("irq_msix: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("irq_msix: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retshardangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("irq_msix: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("irq_msix: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retprismangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("irq_msix: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("irq_msix: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcipherangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("irq_msix: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("irq_msix: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retledgerangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("irq_msix: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("irq_msix: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retvaultangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("irq_msix: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("irq_msix: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (rettokenangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("irq_msix: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("irq_msix: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retphaseangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("irq_msix: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("irq_msix: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retpulseangle stamp; Soft≠product)\n");

/* Grep: irq_msix: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("irq_msix: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("irq_msix: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retboundangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("irq_msix: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("irq_msix: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbladeangle stamp; Soft≠product)\n");
/* Grep: irq_msix: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("irq_msix: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: irq_msix: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("irq_msix: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retarcangle stamp; Soft≠product)\n");
