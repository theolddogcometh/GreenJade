 ...
 *   nvme: soft deepen     — wave=22 areas stamp
...
#define NVME_SOFT_DEEPEN_AREAS 34u
#define NVME_SOFT_DEEPEN_WAVE  22u
                    ...
                    u64 paBar, u32 u32BarBits)
{
    ...
    /* Grep: nvme: soft deepen wave (Wave 22 stamp) */
    /*
    ...
    kprintf("nvme: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: nvme: soft retphase — Wave 22 return-phase honesty */
            kprintf("nvme: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)NVME_SOFT_DEEPEN_WAVE);
            /* Grep: nvme: soft retbadge — Wave 22 exclusive badge stamp */
