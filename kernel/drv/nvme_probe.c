 ...
 *   nvme: soft deepen     — wave=33 areas stamp
...
#define NVME_SOFT_DEEPEN_AREAS 46u
#define NVME_SOFT_DEEPEN_WAVE 32u
 ...
 * Soft≠product; not bar3.
 */
/* Grep: nvme: soft retbastion — Wave 33 return-bastion honesty */
kprintf("nvme: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=33 "
        "(retbastion honesty; Soft≠product; not bar3)\n");
/* Grep: nvme: soft retcitadel — Wave 33 exclusive citadel stamp */
