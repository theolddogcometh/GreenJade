 ...
 *   pci: soft deepen …    / msix: soft deepen …     — wave=21 areas stamp
...
#define PCI_MSIX_SOFT_DEEPEN_AREAS 30u
#define PCI_MSIX_SOFT_DEEPEN_WAVE  21u
...
pci_msix_soft_inventory(const char *szVia)
{
    ...
    kprintf("pci: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: pci: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("pci: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)PCI_MSIX_SOFT_DEEPEN_WAVE);
            /* Grep: pci: soft retmark — Wave 21 exclusive mark stamp */
