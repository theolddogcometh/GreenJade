 ...
 *   pci: soft deepen …    / msix: soft deepen …     — wave=71 areas stamp
...
#define PCI_MSIX_SOFT_DEEPEN_AREAS 88u
#define PCI_MSIX_SOFT_DEEPEN_WAVE 61u
...
kprintf("pci: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=71 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("pci: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=71 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("pci: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=71 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("pci: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=71 (retreentrantangle stamp; Soft≠product)\n");
