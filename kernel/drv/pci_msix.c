 ...
 *   pci: soft deepen …    / msix: soft deepen …     — wave=104 areas stamp
...
#define PCI_MSIX_SOFT_DEEPEN_AREAS 144u
#define PCI_MSIX_SOFT_DEEPEN_WAVE 103u
...
kprintf("pci: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("pci: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("pci: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("pci: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("pci: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("pci: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: pci: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("pci: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("pci: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbastionangle stamp; Soft≠product)\n");
/* Grep: pci: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("pci: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("pci: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retparapetangle stamp; Soft≠product)\n");
/* Grep: pci: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("pci: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("pci: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retowerangle stamp; Soft≠product)\n");
/* Grep: pci: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("pci: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("pci: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retwallangle stamp; Soft≠product)\n");
/* Grep: pci: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("pci: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("pci: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retholdangle stamp; Soft≠product)\n");
/* Grep: pci: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("pci: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("pci: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retfortressangle stamp; Soft≠product)\n");
/* Grep: pci: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("pci: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("pci: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: pci: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("pci: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("pci: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: pci: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("pci: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("pci: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: pci: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("pci: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("pci: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retaegisangle stamp; Soft≠product)\n");
/* Grep: pci: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("pci: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("pci: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retsigilangle stamp; Soft≠product)\n");
/* Grep: pci: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("pci: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("pci: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retglyphangle stamp; Soft≠product)\n");
/* Grep: pci: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("pci: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("pci: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retshardangle stamp; Soft≠product)\n");
/* Grep: pci: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("pci: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("pci: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retprismangle stamp; Soft≠product)\n");
/* Grep: pci: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("pci: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("pci: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retcipherangle stamp; Soft≠product)\n");
/* Grep: pci: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("pci: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("pci: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retledgerangle stamp; Soft≠product)\n");
/* Grep: pci: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("pci: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("pci: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retvaultangle stamp; Soft≠product)\n");
/* Grep: pci: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("pci: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("pci: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (rettokenangle stamp; Soft≠product)\n");
/* Grep: pci: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("pci: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("pci: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retphaseangle stamp; Soft≠product)\n");
/* Grep: pci: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("pci: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("pci: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retpulseangle stamp; Soft≠product)\n");

/* Grep: pci: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("pci: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("pci: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retboundangle stamp; Soft≠product)\n");
/* Grep: pci: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("pci: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("pci: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbladeangle stamp; Soft≠product)\n");
/* Grep: pci: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("pci: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("pci: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retarcangle stamp; Soft≠product)\n");
/* Grep: pci: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("pci: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("pci: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: pci: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("pci: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("pci: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: pci: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("pci: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("pci: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retellipseangle stamp; Soft≠product)\n");
/* Grep: pci: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("pci: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("pci: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: pci: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("pci: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("pci: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (rethelixangle stamp; Soft≠product)\n");
/* Grep: pci: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("pci: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("pci: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retknotangle stamp; Soft≠product)\n");
/* Grep: pci: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("pci: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("pci: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retkleinangle stamp; Soft≠product)\n");
/* Grep: pci: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("pci: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("pci: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retaffineangle stamp; Soft≠product)\n");
/* Grep: pci: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("pci: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("pci: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbilinearangle stamp; Soft≠product)\n");
