 ...
 *   pci: soft deepen …    / msix: soft deepen …     — wave=73 areas stamp
...
#define PCI_MSIX_SOFT_DEEPEN_AREAS 90u
#define PCI_MSIX_SOFT_DEEPEN_WAVE 72u
...
kprintf("pci: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=73 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("pci: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=73 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("pci: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=73 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("pci: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=73 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("pci: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=73 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("pci: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=73 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: pci: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("pci: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=73 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: pci: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("pci: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=73 (retbastionangle stamp; Soft≠product)\n");
