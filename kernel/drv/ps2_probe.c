 ...
 *   ps2: soft deepen     — wave=108 areas stamp
...
#define PS2_SOFT_DEEPEN_AREAS 153u
#define PS2_SOFT_DEEPEN_WAVE 108u
...
kprintf("ps2: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("ps2: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("ps2: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("ps2: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("ps2: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("ps2: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("ps2: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("ps2: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("ps2: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("ps2: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparapetangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("ps2: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("ps2: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retowerangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("ps2: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("ps2: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwallangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("ps2: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("ps2: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retholdangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("ps2: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("ps2: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retfortressangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("ps2: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("ps2: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("ps2: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("ps2: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: ps2: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("ps2: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("ps2: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("ps2: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("ps2: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaegisangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("ps2: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("ps2: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retsigilangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("ps2: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("ps2: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retglyphangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("ps2: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("ps2: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retshardangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("ps2: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("ps2: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retprismangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("ps2: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("ps2: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcipherangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("ps2: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("ps2: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retledgerangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("ps2: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("ps2: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retvaultangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("ps2: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("ps2: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rettokenangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("ps2: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("ps2: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retphaseangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("ps2: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("ps2: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retpulseangle stamp; Soft≠product)\n");

/* Grep: ps2: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("ps2: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("ps2: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retboundangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("ps2: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("ps2: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbladeangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("ps2: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("ps2: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retarcangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("ps2: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("ps2: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("ps2: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("ps2: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("ps2: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("ps2: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retellipseangle stamp; Soft≠product)\n");
/* Grep: ps2: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("ps2: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("ps2: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("ps2: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("ps2: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rethelixangle stamp; Soft≠product)\n");
/* Grep: ps2: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("ps2: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("ps2: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retknotangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("ps2: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("ps2: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retkleinangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("ps2: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("ps2: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaffineangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("ps2: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("ps2: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("ps2: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("ps2: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcubicangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("ps2: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("ps2: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retquinticangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("ps2: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("ps2: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbezierangle stamp; Soft≠product)\n");
/* Grep: ps2: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("ps2: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("ps2: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcatmullangle stamp; Soft≠product)\n");
