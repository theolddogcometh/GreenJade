 ...
 *   ps2: soft deepen     — wave=82 areas stamp
...
#define PS2_SOFT_DEEPEN_AREAS 109u
...
kprintf("ps2: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("ps2: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("ps2: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("ps2: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("ps2: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("ps2: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("ps2: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("ps2: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retbastionangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("ps2: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("ps2: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retparapetangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("ps2: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("ps2: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retowerangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("ps2: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("ps2: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retwallangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("ps2: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("ps2: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retholdangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("ps2: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("ps2: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retfortressangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("ps2: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("ps2: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("ps2: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("ps2: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: ps2: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("ps2: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("ps2: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("ps2: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("ps2: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retaegisangle stamp; Soft≠product)\n");
