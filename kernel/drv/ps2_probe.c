 ...
 *   ps2: soft deepen     — wave=86 areas stamp
...
#define PS2_SOFT_DEEPEN_AREAS 119u
...
kprintf("ps2: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("ps2: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("ps2: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("ps2: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("ps2: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("ps2: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("ps2: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("ps2: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retbastionangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("ps2: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("ps2: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retparapetangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("ps2: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("ps2: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retowerangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("ps2: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("ps2: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retwallangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("ps2: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("ps2: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retholdangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("ps2: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("ps2: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retfortressangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("ps2: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("ps2: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("ps2: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("ps2: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: ps2: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("ps2: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("ps2: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("ps2: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("ps2: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retaegisangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("ps2: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("ps2: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retsigilangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("ps2: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("ps2: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retglyphangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("ps2: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("ps2: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retshardangle stamp; Soft≠product)\n");
/* Grep: ps2: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("ps2: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=86 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: ps2: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("ps2: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=86 (retprismangle stamp; Soft≠product)\n");
