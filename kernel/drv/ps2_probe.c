 ...
 *   ps2: soft deepen     — wave=31 areas stamp
...
#define PS2_SOFT_DEEPEN_AREAS 45u
#define PS2_SOFT_DEEPEN_WAVE 31u
            ...
            */
            ...
            kprintf("ps2: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("ps2: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: ps2: soft retaegis — Wave 31 return-aegis honesty */
                            ...
                            kprintf("ps2: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=31 "
                                    "(retsigil honesty; Soft≠product; not bar3)\n");
                            /* Grep: ps2: soft retmantle — Wave 31 exclusive mantle stamp */
