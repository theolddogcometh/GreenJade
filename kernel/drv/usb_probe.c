 ...
 *   usb: soft deepen     — wave=92 areas stamp
...
#define USB_SOFT_DEEPEN_AREAS 123u
...
kprintf("usb: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("usb: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("usb: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("usb: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("usb: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("usb: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: usb: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("usb: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("usb: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbastionangle stamp; Soft≠product)\n");
/* Grep: usb: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("usb: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("usb: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retparapetangle stamp; Soft≠product)\n");
/* Grep: usb: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("usb: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("usb: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retowerangle stamp; Soft≠product)\n");
/* Grep: usb: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("usb: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("usb: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retwallangle stamp; Soft≠product)\n");
/* Grep: usb: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("usb: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("usb: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retholdangle stamp; Soft≠product)\n");
/* Grep: usb: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("usb: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("usb: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retfortressangle stamp; Soft≠product)\n");
/* Grep: usb: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("usb: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("usb: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: usb: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("usb: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("usb: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: usb: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("usb: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("usb: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: usb: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("usb: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("usb: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retaegisangle stamp; Soft≠product)\n");
/* Grep: usb: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("usb: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("usb: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retsigilangle stamp; Soft≠product)\n");
/* Grep: usb: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("usb: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("usb: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retglyphangle stamp; Soft≠product)\n");
/* Grep: usb: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("usb: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("usb: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retshardangle stamp; Soft≠product)\n");
/* Grep: usb: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("usb: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("usb: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retprismangle stamp; Soft≠product)\n");
/* Grep: usb: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("usb: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("usb: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retcipherangle stamp; Soft≠product)\n");
/* Grep: usb: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("usb: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("usb: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retledgerangle stamp; Soft≠product)\n");
/* Grep: usb: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("usb: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("usb: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retvaultangle stamp; Soft≠product)\n");
/* Grep: usb: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("usb: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("usb: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (rettokenangle stamp; Soft≠product)\n");
/* Grep: usb: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("usb: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("usb: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retphaseangle stamp; Soft≠product)\n");
/* Grep: usb: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("usb: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: usb: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("usb: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retpulseangle stamp; Soft≠product)\n");
