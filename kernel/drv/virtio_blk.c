...
#define VIRTIO_BLK_SOFT_DEEPEN_WAVE 97u
#define VIRTIO_BLK_SOFT_DEEPEN_AREAS 144u
 ...
 *   virtio-blk: soft deepen     — wave=98 areas stamp
 *   virtio-blk: soft PASS|NODEV|PARTIAL
 *   virtio-blk: soft inventory PASS|NODEV|PARTIAL
 *
...
kprintf("virtio-blk: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("virtio-blk: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("virtio-blk: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("virtio-blk: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("virtio-blk: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("virtio-blk: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("virtio-blk: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("virtio-blk: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retbastionangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("virtio-blk: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("virtio-blk: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retparapetangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("virtio-blk: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("virtio-blk: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retowerangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("virtio-blk: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("virtio-blk: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retwallangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("virtio-blk: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("virtio-blk: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retholdangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("virtio-blk: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("virtio-blk: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retfortressangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("virtio-blk: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("virtio-blk: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("virtio-blk: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("virtio-blk: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("virtio-blk: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("virtio-blk: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("virtio-blk: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("virtio-blk: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retaegisangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("virtio-blk: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("virtio-blk: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retsigilangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("virtio-blk: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("virtio-blk: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retglyphangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("virtio-blk: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("virtio-blk: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retshardangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("virtio-blk: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("virtio-blk: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retprismangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("virtio-blk: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("virtio-blk: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retcipherangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("virtio-blk: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("virtio-blk: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retledgerangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("virtio-blk: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("virtio-blk: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retvaultangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("virtio-blk: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("virtio-blk: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (rettokenangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("virtio-blk: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("virtio-blk: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retphaseangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("virtio-blk: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("virtio-blk: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retpulseangle stamp; Soft≠product)\n");

/* Grep: virtio-blk: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("virtio-blk: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("virtio-blk: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retboundangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("virtio-blk: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("virtio-blk: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retbladeangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("virtio-blk: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("virtio-blk: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retarcangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("virtio-blk: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("virtio-blk: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("virtio-blk: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("virtio-blk: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: virtio-blk: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("virtio-blk: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-blk: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("virtio-blk: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retellipseangle stamp; Soft≠product)\n");
