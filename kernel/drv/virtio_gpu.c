 ...
 *   virtio-gpu: soft deepen wave=89 …
...
#define GPU_SOFT_WAVE 89u
#define GPU_SOFT_AREAS 170u
...
kprintf("virtio-gpu: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("virtio-gpu: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("virtio-gpu: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("virtio-gpu: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("virtio-gpu: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("virtio-gpu: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("virtio-gpu: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("virtio-gpu: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbastionangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("virtio-gpu: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("virtio-gpu: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retparapetangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("virtio-gpu: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("virtio-gpu: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retowerangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("virtio-gpu: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("virtio-gpu: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retwallangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("virtio-gpu: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("virtio-gpu: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retholdangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("virtio-gpu: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("virtio-gpu: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retfortressangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("virtio-gpu: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("virtio-gpu: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("virtio-gpu: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("virtio-gpu: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("virtio-gpu: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("virtio-gpu: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("virtio-gpu: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("virtio-gpu: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retaegisangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("virtio-gpu: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("virtio-gpu: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retsigilangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("virtio-gpu: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("virtio-gpu: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retglyphangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("virtio-gpu: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("virtio-gpu: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retshardangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("virtio-gpu: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("virtio-gpu: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retprismangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("virtio-gpu: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("virtio-gpu: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retcipherangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("virtio-gpu: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("virtio-gpu: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retledgerangle stamp; Soft≠product)\n");
/* Grep: virtio-gpu: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("virtio-gpu: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-gpu: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("virtio-gpu: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retvaultangle stamp; Soft≠product)\n");
