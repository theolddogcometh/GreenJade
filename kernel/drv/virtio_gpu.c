 ...
 *   virtio-gpu: soft deepen wave=25 …
...
#define GPU_SOFT_WAVE  25u
#define GPU_SOFT_AREAS 48u
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: virtio-gpu: soft retledger — Wave 25 return-ledger honesty */
            kprintf("virtio-gpu: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)GPU_SOFT_WAVE);
            /* Grep: virtio-gpu: soft retbeacon — Wave 25 exclusive beacon stamp */
