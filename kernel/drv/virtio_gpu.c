 ...
 *   virtio-gpu: soft deepen wave=26 …
...
#define GPU_SOFT_WAVE  26u
#define GPU_SOFT_AREAS 50u
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: virtio-gpu: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("virtio-gpu: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)GPU_SOFT_WAVE);
            /* Grep: virtio-gpu: soft retflame — Wave 26 exclusive flame stamp */
