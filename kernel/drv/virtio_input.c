 ...
 *   virtio-input: soft deepen wave=33 …
...
#define VI_SOFT_WAVE 33u
#define VI_SOFT_AREAS 63u
 ...
 * Soft≠product; not bar3.
 */
/* Grep: virtio-input: soft retbastion — Wave 33 return-bastion honesty */
kprintf("virtio-input: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbastion honesty; Soft≠product; not bar3)\n",
        (unsigned)VI_SOFT_WAVE);
/* Grep: virtio-input: soft retcitadel — Wave 33 exclusive citadel stamp */
