...
#define VIRTIO_NET_SOFT_DEEPEN_WAVE 107u
#define VIRTIO_NET_SOFT_DEEPEN_AREAS 158u
 ...
 *   virtio-net: soft deepen     — wave=107 areas stamp
 *   virtio-net: soft PASS|NODEV|PARTIAL
 *
 * greppable: virtio-net: soft
 */
...
kprintf("virtio-net: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("virtio-net: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("virtio-net: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("virtio-net: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("virtio-net: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("virtio-net: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("virtio-net: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("virtio-net: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retbastionangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("virtio-net: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("virtio-net: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retparapetangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("virtio-net: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("virtio-net: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retowerangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("virtio-net: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("virtio-net: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retwallangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("virtio-net: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("virtio-net: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retholdangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("virtio-net: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("virtio-net: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retfortressangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("virtio-net: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("virtio-net: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("virtio-net: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("virtio-net: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("virtio-net: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("virtio-net: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("virtio-net: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("virtio-net: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retaegisangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("virtio-net: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("virtio-net: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retsigilangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("virtio-net: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("virtio-net: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retglyphangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("virtio-net: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("virtio-net: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retshardangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("virtio-net: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("virtio-net: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retprismangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("virtio-net: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("virtio-net: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retcipherangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("virtio-net: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("virtio-net: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retledgerangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("virtio-net: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("virtio-net: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retvaultangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("virtio-net: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("virtio-net: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (rettokenangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("virtio-net: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("virtio-net: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retphaseangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("virtio-net: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("virtio-net: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retpulseangle stamp; Soft≠product)\n");

/* Grep: virtio-net: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("virtio-net: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("virtio-net: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retboundangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("virtio-net: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("virtio-net: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retbladeangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("virtio-net: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("virtio-net: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retarcangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("virtio-net: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("virtio-net: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("virtio-net: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("virtio-net: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("virtio-net: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("virtio-net: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retellipseangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("virtio-net: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("virtio-net: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("virtio-net: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("virtio-net: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (rethelixangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("virtio-net: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("virtio-net: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retknotangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("virtio-net: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("virtio-net: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retkleinangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("virtio-net: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("virtio-net: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retaffineangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("virtio-net: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("virtio-net: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("virtio-net: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("virtio-net: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retcubicangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("virtio-net: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("virtio-net: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retquinticangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("virtio-net: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=107 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("virtio-net: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=107 (retbezierangle stamp; Soft≠product)\n");
