...
#define VIRTIO_NET_SOFT_DEEPEN_WAVE  23u
 ...
 *   virtio-net: soft deepen     — wave=23 areas stamp
 *   virtio-net: soft PASS|NODEV|PARTIAL
 *
 * greppable: virtio-net: soft
 */
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: virtio-net: soft rettoken — Wave 23 return-token honesty */
            kprintf("virtio-net: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)VIRTIO_NET_SOFT_DEEPEN_WAVE);
            /* Grep: virtio-net: soft retcrest — Wave 23 exclusive crest stamp */
