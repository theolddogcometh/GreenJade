 ...
 *   virtio-net: soft deepen     — wave=91 areas stamp
 *   virtio-net: soft PASS|NODEV|PARTIAL
 *
 * greppable: virtio-net: soft
 */
...
kprintf("virtio-net: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("virtio-net: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("virtio-net: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("virtio-net: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("virtio-net: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("virtio-net: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("virtio-net: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("virtio-net: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retbastionangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("virtio-net: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("virtio-net: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retparapetangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("virtio-net: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("virtio-net: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retowerangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("virtio-net: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("virtio-net: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retwallangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("virtio-net: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("virtio-net: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retholdangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("virtio-net: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("virtio-net: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retfortressangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("virtio-net: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("virtio-net: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("virtio-net: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("virtio-net: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("virtio-net: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("virtio-net: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("virtio-net: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("virtio-net: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retaegisangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("virtio-net: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("virtio-net: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retsigilangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("virtio-net: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("virtio-net: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retglyphangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("virtio-net: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("virtio-net: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retshardangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("virtio-net: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("virtio-net: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retprismangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("virtio-net: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("virtio-net: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retcipherangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("virtio-net: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("virtio-net: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retledgerangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("virtio-net: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("virtio-net: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retvaultangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("virtio-net: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("virtio-net: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (rettokenangle stamp; Soft≠product)\n");
/* Grep: virtio-net: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("virtio-net: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-net: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("virtio-net: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retphaseangle stamp; Soft≠product)\n");
