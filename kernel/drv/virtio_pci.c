...
#define VIRTIO_PCI_SOFT_DEEPEN_WAVE 32u
#define VIRTIO_PCI_SOFT_DEEPEN_AREAS 52u
 ...
 * Soft≠product; not bar3.
 */
/* Grep: virtio: soft retbastion — Wave 33 return-bastion honesty */
kprintf("virtio: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=33 "
        "(retbastion honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retcitadel — Wave 33 exclusive citadel stamp */
