...
#define VIRTIO_PCI_SOFT_DEEPEN_WAVE 114u
#define VIRTIO_PCI_SOFT_DEEPEN_AREAS 168u
...
kprintf("virtio: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("virtio: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("virtio: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("virtio: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("virtio: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("virtio: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("virtio: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("virtio: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbastionangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("virtio: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("virtio: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retparapetangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("virtio: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("virtio: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retowerangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("virtio: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("virtio: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retwallangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("virtio: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("virtio: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retholdangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("virtio: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("virtio: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retfortressangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("virtio: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("virtio: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("virtio: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("virtio: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: virtio: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("virtio: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("virtio: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("virtio: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("virtio: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retaegisangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("virtio: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("virtio: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retsigilangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("virtio: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("virtio: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retglyphangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("virtio: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("virtio: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retshardangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("virtio: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("virtio: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retprismangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("virtio: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("virtio: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retcipherangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("virtio: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("virtio: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retledgerangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("virtio: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("virtio: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retvaultangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("virtio: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("virtio: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (rettokenangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("virtio: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("virtio: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retphaseangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("virtio: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("virtio: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retpulseangle stamp; Soft≠product)\n");

/* Grep: virtio: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("virtio: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("virtio: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retboundangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("virtio: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("virtio: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbladeangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("virtio: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("virtio: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retarcangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("virtio: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("virtio: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("virtio: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("virtio: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("virtio: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("virtio: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retellipseangle stamp; Soft≠product)\n");
/* Grep: virtio: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("virtio: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("virtio: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("virtio: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("virtio: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (rethelixangle stamp; Soft≠product)\n");
/* Grep: virtio: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("virtio: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("virtio: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retknotangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("virtio: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("virtio: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retkleinangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("virtio: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("virtio: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retaffineangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("virtio: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("virtio: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("virtio: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("virtio: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retcubicangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("virtio: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("virtio: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retquinticangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("virtio: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("virtio: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbezierangle stamp; Soft≠product)\n");
/* Grep: virtio: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("virtio: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("virtio: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("virtio: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("virtio: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("virtio: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("virtio: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retgridangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("virtio: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("virtio: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (rettexelangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("virtio: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("virtio: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retvertexangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retshaderangle — Wave 113 return-shaderangle honesty */
kprintf("virtio: soft retshaderangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retshaderangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retpipelineangle — Wave 113 exclusive pipelineangle stamp */
kprintf("virtio: soft retpipelineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retpipelineangle stamp; Soft≠product)\n");
/* Grep: virtio: soft retframebufferangle — Wave 114 return-framebufferangle honesty */
kprintf("virtio: soft retframebufferangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=114 (retframebufferangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio: soft retswapchainangle — Wave 114 exclusive swapchainangle stamp */
kprintf("virtio: soft retswapchainangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=114 (retswapchainangle stamp; Soft≠product)\n");
