 ...
 *   virtio-scsi: soft deepen wave=78 …
...
#define SCSI_SOFT_WAVE 78u
#define SCSI_SOFT_AREAS 146u
...
kprintf("virtio-scsi: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("virtio-scsi: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("virtio-scsi: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("virtio-scsi: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("virtio-scsi: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("virtio-scsi: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("virtio-scsi: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("virtio-scsi: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retbastionangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("virtio-scsi: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("virtio-scsi: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retparapetangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("virtio-scsi: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("virtio-scsi: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retowerangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("virtio-scsi: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("virtio-scsi: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retwallangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("virtio-scsi: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("virtio-scsi: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retholdangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("virtio-scsi: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("virtio-scsi: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retfortressangle stamp; Soft≠product)\n");
