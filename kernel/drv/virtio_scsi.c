 ...
 *   virtio-scsi: soft deepen wave=75 …
...
#define SCSI_SOFT_WAVE 75u
#define SCSI_SOFT_AREAS 140u
...
kprintf("virtio-scsi: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("virtio-scsi: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("virtio-scsi: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("virtio-scsi: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("virtio-scsi: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("virtio-scsi: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("virtio-scsi: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("virtio-scsi: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retbastionangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("virtio-scsi: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("virtio-scsi: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retparapetangle stamp; Soft≠product)\n");
/* Grep: virtio-scsi: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("virtio-scsi: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: virtio-scsi: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("virtio-scsi: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retowerangle stamp; Soft≠product)\n");
