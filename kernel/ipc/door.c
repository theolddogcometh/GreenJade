 ...
 *
 * Soft door call inventory (Wave 25 exclusive deepen — this unit only):
...
#define DOOR_SOFT_DEEPEN_WAVE  24u
...
/**
 * Greppable soft door call inventory (Wave 25 exclusive; product / smoke).
 ...
 *   door: soft return selftest — Wave 19 terminal return surface
 *   door: soft retmap     — Wave 19 return-surface map
 *   door: soft deepen     — wave=25 areas stamp
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: door: soft retledger — Wave 25 return-ledger honesty */
            kprintf("door: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)DOOR_SOFT_DEEPEN_WAVE);
            /* Grep: door: soft retbeacon — Wave 25 exclusive beacon stamp */
...
door_cold_init(void)
{
    ...
    /* Grep: door: soft (baseline inventory after cold init; wave=25) */
