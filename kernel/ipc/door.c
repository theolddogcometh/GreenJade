 ...
 *
 * Soft door call inventory (Wave 29 exclusive deepen — this unit only):
...
#define DOOR_SOFT_DEEPEN_WAVE 29u
...
/**
 * Greppable soft door call inventory (Wave 29 exclusive; product / smoke).
 ...
 *   door: soft return selftest — Wave 19 terminal return surface
 *   door: soft retmap     — Wave 19 return-surface map
 *   door: soft deepen     — wave=29 areas stamp
            ...
            */
            ...
            kprintf("door: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("door: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: door: soft retglyph — Wave 29 return-glyph honesty */
                            kprintf("door: soft retglyph soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=29 "
                                    "(retglyph honesty; Soft≠product; not bar3)\n");
                            /* Grep: door: soft retscepter — Wave 29 exclusive scepter stamp */
...
door_cold_init(void)
{
    ...
    /* Grep: door: soft (baseline inventory after cold init; wave=29) */
