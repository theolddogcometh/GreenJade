 ...
 *
 * Soft door call inventory (Wave 33 exclusive deepen — this unit only):
...
#define DOOR_SOFT_DEEPEN_WAVE 32u
/* +return selftest|retmap over Wave 17 return rate|retcode. */
#define DOOR_SOFT_DEEPEN_AREAS 48u
...
/**
 * Greppable soft door call inventory (Wave 33 exclusive; product / smoke).
 ...
 *   door: soft return selftest — Wave 19 terminal return surface
 *   door: soft retmap     — Wave 19 return-surface map
 *   door: soft deepen     — wave=33 areas stamp
 ...
 * Soft≠product; not bar3.
 */
/* Grep: door: soft retbastion — Wave 33 return-bastion honesty */
kprintf("door: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=33 "
        "(retbastion honesty; Soft≠product; not bar3)\n");
/* Grep: door: soft retcitadel — Wave 33 exclusive citadel stamp */
...
door_cold_init(void)
{
    ...
    /* Grep: door: soft (baseline inventory after cold init; wave=33) */
