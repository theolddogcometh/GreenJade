 ...
 *   notify: soft deepen            — wave=33 areas stamp
...
#define NOTIFY_SOFT_DEEPEN_WAVE 32u
/* +return selftest|retmap over Wave 17 return rate|retcode. */
#define NOTIFY_SOFT_DEEPEN_AREAS 48u
 ...
 * Soft≠product; not bar3.
 */
/* Grep: notify: soft retbastion — Wave 33 return-bastion honesty */
kprintf("notify: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=33 "
        "(retbastion honesty; Soft≠product; not bar3)\n");
/* Grep: notify: soft retcitadel — Wave 33 exclusive citadel stamp */
