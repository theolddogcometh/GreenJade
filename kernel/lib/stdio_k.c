...
kprintf("kprintf: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("kprintf: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("kprintf: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("kprintf: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("kprintf: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("kprintf: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("kprintf: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("kprintf: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retbastionangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("kprintf: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("kprintf: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retparapetangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("kprintf: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("kprintf: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retowerangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("kprintf: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("kprintf: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retwallangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("kprintf: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("kprintf: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retholdangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("kprintf: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("kprintf: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retfortressangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("kprintf: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("kprintf: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("kprintf: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("kprintf: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: kprintf: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("kprintf: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("kprintf: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("kprintf: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("kprintf: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retaegisangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("kprintf: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("kprintf: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retsigilangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("kprintf: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("kprintf: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retglyphangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("kprintf: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("kprintf: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retshardangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("kprintf: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("kprintf: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retprismangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("kprintf: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("kprintf: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retcipherangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("kprintf: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("kprintf: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retledgerangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("kprintf: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("kprintf: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retvaultangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("kprintf: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("kprintf: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (rettokenangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("kprintf: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("kprintf: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retphaseangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("kprintf: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("kprintf: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retpulseangle stamp; Soft≠product)\n");

/* Grep: kprintf: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("kprintf: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("kprintf: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retboundangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("kprintf: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("kprintf: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retbladeangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("kprintf: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("kprintf: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retarcangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("kprintf: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("kprintf: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("kprintf: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("kprintf: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: kprintf: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("kprintf: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=98 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: kprintf: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("kprintf: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=98 (retellipseangle stamp; Soft≠product)\n");
