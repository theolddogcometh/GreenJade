 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=34
 ...
 *   string: soft deepen wave=34 areas=37 …
 *
 ...
 *   retbastion | retcitadel | retredoubt | retkeep | deepen
 */
#define STRING_SOFT_AREAS 53u
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=34";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=34";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=34";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=34 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftPath[] =
    ...
    "early_boot=1 wave=34 (soft inventory; not libc)";

static const char g_szStringSoftDeepen[] =
    "string: soft deepen wave=34 areas=37 helpers=14 mem=5 str=9 "
    ...
    "counts=none hot_path=clean (Wave 34 exclusive; soft only)";

static const char g_szStringSoftHotPath[] =
    "string: soft hot_path clean counters=0 early_boot=1 wave=34";

static const char g_szStringSoftCatalog[] =
    "string: soft catalog helpers=14 mem=5 str=9 areas=35 "
    "idx=mem0..4,str0..8 hot_path=clean wave=34";
...
/* Cold: greppable "string: soft deepen wave=34 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=34 areas=25 */
