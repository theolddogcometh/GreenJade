 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=52
 ...
 *   string: soft deepen wave=52 areas=75 …
 *
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=52";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=52";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=52";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=52 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftNote[] =
    "string: soft note milestone=wave52 exclusive=1 "
    "helpers=14 mem=5 str=9 hot_path=clean soft_only=1 wave=52";

static const char g_szStringSoftReturn[] =
    "string: soft return helpers=14 mem=5 str=9 counts=none "
    "product_gate=0 hot_path=clean wave=52";

static const char g_szStringSoftRetmap[] =
    "string: soft retmap mem=ptr|void str=size|cmp|chr product_gate=0 hot_path=clean wave=52";
...
/* Cold: greppable "string: soft deepen wave=52 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=52 areas=27 */
