 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=95
 ...
 *   string: soft deepen wave=95 areas=149 …
 *
...
static const char g_szStringSoftInventory[] =
    ...
    "counts=none hot_path=clean areas=69";
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=95";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=95";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=95";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=95 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftRetfosseangle[] =
    "string: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retfosseangle honesty; Soft≠product; not bar3)";

static const char g_szStringSoftRetcounterscarple[] =
    "string: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcounterscarple stamp; Soft≠product)";
...
static const char g_szStringSoftRetsallyportangle[] =
    "string: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsallyportangle honesty; Soft≠product; not bar3)";

static const char g_szStringSoftRetreentrantangle[] =
    "string: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retreentrantangle stamp; Soft≠product)";
...
static const char g_szStringSoftRetplaceofarmsangle[] =
    "string: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retplaceofarmsangle honesty; Soft≠product; not bar3)";

static const char g_szStringSoftRetdoubletenailleangle[] =
    "string: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retdoubletenailleangle stamp; Soft≠product)";
/* Grep: string: soft retcurtainface — Wave 73 return-curtainface honesty */
static const char g_szStringSoftRetcurtainface[] =
    "string: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcurtainface honesty; Soft≠product; not bar3)";
/* Grep: string: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
static const char g_szStringSoftRetbastionangle[] =
    "string: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionangle stamp; Soft≠product)";
/* Grep: string: soft retglacisangle — Wave 74 return-glacisangle honesty */
static const char g_szStringSoftRetglacisangle[] =
    "string: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retglacisangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
static const char g_szStringSoftRetparapetangle[] =
    "string: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retparapetangle stamp; Soft≠product)";
/* Grep: string: soft retmoatangle — Wave 75 return-moatangle honesty */
static const char g_szStringSoftRetmoatangle[] =
    "string: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmoatangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retowerangle — Wave 75 exclusive towerangle stamp */
static const char g_szStringSoftRetowerangle[] =
    "string: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retowerangle stamp; Soft≠product)";
/* Grep: string: soft retgateangle — Wave 76 return-gateangle honesty */
static const char g_szStringSoftRetgateangle[] =
    "string: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retgateangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retwallangle — Wave 76 exclusive wallangle stamp */
static const char g_szStringSoftRetwallangle[] =
    "string: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retwallangle stamp; Soft≠product)";
/* Grep: string: soft retspireangle — Wave 77 return-spireangle honesty */
static const char g_szStringSoftRetspireangle[] =
    "string: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retspireangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retholdangle — Wave 77 exclusive holdangle stamp */
static const char g_szStringSoftRetholdangle[] =
    "string: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retholdangle stamp; Soft≠product)";
/* Grep: string: soft retpalaceangle — Wave 78 return-palaceangle honesty */
static const char g_szStringSoftRetpalaceangle[] =
    "string: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpalaceangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
static const char g_szStringSoftRetfortressangle[] =
    "string: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retfortressangle stamp; Soft≠product)";
/* Grep: string: soft retkeepangle — Wave 79 return-keepangle honesty */
static const char g_szStringSoftRetkeepangle[] =
    "string: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retkeepangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
static const char g_szStringSoftRetredoubtangle[] =
    "string: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retredoubtangle stamp; Soft≠product)";
/* Grep: string: soft retcitadelangle — Wave 80 return-citadelangle honesty */
static const char g_szStringSoftRetcitadelangle[] =
    "string: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcitadelangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
static const char g_szStringSoftRetbastionkeep[] =
    "string: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionkeep stamp; Soft≠product)";
/* Grep: string: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
static const char g_szStringSoftRetpanoplyangle[] =
    "string: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpanoplyangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
static const char g_szStringSoftRetbulwarkangle[] =
    "string: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbulwarkangle stamp; Soft≠product)";
/* Grep: string: soft retmantleangle — Wave 82 return-mantleangle honesty */
static const char g_szStringSoftRetmantleangle[] =
    "string: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmantleangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
static const char g_szStringSoftRetaegisangle[] =
    "string: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retaegisangle stamp; Soft≠product)";
/* Grep: string: soft retemblemangle — Wave 83 return-emblemangle honesty */
static const char g_szStringSoftRetemblemangle[] =
    "string: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retemblemangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
static const char g_szStringSoftRetsigilangle[] =
    "string: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retsigilangle stamp; Soft≠product)";
/* Grep: string: soft retscepterangle — Wave 84 return-scepterangle honesty */
static const char g_szStringSoftRetscepterangle[] =
    "string: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retscepterangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
static const char g_szStringSoftRetglyphangle[] =
    "string: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retglyphangle stamp; Soft≠product)";
/* Grep: string: soft retcrownangle — Wave 85 return-crownangle honesty */
static const char g_szStringSoftRetcrownangle[] =
    "string: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrownangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retshardangle — Wave 85 exclusive shardangle stamp */
static const char g_szStringSoftRetshardangle[] =
    "string: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retshardangle stamp; Soft≠product)";
/* Grep: string: soft retforgeangle — Wave 86 return-forgeangle honesty */
static const char g_szStringSoftRetforgeangle[] =
    "string: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retforgeangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retprismangle — Wave 86 exclusive prismangle stamp */
static const char g_szStringSoftRetprismangle[] =
    "string: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retprismangle stamp; Soft≠product)";
/* Grep: string: soft retflameangle — Wave 87 return-flameangle honesty */
static const char g_szStringSoftRetflameangle[] =
    "string: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retflameangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
static const char g_szStringSoftRetcipherangle[] =
    "string: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcipherangle stamp; Soft≠product)";
/* Grep: string: soft retbeaconangle — Wave 88 return-beaconangle honesty */
static const char g_szStringSoftRetbeaconangle[] =
    "string: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbeaconangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
static const char g_szStringSoftRetledgerangle[] =
    "string: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retledgerangle stamp; Soft≠product)";
/* Grep: string: soft retbannerangle — Wave 89 return-bannerangle honesty */
static const char g_szStringSoftRetbannerangle[] =
    "string: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbannerangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
static const char g_szStringSoftRetvaultangle[] =
    "string: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retvaultangle stamp; Soft≠product)";
/* Grep: string: soft retcrestangle — Wave 90 return-crestangle honesty */
static const char g_szStringSoftRetcrestangle[] =
    "string: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrestangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
static const char g_szStringSoftRettokenangle[] =
    "string: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (rettokenangle stamp; Soft≠product)";
/* Grep: string: soft retbadgeangle — Wave 91 return-badgeangle honesty */
static const char g_szStringSoftRetbadgeangle[] =
    "string: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbadgeangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
static const char g_szStringSoftRetphaseangle[] =
    "string: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retphaseangle stamp; Soft≠product)";
/* Grep: string: soft retmarkangle — Wave 92 return-markangle honesty */
static const char g_szStringSoftRetmarkangle[] =
    "string: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmarkangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
static const char g_szStringSoftRetpulseangle[] =
    "string: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retpulseangle stamp; Soft≠product)";
/* Grep: string: soft retsealangle — Wave 93 return-sealangle honesty */
static const char g_szStringSoftRetsealangle[] =
    "string: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsealangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retboundangle — Wave 93 exclusive boundangle stamp */
static const char g_szStringSoftRetboundangle[] =
    "string: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retboundangle stamp; Soft≠product)";
/* Grep: string: soft retstemangle — Wave 94 return-stemangle honesty */
static const char g_szStringSoftRetstemangle[] =
    "string: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retstemangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
static const char g_szStringSoftRetbladeangle[] =
    "string: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbladeangle stamp; Soft≠product)";
/* Grep: string: soft retchordangle — Wave 95 return-chordangle honesty */
static const char g_szStringSoftRetchordangle[] =
    "string: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retchordangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retarcangle — Wave 95 exclusive arcangle stamp */
static const char g_szStringSoftRetarcangle[] =
    "string: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retarcangle stamp; Soft≠product)";
...
/* Cold: greppable "string: soft deepen wave=95 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=95 areas=93 */
