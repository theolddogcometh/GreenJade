 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=41
 ...
 *   string: soft deepen wave=41 areas=51 …
 *
 ...
 *   retbastion | retcitadel | retredoubt | retkeep | retfortress | retpalace | rethold | retspire | retwall | retgate | retmoat | retower | retbarbican | retglacis | retcurtain | retparapet | retravelin | retditch | deepen
 */
#define STRING_SOFT_AREAS 67u
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=41";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=41";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=41";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=41 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftSurfaces[] =
    ...
    "honesty,surfaces,note,return,retmap,retclass,retlane,retbound,retseal,retpulse,retmark,retphase,retbadge,rettoken,retcrest,retvault,retbanner,retledger,retbeacon,retcipher,retflame,retprism,retforge,retshard,retcrown,retglyph,retscepter,retsigil,retemblem,retaegis,retmantle,retbulwark,retpanoply,retbastion,retcitadel,retredoubt,retkeep,retfortress,retpalace,rethold,retspire,retwall,retgate,retmoat,retower,retbarbican,retglacis,retcurtain,retparapet,retravelin,retditch,deepen wave=41";

static const char g_szStringSoftNote[] =
    "string: soft note milestone=wave41 exclusive=1 "
    "helpers=14 mem=5 str=9 hot_path=clean soft_only=1 wave=41";

static const char g_szStringSoftReturn[] =
    "string: soft return helpers=14 mem=5 str=9 counts=none "
    "product_gate=0 hot_path=clean wave=41";

static const char g_szStringSoftRetmap[] =
    "string: soft retmap mem=ptr|void str=size|cmp|chr product_gate=0 hot_path=clean wave=41";
...
/* Cold: greppable "string: soft deepen wave=41 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=41 areas=25 */
