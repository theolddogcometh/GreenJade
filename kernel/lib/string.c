 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=49
 ...
 *   string: soft deepen wave=49 areas=69 …
 *
 ...
 *   retbastion | retcitadel | retredoubt | retkeep | retfortress | retpalace | rethold | retspire | retwall | retgate | retmoat | retower | retbarbican | retglacis | retcurtain | retparapet | retravelin | retditch | retportcullis | retbattlement | retmachicolation | retarrowslit | retmerlon | retembrasure | retkeepgate | retouterward | retbailey | retpostern | retinnerward | retdonjon | retchevaux | retpalisade | retglacisgate | retoutwork | deepen
 */
#define STRING_SOFT_AREAS 83u
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=49";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=49";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=49";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=49 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftNote[] =
    "string: soft note milestone=wave49 exclusive=1 "
    "helpers=14 mem=5 str=9 hot_path=clean soft_only=1 wave=49";

static const char g_szStringSoftReturn[] =
    "string: soft return helpers=14 mem=5 str=9 counts=none "
    "product_gate=0 hot_path=clean wave=49";

static const char g_szStringSoftRetmap[] =
    "string: soft retmap mem=ptr|void str=size|cmp|chr product_gate=0 hot_path=clean wave=49";
...
/* Cold: greppable "string: soft deepen wave=49 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=49 areas=27 */
