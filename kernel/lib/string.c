 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=57
 ...
 *   string: soft deepen wave=57 areas=85 …
 *
...
static const char g_szStringSoftInventory[] =
    ...
    "counts=none hot_path=clean areas=21";
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=57";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=57";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=57";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=57 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftNote[] =
    ...
    "helpers=14 mem=5 str=9 hot_path=clean soft_only=1 wave=57";

static const char g_szStringSoftReturn[] =
    "string: soft return helpers=14 mem=5 str=9 counts=none "
    "product_gate=0 hot_path=clean wave=57";

static const char g_szStringSoftRetmap[] =
    "string: soft retmap mem=ptr|void str=size|cmp|chr product_gate=0 hot_path=clean wave=57";
...
/* Cold: greppable "string: soft deepen wave=57 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=57 areas=29 */
