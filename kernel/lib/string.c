 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=75
 ...
 *   string: soft deepen wave=75 areas=119 …
 *
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=75";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=75";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=75";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=75 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftRetfosseangle[] =
    "string: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retfosseangle honesty; Soft≠product; not bar3)";

static const char g_szStringSoftRetcounterscarple[] =
    "string: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retcounterscarple stamp; Soft≠product)";
...
static const char g_szStringSoftRetsallyportangle[] =
    "string: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retsallyportangle honesty; Soft≠product; not bar3)";

static const char g_szStringSoftRetreentrantangle[] =
    "string: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retreentrantangle stamp; Soft≠product)";
...
static const char g_szStringSoftRetplaceofarmsangle[] =
    "string: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retplaceofarmsangle honesty; Soft≠product; not bar3)";

static const char g_szStringSoftRetdoubletenailleangle[] =
    "string: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retdoubletenailleangle stamp; Soft≠product)";
/* Grep: string: soft retcurtainface — Wave 73 return-curtainface honesty */
static const char g_szStringSoftRetcurtainface[] =
    "string: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retcurtainface honesty; Soft≠product; not bar3)";
/* Grep: string: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
static const char g_szStringSoftRetbastionangle[] =
    "string: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retbastionangle stamp; Soft≠product)";
/* Grep: string: soft retglacisangle — Wave 74 return-glacisangle honesty */
static const char g_szStringSoftRetglacisangle[] =
    "string: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retglacisangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
static const char g_szStringSoftRetparapetangle[] =
    "string: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retparapetangle stamp; Soft≠product)";
/* Grep: string: soft retmoatangle — Wave 75 return-moatangle honesty */
static const char g_szStringSoftRetmoatangle[] =
    "string: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=75 (retmoatangle honesty; Soft≠product; not bar3)";
/* Grep: string: soft retowerangle — Wave 75 exclusive towerangle stamp */
static const char g_szStringSoftRetowerangle[] =
    "string: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=75 (retowerangle stamp; Soft≠product)";
...
/* Cold: greppable "string: soft deepen wave=75 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=75 areas=63 */
