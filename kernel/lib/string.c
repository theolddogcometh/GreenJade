 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=30
 ...
 *   string: soft deepen wave=30 areas=27 …
 *
 ...
 *   retsigil | retemblem | deepen
 */
#define STRING_SOFT_AREAS 45u
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=30";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=30";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=30";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=30 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftPath[] =
    ...
    "early_boot=1 wave=30 (soft inventory; not libc)";

static const char g_szStringSoftDeepen[] =
    "string: soft deepen wave=30 areas=29 helpers=14 mem=5 str=9 "
    "return=1 retmap=1 retclass=1 retlane=1 retbound=1 retseal=1 retpulse=1 "
    "retmark=1 retphase=1 retbadge=1 rettoken=1 retcrest=1 retvault=1 retbanner=1 retledger=1 retbeacon=1 retcipher=1 retflame=1 retprism=1 retforge=1 retshard=1 retcrown=1 retglyph=1 retscepter=1 retsigil=1 retemblem=1 "
    "counts=none hot_path=clean (Wave 30 exclusive; soft only)";

static const char g_szStringSoftHotPath[] =
    "string: soft hot_path clean counters=0 early_boot=1 wave=30";

static const char g_szStringSoftCatalog[] =
    "string: soft catalog helpers=14 mem=5 str=9 areas=27 "
    "idx=mem0..4,str0..8 hot_path=clean wave=30";
...
static const char g_szStringSoftHonesty[] =
    ...
    "wave=30 (soft inventory; not bar3)";
...
static const char g_szStringSoftSurfaces[] =
    ...
    "honesty,surfaces,note,return,retmap,retclass,retlane,retbound,retseal,retpulse,retmark,retphase,retbadge,rettoken,retcrest,retvault,retbanner,retledger,retbeacon,retcipher,retflame,retprism,retforge,retshard,retcrown,retglyph,retscepter,retsigil,retemblem,deepen wave=30";

static const char g_szStringSoftNote[] =
    "string: soft note milestone=wave30 exclusive=1 "
    "helpers=14 mem=5 str=9 hot_path=clean soft_only=1 wave=30";

static const char g_szStringSoftReturn[] =
    "string: soft return helpers=14 mem=5 str=9 counts=none "
    "product_gate=0 hot_path=clean wave=30";

static const char g_szStringSoftRetmap[] =
    "string: soft retmap mem=ptr|void str=size|cmp|chr product_gate=0 hot_path=clean wave=30";
...
/* Cold: greppable "string: soft deepen wave=30 …" line. */
const char *
...
/* Cold: greppable "string: soft retsigil …" line (Wave 30 exclusive). */
const char *
...
/* Cold: greppable "string: soft retemblem …" line (Wave 30 exclusive). */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=30 areas=19 */
