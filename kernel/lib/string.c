 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=65
 ...
 *   string: soft deepen wave=65 areas=101 …
 *
...
static const char g_szStringSoftInventory[] =
    ...
    "counts=none hot_path=clean areas=33";
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=65";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=65";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=65";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=65 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftPath[] =
    ...
    "early_boot=1 wave=65 (soft inventory; not libc)";

static const char g_szStringSoftDeepen[] =
    "string: soft deepen wave=65 areas=101 helpers=14 mem=5 str=9 "
    ...
    "counts=none hot_path=clean (Wave 65 exclusive; soft only)";

static const char g_szStringSoftHotPath[] =
    "string: soft hot_path clean counters=0 early_boot=1 wave=65";

static const char g_szStringSoftCatalog[] =
    "string: soft catalog helpers=14 mem=5 str=9 areas=55 "
    "idx=mem0..4,str0..8 hot_path=clean wave=65";
...
/* Cold: greppable "string: soft deepen wave=65 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=65 areas=45 */
