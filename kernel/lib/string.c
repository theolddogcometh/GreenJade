 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=33
 ...
 *   string: soft deepen wave=33 areas=33 …
 *
...
/* Wave 33 soft inventory stamp (file-local; never product gate). */
#define STRING_SOFT_WAVE 33u
 ...
 *   retsigil | retemblem | retaegis | retmantle | retbulwark | retpanoply | retbastion | retcitadel | deepen
 */
#define STRING_SOFT_AREAS 51u
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=33";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=33";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=33";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=33 (intentional; helpers stay cold of tallies)";
...
static const char g_szStringSoftPath[] =
    ...
    "early_boot=1 wave=33 (soft inventory; not libc)";

static const char g_szStringSoftDeepen[] =
    "string: soft deepen wave=33 areas=35 helpers=14 mem=5 str=9 "
    "return=1 retmap=1 retclass=1 retlane=1 retbound=1 retseal=1 retpulse=1 "
    "retmark=1 retphase=1 retbadge=1 rettoken=1 retcrest=1 retvault=1 retbanner=1 retledger=1 retbeacon=1 retcipher=1 retflame=1 retprism=1 retforge=1 retshard=1 retcrown=1 retglyph=1 retscepter=1 retsigil=1 retemblem=1 retaegis=1 retmantle=1 retbulwark=1 retpanoply=1 retbastion=1 retcitadel=1 "
    "counts=none hot_path=clean (Wave 33 exclusive; soft only)";

static const char g_szStringSoftHotPath[] =
    "string: soft hot_path clean counters=0 early_boot=1 wave=33";

static const char g_szStringSoftCatalog[] =
    "string: soft catalog helpers=14 mem=5 str=9 areas=33 "
    "idx=mem0..4,str0..8 hot_path=clean wave=33";
...
/* Cold: greppable "string: soft deepen wave=33 …" line. */
const char *
...
/* Cold: greppable "string: soft retbastion …" line (Wave 33 exclusive). */
const char *
...
/* Cold: greppable "string: soft retcitadel …" line (Wave 33 exclusive). */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=33 areas=25 */
