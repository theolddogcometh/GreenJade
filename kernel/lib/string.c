 ...
 * hot path clean):
 *   string: soft inventory helpers=14 groups=2 wave=56
 ...
 *   string: soft deepen wave=56 areas=83 …
 *
...
/* Wave 56 soft inventory stamp (file-local; never product gate). */
#define STRING_SOFT_WAVE 56u
...
static const char g_szStringSoftStr[] =
    "string: soft str strlen,strnlen,strcmp,strncmp,strlcpy,strlcat,"
    "strchr,strrchr,strstr count=9 group=str wave=56";

static const char g_szStringSoftGroups[] =
    "string: soft groups mem=5 str=9 total=14 wave=56";

static const char g_szStringSoftPolicy[] =
    "string: soft policy freestanding pure_c no_heap no_locale no_io "
    "early_boot=1 counters=0 wave=56";

static const char g_szStringSoftCounts[] =
    "string: soft counts none hot_path=clean reason=early_boot "
    "wave=56 (intentional; helpers stay cold of tallies)";
...
/* Cold: greppable "string: soft deepen wave=56 …" line. */
const char *
...
/* string: soft inventory end helpers=14 counts=none hot_path=clean wave=56 areas=27 */
