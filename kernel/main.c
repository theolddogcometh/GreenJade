...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 85u, MAIN_SOFT_SMOKE_AREAS = 148u };
        ...
        kprintf("soft: note milestone=wave85 exclusive=1 soft_only=1 "
