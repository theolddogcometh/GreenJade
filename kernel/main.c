...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 91u, MAIN_SOFT_SMOKE_AREAS = 160u };
        ...
        kprintf("soft: note milestone=wave91 exclusive=1 soft_only=1 "
