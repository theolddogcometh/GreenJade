...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 80u, MAIN_SOFT_SMOKE_AREAS = 138u };
        ...
        kprintf("soft: note milestone=wave80 exclusive=1 soft_only=1 "
