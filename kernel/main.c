...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 46u, MAIN_SOFT_SMOKE_AREAS = 70u };
        ...
        kprintf("soft: note milestone=wave46 exclusive=1 soft_only=1 "
