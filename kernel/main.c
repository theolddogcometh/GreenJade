...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 64u, MAIN_SOFT_SMOKE_AREAS = 106u };
        ...
        kprintf("soft: note milestone=wave64 exclusive=1 soft_only=1 "
