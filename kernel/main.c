...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 53u, MAIN_SOFT_SMOKE_AREAS = 84u };
        ...
        kprintf("soft: note milestone=wave53 exclusive=1 soft_only=1 "
