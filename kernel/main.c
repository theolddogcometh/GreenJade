...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 84u, MAIN_SOFT_SMOKE_AREAS = 146u };
        ...
        kprintf("soft: note milestone=wave84 exclusive=1 soft_only=1 "
