...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 56u, MAIN_SOFT_SMOKE_AREAS = 90u };
        ...
        kprintf("soft: note milestone=wave56 exclusive=1 soft_only=1 "
