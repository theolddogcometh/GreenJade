...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     * Wave 34 exclusive deepen: soft inventory + path + capacity +
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 34u, MAIN_SOFT_SMOKE_AREAS = 46u };
        ...
        kprintf("soft: note milestone=wave34 exclusive=1 soft_only=1 "
