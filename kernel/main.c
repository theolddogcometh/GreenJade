...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 45u, MAIN_SOFT_SMOKE_AREAS = 68u };
        ...
        kprintf("soft: note milestone=wave45 exclusive=1 soft_only=1 "
