...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 55u, MAIN_SOFT_SMOKE_AREAS = 88u };
        ...
        kprintf("soft: note milestone=wave55 exclusive=1 soft_only=1 "
