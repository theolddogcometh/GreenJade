...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 74u, MAIN_SOFT_SMOKE_AREAS = 126u };
        ...
        kprintf("soft: note milestone=wave74 exclusive=1 soft_only=1 "
