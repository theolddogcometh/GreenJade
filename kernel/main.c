...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 44u, MAIN_SOFT_SMOKE_AREAS = 66u };
        ...
        kprintf("soft: note milestone=wave44 exclusive=1 soft_only=1 "
