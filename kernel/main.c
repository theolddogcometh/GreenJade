...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     * Wave 35 exclusive deepen: soft inventory + path + capacity +
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 35u, MAIN_SOFT_SMOKE_AREAS = 48u };
        ...
        kprintf("soft: note milestone=wave35 exclusive=1 soft_only=1 "
