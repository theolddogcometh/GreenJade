...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 73u, MAIN_SOFT_SMOKE_AREAS = 124u };
        ...
        kprintf("soft: note milestone=wave73 exclusive=1 soft_only=1 "
