...
kernel_after_mmap(struct gj_mem_region *aRegions, size_t cRegions)
{
     ...
     */
    {
        ...
        enum { MAIN_SOFT_SMOKE_WAVE = 82u, MAIN_SOFT_SMOKE_AREAS = 142u };
        ...
        kprintf("soft: note milestone=wave82 exclusive=1 soft_only=1 "
