 ...
 *
 * Soft deepen (Wave 27 exclusive; this unit only):
 ...
 *     deepen wave=27 stamp + surf= bitmask
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("fault: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: fault: soft retprism — Wave 27 return-prism honesty */
                    kprintf("fault: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)FAULT_SOFT_WAVE);
                    /* Grep: fault: soft retforge — Wave 27 exclusive forge stamp */
    ...
    kprintf("fault: soft deepen wave=%u areas=%u logs=%llu "
            ...
            "product_call=0 product_frame=0 product_cr3_map=0 "
            "(Wave 27 exclusive; Soft≠real pager product Call+FRAME "
...
/*
 * Soft FRAME shape after consume (Wave 27 exclusive deepen).
 *
...
/*
 * Soft CR3 map-under-space shape after consume (Wave 27 exclusive deepen).
 *
