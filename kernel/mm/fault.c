 ...
 *     deepen wave=78 stamp + surf= bitmask
...
kprintf("fault: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("fault: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("fault: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("fault: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("fault: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("fault: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: fault: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("fault: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("fault: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retbastionangle stamp; Soft≠product)\n");
/* Grep: fault: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("fault: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("fault: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retparapetangle stamp; Soft≠product)\n");
/* Grep: fault: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("fault: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("fault: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retowerangle stamp; Soft≠product)\n");
/* Grep: fault: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("fault: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("fault: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retwallangle stamp; Soft≠product)\n");
/* Grep: fault: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("fault: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("fault: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retholdangle stamp; Soft≠product)\n");
/* Grep: fault: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("fault: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=78 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: fault: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("fault: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=78 (retfortressangle stamp; Soft≠product)\n");
