 ...
 *
 * Soft deepen (Wave 20 exclusive; this unit only):
 ...
 *     deepen wave=20 stamp + surf= bitmask
...
fault_soft_inventory_log(void)
{
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: fault: soft retbound — Wave 20 return-bound honesty */
    kprintf("fault: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)FAULT_SOFT_WAVE);
    /* Grep: fault: soft retseal — Wave 20 exclusive seal stamp */
    ...
    kprintf("fault: soft deepen wave=%u areas=%u logs=%llu "
            ...
            "product_call=0 product_frame=0 product_cr3_map=0 "
            "(Wave 20 exclusive; Soft≠real pager product Call+FRAME "
...
/*
 * Soft FRAME shape after consume (Wave 20 exclusive deepen).
 *
...
/*
 * Soft CR3 map-under-space shape after consume (Wave 20 exclusive deepen).
 *
