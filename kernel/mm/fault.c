 ...
 *
 * Soft deepen (Wave 24 exclusive; this unit only):
 ...
 *     deepen wave=24 stamp + surf= bitmask
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: fault: soft retvault — Wave 24 return-vault honesty */
            kprintf("fault: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)FAULT_SOFT_WAVE);
            /* Grep: fault: soft retbanner — Wave 24 exclusive banner stamp */
    ...
    kprintf("fault: soft deepen wave=%u areas=%u logs=%llu "
            ...
            "product_call=0 product_frame=0 product_cr3_map=0 "
            "(Wave 24 exclusive; Soft≠real pager product Call+FRAME "
...
/*
 * Soft FRAME shape after consume (Wave 24 exclusive deepen).
 *
...
/*
 * Soft CR3 map-under-space shape after consume (Wave 24 exclusive deepen).
 *
