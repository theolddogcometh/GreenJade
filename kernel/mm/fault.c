 ...
 *
 * Soft deepen (Wave 23 exclusive; this unit only):
 ...
 *     deepen wave=23 stamp + surf= bitmask
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: fault: soft rettoken — Wave 23 return-token honesty */
            kprintf("fault: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)FAULT_SOFT_WAVE);
            /* Grep: fault: soft retcrest — Wave 23 exclusive crest stamp */
    ...
    kprintf("fault: soft deepen wave=%u areas=%u logs=%llu "
            ...
            "product_call=0 product_frame=0 product_cr3_map=0 "
            "(Wave 23 exclusive; Soft≠real pager product Call+FRAME "
...
/*
 * Soft FRAME shape after consume (Wave 23 exclusive deepen).
 *
...
/*
 * Soft CR3 map-under-space shape after consume (Wave 23 exclusive deepen).
 *
