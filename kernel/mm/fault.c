 ...
 *
 * Soft deepen (Wave 21 exclusive; this unit only):
 ...
 *     deepen wave=21 stamp + surf= bitmask
...
fault_soft_inventory_log(void)
{
    ...
    kprintf("fault: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: fault: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("fault: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)FAULT_SOFT_WAVE);
            /* Grep: fault: soft retmark — Wave 21 exclusive mark stamp */
    ...
    kprintf("fault: soft deepen wave=%u areas=%u logs=%llu "
            ...
            "product_call=0 product_frame=0 product_cr3_map=0 "
            "(Wave 21 exclusive; Soft≠real pager product Call+FRAME "
...
/*
 * Soft FRAME shape after consume (Wave 21 exclusive deepen).
 *
...
/*
 * Soft CR3 map-under-space shape after consume (Wave 21 exclusive deepen).
 *
