 ...
 *
 * Soft deepen (Wave 22 exclusive; this unit only):
 ...
 *     deepen wave=22 stamp + surf= bitmask
...
fault_soft_inventory_log(void)
{
    ...
    kprintf("fault: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: fault: soft retphase — Wave 22 return-phase honesty */
            kprintf("fault: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)FAULT_SOFT_WAVE);
            /* Grep: fault: soft retbadge — Wave 22 exclusive badge stamp */
    ...
    kprintf("fault: soft deepen wave=%u areas=%u logs=%llu "
            ...
            "product_call=0 product_frame=0 product_cr3_map=0 "
            "(Wave 22 exclusive; Soft≠real pager product Call+FRAME "
...
/*
 * Soft FRAME shape after consume (Wave 22 exclusive deepen).
 *
...
/*
 * Soft CR3 map-under-space shape after consume (Wave 22 exclusive deepen).
 *
