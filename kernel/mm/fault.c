 ...
 *
 * Soft deepen (Wave 26 exclusive; this unit only):
 ...
 *     deepen wave=26 stamp + surf= bitmask
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: fault: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("fault: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)FAULT_SOFT_WAVE);
            /* Grep: fault: soft retflame — Wave 26 exclusive flame stamp */
    ...
    kprintf("fault: soft deepen wave=%u areas=%u logs=%llu "
            ...
            "product_call=0 product_frame=0 product_cr3_map=0 "
            "(Wave 26 exclusive; Soft≠real pager product Call+FRAME "
...
/*
 * Soft FRAME shape after consume (Wave 26 exclusive deepen).
 *
...
/*
 * Soft CR3 map-under-space shape after consume (Wave 26 exclusive deepen).
 *
