 ...
 *
 * Wave 36 exclusive soft deepen (this unit only — greppable "iommu: soft …"):
 ...
 *   iommu: soft deepen     — wave=36 stamp + area count
...
kprintf("iommu: soft retspire exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)IOMMU_SOFT_WAVE);
            ...
            "(Wave 36 exclusive; soft only; not product always-on IOMMU; "
