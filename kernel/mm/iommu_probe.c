 ...
 *   iommu: soft deepen     — wave=99 stamp + area count
...
kprintf("iommu: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("iommu: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("iommu: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("iommu: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("iommu: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("iommu: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("iommu: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("iommu: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbastionangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("iommu: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("iommu: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retparapetangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("iommu: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("iommu: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retowerangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("iommu: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("iommu: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retwallangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("iommu: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("iommu: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retholdangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("iommu: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("iommu: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retfortressangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("iommu: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("iommu: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("iommu: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("iommu: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: iommu: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("iommu: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("iommu: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("iommu: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("iommu: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retaegisangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("iommu: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("iommu: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retsigilangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("iommu: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("iommu: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retglyphangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("iommu: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("iommu: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retshardangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("iommu: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("iommu: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retprismangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("iommu: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("iommu: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retcipherangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("iommu: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("iommu: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retledgerangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("iommu: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("iommu: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retvaultangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("iommu: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("iommu: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (rettokenangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("iommu: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("iommu: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retphaseangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("iommu: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("iommu: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retpulseangle stamp; Soft≠product)\n");

/* Grep: iommu: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("iommu: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("iommu: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retboundangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("iommu: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("iommu: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbladeangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("iommu: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("iommu: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retarcangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("iommu: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("iommu: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("iommu: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("iommu: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: iommu: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("iommu: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("iommu: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retellipseangle stamp; Soft≠product)\n");
/* Grep: iommu: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("iommu: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: iommu: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("iommu: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retparabolaangle stamp; Soft≠product)\n");
