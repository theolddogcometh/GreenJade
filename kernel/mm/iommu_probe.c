 ...
 *
 * Wave 39 exclusive soft deepen (this unit only — greppable "iommu: soft …"):
 ...
 *   iommu: soft deepen     — wave=39 stamp + area count
...
kprintf("iommu: soft retglacis exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)IOMMU_SOFT_WAVE);
            ...
            "(Wave 39 exclusive; soft only; not product always-on IOMMU; "
