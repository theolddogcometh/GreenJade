 ...
 *
 * Wave 23 exclusive soft deepen (this unit only — greppable "iommu: soft …"):
 ...
 *   iommu: soft deepen     — wave=23 stamp + area count
...
iommu_soft_inventory_log(void)
{
    ...
    /* Grep: iommu: soft deepen wave (Wave 23 stamp) */
    /*
