 ...
 *
 * Wave 21 exclusive soft deepen (this unit only — greppable "iommu: soft …"):
 ...
 *   iommu: soft deepen     — wave=21 stamp + area count
...
iommu_soft_inventory_log(void)
{
    ...
    /* Grep: iommu: soft deepen wave (Wave 21 stamp) */
    /*
