 ...
 *
 * Wave 26 exclusive soft deepen (this unit only — greppable "vtd: soft …"):
 ...
 *   vtd: soft deepen     — wave=26 stamp + area count
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: vtd: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("vtd: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)VTD_SOFT_WAVE);
            /* Grep: vtd: soft retflame — Wave 26 exclusive flame stamp */
