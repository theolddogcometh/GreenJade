 ...
 *
 * Wave 21 exclusive soft deepen (this unit only — greppable "vtd: soft …"):
 ...
 *   vtd: soft deepen     — wave=21 stamp + area count
...
vtd_soft_inventory_log(void)
{
    ...
    /* Grep: vtd: soft deepen wave (Wave 21 stamp) */
    /*
    ...
    kprintf("vtd: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: vtd: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("vtd: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)VTD_SOFT_WAVE);
            /* Grep: vtd: soft retmark — Wave 21 exclusive mark stamp */
