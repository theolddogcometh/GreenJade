 ...
 *
 * Wave 20 exclusive soft deepen (this unit only — greppable "vtd: soft …"):
 ...
 *   vtd: soft deepen     — wave=20 stamp + area count
...
vtd_soft_inventory_log(void)
{
    ...
    /* Grep: vtd: soft deepen wave (Wave 20 stamp) */
    /*
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: vtd: soft retbound — Wave 20 return-bound honesty */
    kprintf("vtd: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)VTD_SOFT_WAVE);
    /* Grep: vtd: soft retseal — Wave 20 exclusive seal stamp */
