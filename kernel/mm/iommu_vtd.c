 ...
 *
 * Wave 27 exclusive soft deepen (this unit only — greppable "vtd: soft …"):
 ...
 *   vtd: soft deepen     — wave=27 stamp + area count
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("vtd: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: vtd: soft retprism — Wave 27 return-prism honesty */
                    kprintf("vtd: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)VTD_SOFT_WAVE);
                    /* Grep: vtd: soft retforge — Wave 27 exclusive forge stamp */
