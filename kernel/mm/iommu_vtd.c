 ...
 *
 * Wave 42 exclusive soft deepen (this unit only — greppable "vtd: soft …"):
 ...
 *   vtd: soft deepen     — wave=42 stamp + area count
...
kprintf("vtd: soft retbattlement exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)VTD_SOFT_WAVE);
            ...
            "(Wave 42 exclusive; soft only; not product always-on IOMMU; "
