 ...
 *
 * Wave 30 exclusive soft deepen (this unit only — greppable "vtd: soft …"):
 ...
 *   vtd: soft deepen     — wave=30 stamp + area count
            ...
            */
            ...
            kprintf("vtd: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("vtd: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: vtd: soft retsigil — Wave 30 return-sigil honesty */
                            kprintf("vtd: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)VTD_SOFT_WAVE);
                            /* Grep: vtd: soft retemblem — Wave 30 exclusive emblem stamp */
