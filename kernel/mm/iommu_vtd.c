 ...
 *
 * Wave 22 exclusive soft deepen (this unit only — greppable "vtd: soft …"):
 ...
 *   vtd: soft deepen     — wave=22 stamp + area count
...
vtd_soft_inventory_log(void)
{
    ...
    /* Grep: vtd: soft deepen wave (Wave 22 stamp) */
    /*
    ...
    kprintf("vtd: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: vtd: soft retphase — Wave 22 return-phase honesty */
            kprintf("vtd: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)VTD_SOFT_WAVE);
            /* Grep: vtd: soft retbadge — Wave 22 exclusive badge stamp */
