 ...
 *   - Path catalog + stats rollup + deepen wave=79 + PASS/NONE
...
kprintf("kheap: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("kheap: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("kheap: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("kheap: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("kheap: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("kheap: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("kheap: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("kheap: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retbastionangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("kheap: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("kheap: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retparapetangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("kheap: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("kheap: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retowerangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("kheap: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("kheap: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retwallangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("kheap: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("kheap: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retholdangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("kheap: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("kheap: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retfortressangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("kheap: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=79 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("kheap: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=79 (retredoubtangle stamp; Soft≠product)\n");
