 ...
 *   - Path catalog + stats rollup + deepen wave=89 + PASS/NONE
...
kprintf("kheap: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("kheap: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("kheap: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("kheap: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("kheap: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("kheap: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("kheap: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("kheap: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbastionangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("kheap: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("kheap: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retparapetangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("kheap: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("kheap: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retowerangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("kheap: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("kheap: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retwallangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("kheap: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("kheap: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retholdangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("kheap: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("kheap: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retfortressangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("kheap: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("kheap: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("kheap: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("kheap: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: kheap: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("kheap: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("kheap: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("kheap: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("kheap: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retaegisangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("kheap: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("kheap: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retsigilangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("kheap: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("kheap: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retglyphangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("kheap: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("kheap: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retshardangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("kheap: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("kheap: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retprismangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("kheap: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("kheap: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retcipherangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("kheap: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("kheap: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retledgerangle stamp; Soft≠product)\n");
/* Grep: kheap: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("kheap: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=89 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: kheap: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("kheap: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=89 (retvaultangle stamp; Soft≠product)\n");
