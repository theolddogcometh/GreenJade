 ...
 *
 * Soft memobj inventory (Wave 25 exclusive deepen):
 ...
 *   - Stats rollup + deepen wave=25 stamp + PASS/PARTIAL/INIT/NONE
...
#define MEMOBJ_SOFT_WAVE 25u
/* Catalog areas prior to deepen (honesty..OPEN). Soft ≠ product. */
#define MEMOBJ_SOFT_AREAS 44u
 ...
 *   memobj: soft deepen     — wave=25 stamp + area count
 *   memobj: soft PASS|PARTIAL|INIT|NONE | inventory PASS
 * greppable: memobj: soft
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: memobj: soft retledger — Wave 25 return-ledger honesty */
            kprintf("memobj: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)MEMOBJ_SOFT_WAVE);
            /* Grep: memobj: soft retbeacon — Wave 25 exclusive beacon stamp */
    ...
    kprintf("memobj: soft deepen wave=%u areas=%u catalog=%u logs=%u "
            ...
            "(Wave 25 exclusive; soft; not product; not bar3; "
