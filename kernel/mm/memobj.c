 ...
 *
 * Soft memobj inventory (Wave 26 exclusive deepen):
 ...
 *   - Stats rollup + deepen wave=26 stamp + PASS/PARTIAL/INIT/NONE
...
#define MEMOBJ_SOFT_WAVE 26u
/* Catalog areas prior to deepen (honesty..OPEN). Soft ≠ product. */
#define MEMOBJ_SOFT_AREAS 46u
 ...
 *   memobj: soft deepen     — wave=26 stamp + area count
 *   memobj: soft PASS|PARTIAL|INIT|NONE | inventory PASS
 * greppable: memobj: soft
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: memobj: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("memobj: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)MEMOBJ_SOFT_WAVE);
            /* Grep: memobj: soft retflame — Wave 26 exclusive flame stamp */
    ...
    kprintf("memobj: soft deepen wave=%u areas=%u catalog=%u logs=%u "
            ...
            "(Wave 26 exclusive; soft; not product; not bar3; "
