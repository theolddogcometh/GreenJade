 ...
 *
 * Soft memobj inventory (Wave 23 exclusive deepen):
 ...
 *   - Stats rollup + deepen wave=23 stamp + PASS/PARTIAL/INIT/NONE
...
#define MEMOBJ_SOFT_WAVE 23u
/* Catalog areas prior to deepen (honesty..OPEN). Soft ≠ product. */
#define MEMOBJ_SOFT_AREAS 40u
 ...
 *   memobj: soft deepen     — wave=23 stamp + area count
 *   memobj: soft PASS|PARTIAL|INIT|NONE | inventory PASS
 * greppable: memobj: soft
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: memobj: soft rettoken — Wave 23 return-token honesty */
            kprintf("memobj: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)MEMOBJ_SOFT_WAVE);
            /* Grep: memobj: soft retcrest — Wave 23 exclusive crest stamp */
