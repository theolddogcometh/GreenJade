 ...
 *
 * Soft memobj inventory (Wave 33 exclusive deepen):
 ...
 *   - Stats rollup + deepen wave=33 stamp + PASS/PARTIAL/INIT/NONE
...
#define MEMOBJ_SOFT_WAVE 33u
/* Catalog areas prior to deepen (honesty..OPEN). Soft ≠ product. */
#define MEMOBJ_SOFT_AREAS 58u
 ...
 *   memobj: soft deepen     — wave=33 stamp + area count
 *   memobj: soft PASS|PARTIAL|INIT|NONE | inventory PASS
 * greppable: memobj: soft
 ...
 * Soft≠product; not bar3.
 */
/* Grep: memobj: soft retbastion — Wave 33 return-bastion honesty */
kprintf("memobj: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbastion honesty; Soft≠product; not bar3)\n",
        (unsigned)MEMOBJ_SOFT_WAVE);
/* Grep: memobj: soft retcitadel — Wave 33 exclusive citadel stamp */
kprintf("memobj: soft retcitadel exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)MEMOBJ_SOFT_WAVE);
            ...
            "(Wave 33 exclusive; soft; not product; not bar3; "
