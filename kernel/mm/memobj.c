 ...
 *
 * Soft memobj inventory (Wave 24 exclusive deepen):
 ...
 *   - Stats rollup + deepen wave=24 stamp + PASS/PARTIAL/INIT/NONE
...
#define MEMOBJ_SOFT_WAVE 24u
/* Catalog areas prior to deepen (honesty..OPEN). Soft ≠ product. */
#define MEMOBJ_SOFT_AREAS 42u
 ...
 *   memobj: soft deepen     — wave=24 stamp + area count
 *   memobj: soft PASS|PARTIAL|INIT|NONE | inventory PASS
 * greppable: memobj: soft
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: memobj: soft retvault — Wave 24 return-vault honesty */
            kprintf("memobj: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)MEMOBJ_SOFT_WAVE);
            /* Grep: memobj: soft retbanner — Wave 24 exclusive banner stamp */
