 ...
 *
 * Soft memobj inventory (Wave 29 exclusive deepen):
 ...
 *   - Stats rollup + deepen wave=29 stamp + PASS/PARTIAL/INIT/NONE
...
#define MEMOBJ_SOFT_WAVE 29u
/* Catalog areas prior to deepen (honesty..OPEN). Soft ≠ product. */
#define MEMOBJ_SOFT_AREAS 50u
 ...
 *   memobj: soft deepen     — wave=29 stamp + area count
 *   memobj: soft PASS|PARTIAL|INIT|NONE | inventory PASS
 * greppable: memobj: soft
            ...
            */
            ...
            kprintf("memobj: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("memobj: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: memobj: soft retglyph — Wave 29 return-glyph honesty */
                            kprintf("memobj: soft retglyph soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retglyph honesty; Soft≠product; not bar3)\n",
                                    (unsigned)MEMOBJ_SOFT_WAVE);
                            /* Grep: memobj: soft retscepter — Wave 29 exclusive scepter stamp */
            ...
            "(Wave 29 exclusive; soft; not product; not bar3; "
