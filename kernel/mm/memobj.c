 ...
 *
 * Soft memobj inventory (Wave 22 exclusive deepen):
 ...
 *   - Stats rollup + deepen wave=22 stamp + PASS/PARTIAL/INIT/NONE
...
#define MEMOBJ_SOFT_WAVE 22u
/* Catalog areas prior to deepen (honesty..OPEN). Soft ≠ product. */
#define MEMOBJ_SOFT_AREAS 38u
 ...
 *   memobj: soft deepen     — wave=22 stamp + area count
 *   memobj: soft PASS|PARTIAL|INIT|NONE | inventory PASS
 * greppable: memobj: soft
...
soft_inventory_log(void)
{
    ...
    kprintf("memobj: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: memobj: soft retphase — Wave 22 return-phase honesty */
            kprintf("memobj: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)MEMOBJ_SOFT_WAVE);
            /* Grep: memobj: soft retbadge — Wave 22 exclusive badge stamp */
    ...
    kprintf("memobj: soft deepen wave=%u areas=%u catalog=%u logs=%u "
            ...
            "(Wave 22 exclusive; soft; not product; not bar3; "
