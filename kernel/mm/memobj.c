 ...
 *
 * Soft memobj inventory (Wave 32 exclusive deepen):
 ...
 *   - Stats rollup + deepen wave=32 stamp + PASS/PARTIAL/INIT/NONE
...
#define MEMOBJ_SOFT_WAVE 32u
/* Catalog areas prior to deepen (honesty..OPEN). Soft ≠ product. */
#define MEMOBJ_SOFT_AREAS 56u
 ...
 *   memobj: soft deepen     — wave=32 stamp + area count
 *   memobj: soft PASS|PARTIAL|INIT|NONE | inventory PASS
 * greppable: memobj: soft
 ...
 * Soft≠product; not bar3.
 */
/* Grep: memobj: soft retbulwark — Wave 32 return-bulwark honesty */
kprintf("memobj: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbulwark honesty; Soft≠product; not bar3)\n",
        (unsigned)MEMOBJ_SOFT_WAVE);
/* Grep: memobj: soft retpanoply — Wave 32 exclusive panoply stamp */
kprintf("memobj: soft retpanoply exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)MEMOBJ_SOFT_WAVE);
            ...
            "(Wave 32 exclusive; soft; not product; not bar3; "
