 ...
 *   "pmm: soft deepen …"     wave=33 stamp + area count
 ...
 * Soft≠product; not bar3.
 */
/* Grep: pmm: soft retbastion — Wave 33 return-bastion honesty */
kprintf("pmm: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbastion honesty; Soft≠product; not bar3)\n",
        (unsigned)PMM_SOFT_WAVE);
/* Grep: pmm: soft retcitadel — Wave 33 exclusive citadel stamp */
kprintf("pmm: soft retcitadel exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)PMM_SOFT_WAVE);
            ...
            "(Wave 33 exclusive; soft; not 1TiB product; not bar3; "
            "soft≠product)\n",
