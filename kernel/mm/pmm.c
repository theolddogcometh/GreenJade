 ...
 *   "pmm: soft deepen …"     wave=25 stamp + area count
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: pmm: soft retledger — Wave 25 return-ledger honesty */
            kprintf("pmm: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)PMM_SOFT_WAVE);
            /* Grep: pmm: soft retbeacon — Wave 25 exclusive beacon stamp */
    ...
    kprintf("pmm: soft deepen wave=%u areas=%u catalog=%u via=%s ready=%s "
            ...
            "(Wave 25 exclusive; soft; not 1TiB product; not bar3; "
            "soft≠product)\n",
