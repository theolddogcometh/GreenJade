 ...
 *   "pmm: soft deepen …"     wave=95 stamp + area count
...
kprintf("pmm: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("pmm: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("pmm: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("pmm: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("pmm: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("pmm: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("pmm: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("pmm: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("pmm: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("pmm: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retparapetangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("pmm: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("pmm: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retowerangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("pmm: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("pmm: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retwallangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("pmm: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("pmm: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retholdangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("pmm: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("pmm: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retfortressangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("pmm: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("pmm: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("pmm: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("pmm: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: pmm: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("pmm: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("pmm: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("pmm: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("pmm: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retaegisangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("pmm: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("pmm: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retsigilangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("pmm: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("pmm: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retglyphangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("pmm: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("pmm: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retshardangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("pmm: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("pmm: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retprismangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("pmm: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("pmm: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcipherangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("pmm: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("pmm: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retledgerangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("pmm: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("pmm: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retvaultangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("pmm: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("pmm: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (rettokenangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("pmm: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("pmm: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retphaseangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("pmm: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("pmm: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retpulseangle stamp; Soft≠product)\n");

/* Grep: pmm: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("pmm: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("pmm: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retboundangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("pmm: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("pmm: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbladeangle stamp; Soft≠product)\n");
/* Grep: pmm: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("pmm: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("pmm: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retarcangle stamp; Soft≠product)\n");
