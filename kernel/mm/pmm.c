 ...
 *   "pmm: soft deepen …"     wave=23 stamp + area count
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: pmm: soft rettoken — Wave 23 return-token honesty */
            kprintf("pmm: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)PMM_SOFT_WAVE);
            /* Grep: pmm: soft retcrest — Wave 23 exclusive crest stamp */
    ...
    kprintf("pmm: soft deepen wave=%u areas=%u catalog=%u via=%s ready=%s "
            ...
            "(Wave 23 exclusive; soft; not 1TiB product; not bar3; "
            "soft≠product)\n",
