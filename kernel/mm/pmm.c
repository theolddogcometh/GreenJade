 ...
 *   "pmm: soft deepen …"     wave=30 stamp + area count
            ...
            */
            ...
            kprintf("pmm: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("pmm: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: pmm: soft retsigil — Wave 30 return-sigil honesty */
                            kprintf("pmm: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)PMM_SOFT_WAVE);
                            /* Grep: pmm: soft retemblem — Wave 30 exclusive emblem stamp */
            ...
            "(Wave 30 exclusive; soft; not 1TiB product; not bar3; "
            "soft≠product)\n",
