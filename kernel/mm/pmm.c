 ...
 *   "pmm: soft deepen …"     wave=24 stamp + area count
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: pmm: soft retvault — Wave 24 return-vault honesty */
            kprintf("pmm: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)PMM_SOFT_WAVE);
            /* Grep: pmm: soft retbanner — Wave 24 exclusive banner stamp */
    ...
    kprintf("pmm: soft deepen wave=%u areas=%u catalog=%u via=%s ready=%s "
            ...
            "(Wave 24 exclusive; soft; not 1TiB product; not bar3; "
            "soft≠product)\n",
