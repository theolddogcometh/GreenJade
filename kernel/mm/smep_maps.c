 ...
 *
 * Soft deepen (Wave 9 base; Wave 22 exclusive deepen): soft SMEP/map
 ...
 *   "smep: soft deepen …"     wave=22 stamp + area count
...
smep_soft_inventory(const char *szWhere)
{
    ...
    kprintf("smep: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: smep: soft retphase — Wave 22 return-phase honesty */
            kprintf("smep: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)SMEP_SOFT_WAVE);
            /* Grep: smep: soft retbadge — Wave 22 exclusive badge stamp */
    ...
    kprintf("smep: soft deepen wave=%u areas=%u via=%s logs=%lu "
            ...
            "(Wave 22 exclusive; not product G-MAP; not bar3; soft≠product)\n",
            (unsigned)SMEP_SOFT_WAVE,
            (unsigned)u32Areas,
            szWhere,
            (unsigned long)g_u64SoftInvLogs,
