 ...
 *   "smep: soft deepen …"     wave=92 stamp + area count
...
kprintf("smep: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("smep: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("smep: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("smep: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("smep: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("smep: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("smep: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("smep: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbastionangle stamp; Soft≠product)\n");
/* Grep: smep: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("smep: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("smep: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retparapetangle stamp; Soft≠product)\n");
/* Grep: smep: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("smep: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("smep: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retowerangle stamp; Soft≠product)\n");
/* Grep: smep: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("smep: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("smep: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retwallangle stamp; Soft≠product)\n");
/* Grep: smep: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("smep: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("smep: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retholdangle stamp; Soft≠product)\n");
/* Grep: smep: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("smep: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("smep: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retfortressangle stamp; Soft≠product)\n");
/* Grep: smep: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("smep: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("smep: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("smep: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("smep: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: smep: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("smep: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("smep: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: smep: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("smep: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("smep: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retaegisangle stamp; Soft≠product)\n");
/* Grep: smep: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("smep: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("smep: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retsigilangle stamp; Soft≠product)\n");
/* Grep: smep: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("smep: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("smep: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retglyphangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("smep: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("smep: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retshardangle stamp; Soft≠product)\n");
/* Grep: smep: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("smep: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("smep: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retprismangle stamp; Soft≠product)\n");
/* Grep: smep: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("smep: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("smep: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retcipherangle stamp; Soft≠product)\n");
/* Grep: smep: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("smep: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("smep: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retledgerangle stamp; Soft≠product)\n");
/* Grep: smep: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("smep: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("smep: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retvaultangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("smep: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("smep: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (rettokenangle stamp; Soft≠product)\n");
/* Grep: smep: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("smep: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("smep: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retphaseangle stamp; Soft≠product)\n");
/* Grep: smep: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("smep: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("smep: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retpulseangle stamp; Soft≠product)\n");
