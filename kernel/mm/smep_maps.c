 ...
 *   "smep: soft deepen …"     wave=101 stamp + area count
...
kprintf("smep: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("smep: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("smep: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("smep: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("smep: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("smep: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("smep: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("smep: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retbastionangle stamp; Soft≠product)\n");
/* Grep: smep: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("smep: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("smep: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retparapetangle stamp; Soft≠product)\n");
/* Grep: smep: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("smep: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("smep: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retowerangle stamp; Soft≠product)\n");
/* Grep: smep: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("smep: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("smep: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retwallangle stamp; Soft≠product)\n");
/* Grep: smep: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("smep: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("smep: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retholdangle stamp; Soft≠product)\n");
/* Grep: smep: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("smep: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("smep: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retfortressangle stamp; Soft≠product)\n");
/* Grep: smep: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("smep: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("smep: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("smep: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("smep: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: smep: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("smep: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("smep: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: smep: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("smep: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("smep: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retaegisangle stamp; Soft≠product)\n");
/* Grep: smep: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("smep: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("smep: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retsigilangle stamp; Soft≠product)\n");
/* Grep: smep: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("smep: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("smep: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retglyphangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("smep: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("smep: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retshardangle stamp; Soft≠product)\n");
/* Grep: smep: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("smep: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("smep: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retprismangle stamp; Soft≠product)\n");
/* Grep: smep: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("smep: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("smep: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retcipherangle stamp; Soft≠product)\n");
/* Grep: smep: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("smep: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("smep: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retledgerangle stamp; Soft≠product)\n");
/* Grep: smep: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("smep: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("smep: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retvaultangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("smep: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("smep: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (rettokenangle stamp; Soft≠product)\n");
/* Grep: smep: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("smep: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("smep: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retphaseangle stamp; Soft≠product)\n");
/* Grep: smep: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("smep: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("smep: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retpulseangle stamp; Soft≠product)\n");

/* Grep: smep: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("smep: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("smep: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retboundangle stamp; Soft≠product)\n");
/* Grep: smep: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("smep: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("smep: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retbladeangle stamp; Soft≠product)\n");
/* Grep: smep: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("smep: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("smep: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retarcangle stamp; Soft≠product)\n");
/* Grep: smep: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("smep: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("smep: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: smep: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("smep: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("smep: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("smep: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("smep: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retellipseangle stamp; Soft≠product)\n");
/* Grep: smep: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("smep: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("smep: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: smep: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("smep: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("smep: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (rethelixangle stamp; Soft≠product)\n");
/* Grep: smep: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("smep: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=101 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("smep: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=101 (retknotangle stamp; Soft≠product)\n");
