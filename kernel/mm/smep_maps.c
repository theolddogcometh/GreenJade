 ...
 *   "smep: soft deepen …"     wave=88 stamp + area count
...
kprintf("smep: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("smep: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("smep: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("smep: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("smep: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("smep: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("smep: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("smep: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retbastionangle stamp; Soft≠product)\n");
/* Grep: smep: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("smep: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("smep: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retparapetangle stamp; Soft≠product)\n");
/* Grep: smep: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("smep: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("smep: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retowerangle stamp; Soft≠product)\n");
/* Grep: smep: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("smep: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("smep: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retwallangle stamp; Soft≠product)\n");
/* Grep: smep: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("smep: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("smep: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retholdangle stamp; Soft≠product)\n");
/* Grep: smep: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("smep: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("smep: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retfortressangle stamp; Soft≠product)\n");
/* Grep: smep: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("smep: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("smep: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("smep: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("smep: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: smep: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("smep: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("smep: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: smep: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("smep: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("smep: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retaegisangle stamp; Soft≠product)\n");
/* Grep: smep: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("smep: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("smep: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retsigilangle stamp; Soft≠product)\n");
/* Grep: smep: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("smep: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("smep: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retglyphangle stamp; Soft≠product)\n");
/* Grep: smep: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("smep: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("smep: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retshardangle stamp; Soft≠product)\n");
/* Grep: smep: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("smep: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("smep: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retprismangle stamp; Soft≠product)\n");
/* Grep: smep: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("smep: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("smep: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retcipherangle stamp; Soft≠product)\n");
/* Grep: smep: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("smep: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=88 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: smep: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("smep: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=88 (retledgerangle stamp; Soft≠product)\n");
