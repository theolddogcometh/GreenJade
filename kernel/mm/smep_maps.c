 ...
 *
 * Soft deepen (Wave 9 base; Wave 24 exclusive deepen): soft SMEP/map
 ...
 *   "smep: soft deepen …"     wave=24 stamp + area count
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: smep: soft retvault — Wave 24 return-vault honesty */
            kprintf("smep: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)SMEP_SOFT_WAVE);
            /* Grep: smep: soft retbanner — Wave 24 exclusive banner stamp */
    ...
    kprintf("smep: soft deepen wave=%u areas=%u via=%s logs=%lu "
            ...
            "(Wave 24 exclusive; not product G-MAP; not bar3; soft≠product)\n",
            (unsigned)SMEP_SOFT_WAVE,
            (unsigned)u32Areas,
            szWhere,
            (unsigned long)g_u64SoftInvLogs,
