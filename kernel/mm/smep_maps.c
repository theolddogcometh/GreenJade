 ...
 *
 * Soft deepen (Wave 9 base; Wave 30 exclusive deepen): soft SMEP/map
 ...
 *   "smep: soft deepen …"     wave=30 stamp + area count
            ...
            */
            ...
            kprintf("smep: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("smep: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: smep: soft retsigil — Wave 30 return-sigil honesty */
                            kprintf("smep: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)SMEP_SOFT_WAVE);
                            /* Grep: smep: soft retemblem — Wave 30 exclusive emblem stamp */
            ...
            "(Wave 30 exclusive; not product G-MAP; not bar3; soft≠product)\n",
            (unsigned)SMEP_SOFT_WAVE,
            (unsigned)u32Areas,
            szWhere,
            (unsigned long)g_u64SoftInvLogs,
