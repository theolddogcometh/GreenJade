 ...
 *
 * Soft deepen (Wave 9 base; Wave 26 exclusive deepen): soft SMEP/map
 ...
 *   "smep: soft deepen …"     wave=26 stamp + area count
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: smep: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("smep: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)SMEP_SOFT_WAVE);
            /* Grep: smep: soft retflame — Wave 26 exclusive flame stamp */
    ...
    kprintf("smep: soft deepen wave=%u areas=%u via=%s logs=%lu "
            ...
            "(Wave 26 exclusive; not product G-MAP; not bar3; soft≠product)\n",
            (unsigned)SMEP_SOFT_WAVE,
            (unsigned)u32Areas,
            szWhere,
            (unsigned long)g_u64SoftInvLogs,
