 ...
 *
 * Soft deepen (Wave 9 base; Wave 23 exclusive deepen): soft SMEP/map
 ...
 *   "smep: soft deepen …"     wave=23 stamp + area count
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: smep: soft rettoken — Wave 23 return-token honesty */
            kprintf("smep: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)SMEP_SOFT_WAVE);
            /* Grep: smep: soft retcrest — Wave 23 exclusive crest stamp */
    ...
    kprintf("smep: soft deepen wave=%u areas=%u via=%s logs=%lu "
            ...
            "(Wave 23 exclusive; not product G-MAP; not bar3; soft≠product)\n",
            (unsigned)SMEP_SOFT_WAVE,
            (unsigned)u32Areas,
            szWhere,
            (unsigned long)g_u64SoftInvLogs,
