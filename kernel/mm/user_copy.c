 ...
 *   "user_copy: soft deepen …"    wave=106 stamp + area count
 ...
 *   user_copy: soft return selftest — Wave 19 terminal return surface
 *   user_copy: soft retmap     — Wave 19 return-surface map
 *   user_copy: soft deepen     — wave=106 stamp + areas
...
kprintf("user_copy: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("user_copy: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("user_copy: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("user_copy: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("user_copy: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("user_copy: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("user_copy: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("user_copy: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbastionangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("user_copy: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("user_copy: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retparapetangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("user_copy: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("user_copy: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retowerangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("user_copy: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("user_copy: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retwallangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("user_copy: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("user_copy: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retholdangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("user_copy: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("user_copy: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retfortressangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("user_copy: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("user_copy: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("user_copy: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("user_copy: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: user_copy: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("user_copy: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("user_copy: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("user_copy: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("user_copy: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retaegisangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("user_copy: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("user_copy: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retsigilangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("user_copy: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("user_copy: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retglyphangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("user_copy: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("user_copy: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retshardangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("user_copy: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("user_copy: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retprismangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("user_copy: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("user_copy: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retcipherangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("user_copy: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("user_copy: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retledgerangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("user_copy: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("user_copy: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retvaultangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("user_copy: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("user_copy: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (rettokenangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("user_copy: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("user_copy: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retphaseangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("user_copy: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("user_copy: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retpulseangle stamp; Soft≠product)\n");

/* Grep: user_copy: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("user_copy: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("user_copy: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retboundangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("user_copy: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("user_copy: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbladeangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("user_copy: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("user_copy: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retarcangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("user_copy: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("user_copy: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("user_copy: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("user_copy: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("user_copy: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("user_copy: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retellipseangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("user_copy: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("user_copy: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("user_copy: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("user_copy: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (rethelixangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("user_copy: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("user_copy: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retknotangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("user_copy: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("user_copy: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retkleinangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("user_copy: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("user_copy: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retaffineangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("user_copy: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("user_copy: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("user_copy: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("user_copy: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retcubicangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("user_copy: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=106 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("user_copy: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=106 (retquinticangle stamp; Soft≠product)\n");
