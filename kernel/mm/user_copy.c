 ...
 *   "user_copy: soft deepen …"    wave=96 stamp + area count
 ...
 *   user_copy: soft return selftest — Wave 19 terminal return surface
 *   user_copy: soft retmap     — Wave 19 return-surface map
 *   user_copy: soft deepen     — wave=96 stamp + areas
...
kprintf("user_copy: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("user_copy: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("user_copy: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("user_copy: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("user_copy: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("user_copy: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("user_copy: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("user_copy: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbastionangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("user_copy: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("user_copy: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retparapetangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("user_copy: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("user_copy: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retowerangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("user_copy: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("user_copy: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retwallangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("user_copy: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("user_copy: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retholdangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("user_copy: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("user_copy: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retfortressangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("user_copy: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("user_copy: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("user_copy: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("user_copy: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: user_copy: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("user_copy: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("user_copy: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("user_copy: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("user_copy: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retaegisangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("user_copy: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("user_copy: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retsigilangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("user_copy: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("user_copy: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retglyphangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("user_copy: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("user_copy: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retshardangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("user_copy: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("user_copy: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retprismangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("user_copy: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("user_copy: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retcipherangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("user_copy: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("user_copy: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retledgerangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("user_copy: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("user_copy: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retvaultangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("user_copy: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("user_copy: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (rettokenangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("user_copy: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("user_copy: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retphaseangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("user_copy: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("user_copy: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retpulseangle stamp; Soft≠product)\n");

/* Grep: user_copy: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("user_copy: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("user_copy: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retboundangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("user_copy: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("user_copy: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbladeangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("user_copy: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("user_copy: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retarcangle stamp; Soft≠product)\n");
/* Grep: user_copy: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("user_copy: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: user_copy: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("user_copy: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retwedgeangle stamp; Soft≠product)\n");
