 ...
 *
 * Soft VMM inventory (Wave 34 exclusive deepen; Wave 10/13 base):
...
/*
 * Soft product inventory (Wave 34 exclusive deepen; extends Wave 13).
...
#define GJ_VMM_SOFT_WAVE 34u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS 58u
...
/**
 * Greppable soft VMM inventory (product / smoke; Wave 34 exclusive deepen).
 *   vmm: soft honesty …
 *   vmm: soft inventory …
 *   vmm: soft as …
 *   vmm: soft cow …
...
kprintf("vmm: soft retkeep exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)GJ_VMM_SOFT_WAVE);
            ...
            "(Wave 34 exclusive; soft only; not product; not bar3; "
