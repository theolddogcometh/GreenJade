 ...
 *
 * Soft VMM inventory (Wave 32 exclusive deepen; Wave 10/13 base):
...
/*
 * Soft product inventory (Wave 32 exclusive deepen; extends Wave 13).
...
#define GJ_VMM_SOFT_WAVE 32u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS 54u
...
/**
 * Greppable soft VMM inventory (product / smoke; Wave 32 exclusive deepen).
 *   vmm: soft honesty …
 *   vmm: soft inventory …
 *   vmm: soft as …
 *   vmm: soft cow …
 ...
 * Soft≠product; not bar3.
 */
/* Grep: vmm: soft retbulwark — Wave 32 return-bulwark honesty */
kprintf("vmm: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbulwark honesty; Soft≠product; not bar3)\n",
        (unsigned)GJ_VMM_SOFT_WAVE);
/* Grep: vmm: soft retpanoply — Wave 32 exclusive panoply stamp */
kprintf("vmm: soft retpanoply exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)GJ_VMM_SOFT_WAVE);
            ...
            "(Wave 32 exclusive; soft only; not product; not bar3; "
