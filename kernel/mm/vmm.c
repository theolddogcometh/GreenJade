 ...
 *
 * Soft VMM inventory (Wave 20 exclusive deepen; Wave 10/13 base):
...
/*
 * Soft product inventory (Wave 20 exclusive deepen; extends Wave 13).
...
#define GJ_VMM_SOFT_WAVE           20u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS          32u
...
/**
 * Greppable soft VMM inventory (product / smoke; Wave 20 exclusive deepen).
 *   vmm: soft honesty …
 *   vmm: soft inventory …
 *   vmm: soft as …
 *   vmm: soft cow …
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: vmm: soft deepen wave (Wave 20 stamp; areas = prior soft lines).
     */
    /*
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: vmm: soft retbound — Wave 20 return-bound honesty */
    kprintf("vmm: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)GJ_VMM_SOFT_WAVE);
    /* Grep: vmm: soft retseal — Wave 20 exclusive seal stamp */
    ...
    kprintf("vmm: soft deepen wave=%u areas=%u catalog=%u logs=%u "
            ...
            "(Wave 20 exclusive; soft only; not product; not bar3; "
