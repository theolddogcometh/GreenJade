 ...
 *
 * Soft VMM inventory (Wave 22 exclusive deepen; Wave 10/13 base):
...
/*
 * Soft product inventory (Wave 22 exclusive deepen; extends Wave 13).
...
#define GJ_VMM_SOFT_WAVE           22u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS 36u
...
/**
 * Greppable soft VMM inventory (product / smoke; Wave 22 exclusive deepen).
 *   vmm: soft honesty …
 *   vmm: soft inventory …
 *   vmm: soft as …
 *   vmm: soft cow …
...
soft_inventory_log(void)
{
    ...
    kprintf("vmm: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: vmm: soft retphase — Wave 22 return-phase honesty */
            kprintf("vmm: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_VMM_SOFT_WAVE);
            /* Grep: vmm: soft retbadge — Wave 22 exclusive badge stamp */
    ...
    kprintf("vmm: soft deepen wave=%u areas=%u catalog=%u logs=%u "
            ...
            "(Wave 22 exclusive; soft only; not product; not bar3; "
