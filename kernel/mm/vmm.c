 ...
 *
 * Soft VMM inventory (Wave 33 exclusive deepen; Wave 10/13 base):
...
/*
 * Soft product inventory (Wave 33 exclusive deepen; extends Wave 13).
...
#define GJ_VMM_SOFT_WAVE 33u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS 56u
...
/**
 * Greppable soft VMM inventory (product / smoke; Wave 33 exclusive deepen).
 *   vmm: soft honesty …
 *   vmm: soft inventory …
 *   vmm: soft as …
 *   vmm: soft cow …
 ...
 * Soft≠product; not bar3.
 */
/* Grep: vmm: soft retbastion — Wave 33 return-bastion honesty */
kprintf("vmm: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbastion honesty; Soft≠product; not bar3)\n",
        (unsigned)GJ_VMM_SOFT_WAVE);
/* Grep: vmm: soft retcitadel — Wave 33 exclusive citadel stamp */
kprintf("vmm: soft retcitadel exclusive=1 soft_ne_product=1 "
        ...
        (unsigned)GJ_VMM_SOFT_WAVE);
            ...
            "(Wave 33 exclusive; soft only; not product; not bar3; "
