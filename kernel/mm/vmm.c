...
#define GJ_VMM_SOFT_WAVE 108u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS 202u
...
kprintf("vmm: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("vmm: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("vmm: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("vmm: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("vmm: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("vmm: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("vmm: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("vmm: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("vmm: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("vmm: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparapetangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("vmm: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("vmm: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retowerangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("vmm: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("vmm: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwallangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("vmm: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("vmm: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retholdangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("vmm: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("vmm: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retfortressangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("vmm: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("vmm: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("vmm: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("vmm: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: vmm: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("vmm: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("vmm: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("vmm: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("vmm: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaegisangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("vmm: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("vmm: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retsigilangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("vmm: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("vmm: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retglyphangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("vmm: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("vmm: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retshardangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("vmm: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("vmm: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retprismangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("vmm: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("vmm: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcipherangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("vmm: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("vmm: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retledgerangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("vmm: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("vmm: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retvaultangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("vmm: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("vmm: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rettokenangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("vmm: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("vmm: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retphaseangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("vmm: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("vmm: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retpulseangle stamp; Soft≠product)\n");

/* Grep: vmm: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("vmm: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("vmm: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retboundangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("vmm: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("vmm: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbladeangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("vmm: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("vmm: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retarcangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("vmm: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("vmm: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("vmm: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("vmm: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("vmm: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("vmm: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retellipseangle stamp; Soft≠product)\n");
/* Grep: vmm: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("vmm: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("vmm: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("vmm: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("vmm: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rethelixangle stamp; Soft≠product)\n");
/* Grep: vmm: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("vmm: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("vmm: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retknotangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("vmm: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("vmm: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retkleinangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("vmm: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("vmm: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaffineangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("vmm: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("vmm: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("vmm: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("vmm: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcubicangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("vmm: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("vmm: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retquinticangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("vmm: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("vmm: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbezierangle stamp; Soft≠product)\n");
/* Grep: vmm: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("vmm: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("vmm: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcatmullangle stamp; Soft≠product)\n");
