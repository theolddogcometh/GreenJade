 ...
 *
 * Soft VMM inventory (Wave 21 exclusive deepen; Wave 10/13 base):
...
/*
 * Soft product inventory (Wave 21 exclusive deepen; extends Wave 13).
...
#define GJ_VMM_SOFT_WAVE           21u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS          34u
...
/**
 * Greppable soft VMM inventory (product / smoke; Wave 21 exclusive deepen).
 *   vmm: soft honesty …
 *   vmm: soft inventory …
 *   vmm: soft as …
 *   vmm: soft cow …
...
soft_inventory_log(void)
{
    ...
    kprintf("vmm: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: vmm: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("vmm: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_VMM_SOFT_WAVE);
            /* Grep: vmm: soft retmark — Wave 21 exclusive mark stamp */
    ...
    kprintf("vmm: soft deepen wave=%u areas=%u catalog=%u logs=%u "
            ...
            "(Wave 21 exclusive; soft only; not product; not bar3; "
