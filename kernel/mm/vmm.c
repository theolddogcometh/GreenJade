 ...
 *
 * Soft VMM inventory (Wave 23 exclusive deepen; Wave 10/13 base):
...
/*
 * Soft product inventory (Wave 23 exclusive deepen; extends Wave 13).
...
#define GJ_VMM_SOFT_WAVE           23u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS 38u
...
/**
 * Greppable soft VMM inventory (product / smoke; Wave 23 exclusive deepen).
 *   vmm: soft honesty …
 *   vmm: soft inventory …
 *   vmm: soft as …
 *   vmm: soft cow …
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: vmm: soft rettoken — Wave 23 return-token honesty */
            kprintf("vmm: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_VMM_SOFT_WAVE);
            /* Grep: vmm: soft retcrest — Wave 23 exclusive crest stamp */
    ...
    kprintf("vmm: soft deepen wave=%u areas=%u catalog=%u logs=%u "
            ...
            "(Wave 23 exclusive; soft only; not product; not bar3; "
