...
#define GJ_VMM_SOFT_WAVE 92u
/* Catalog areas prior to deepen line (honesty..share). */
#define GJ_VMM_SOFT_AREAS 170u
...
kprintf("vmm: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("vmm: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("vmm: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("vmm: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("vmm: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("vmm: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("vmm: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("vmm: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbastionangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("vmm: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("vmm: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retparapetangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("vmm: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("vmm: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retowerangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("vmm: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("vmm: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retwallangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("vmm: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("vmm: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retholdangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("vmm: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("vmm: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retfortressangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("vmm: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("vmm: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("vmm: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("vmm: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: vmm: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("vmm: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("vmm: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("vmm: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("vmm: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retaegisangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("vmm: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("vmm: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retsigilangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("vmm: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("vmm: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retglyphangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("vmm: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("vmm: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retshardangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("vmm: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("vmm: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retprismangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("vmm: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("vmm: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retcipherangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("vmm: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("vmm: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retledgerangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("vmm: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("vmm: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retvaultangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("vmm: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("vmm: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (rettokenangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("vmm: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("vmm: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retphaseangle stamp; Soft≠product)\n");
/* Grep: vmm: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("vmm: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=92 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: vmm: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("vmm: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=92 (retpulseangle stamp; Soft≠product)\n");
