 ...
 *   net_door: soft deepen      — wave=24 stamp + area count
...
net_door_soft_inventory_log(void)
{
    ...
    kprintf("net_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=24\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: net_door: soft retvault — Wave 24 return-vault honesty */
            kprintf("net_door: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)NET_DOOR_SOFT_DEEPEN_WAVE);
            /* Grep: net_door: soft retbanner — Wave 24 exclusive banner stamp */
