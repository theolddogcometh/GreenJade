 ...
 *   net_door: soft deepen      — wave=21 stamp + area count
...
#define NET_DOOR_SOFT_DEEPEN_WAVE  21u
...
#define NET_DOOR_SOFT_DEEPEN_AREAS 30u
...
net_door_soft_inventory_log(void)
{
    ...
    kprintf("net_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=21\n");
    ...
    kprintf("net_door: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: net_door: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("net_door: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)NET_DOOR_SOFT_DEEPEN_WAVE);
            /* Grep: net_door: soft retmark — Wave 21 exclusive mark stamp */
