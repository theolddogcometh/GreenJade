 ...
 *   net_door: soft deepen      — wave=82 stamp + area count
...
#define NET_DOOR_SOFT_DEEPEN_AREAS 106u
...
net_door_soft_inventory_log(void)
{
    ...
    kprintf("net_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=82\n");
...
kprintf("net_door: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("net_door: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("net_door: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("net_door: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("net_door: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("net_door: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("net_door: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("net_door: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retbastionangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("net_door: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("net_door: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retparapetangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("net_door: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("net_door: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retowerangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("net_door: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("net_door: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retwallangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("net_door: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("net_door: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retholdangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("net_door: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("net_door: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retfortressangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("net_door: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("net_door: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("net_door: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("net_door: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: net_door: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("net_door: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("net_door: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: net_door: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("net_door: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=82 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("net_door: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=82 (retaegisangle stamp; Soft≠product)\n");
