 ...
 *   net_door: soft deepen      — wave=33 stamp + area count
...
#define NET_DOOR_SOFT_DEEPEN_WAVE 32u
...
#define NET_DOOR_SOFT_DEEPEN_AREAS 44u
...
net_door_soft_inventory_log(void)
{
    ...
    kprintf("net_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=33\n");
 ...
 * Soft≠product; not bar3.
 */
/* Grep: net_door: soft retbastion — Wave 33 return-bastion honesty */
kprintf("net_door: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=33 "
        "(retbastion honesty; Soft≠product; not bar3)\n");
/* Grep: net_door: soft retcitadel — Wave 33 exclusive citadel stamp */
