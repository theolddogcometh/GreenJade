 ...
 *   net_door: soft deepen      — wave=65 stamp + area count
...
#define NET_DOOR_SOFT_DEEPEN_AREAS 86u
...
net_door_soft_inventory_log(void)
{
    ...
    kprintf("net_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=65\n");
