 ...
 *     net: tcp soft deepen …     — wave=57 stamp + area count
...
#define TCP_SOFT_DEEPEN_AREAS 75u
...
kprintf("net: tcp: soft retcasemate exclusive=1 soft_ne_product=1 "
	...
	kprintf("net_tcp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=57\n");
