 ...
 *     net: tcp soft deepen …     — wave=91 stamp + area count
...
kprintf("net: tcp: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("net: tcp: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("net: tcp: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("net: tcp: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("net: tcp: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("net: tcp: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("net: tcp: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("net: tcp: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retbastionangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("net: tcp: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("net: tcp: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retparapetangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("net: tcp: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("net: tcp: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retowerangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("net: tcp: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("net: tcp: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retwallangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("net: tcp: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("net: tcp: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retholdangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("net: tcp: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("net: tcp: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retfortressangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("net: tcp: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("net: tcp: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("net: tcp: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("net: tcp: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("net: tcp: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("net: tcp: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("net: tcp: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("net: tcp: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retaegisangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("net: tcp: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("net: tcp: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retsigilangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("net: tcp: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("net: tcp: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retglyphangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("net: tcp: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("net: tcp: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retshardangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("net: tcp: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("net: tcp: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retprismangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("net: tcp: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("net: tcp: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retcipherangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("net: tcp: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("net: tcp: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retledgerangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("net: tcp: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("net: tcp: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retvaultangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("net: tcp: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("net: tcp: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (rettokenangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("net: tcp: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=91 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("net: tcp: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=91 (retphaseangle stamp; Soft≠product)\n");
	...
	kprintf("net_tcp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=91\n");
