 ...
 *     net: tcp soft deepen …     — wave=21 stamp + area count
...
#define TCP_SOFT_DEEPEN_WAVE  21u
...
#define TCP_SOFT_DEEPEN_AREAS 29u
...
tcp_soft_print(int fForce)
{
	...
	kprintf("net: tcp: soft retseal exclusive=1 soft_ne_product=1 "
	         ...
	         * Soft≠product; not bar3.
	        */
	        /* Grep: net: tcp: soft retpulse — Wave 21 return-pulse honesty */
	        kprintf("net: tcp: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
	                "never_blocks_m0=1 wave=%u "
	                "(retpulse honesty; Soft≠product; not bar3)\n",
	                (unsigned)TCP_SOFT_DEEPEN_WAVE);
	        /* Grep: net: tcp: soft retmark — Wave 21 exclusive mark stamp */
	...
	kprintf("net_tcp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=21\n");
