 ...
 *     net: tcp soft deepen …     — wave=80 stamp + area count
...
#define TCP_SOFT_DEEPEN_AREAS 101u
...
kprintf("net: tcp: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("net: tcp: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("net: tcp: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("net: tcp: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("net: tcp: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("net: tcp: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("net: tcp: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("net: tcp: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retbastionangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("net: tcp: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("net: tcp: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retparapetangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("net: tcp: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("net: tcp: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retowerangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("net: tcp: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("net: tcp: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retwallangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("net: tcp: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("net: tcp: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retholdangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("net: tcp: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("net: tcp: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retfortressangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("net: tcp: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("net: tcp: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("net: tcp: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=80 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("net: tcp: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=80 (retbastionkeep stamp; Soft≠product)\n");
	...
	kprintf("net_tcp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=80\n");
