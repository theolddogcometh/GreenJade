 ...
 *     net: tcp soft deepen …     — wave=108 stamp + area count
...
#define TCP_SOFT_DEEPEN_AREAS 149u
...
kprintf("net: tcp: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("net: tcp: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("net: tcp: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("net: tcp: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("net: tcp: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("net: tcp: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("net: tcp: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("net: tcp: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("net: tcp: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("net: tcp: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparapetangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("net: tcp: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("net: tcp: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retowerangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("net: tcp: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("net: tcp: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwallangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("net: tcp: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("net: tcp: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retholdangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("net: tcp: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("net: tcp: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retfortressangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("net: tcp: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("net: tcp: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("net: tcp: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("net: tcp: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("net: tcp: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("net: tcp: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("net: tcp: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("net: tcp: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaegisangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("net: tcp: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("net: tcp: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retsigilangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("net: tcp: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("net: tcp: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retglyphangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("net: tcp: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("net: tcp: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retshardangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("net: tcp: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("net: tcp: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retprismangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("net: tcp: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("net: tcp: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcipherangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("net: tcp: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("net: tcp: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retledgerangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("net: tcp: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("net: tcp: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retvaultangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("net: tcp: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("net: tcp: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rettokenangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("net: tcp: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("net: tcp: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retphaseangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("net: tcp: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("net: tcp: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retpulseangle stamp; Soft≠product)\n");

/* Grep: net: tcp: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("net: tcp: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("net: tcp: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retboundangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("net: tcp: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("net: tcp: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbladeangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("net: tcp: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("net: tcp: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retarcangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("net: tcp: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("net: tcp: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("net: tcp: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("net: tcp: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("net: tcp: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("net: tcp: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retellipseangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("net: tcp: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("net: tcp: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("net: tcp: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("net: tcp: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (rethelixangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("net: tcp: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("net: tcp: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retknotangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("net: tcp: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("net: tcp: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retkleinangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("net: tcp: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("net: tcp: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retaffineangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("net: tcp: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("net: tcp: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("net: tcp: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("net: tcp: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcubicangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("net: tcp: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("net: tcp: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retquinticangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("net: tcp: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("net: tcp: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retbezierangle stamp; Soft≠product)\n");
/* Grep: net: tcp: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("net: tcp: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=108 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: net: tcp: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("net: tcp: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=108 (retcatmullangle stamp; Soft≠product)\n");
	...
	kprintf("net_tcp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=108\n");
