 ...
 *     net: tcp soft deepen …     — wave=31 stamp + area count
...
#define TCP_SOFT_DEEPEN_WAVE 31u
...
#define TCP_SOFT_DEEPEN_AREAS 41u
 ...
 * Soft≠product; not bar3.
	        */
	        ...
	        kprintf("net: tcp: soft retflame exclusive=1 soft_ne_product=1 "
	                ...
	                kprintf("net: tcp: soft retforge exclusive=1 soft_ne_product=1 "
                         ...
                         * Soft≠product; not bar3.
                         */
                        /* Grep: net: tcp: soft retaegis — Wave 31 return-aegis honesty */
                        kprintf("net: tcp: soft retaegis soft_only=1 product_gate=0 soft_ne_product=1 "
                                "never_blocks_m0=1 wave=%u "
                                "(retaegis honesty; Soft≠product; not bar3)\n",
                                (unsigned)TCP_SOFT_DEEPEN_WAVE);
                        /* Grep: net: tcp: soft retmantle — Wave 31 exclusive mantle stamp */
	...
	kprintf("net_tcp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=31\n");
