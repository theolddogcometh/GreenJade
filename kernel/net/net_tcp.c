 ...
 *     net: tcp soft deepen …     — wave=42 stamp + area count
...
#define TCP_SOFT_DEEPEN_WAVE 42u
...
kprintf("net: tcp: soft retbattlement exclusive=1 soft_ne_product=1 "
	...
	kprintf("net_tcp: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=42\n");
