 ...
 *
 * Soft inventory (Wave 37 exclusive deepen; this unit only; never hard-gates):
 ...
 * Soft≠product; not bar3.
    ...
    kprintf("elf_load: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=37\n");
