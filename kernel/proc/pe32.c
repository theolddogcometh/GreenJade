 ...
 *
 * Soft inventory (Wave 11 base + Wave 25 exclusive deepen; this unit only —
 * greppable "pe32: soft …"):
 ...
 *   pe32: soft deepen      — wave=25 areas stamp
...
pe32_soft_inventory_log(const char *szVia)
{
    ...
    kprintf("pe32: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=25\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: pe32: soft retledger — Wave 25 return-ledger honesty */
            kprintf("pe32: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)PE32_SOFT_WAVE);
            /* Grep: pe32: soft retbeacon — Wave 25 exclusive beacon stamp */
