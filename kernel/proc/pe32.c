 ...
 *
 * Soft inventory (Wave 11 base + Wave 24 exclusive deepen; this unit only —
 * greppable "pe32: soft …"):
 ...
 *   pe32: soft deepen      — wave=24 areas stamp
...
pe32_soft_inventory_log(const char *szVia)
{
    ...
    kprintf("pe32: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=24\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: pe32: soft retvault — Wave 24 return-vault honesty */
            kprintf("pe32: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)PE32_SOFT_WAVE);
            /* Grep: pe32: soft retbanner — Wave 24 exclusive banner stamp */
