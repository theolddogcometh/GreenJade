 ...
 *   pe32: soft deepen      — wave=95 areas stamp
...
pe32_soft_inventory_log(const char *szVia)
{
    ...
    kprintf("pe32: soft ret_surface parse=ok|e stage=ok|e map=ok|e "
            ...
            "soft_iretq=ok product_kernel=OPEN areas=87 wave=%u\n",
            (unsigned)PE32_SOFT_WAVE);
    ...
    kprintf("pe32: soft surface inventory,parse,stage,load,exec,int80,"
            ...
            "capacity,return,ret_surface,surface,deepen areas=87 wave=%u\n",
            (unsigned)PE32_SOFT_WAVE);

    /* Grep: pe32: soft retmap — Wave 19 return-surface map */
    kprintf("pe32: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=95\n");
...
kprintf("pe32: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("pe32: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("pe32: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("pe32: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("pe32: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("pe32: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("pe32: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("pe32: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("pe32: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("pe32: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retparapetangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("pe32: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("pe32: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retowerangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("pe32: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("pe32: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retwallangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("pe32: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("pe32: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retholdangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("pe32: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("pe32: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retfortressangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("pe32: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("pe32: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("pe32: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("pe32: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: pe32: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("pe32: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("pe32: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("pe32: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("pe32: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retaegisangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("pe32: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("pe32: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retsigilangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("pe32: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("pe32: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retglyphangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("pe32: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("pe32: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retshardangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("pe32: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("pe32: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retprismangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("pe32: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("pe32: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcipherangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("pe32: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("pe32: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retledgerangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("pe32: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("pe32: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retvaultangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("pe32: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("pe32: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (rettokenangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("pe32: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("pe32: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retphaseangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("pe32: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("pe32: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retpulseangle stamp; Soft≠product)\n");

/* Grep: pe32: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("pe32: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("pe32: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retboundangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("pe32: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("pe32: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbladeangle stamp; Soft≠product)\n");
/* Grep: pe32: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("pe32: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: pe32: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("pe32: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retarcangle stamp; Soft≠product)\n");
