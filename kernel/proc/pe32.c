 ...
 *
 * Soft inventory (Wave 11 base + Wave 27 exclusive deepen; this unit only —
 * greppable "pe32: soft …"):
 ...
 *   pe32: soft deepen      — wave=27 areas stamp
...
pe32_soft_inventory_log(const char *szVia)
{
    ...
    kprintf("pe32: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=27\n");
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("pe32: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: pe32: soft retprism — Wave 27 return-prism honesty */
                    kprintf("pe32: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)PE32_SOFT_WAVE);
                    /* Grep: pe32: soft retforge — Wave 27 exclusive forge stamp */
