 ...
 *
 * Soft inventory (Wave 11 base + Wave 30 exclusive deepen; this unit only —
 * greppable "pe32: soft …"):
 ...
 *   pe32: soft deepen      — wave=30 areas stamp
...
pe32_soft_inventory_log(const char *szVia)
{
    ...
    kprintf("pe32: soft ret_surface parse=ok|e stage=ok|e map=ok|e "
            ...
            "soft_iretq=ok product_kernel=OPEN areas=25 wave=%u\n",
            (unsigned)PE32_SOFT_WAVE);
    ...
    kprintf("pe32: soft surface inventory,parse,stage,load,exec,int80,"
            ...
            "capacity,return,ret_surface,surface,deepen areas=25 wave=%u\n",
            (unsigned)PE32_SOFT_WAVE);

    /* Grep: pe32: soft retmap — Wave 19 return-surface map */
    kprintf("pe32: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=30\n");
            ...
            */
            ...
            kprintf("pe32: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("pe32: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: pe32: soft retsigil — Wave 30 return-sigil honesty */
                            kprintf("pe32: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)PE32_SOFT_WAVE);
                            /* Grep: pe32: soft retemblem — Wave 30 exclusive emblem stamp */
