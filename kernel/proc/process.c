 ...
 *   process: soft deepen wave=52 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=52 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=52 …
 *   G-PROC-5 death tallies (wave=52 stamp):
 *     process: death … / process: death deepen wave=52 …
 *
...
#define GJ_PROCESS_SOFT_WAVE 52u
#define GJ_PROCESS_SOFT_AREAS 85u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE 52u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=52\n");
