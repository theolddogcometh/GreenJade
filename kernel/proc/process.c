 ...
 *
 * Soft product inventory (Wave 32 exclusive deepen; this unit only):
 ...
 *   process: soft deepen wave=32 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=32 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=32 …
 *   G-PROC-5 death tallies (wave=32 stamp):
 *     process: death … / process: death deepen wave=32 …
 *
...
#define GJ_PROCESS_SOFT_WAVE 32u
#define GJ_PROCESS_SOFT_AREAS 49u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE 32u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=32\n");
 ...
 * Soft≠product; not bar3.
 */
/* Grep: process: bootstrap seal: soft retbulwark — Wave 32 return-bulwark honesty */
kprintf("process: bootstrap seal: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbulwark honesty; Soft≠product; not bar3)\n",
        (unsigned)GJ_PROCESS_SOFT_WAVE);
/* Grep: process: bootstrap seal: soft retpanoply — Wave 32 exclusive panoply stamp */
