 ...
 *   process: soft deepen wave=22 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=22 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=22 …
 *   G-PROC-5 death tallies (wave=22 stamp):
 *     process: death … / process: death deepen wave=22 …
 *
...
#define GJ_PROCESS_SOFT_WAVE   22u
#define GJ_PROCESS_SOFT_AREAS 31u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE      22u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=22\n");
    ...
    kprintf("process: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: process: soft retphase — Wave 22 return-phase honesty */
            kprintf("process: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_PROCESS_SOFT_WAVE);
            /* Grep: process: soft retbadge — Wave 22 exclusive badge stamp */
...
process_seal_checklist_soft(const struct gj_process *pProc, const char *szVia)
{
    ...
    kprintf("process: bootstrap seal: soft retseal exclusive=1 soft_ne_product=1 "
            ...
            */
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: process: bootstrap seal: soft retphase — Wave 22 return-phase honesty */
            kprintf("process: bootstrap seal: soft retphase soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retphase honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_PROCESS_SOFT_WAVE);
            /* Grep: process: bootstrap seal: soft retbadge — Wave 22 exclusive badge stamp */
