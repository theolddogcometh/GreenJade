 ...
 *
 * Soft product inventory (Wave 21 exclusive deepen; this unit only):
 ...
 *   process: soft deepen wave=21 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=21 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=21 …
 *   G-PROC-5 death tallies (wave=21 stamp):
 *     process: death … / process: death deepen wave=21 …
 *
...
#define GJ_PROCESS_SOFT_WAVE   21u
#define GJ_PROCESS_SOFT_AREAS  29u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE      21u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=21\n");
    ...
    kprintf("process: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: process: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("process: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_PROCESS_SOFT_WAVE);
            /* Grep: process: soft retmark — Wave 21 exclusive mark stamp */
...
process_seal_checklist_soft(const struct gj_process *pProc, const char *szVia)
{
    ...
    kprintf("process: bootstrap seal: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: process: bootstrap seal: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("process: bootstrap seal: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_PROCESS_SOFT_WAVE);
            /* Grep: process: bootstrap seal: soft retmark — Wave 21 exclusive mark stamp */
