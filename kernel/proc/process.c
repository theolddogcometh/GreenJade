 ...
 *   process: soft deepen wave=60 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=60 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=60 …
 *   G-PROC-5 death tallies (wave=60 stamp):
 *     process: death … / process: death deepen wave=60 …
 *
...
#define GJ_PROCESS_SOFT_WAVE 60u
#define GJ_PROCESS_SOFT_AREAS 101u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE 60u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=60\n");
