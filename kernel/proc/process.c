 ...
 *   process: soft deepen wave=113 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=113 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=113 …
 *   G-PROC-5 death tallies (wave=113 stamp):
 *     process: death … / process: death deepen wave=113 …
 *
...
#define GJ_PROCESS_SOFT_WAVE 113u
#define GJ_PROCESS_SOFT_AREAS 207u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE 113u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=113\n");
...
kprintf("process: bootstrap seal: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("process: bootstrap seal: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("process: bootstrap seal: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("process: bootstrap seal: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("process: bootstrap seal: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("process: bootstrap seal: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("process: bootstrap seal: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("process: bootstrap seal: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retbastionangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("process: bootstrap seal: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("process: bootstrap seal: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retparapetangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("process: bootstrap seal: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("process: bootstrap seal: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retowerangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("process: bootstrap seal: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("process: bootstrap seal: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retwallangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("process: bootstrap seal: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("process: bootstrap seal: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retholdangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("process: bootstrap seal: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("process: bootstrap seal: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retfortressangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("process: bootstrap seal: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("process: bootstrap seal: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("process: bootstrap seal: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("process: bootstrap seal: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("process: bootstrap seal: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("process: bootstrap seal: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("process: bootstrap seal: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("process: bootstrap seal: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retaegisangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("process: bootstrap seal: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("process: bootstrap seal: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retsigilangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("process: bootstrap seal: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("process: bootstrap seal: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retglyphangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("process: bootstrap seal: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("process: bootstrap seal: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retshardangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("process: bootstrap seal: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("process: bootstrap seal: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retprismangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("process: bootstrap seal: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("process: bootstrap seal: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retcipherangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("process: bootstrap seal: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("process: bootstrap seal: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retledgerangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("process: bootstrap seal: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("process: bootstrap seal: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retvaultangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("process: bootstrap seal: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("process: bootstrap seal: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (rettokenangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("process: bootstrap seal: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("process: bootstrap seal: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retphaseangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("process: bootstrap seal: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("process: bootstrap seal: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retpulseangle stamp; Soft≠product)\n");

/* Grep: process: bootstrap seal: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("process: bootstrap seal: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("process: bootstrap seal: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retboundangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("process: bootstrap seal: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("process: bootstrap seal: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retbladeangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("process: bootstrap seal: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("process: bootstrap seal: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retarcangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("process: bootstrap seal: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("process: bootstrap seal: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("process: bootstrap seal: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("process: bootstrap seal: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("process: bootstrap seal: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("process: bootstrap seal: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retellipseangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("process: bootstrap seal: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("process: bootstrap seal: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("process: bootstrap seal: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("process: bootstrap seal: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (rethelixangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("process: bootstrap seal: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("process: bootstrap seal: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retknotangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("process: bootstrap seal: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("process: bootstrap seal: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retkleinangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("process: bootstrap seal: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("process: bootstrap seal: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retaffineangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("process: bootstrap seal: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("process: bootstrap seal: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("process: bootstrap seal: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("process: bootstrap seal: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retcubicangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("process: bootstrap seal: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("process: bootstrap seal: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retquinticangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("process: bootstrap seal: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("process: bootstrap seal: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retbezierangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("process: bootstrap seal: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("process: bootstrap seal: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("process: bootstrap seal: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("process: bootstrap seal: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("process: bootstrap seal: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("process: bootstrap seal: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retgridangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("process: bootstrap seal: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("process: bootstrap seal: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (rettexelangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("process: bootstrap seal: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("process: bootstrap seal: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retvertexangle stamp; Soft≠product)\n");
/* Grep: process: bootstrap seal: soft retshaderangle — Wave 113 return-shaderangle honesty */
kprintf("process: bootstrap seal: soft retshaderangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=113 (retshaderangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retpipelineangle — Wave 113 exclusive pipelineangle stamp */
kprintf("process: bootstrap seal: soft retpipelineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=113 (retpipelineangle stamp; Soft≠product)\n");
