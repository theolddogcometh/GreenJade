 ...
 *   process: soft deepen wave=23 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=23 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=23 …
 *   G-PROC-5 death tallies (wave=23 stamp):
 *     process: death … / process: death deepen wave=23 …
 *
...
#define GJ_PROCESS_SOFT_WAVE   23u
#define GJ_PROCESS_SOFT_AREAS 33u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE      23u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=23\n");
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: process: soft rettoken — Wave 23 return-token honesty */
            kprintf("process: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_PROCESS_SOFT_WAVE);
            /* Grep: process: soft retcrest — Wave 23 exclusive crest stamp */
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: process: bootstrap seal: soft rettoken — Wave 23 return-token honesty */
            kprintf("process: bootstrap seal: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_PROCESS_SOFT_WAVE);
            /* Grep: process: bootstrap seal: soft retcrest — Wave 23 exclusive crest stamp */
