 ...
 *
 * Soft product inventory (Wave 28 exclusive deepen; this unit only):
 ...
 *   process: soft deepen wave=28 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=28 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=28 …
 *   G-PROC-5 death tallies (wave=28 stamp):
 *     process: death … / process: death deepen wave=28 …
 *
...
#define GJ_PROCESS_SOFT_WAVE   28u
#define GJ_PROCESS_SOFT_AREAS 43u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE      28u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=28\n");
            ...
            */
            ...
            kprintf("process: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("process: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: process: soft retshard — Wave 28 return-shard honesty */
                            kprintf("process: soft retshard soft_only=1 product_gate=0 soft_ne_product=1 "
                                "never_blocks_m0=1 wave=%u "
                                "(retshard honesty; Soft≠product; not bar3)\n",
                                (unsigned)GJ_PROCESS_SOFT_WAVE);
                            /* Grep: process: soft retcrown — Wave 28 exclusive crown stamp */
            ...
            */
            ...
            kprintf("process: bootstrap seal: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("process: bootstrap seal: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: process: bootstrap seal: soft retshard — Wave 28 return-shard honesty */
                            kprintf("process: bootstrap seal: soft retshard soft_only=1 product_gate=0 soft_ne_product=1 "
                                "never_blocks_m0=1 wave=%u "
                                "(retshard honesty; Soft≠product; not bar3)\n",
                                (unsigned)GJ_PROCESS_SOFT_WAVE);
                            /* Grep: process: bootstrap seal: soft retcrown — Wave 28 exclusive crown stamp */
