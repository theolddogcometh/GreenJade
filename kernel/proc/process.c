 ...
 *
 * Soft product inventory (Wave 29 exclusive deepen; this unit only):
 ...
 *   process: soft deepen wave=29 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=29 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=29 …
 *   G-PROC-5 death tallies (wave=29 stamp):
 *     process: death … / process: death deepen wave=29 …
 *
...
#define GJ_PROCESS_SOFT_WAVE   29u
#define GJ_PROCESS_SOFT_AREAS 43u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE      29u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=29\n");
            ...
            */
            ...
            kprintf("process: bootstrap seal: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("process: bootstrap seal: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: process: bootstrap seal: soft retglyph — Wave 29 return-glyph honesty */
                            kprintf("process: bootstrap seal: soft retglyph soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retglyph honesty; Soft≠product; not bar3)\n",
                                    (unsigned)GJ_PROCESS_SOFT_WAVE);
                            /* Grep: process: bootstrap seal: soft retscepter — Wave 29 exclusive scepter stamp */
