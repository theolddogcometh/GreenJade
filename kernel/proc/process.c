 ...
 *   process: soft deepen wave=70 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=70 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=70 …
 *   G-PROC-5 death tallies (wave=70 stamp):
 *     process: death … / process: death deepen wave=70 …
 *
...
#define GJ_PROCESS_SOFT_WAVE 70u
#define GJ_PROCESS_SOFT_AREAS 121u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE 70u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=70\n");
...
kprintf("process: bootstrap seal: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=70 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: process: bootstrap seal: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("process: bootstrap seal: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=70 (retcounterscarple stamp; Soft≠product)\n");
