 ...
 *   process: soft deepen wave=20 …
 *   process: soft PASS|PARTIAL
 *   Apple §13 bootstrap seal checklist (wave=20 stamp):
 *     process: bootstrap seal soft …
 *     process: seal checklist …
 *     process: bootstrap seal soft deepen wave=20 …
 *   G-PROC-5 death tallies (wave=20 stamp):
 *     process: death … / process: death deepen wave=20 …
 *
...
#define GJ_PROCESS_SOFT_WAVE   20u
#define GJ_PROCESS_SOFT_AREAS  27u /* greppable inventory area count */
#define GJ_SEAL_SOFT_WAVE      20u /* Apple s13 seal checklist stamp */
...
process_soft_inventory(const char *szVia)
{
    ...
    kprintf("process: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=20\n");
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: process: soft retbound — Wave 20 return-bound honesty */
    kprintf("process: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)GJ_PROCESS_SOFT_WAVE);
    /* Grep: process: soft retseal — Wave 20 exclusive seal stamp */
...
process_seal_checklist_soft(const struct gj_process *pProc, const char *szVia)
{
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: process: bootstrap seal: soft retbound — Wave 20 return-bound honesty */
    kprintf("process: bootstrap seal: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)GJ_PROCESS_SOFT_WAVE);
    /* Grep: process: bootstrap seal: soft retseal — Wave 20 exclusive seal stamp */
