...
soft_inventory_log(const char *szVia)
{
    ...
    kprintf("spawn: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=99\n");
...
kprintf("spawn: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("spawn: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("spawn: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("spawn: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("spawn: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("spawn: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("spawn: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("spawn: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbastionangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("spawn: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("spawn: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retparapetangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("spawn: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("spawn: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retowerangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("spawn: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("spawn: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retwallangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("spawn: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("spawn: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retholdangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("spawn: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("spawn: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retfortressangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("spawn: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("spawn: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("spawn: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("spawn: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: spawn: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("spawn: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("spawn: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("spawn: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("spawn: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retaegisangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("spawn: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("spawn: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retsigilangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("spawn: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("spawn: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retglyphangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("spawn: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("spawn: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retshardangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("spawn: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("spawn: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retprismangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("spawn: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("spawn: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retcipherangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("spawn: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("spawn: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retledgerangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("spawn: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("spawn: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retvaultangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("spawn: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("spawn: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (rettokenangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("spawn: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("spawn: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retphaseangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("spawn: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("spawn: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retpulseangle stamp; Soft≠product)\n");

/* Grep: spawn: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("spawn: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("spawn: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retboundangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("spawn: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("spawn: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retbladeangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("spawn: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("spawn: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retarcangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("spawn: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("spawn: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("spawn: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("spawn: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("spawn: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("spawn: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retellipseangle stamp; Soft≠product)\n");
/* Grep: spawn: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("spawn: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=99 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("spawn: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=99 (retparabolaangle stamp; Soft≠product)\n");
