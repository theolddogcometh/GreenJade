...
soft_inventory_log(const char *szVia)
{
    ...
    kprintf("spawn: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=87\n");
...
kprintf("spawn: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("spawn: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("spawn: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("spawn: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("spawn: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("spawn: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("spawn: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("spawn: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbastionangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("spawn: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("spawn: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retparapetangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("spawn: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("spawn: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retowerangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("spawn: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("spawn: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retwallangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("spawn: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("spawn: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retholdangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("spawn: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("spawn: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retfortressangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("spawn: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("spawn: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("spawn: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("spawn: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: spawn: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("spawn: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("spawn: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("spawn: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("spawn: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retaegisangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("spawn: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("spawn: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retsigilangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("spawn: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("spawn: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retglyphangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("spawn: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("spawn: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retshardangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("spawn: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("spawn: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retprismangle stamp; Soft≠product)\n");
/* Grep: spawn: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("spawn: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: spawn: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("spawn: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retcipherangle stamp; Soft≠product)\n");
