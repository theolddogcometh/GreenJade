 ...
 *
 * Soft product deepen (Wave 32 exclusive; this unit only):
 ...
 *   - Wave 19 greppable "thread: soft …" deepen (wave=32 stamp):
...
sched_soft_inventory_print(void)
{
    ...
    kprintf("thread: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=32\n");
 ...
 * Soft≠product; not bar3.
 */
/* Grep: thread: soft retbulwark — Wave 32 return-bulwark honesty */
kprintf("thread: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=32 "
        "(retbulwark honesty; Soft≠product; not bar3)\n");
/* Grep: thread: soft retpanoply — Wave 32 exclusive panoply stamp */
