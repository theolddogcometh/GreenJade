 ...
 *
 * Soft product deepen (Wave 34 exclusive; this unit only):
 ...
 *   - Wave 19 greppable "thread: soft …" deepen (wave=34 stamp):
...
#define THREAD_SOFT_DEEPEN_WAVE 34u
/* Fixed greppable categories emitted under "thread: soft …". */
#define THREAD_SOFT_DEEPEN_AREAS 55u
...
sched_soft_inventory_print(void)
{
    ...
    kprintf("thread: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=34\n");
