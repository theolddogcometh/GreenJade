 ...
 *
 * Soft product deepen (Wave 33 exclusive; this unit only):
 ...
 *   - Wave 19 greppable "thread: soft …" deepen (wave=33 stamp):
...
#define THREAD_SOFT_DEEPEN_WAVE 32u
/* Fixed greppable categories emitted under "thread: soft …". */
#define THREAD_SOFT_DEEPEN_AREAS 53u
...
sched_soft_inventory_print(void)
{
    ...
    kprintf("thread: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=33\n");
 ...
 * Soft≠product; not bar3.
 */
/* Grep: thread: soft retbastion — Wave 33 return-bastion honesty */
kprintf("thread: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=33 "
        "(retbastion honesty; Soft≠product; not bar3)\n");
/* Grep: thread: soft retcitadel — Wave 33 exclusive citadel stamp */
