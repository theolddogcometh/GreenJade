 ...
 *   - Wave 19 greppable "thread: soft …" deepen (wave=41 stamp):
...
#define THREAD_SOFT_DEEPEN_WAVE 41u
/* Fixed greppable categories emitted under "thread: soft …". */
#define THREAD_SOFT_DEEPEN_AREAS 67u
...
sched_soft_inventory_print(void)
{
    ...
    kprintf("thread: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=41\n");
