...
/*
 * Soft product inventory (Wave 21 exclusive deepen). Cumulative unless noted
...
soft_inventory_log(void)
{
    ...
    kprintf("compositor: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=21\n");
    ...
    kprintf("compositor: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: compositor: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("compositor: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_COMP_SOFT_WAVE);
            /* Grep: compositor: soft retmark — Wave 21 exclusive mark stamp */
