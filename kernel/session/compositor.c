...
/*
 * Soft product inventory (Wave 26 exclusive deepen). Cumulative unless noted
...
soft_inventory_log(void)
{
    ...
    kprintf("compositor: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=26\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: compositor: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("compositor: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_COMP_SOFT_WAVE);
            /* Grep: compositor: soft retflame — Wave 26 exclusive flame stamp */
