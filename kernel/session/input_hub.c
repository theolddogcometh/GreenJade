 ...
 *
 * Soft input hub inventory (Wave 26 exclusive deepen; this unit only):
...
soft_inventory_log(void)
{
    ...
    kprintf("input_hub: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=26\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: input_hub: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("input_hub: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_INPUT_SOFT_WAVE);
            /* Grep: input_hub: soft retflame — Wave 26 exclusive flame stamp */
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: input: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("input: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_INPUT_SOFT_WAVE);
            /* Grep: input: soft retflame — Wave 26 exclusive flame stamp */
