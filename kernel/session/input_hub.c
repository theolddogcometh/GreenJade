 ...
 *
 * Soft input hub inventory (Wave 27 exclusive deepen; this unit only):
...
soft_inventory_log(void)
{
    ...
    kprintf("input_hub: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=27\n");
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("input_hub: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: input_hub: soft retprism — Wave 27 return-prism honesty */
                    kprintf("input_hub: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)GJ_INPUT_SOFT_WAVE);
                    /* Grep: input_hub: soft retforge — Wave 27 exclusive forge stamp */
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("input: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: input: soft retprism — Wave 27 return-prism honesty */
                    kprintf("input: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)GJ_INPUT_SOFT_WAVE);
                    /* Grep: input: soft retforge — Wave 27 exclusive forge stamp */
