 ...
 *
 * Soft input hub inventory (Wave 25 exclusive deepen; this unit only):
...
soft_inventory_log(void)
{
    ...
    kprintf("input_hub: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=25\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: input_hub: soft retledger — Wave 25 return-ledger honesty */
            kprintf("input_hub: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_INPUT_SOFT_WAVE);
            /* Grep: input_hub: soft retbeacon — Wave 25 exclusive beacon stamp */
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: input: soft retledger — Wave 25 return-ledger honesty */
            kprintf("input: soft retledger soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retledger honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_INPUT_SOFT_WAVE);
            /* Grep: input: soft retbeacon — Wave 25 exclusive beacon stamp */
