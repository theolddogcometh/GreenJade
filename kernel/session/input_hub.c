 ...
 *
 * Soft input hub inventory (Wave 21 exclusive deepen; this unit only):
...
soft_inventory_log(void)
{
    ...
    kprintf("input_hub: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=21\n");
    ...
    kprintf("input_hub: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: input_hub: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("input_hub: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_INPUT_SOFT_WAVE);
            /* Grep: input_hub: soft retmark — Wave 21 exclusive mark stamp */
    ...
    kprintf("input: soft retseal exclusive=1 soft_ne_product=1 "
             ...
             * Soft≠product; not bar3.
            */
            /* Grep: input: soft retpulse — Wave 21 return-pulse honesty */
            kprintf("input: soft retpulse soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retpulse honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_INPUT_SOFT_WAVE);
            /* Grep: input: soft retmark — Wave 21 exclusive mark stamp */
