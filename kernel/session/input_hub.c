 ...
 *
 * Soft input hub inventory (Wave 24 exclusive deepen; this unit only):
...
soft_inventory_log(void)
{
    ...
    kprintf("input_hub: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=24\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: input_hub: soft retvault — Wave 24 return-vault honesty */
            kprintf("input_hub: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_INPUT_SOFT_WAVE);
            /* Grep: input_hub: soft retbanner — Wave 24 exclusive banner stamp */
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: input: soft retvault — Wave 24 return-vault honesty */
            kprintf("input: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_INPUT_SOFT_WAVE);
            /* Grep: input: soft retbanner — Wave 24 exclusive banner stamp */
