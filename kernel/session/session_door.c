 ...
 *
 * Soft door inventory (Wave 29 exclusive deepen; this unit only):
...
/*
 * Soft product inventory (Wave 29 exclusive deepen). Cumulative path tallies.
 * greppable: session_door: soft …
 */
...
sess_soft_inventory_log(void)
{
    ...
    kprintf("session_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=29\n");
            ...
            */
            ...
            kprintf("session_door: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("session_door: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: session_door: soft retglyph — Wave 29 return-glyph honesty */
                            kprintf("session_door: soft retglyph soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retglyph honesty; Soft≠product; not bar3)\n",
                                    (unsigned)GJ_SESS_SOFT_WAVE);
                            /* Grep: session_door: soft retscepter — Wave 29 exclusive scepter stamp */
