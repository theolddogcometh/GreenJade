 ...
 *
 * Soft door inventory (Wave 28 exclusive deepen; this unit only):
...
/*
 * Soft product inventory (Wave 28 exclusive deepen). Cumulative path tallies.
 * greppable: session_door: soft …
 */
...
sess_soft_inventory_log(void)
{
    ...
    kprintf("session_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=28\n");
            ...
            */
            ...
            kprintf("session_door: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("session_door: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: session_door: soft retshard — Wave 28 return-shard honesty */
                            kprintf("session_door: soft retshard soft_only=1 product_gate=0 soft_ne_product=1 "
                                "never_blocks_m0=1 wave=%u "
                                "(retshard honesty; Soft≠product; not bar3)\n",
                                (unsigned)GJ_SESS_SOFT_WAVE);
                            /* Grep: session_door: soft retcrown — Wave 28 exclusive crown stamp */
