...
sess_soft_inventory_log(void)
{
    ...
    kprintf("session_door: soft catalog honesty,inventory,claim,present,"
            ...
            "wave=%u areas_expect=48 soft PASS\n",
            GJ_SESS_SOFT_WAVE);
    cAreas++;
    ...
    kprintf("session_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=66\n");
