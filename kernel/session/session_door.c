 ...
 *
 * Soft door inventory (Wave 27 exclusive deepen; this unit only):
...
/*
 * Soft product inventory (Wave 27 exclusive deepen). Cumulative path tallies.
 * greppable: session_door: soft …
 */
...
sess_soft_inventory_log(void)
{
    ...
    kprintf("session_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=27\n");
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("session_door: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: session_door: soft retprism — Wave 27 return-prism honesty */
                    kprintf("session_door: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)GJ_SESS_SOFT_WAVE);
                    /* Grep: session_door: soft retforge — Wave 27 exclusive forge stamp */
