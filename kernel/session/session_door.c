...
sess_soft_inventory_log(void)
{
    ...
    kprintf("session_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=115\n");
...
kprintf("session_door: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("session_door: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("session_door: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("session_door: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("session_door: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("session_door: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("session_door: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("session_door: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retbastionangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("session_door: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("session_door: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retparapetangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("session_door: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("session_door: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retowerangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("session_door: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("session_door: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retwallangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("session_door: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("session_door: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retholdangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("session_door: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("session_door: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retfortressangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("session_door: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("session_door: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("session_door: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("session_door: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: session_door: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("session_door: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("session_door: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("session_door: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("session_door: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retaegisangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("session_door: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("session_door: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retsigilangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("session_door: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("session_door: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retglyphangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("session_door: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("session_door: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retshardangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("session_door: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("session_door: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retprismangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("session_door: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("session_door: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retcipherangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("session_door: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("session_door: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retledgerangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("session_door: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("session_door: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retvaultangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("session_door: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("session_door: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (rettokenangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("session_door: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("session_door: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retphaseangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("session_door: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("session_door: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retpulseangle stamp; Soft≠product)\n");

/* Grep: session_door: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("session_door: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("session_door: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retboundangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("session_door: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("session_door: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retbladeangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("session_door: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("session_door: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retarcangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("session_door: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("session_door: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("session_door: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("session_door: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("session_door: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("session_door: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retellipseangle stamp; Soft≠product)\n");
/* Grep: session_door: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("session_door: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("session_door: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("session_door: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("session_door: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (rethelixangle stamp; Soft≠product)\n");
/* Grep: session_door: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("session_door: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("session_door: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retknotangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("session_door: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("session_door: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retkleinangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("session_door: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("session_door: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retaffineangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("session_door: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("session_door: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("session_door: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("session_door: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retcubicangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("session_door: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("session_door: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retquinticangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("session_door: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("session_door: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retbezierangle stamp; Soft≠product)\n");
/* Grep: session_door: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("session_door: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("session_door: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("session_door: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("session_door: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("session_door: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("session_door: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retgridangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("session_door: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("session_door: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (rettexelangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("session_door: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("session_door: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retvertexangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retshaderangle — Wave 113 return-shaderangle honesty */
kprintf("session_door: soft retshaderangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retshaderangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retpipelineangle — Wave 113 exclusive pipelineangle stamp */
kprintf("session_door: soft retpipelineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retpipelineangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retframebufferangle — Wave 114 return-framebufferangle honesty */
kprintf("session_door: soft retframebufferangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retframebufferangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retswapchainangle — Wave 114 exclusive swapchainangle stamp */
kprintf("session_door: soft retswapchainangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retswapchainangle stamp; Soft≠product)\n");
/* Grep: session_door: soft retpresentangle — Wave 115 return-presentangle honesty */
kprintf("session_door: soft retpresentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=115 (retpresentangle honesty; Soft≠product; not bar3)\n");
/* Grep: session_door: soft retvsyncangle — Wave 115 exclusive vsyncangle stamp */
kprintf("session_door: soft retvsyncangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=115 (retvsyncangle stamp; Soft≠product)\n");
