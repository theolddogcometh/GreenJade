 ...
 *
 * Soft door inventory (Wave 24 exclusive deepen; this unit only):
...
/*
 * Soft product inventory (Wave 24 exclusive deepen). Cumulative path tallies.
 * greppable: session_door: soft …
 */
...
sess_soft_inventory_log(void)
{
    ...
    kprintf("session_door: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=24\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: session_door: soft retvault — Wave 24 return-vault honesty */
            kprintf("session_door: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_SESS_SOFT_WAVE);
            /* Grep: session_door: soft retbanner — Wave 24 exclusive banner stamp */
