 ...
 *   pmm_core: soft deepen    — wave=87 stamp + area count
...
kprintf("pmm_core: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("pmm_core: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("pmm_core: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("pmm_core: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("pmm_core: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("pmm_core: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("pmm_core: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("pmm_core: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbastionangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("pmm_core: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("pmm_core: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retparapetangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("pmm_core: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("pmm_core: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retowerangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("pmm_core: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("pmm_core: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retwallangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("pmm_core: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("pmm_core: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retholdangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("pmm_core: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("pmm_core: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retfortressangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("pmm_core: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("pmm_core: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("pmm_core: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("pmm_core: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("pmm_core: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("pmm_core: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("pmm_core: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("pmm_core: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retaegisangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("pmm_core: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("pmm_core: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retsigilangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("pmm_core: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("pmm_core: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retglyphangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("pmm_core: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("pmm_core: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retshardangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("pmm_core: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("pmm_core: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retprismangle stamp; Soft≠product)\n");
/* Grep: pmm_core: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("pmm_core: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: pmm_core: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("pmm_core: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retcipherangle stamp; Soft≠product)\n");
