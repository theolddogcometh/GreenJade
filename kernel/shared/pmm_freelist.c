 ...
 *
 * Wave 27 exclusive soft deepen (this unit only — greppable "pmm_core: soft …"):
 ...
 *   pmm_core: soft deepen    — wave=27 stamp + area count
                        ...
                        unsigned cFreeSnap, unsigned cTotalSnap)
{
    ...
    /* Grep: pmm_core: soft exclusive — Wave 27 exclusive deepen */
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("pmm_core: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: pmm_core: soft retprism — Wave 27 return-prism honesty */
                    kprintf("pmm_core: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)PMM_CORE_SOFT_WAVE);
                    /* Grep: pmm_core: soft retforge — Wave 27 exclusive forge stamp */
