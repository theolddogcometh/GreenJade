 ...
 *
 * Wave 23 exclusive soft deepen (this unit only — greppable "coop: soft …"):
 ...
 *   coop: soft deepen      — wave=23 stamp + area count
...
coop_soft_inventory(int fPass, unsigned cAreas, u32 u32Surf)
{
    ...
    /* Grep: coop: soft exclusive — Wave 23 exclusive deepen */
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: coop: soft rettoken — Wave 23 return-token honesty */
            kprintf("coop: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)COOP_SOFT_WAVE);
            /* Grep: coop: soft retcrest — Wave 23 exclusive crest stamp */
