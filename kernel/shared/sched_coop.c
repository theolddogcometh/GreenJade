 ...
 *
 * Wave 32 exclusive soft deepen (this unit only — greppable "coop: soft …"):
 ...
 *   coop: soft deepen      — wave=32 stamp + area count
...
coop_soft_inventory(int fPass, unsigned cAreas, u32 u32Surf)
{
    ...
    /* Grep: coop: soft exclusive — Wave 32 exclusive deepen */
 ...
 * Soft≠product; not bar3.
 */
/* Grep: coop: soft retbulwark — Wave 32 return-bulwark honesty */
kprintf("coop: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbulwark honesty; Soft≠product; not bar3)\n",
        (unsigned)COOP_SOFT_WAVE);
/* Grep: coop: soft retpanoply — Wave 32 exclusive panoply stamp */
