 ...
 * Wave 30 exclusive deepen — greppable prefix-stable serial markers
 ...
 *   futex: soft deepen           — wave=30 areas stamp
...
#define FUTEX_SOFT_DEEPEN_WAVE 30u
/* Fixed greppable categories emitted under "futex: soft …". */
#define FUTEX_SOFT_DEEPEN_AREAS 49u
 ...
 * Wave 19 exclusive: wave=30 stamp + claim/peak/g_fut/match/einval +
...
futex_soft_log(void)
{
    ...
    kprintf("futex: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=30\n");
            ...
            */
            ...
            kprintf("futex: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("futex: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: futex: soft retsigil — Wave 30 return-sigil honesty */
                            kprintf("futex: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=30 "
                                    "(retsigil honesty; Soft≠product; not bar3)\n");
                            /* Grep: futex: soft retemblem — Wave 30 exclusive emblem stamp */
