 ...
 *   futex: soft deepen           — wave=58 areas stamp
...
#define FUTEX_SOFT_DEEPEN_AREAS 87u
 ...
 * Wave 19 exclusive: wave=58 stamp + claim/peak/g_fut/match/einval +
...
futex_soft_log(void)
{
    ...
    kprintf("futex: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=58\n");
