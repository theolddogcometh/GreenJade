 ...
 *   futex: soft deepen           — wave=59 areas stamp
...
#define FUTEX_SOFT_DEEPEN_WAVE 59u
/* Fixed greppable categories emitted under "futex: soft …". */
#define FUTEX_SOFT_DEEPEN_AREAS 89u
 ...
 * Wave 19 exclusive: wave=59 stamp + claim/peak/g_fut/match/einval +
...
futex_soft_log(void)
{
    ...
    kprintf("futex: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=59\n");
