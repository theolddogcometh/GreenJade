 ...
 *   futex: soft deepen           — wave=67 areas stamp
 ...
 * Wave 19 exclusive: wave=67 stamp + claim/peak/g_fut/match/einval +
...
futex_soft_log(void)
{
    ...
    kprintf("futex: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=67\n");
