 ...
 *   futex: soft deepen           — wave=70 areas stamp
 ...
 * Wave 19 exclusive: wave=70 stamp + claim/peak/g_fut/match/einval +
...
futex_soft_log(void)
{
    ...
    kprintf("futex: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=70\n");
...
kprintf("futex: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=70 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("futex: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=70 (retcounterscarple stamp; Soft≠product)\n");
