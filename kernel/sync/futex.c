 ...
 * Wave 33 exclusive deepen — greppable prefix-stable serial markers
 ...
 *   futex: soft deepen           — wave=33 areas stamp
...
#define FUTEX_SOFT_DEEPEN_WAVE 32u
/* Fixed greppable categories emitted under "futex: soft …". */
#define FUTEX_SOFT_DEEPEN_AREAS 53u
 ...
 * Wave 19 exclusive: wave=33 stamp + claim/peak/g_fut/match/einval +
...
futex_soft_log(void)
{
    ...
    kprintf("futex: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=33\n");
 ...
 * Soft≠product; not bar3.
 */
/* Grep: futex: soft retbastion — Wave 33 return-bastion honesty */
kprintf("futex: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=33 "
        "(retbastion honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retcitadel — Wave 33 exclusive citadel stamp */
