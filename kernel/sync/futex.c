 ...
 *   futex: soft deepen           — wave=109 areas stamp
...
#define FUTEX_SOFT_DEEPEN_WAVE 109u
/* Fixed greppable categories emitted under "futex: soft …". */
#define FUTEX_SOFT_DEEPEN_AREAS 161u
 ...
 * Wave 19 exclusive: wave=109 stamp + claim/peak/g_fut/match/einval +
...
futex_soft_log(void)
{
    ...
    kprintf("futex: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=109\n");
...
kprintf("futex: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("futex: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("futex: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("futex: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("futex: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("futex: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: futex: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("futex: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("futex: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbastionangle stamp; Soft≠product)\n");
/* Grep: futex: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("futex: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("futex: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retparapetangle stamp; Soft≠product)\n");
/* Grep: futex: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("futex: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("futex: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retowerangle stamp; Soft≠product)\n");
/* Grep: futex: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("futex: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("futex: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retwallangle stamp; Soft≠product)\n");
/* Grep: futex: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("futex: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("futex: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retholdangle stamp; Soft≠product)\n");
/* Grep: futex: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("futex: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("futex: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retfortressangle stamp; Soft≠product)\n");
/* Grep: futex: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("futex: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("futex: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: futex: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("futex: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("futex: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: futex: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("futex: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("futex: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: futex: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("futex: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("futex: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retaegisangle stamp; Soft≠product)\n");
/* Grep: futex: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("futex: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("futex: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retsigilangle stamp; Soft≠product)\n");
/* Grep: futex: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("futex: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("futex: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retglyphangle stamp; Soft≠product)\n");
/* Grep: futex: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("futex: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("futex: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retshardangle stamp; Soft≠product)\n");
/* Grep: futex: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("futex: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("futex: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retprismangle stamp; Soft≠product)\n");
/* Grep: futex: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("futex: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("futex: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retcipherangle stamp; Soft≠product)\n");
/* Grep: futex: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("futex: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("futex: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retledgerangle stamp; Soft≠product)\n");
/* Grep: futex: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("futex: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("futex: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retvaultangle stamp; Soft≠product)\n");
/* Grep: futex: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("futex: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("futex: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (rettokenangle stamp; Soft≠product)\n");
/* Grep: futex: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("futex: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("futex: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retphaseangle stamp; Soft≠product)\n");
/* Grep: futex: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("futex: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("futex: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retpulseangle stamp; Soft≠product)\n");

/* Grep: futex: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("futex: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("futex: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retboundangle stamp; Soft≠product)\n");
/* Grep: futex: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("futex: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("futex: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbladeangle stamp; Soft≠product)\n");
/* Grep: futex: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("futex: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("futex: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retarcangle stamp; Soft≠product)\n");
/* Grep: futex: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("futex: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("futex: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: futex: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("futex: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("futex: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: futex: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("futex: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("futex: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retellipseangle stamp; Soft≠product)\n");
/* Grep: futex: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("futex: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("futex: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: futex: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("futex: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("futex: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (rethelixangle stamp; Soft≠product)\n");
/* Grep: futex: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("futex: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("futex: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retknotangle stamp; Soft≠product)\n");
/* Grep: futex: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("futex: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("futex: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retkleinangle stamp; Soft≠product)\n");
/* Grep: futex: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("futex: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("futex: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retaffineangle stamp; Soft≠product)\n");
/* Grep: futex: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("futex: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("futex: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: futex: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("futex: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("futex: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retcubicangle stamp; Soft≠product)\n");
/* Grep: futex: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("futex: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("futex: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retquinticangle stamp; Soft≠product)\n");
/* Grep: futex: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("futex: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("futex: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbezierangle stamp; Soft≠product)\n");
/* Grep: futex: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("futex: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("futex: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: futex: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("futex: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: futex: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("futex: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbsplineangle stamp; Soft≠product)\n");
