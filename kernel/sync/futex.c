 ...
 *   futex: soft deepen           — wave=41 areas stamp
...
#define FUTEX_SOFT_DEEPEN_WAVE 41u
/* Fixed greppable categories emitted under "futex: soft …". */
#define FUTEX_SOFT_DEEPEN_AREAS 67u
 ...
 * Wave 19 exclusive: wave=41 stamp + claim/peak/g_fut/match/einval +
...
futex_soft_log(void)
{
    ...
    kprintf("futex: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=41\n");
