...
soft_inventory_log(void)
{
    ...
    kprintf("cold_ipc: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=104\n");
...
kprintf("cold: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("cold: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("cold: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("cold: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("cold: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("cold: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: cold: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("cold: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("cold: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbastionangle stamp; Soft≠product)\n");
/* Grep: cold: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("cold: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("cold: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retparapetangle stamp; Soft≠product)\n");
/* Grep: cold: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("cold: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("cold: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retowerangle stamp; Soft≠product)\n");
/* Grep: cold: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("cold: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("cold: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retwallangle stamp; Soft≠product)\n");
/* Grep: cold: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("cold: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("cold: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retholdangle stamp; Soft≠product)\n");
/* Grep: cold: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("cold: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("cold: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retfortressangle stamp; Soft≠product)\n");
/* Grep: cold: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("cold: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("cold: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: cold: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("cold: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("cold: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: cold: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("cold: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("cold: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: cold: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("cold: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("cold: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retaegisangle stamp; Soft≠product)\n");
/* Grep: cold: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("cold: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("cold: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retsigilangle stamp; Soft≠product)\n");
/* Grep: cold: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("cold: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("cold: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retglyphangle stamp; Soft≠product)\n");
/* Grep: cold: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("cold: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("cold: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retshardangle stamp; Soft≠product)\n");
/* Grep: cold: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("cold: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("cold: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retprismangle stamp; Soft≠product)\n");
/* Grep: cold: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("cold: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("cold: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retcipherangle stamp; Soft≠product)\n");
/* Grep: cold: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("cold: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("cold: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retledgerangle stamp; Soft≠product)\n");
/* Grep: cold: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("cold: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("cold: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retvaultangle stamp; Soft≠product)\n");
/* Grep: cold: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("cold: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("cold: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (rettokenangle stamp; Soft≠product)\n");
/* Grep: cold: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("cold: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("cold: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retphaseangle stamp; Soft≠product)\n");
/* Grep: cold: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("cold: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("cold: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retpulseangle stamp; Soft≠product)\n");

/* Grep: cold: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("cold: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("cold: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retboundangle stamp; Soft≠product)\n");
/* Grep: cold: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("cold: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("cold: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbladeangle stamp; Soft≠product)\n");
/* Grep: cold: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("cold: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("cold: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retarcangle stamp; Soft≠product)\n");
/* Grep: cold: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("cold: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("cold: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: cold: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("cold: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("cold: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: cold: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("cold: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("cold: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retellipseangle stamp; Soft≠product)\n");
/* Grep: cold: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("cold: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("cold: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: cold: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("cold: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("cold: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (rethelixangle stamp; Soft≠product)\n");
/* Grep: cold: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("cold: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("cold: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retknotangle stamp; Soft≠product)\n");
/* Grep: cold: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("cold: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("cold: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retkleinangle stamp; Soft≠product)\n");
/* Grep: cold: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("cold: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("cold: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retaffineangle stamp; Soft≠product)\n");
/* Grep: cold: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("cold: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=104 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("cold: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=104 (retbilinearangle stamp; Soft≠product)\n");
