 ...
 *   "syscall: soft deepen …"      — wave=67 area stamp
...
#define SYSCALL_SOFT_WAVE 67u
#define SYSCALL_SOFT_AREAS 114u
...
entry_soft_inventory_log(void)
{
    ...
    kprintf("syscall: soft note milestone=wave67 exclusive=1 "
    ...
    kprintf("syscall: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=67\n");
