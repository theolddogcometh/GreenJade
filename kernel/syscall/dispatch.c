 ...
 *   "syscall: soft deepen …"      — wave=49 area stamp
...
#define SYSCALL_SOFT_WAVE 49u
#define SYSCALL_SOFT_AREAS 78u
...
entry_soft_inventory_log(void)
{
    ...
    kprintf("syscall: soft note milestone=wave49 exclusive=1 "
    ...
    kprintf("syscall: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=49\n");
