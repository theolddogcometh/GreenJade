 ...
 *   "syscall: soft deepen …"      — wave=55 area stamp
...
#define SYSCALL_SOFT_WAVE 55u
#define SYSCALL_SOFT_AREAS 90u
...
entry_soft_inventory_log(void)
{
    ...
    kprintf("syscall: soft note milestone=wave55 exclusive=1 "
    ...
    kprintf("syscall: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=55\n");
