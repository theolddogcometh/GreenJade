...
#define ENTRY_BRIDGE_SOFT_WAVE 87u
/* inventory|path|rates|honesty|last|surfaces|note|catalog|deepen|PASS */
#define ENTRY_BRIDGE_SOFT_AREAS 144u
...
entry_bridge_soft_inventory_log(void)
{
    ...
    kprintf("entry_bridge: soft note milestone=wave87 exclusive=1 "
    ...
    kprintf("entry_bridge: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=87\n");
...
kprintf("entry_bridge: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("entry_bridge: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("entry_bridge: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("entry_bridge: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("entry_bridge: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("entry_bridge: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("entry_bridge: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("entry_bridge: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbastionangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("entry_bridge: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("entry_bridge: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retparapetangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("entry_bridge: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("entry_bridge: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retowerangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("entry_bridge: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("entry_bridge: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retwallangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("entry_bridge: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("entry_bridge: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retholdangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("entry_bridge: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("entry_bridge: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retfortressangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("entry_bridge: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("entry_bridge: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("entry_bridge: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("entry_bridge: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("entry_bridge: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("entry_bridge: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("entry_bridge: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("entry_bridge: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retaegisangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("entry_bridge: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("entry_bridge: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retsigilangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("entry_bridge: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("entry_bridge: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retglyphangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("entry_bridge: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("entry_bridge: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retshardangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("entry_bridge: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("entry_bridge: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retprismangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("entry_bridge: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("entry_bridge: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retcipherangle stamp; Soft≠product)\n");
