...
#define ENTRY_BRIDGE_SOFT_WAVE  30u
/* inventory|path|rates|honesty|last|surfaces|note|catalog|deepen|PASS */
#define ENTRY_BRIDGE_SOFT_AREAS 34u
...
/**
 * Greppable soft entry-bridge inventory (Wave 30 exclusive deepen).
...
entry_bridge_soft_inventory_log(void)
{
    ...
    kprintf("entry_bridge: soft note milestone=wave30 exclusive=1 "
    ...
    kprintf("entry_bridge: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=30\n");
            ...
            */
            ...
            kprintf("entry_bridge: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("entry_bridge: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: entry_bridge: soft retsigil — Wave 30 return-sigil honesty */
                            kprintf("entry_bridge: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)ENTRY_BRIDGE_SOFT_WAVE);
                            /* Grep: entry_bridge: soft retemblem — Wave 30 exclusive emblem stamp */
