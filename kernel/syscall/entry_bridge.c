...
#define ENTRY_BRIDGE_SOFT_WAVE 110u
/* inventory|path|rates|honesty|last|surfaces|note|catalog|deepen|PASS */
#define ENTRY_BRIDGE_SOFT_AREAS 190u
...
entry_bridge_soft_inventory_log(void)
{
    ...
    kprintf("entry_bridge: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=110\n");
...
kprintf("entry_bridge: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("entry_bridge: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("entry_bridge: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("entry_bridge: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("entry_bridge: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("entry_bridge: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("entry_bridge: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("entry_bridge: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retbastionangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("entry_bridge: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("entry_bridge: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retparapetangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("entry_bridge: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("entry_bridge: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retowerangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("entry_bridge: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("entry_bridge: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retwallangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("entry_bridge: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("entry_bridge: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retholdangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("entry_bridge: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("entry_bridge: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retfortressangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("entry_bridge: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("entry_bridge: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("entry_bridge: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("entry_bridge: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("entry_bridge: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("entry_bridge: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("entry_bridge: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("entry_bridge: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retaegisangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("entry_bridge: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("entry_bridge: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retsigilangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("entry_bridge: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("entry_bridge: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retglyphangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("entry_bridge: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("entry_bridge: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retshardangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("entry_bridge: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("entry_bridge: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retprismangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("entry_bridge: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("entry_bridge: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retcipherangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("entry_bridge: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("entry_bridge: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retledgerangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("entry_bridge: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("entry_bridge: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retvaultangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("entry_bridge: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("entry_bridge: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (rettokenangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("entry_bridge: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("entry_bridge: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retphaseangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("entry_bridge: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("entry_bridge: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retpulseangle stamp; Soft≠product)\n");

/* Grep: entry_bridge: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("entry_bridge: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("entry_bridge: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retboundangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("entry_bridge: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("entry_bridge: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retbladeangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("entry_bridge: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("entry_bridge: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retarcangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("entry_bridge: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("entry_bridge: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("entry_bridge: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("entry_bridge: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("entry_bridge: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("entry_bridge: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retellipseangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("entry_bridge: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("entry_bridge: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("entry_bridge: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("entry_bridge: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (rethelixangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("entry_bridge: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("entry_bridge: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retknotangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("entry_bridge: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("entry_bridge: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retkleinangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("entry_bridge: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("entry_bridge: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retaffineangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("entry_bridge: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("entry_bridge: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("entry_bridge: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("entry_bridge: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retcubicangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("entry_bridge: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("entry_bridge: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retquinticangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("entry_bridge: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("entry_bridge: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retbezierangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("entry_bridge: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("entry_bridge: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("entry_bridge: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("entry_bridge: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: entry_bridge: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("entry_bridge: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=110 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: entry_bridge: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("entry_bridge: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=110 (retgridangle stamp; Soft≠product)\n");
