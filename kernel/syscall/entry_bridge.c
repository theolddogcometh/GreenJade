...
#define ENTRY_BRIDGE_SOFT_WAVE 31u
/* inventory|path|rates|honesty|last|surfaces|note|catalog|deepen|PASS */
#define ENTRY_BRIDGE_SOFT_AREAS 36u
...
/**
 * Greppable soft entry-bridge inventory (Wave 31 exclusive deepen).
...
entry_bridge_soft_inventory_log(void)
{
    ...
    kprintf("entry_bridge: soft note milestone=wave31 exclusive=1 "
    ...
    kprintf("entry_bridge: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=31\n");
            ...
            */
            ...
            kprintf("entry_bridge: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("entry_bridge: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: entry_bridge: soft retaegis — Wave 31 return-aegis honesty */
                            ...
                            kprintf("entry_bridge: soft retsigil soft_only=1 product_gate=0 soft_ne_product=1 "
                                    ...
                                    "(retsigil honesty; Soft≠product; not bar3)\n",
                                    (unsigned)ENTRY_BRIDGE_SOFT_WAVE);
                            /* Grep: entry_bridge: soft retmantle — Wave 31 exclusive mantle stamp */
