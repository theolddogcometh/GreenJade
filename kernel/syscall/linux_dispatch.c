 ...
 *
 * Soft inventory (Wave 12/14 base + Wave 17 exclusive deepen; this unit):
...
/*
 * Soft product inventory (Wave 12/14 base + Wave 17 exclusive deepen).
...
#define LINUX_DISPATCH_SOFT_WAVE  17u
#define LINUX_DISPATCH_SOFT_AREAS 31u
...
soft_dispatch_deepen_log(void)
{
    ...
    /* Grep: linux: nr class soft edge (Wave 17 deepen) */
    ...
    /* Grep: linux: nr class soft share (Wave 17 deepen) */
    ...
    /* Grep: linux: nr class soft surfaces (Wave 17 deepen) */
    kprintf("linux: nr class soft surfaces count=%u wave=%u "
            "names=inventory,path,rates,ret,honesty,edge,share,catalog,"
            "surfaces,note,return,deepen,PASS\n",
            LINUX_DISPATCH_SOFT_AREAS,
            (unsigned)LINUX_DISPATCH_SOFT_WAVE);

    /* Grep: linux: nr class soft note (Wave 17 deepen) */
    kprintf("linux: nr class soft note milestone=wave17 exclusive=1 "
            "soft_only=1 not_bar3=1 wave=%u\n",
            (unsigned)LINUX_DISPATCH_SOFT_WAVE);

    /* Grep: linux: nr class soft catalog (Wave 17 deepen) */
    ...
    /* Grep: linux: nr class soft return (Wave 17 deepen) */
    ...
    /* Grep: linux: dispatch soft edge (Wave 17 deepen) */
    ...
    /* Grep: linux: dispatch soft share (Wave 17 deepen) */
    ...
    /* Grep: linux: dispatch soft surfaces (Wave 17 deepen) */
    kprintf("linux: dispatch soft surfaces count=%u wave=%u "
            "names=inventory,path,rates,ret,last,honesty,edge,share,"
            "catalog,surfaces,note,return,deepen,PASS\n",
            LINUX_DISPATCH_SOFT_AREAS,
            (unsigned)LINUX_DISPATCH_SOFT_WAVE);

    /* Grep: linux: dispatch soft note (Wave 17 deepen) */
    kprintf("linux: dispatch soft note milestone=wave17 exclusive=1 "
            "soft_only=1 not_bar3=1 wave=%u\n",
            (unsigned)LINUX_DISPATCH_SOFT_WAVE);

    /* Grep: linux: dispatch soft catalog (Wave 17 deepen) */
    ...
    /* Grep: linux: dispatch soft return (Wave 17 deepen) */
...
gj_linux_nr_class_soft_log(void)
{
    ...
    /* Wave 12 + Wave 17 exclusive deepen (additive; never hard-gates). */
