 ...
 *
 * Soft inventory (Wave 12/14 base + Wave 26 exclusive deepen; this unit):
...
/*
 * Soft product inventory (Wave 12/14 base + Wave 26 exclusive deepen).
...
#define LINUX_DISPATCH_SOFT_WAVE  26u
#define LINUX_DISPATCH_SOFT_AREAS 48u
...
soft_dispatch_deepen_log(void)
{
    ...
    kprintf("linux: nr class soft note milestone=wave26 exclusive=1 "
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: linux: nr class: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("linux: nr class: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)LINUX_DISPATCH_SOFT_WAVE);
            /* Grep: linux: nr class: soft retflame — Wave 26 exclusive flame stamp */
    ...
    kprintf("linux: dispatch soft note milestone=wave26 exclusive=1 "
            "soft_only=1 not_bar3=1 wave=%u\n",
            (unsigned)LINUX_DISPATCH_SOFT_WAVE);
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: linux: dispatch: soft retcipher — Wave 26 return-cipher honesty */
            kprintf("linux: dispatch: soft retcipher soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retcipher honesty; Soft≠product; not bar3)\n",
                    (unsigned)LINUX_DISPATCH_SOFT_WAVE);
            /* Grep: linux: dispatch: soft retflame — Wave 26 exclusive flame stamp */
...
gj_linux_nr_class_soft_log(void)
{
    ...
    /* Wave 12 + Wave 26 exclusive deepen (additive; never hard-gates). */
