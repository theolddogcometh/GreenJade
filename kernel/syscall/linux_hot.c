 ...
 *
 * Soft product inventory (Wave 11/14 base + Wave 20 exclusive deepen):
...
#define GJ_LINUX_HOT_SOFT_WAVE     20u
#define GJ_LINUX_HOT_SOFT_AREAS    29u
...
hot_soft_inventory_log(void)
{
    ...
    kprintf("linux: hot soft note milestone=wave20 exclusive=1 "
     ...
     * Soft≠product; not bar3.
     */
    /* Grep: linux: hot: soft retbound — Wave 20 return-bound honesty */
    kprintf("linux: hot: soft retbound soft_only=1 product_gate=0 hard_gate=0 "
            "never_blocks_m0=1 wave=%u "
            "(retbound honesty; Soft≠product; not bar3)\n",
            (unsigned)GJ_LINUX_HOT_SOFT_WAVE);
    /* Grep: linux: hot: soft retseal — Wave 20 exclusive seal stamp */
