...
#define GJ_LINUX_HOT_SOFT_WAVE 116u
#define GJ_LINUX_HOT_SOFT_AREAS 215u
...
kprintf("linux: hot: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("linux: hot: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("linux: hot: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("linux: hot: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("linux: hot: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("linux: hot: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("linux: hot: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("linux: hot: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbastionangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("linux: hot: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("linux: hot: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retparapetangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("linux: hot: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("linux: hot: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retowerangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("linux: hot: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("linux: hot: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retwallangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("linux: hot: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("linux: hot: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retholdangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("linux: hot: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("linux: hot: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retfortressangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("linux: hot: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("linux: hot: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("linux: hot: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("linux: hot: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("linux: hot: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("linux: hot: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("linux: hot: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("linux: hot: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retaegisangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("linux: hot: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("linux: hot: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retsigilangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("linux: hot: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("linux: hot: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retglyphangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("linux: hot: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("linux: hot: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retshardangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("linux: hot: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("linux: hot: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retprismangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("linux: hot: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("linux: hot: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retcipherangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("linux: hot: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("linux: hot: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retledgerangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("linux: hot: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("linux: hot: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retvaultangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("linux: hot: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("linux: hot: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (rettokenangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("linux: hot: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("linux: hot: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retphaseangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("linux: hot: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("linux: hot: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retpulseangle stamp; Soft≠product)\n");

/* Grep: linux: hot: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("linux: hot: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("linux: hot: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retboundangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("linux: hot: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("linux: hot: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbladeangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("linux: hot: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("linux: hot: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retarcangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("linux: hot: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("linux: hot: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("linux: hot: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("linux: hot: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("linux: hot: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("linux: hot: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retellipseangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("linux: hot: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("linux: hot: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("linux: hot: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("linux: hot: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (rethelixangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("linux: hot: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("linux: hot: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retknotangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("linux: hot: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("linux: hot: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retkleinangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("linux: hot: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("linux: hot: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retaffineangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("linux: hot: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("linux: hot: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("linux: hot: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("linux: hot: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retcubicangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("linux: hot: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("linux: hot: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retquinticangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("linux: hot: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("linux: hot: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbezierangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("linux: hot: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("linux: hot: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("linux: hot: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("linux: hot: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("linux: hot: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("linux: hot: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retgridangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("linux: hot: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("linux: hot: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (rettexelangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("linux: hot: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("linux: hot: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retvertexangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retshaderangle — Wave 113 return-shaderangle honesty */
kprintf("linux: hot: soft retshaderangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retshaderangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retpipelineangle — Wave 113 exclusive pipelineangle stamp */
kprintf("linux: hot: soft retpipelineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retpipelineangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retframebufferangle — Wave 114 return-framebufferangle honesty */
kprintf("linux: hot: soft retframebufferangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retframebufferangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retswapchainangle — Wave 114 exclusive swapchainangle stamp */
kprintf("linux: hot: soft retswapchainangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retswapchainangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retpresentangle — Wave 115 return-presentangle honesty */
kprintf("linux: hot: soft retpresentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retpresentangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retvsyncangle — Wave 115 exclusive vsyncangle stamp */
kprintf("linux: hot: soft retvsyncangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retvsyncangle stamp; Soft≠product)\n");
/* Grep: linux: hot: soft retfenceangle — Wave 116 return-fenceangle honesty */
kprintf("linux: hot: soft retfenceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=116 (retfenceangle honesty; Soft≠product; not bar3)\n");
/* Grep: linux: hot: soft retsemaphoreangle — Wave 116 exclusive semaphoreangle stamp */
kprintf("linux: hot: soft retsemaphoreangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=116 (retsemaphoreangle stamp; Soft≠product)\n");
