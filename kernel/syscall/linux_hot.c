 ...
 *
 * Soft product inventory (Wave 11/14 base + Wave 32 exclusive deepen):
...
#define GJ_LINUX_HOT_SOFT_WAVE 32u
#define GJ_LINUX_HOT_SOFT_AREAS 51u
...
hot_soft_inventory_log(void)
{
    ...
    kprintf("linux: hot soft note milestone=wave32 exclusive=1 "
 ...
 * Soft≠product; not bar3.
 */
/* Grep: linux: hot: soft retbulwark — Wave 32 return-bulwark honesty */
kprintf("linux: hot: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbulwark honesty; Soft≠product; not bar3)\n",
        (unsigned)GJ_LINUX_HOT_SOFT_WAVE);
/* Grep: linux: hot: soft retpanoply — Wave 32 exclusive panoply stamp */
