 ...
 *
 * Soft inventory (Wave 11/14 base + Wave 24 exclusive deepen; this unit only):
 ...
 *   native: soft deepen      — wave=24 area stamp
...
/*
 * Wave 11/14 base + Wave 24 exclusive deepen (file-local; never hard-gates).
...
#define NATIVE_SOFT_WAVE  24u
#define NATIVE_SOFT_AREAS 44u
...
native_soft_inventory_log(void)
{
    ...
    kprintf("native: soft note milestone=wave24 exclusive=1 "
            "soft_only=1 not_bar3=1 wave=%u\n",
            (unsigned)NATIVE_SOFT_WAVE);

    /* Grep: native: soft retmap — Wave 19 return-surface map */
    kprintf("native: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=24\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: native: soft retvault — Wave 24 return-vault honesty */
            kprintf("native: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)NATIVE_SOFT_WAVE);
            /* Grep: native: soft retbanner — Wave 24 exclusive banner stamp */
