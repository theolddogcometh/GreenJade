 ...
 *   native: soft deepen      — wave=96 area stamp
...
#define NATIVE_SOFT_WAVE 96u
#define NATIVE_SOFT_AREAS 182u
...
native_soft_inventory_log(void)
{
    ...
    kprintf("native: soft note milestone=wave96 exclusive=1 "
            "soft_only=1 not_bar3=1 wave=%u\n",
            (unsigned)NATIVE_SOFT_WAVE);

    /* Grep: native: soft retmap — Wave 19 return-surface map */
    kprintf("native: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=96\n");
...
kprintf("native: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("native: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("native: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("native: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("native: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("native: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: native: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("native: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("native: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbastionangle stamp; Soft≠product)\n");
/* Grep: native: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("native: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("native: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retparapetangle stamp; Soft≠product)\n");
/* Grep: native: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("native: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("native: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retowerangle stamp; Soft≠product)\n");
/* Grep: native: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("native: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("native: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retwallangle stamp; Soft≠product)\n");
/* Grep: native: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("native: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("native: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retholdangle stamp; Soft≠product)\n");
/* Grep: native: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("native: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("native: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retfortressangle stamp; Soft≠product)\n");
/* Grep: native: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("native: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("native: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: native: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("native: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("native: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: native: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("native: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("native: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: native: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("native: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("native: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retaegisangle stamp; Soft≠product)\n");
/* Grep: native: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("native: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("native: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retsigilangle stamp; Soft≠product)\n");
/* Grep: native: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("native: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("native: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retglyphangle stamp; Soft≠product)\n");
/* Grep: native: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("native: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("native: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retshardangle stamp; Soft≠product)\n");
/* Grep: native: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("native: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("native: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retprismangle stamp; Soft≠product)\n");
/* Grep: native: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("native: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("native: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retcipherangle stamp; Soft≠product)\n");
/* Grep: native: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("native: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("native: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retledgerangle stamp; Soft≠product)\n");
/* Grep: native: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("native: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("native: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retvaultangle stamp; Soft≠product)\n");
/* Grep: native: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("native: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("native: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (rettokenangle stamp; Soft≠product)\n");
/* Grep: native: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("native: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("native: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retphaseangle stamp; Soft≠product)\n");
/* Grep: native: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("native: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("native: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retpulseangle stamp; Soft≠product)\n");

/* Grep: native: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("native: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("native: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retboundangle stamp; Soft≠product)\n");
/* Grep: native: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("native: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("native: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retbladeangle stamp; Soft≠product)\n");
/* Grep: native: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("native: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("native: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retarcangle stamp; Soft≠product)\n");
/* Grep: native: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("native: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=96 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: native: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("native: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=96 (retwedgeangle stamp; Soft≠product)\n");
