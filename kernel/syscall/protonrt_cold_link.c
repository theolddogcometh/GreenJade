...
/**
 * Greppable soft cold personality inventory (Wave 23 exclusive deepen).
...
protonrt_soft_inventory_log(void)
{
    ...
    kprintf("protonrt: soft note milestone=wave23 exclusive=1 "
    ...
    kprintf("protonrt: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=23\n");

    /* Grep: protonrt: soft deepen wave (Wave 23 stamp) */
    /*
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: protonrt: soft rettoken — Wave 23 return-token honesty */
            kprintf("protonrt: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_PROTONRT_SOFT_WAVE);
            /* Grep: protonrt: soft retcrest — Wave 23 exclusive crest stamp */
    ...
    kprintf("protonrt: soft deepen wave=%u areas=%u logs=%llu enter=%llu "
            ...
            "(Wave 23 exclusive; cold link soft; not bar3)\n",
            (unsigned)GJ_PROTONRT_SOFT_WAVE,
            (unsigned)GJ_PROTONRT_SOFT_AREAS,
            (unsigned long long)g_u64PrtSoftLogN,
            (unsigned long long)g_u64PrtSoftEnter,
    ...
    /* Grep: cold_link: soft deepen wave (Wave 23 stamp) */
    /*
     * ---- Wave 19 complementary surfaces (kept) (never reshape primary).
     * Return surfaces only — soft inventory; never hard-gates product paths.
     * Soft≠product; not bar3.
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: cold_link: soft rettoken — Wave 23 return-token honesty */
            kprintf("cold_link: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_PROTONRT_SOFT_WAVE);
            /* Grep: cold_link: soft retcrest — Wave 23 exclusive crest stamp */
