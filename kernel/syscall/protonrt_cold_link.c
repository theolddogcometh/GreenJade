...
/**
 * Greppable soft cold personality inventory (Wave 18 exclusive deepen).
...
protonrt_soft_inventory_log(void)
{
    ...
    /* Grep: protonrt: soft rates (Wave 18 deepen) */
    {
        u64 u64BpFs;
        u64 u64BpNet;
        u64 u64BpNull;
    ...
    /* Grep: protonrt: soft honesty (Wave 18 deepen) */
    ...
    /* Grep: protonrt: soft surfaces (Wave 18 deepen) */
    ...
    /* Grep: protonrt: soft note (Wave 18 deepen) */
    kprintf("protonrt: soft note milestone=wave18 exclusive=1 "
            "soft_only=1 not_bar3=1 wave=%u\n",
            (unsigned)GJ_PROTONRT_SOFT_WAVE);

    /* Grep: protonrt: soft catalog (Wave 18 deepen) */
    ...
    /* Grep: protonrt: soft return (Wave 18 deepen) */
    ...
    /* Grep: protonrt: soft retmap — Wave 18 return-surface map */
    kprintf("protonrt: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=18\n");

    /* Grep: protonrt: soft deepen wave (Wave 18 stamp) */
    kprintf("protonrt: soft deepen wave=%u areas=%u logs=%llu enter=%llu "
            "fs=%llu net=%llu proc=%llu confine_deny=%u "
            "(Wave 18 exclusive; cold link soft; not bar3)\n",
            (unsigned)GJ_PROTONRT_SOFT_WAVE,
            (unsigned)GJ_PROTONRT_SOFT_AREAS,
            (unsigned long long)g_u64PrtSoftLogN,
            (unsigned long long)g_u64PrtSoftEnter,
    ...
    /* Grep: cold_link: soft rates (Wave 18 deepen) */
    {
        u64 u64BpFs;
        u64 u64BpOther;
    ...
    /* Grep: cold_link: soft return (Wave 18 deepen) */
    ...
    /* Grep: cold_link: soft deepen wave (Wave 18 stamp) */
