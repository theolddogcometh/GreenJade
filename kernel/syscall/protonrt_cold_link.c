...
protonrt_soft_inventory_log(void)
{
    ...
    kprintf("protonrt: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=112\n");
...
kprintf("cold_link: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("cold_link: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("cold_link: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("cold_link: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("cold_link: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("cold_link: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("cold_link: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("cold_link: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbastionangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("cold_link: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("cold_link: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retparapetangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("cold_link: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("cold_link: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retowerangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("cold_link: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("cold_link: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retwallangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("cold_link: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("cold_link: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retholdangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("cold_link: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("cold_link: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retfortressangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("cold_link: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("cold_link: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("cold_link: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("cold_link: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: cold_link: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("cold_link: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("cold_link: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("cold_link: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("cold_link: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retaegisangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("cold_link: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("cold_link: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retsigilangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("cold_link: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("cold_link: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retglyphangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("cold_link: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("cold_link: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retshardangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("cold_link: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("cold_link: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retprismangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("cold_link: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("cold_link: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retcipherangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("cold_link: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("cold_link: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retledgerangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("cold_link: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("cold_link: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retvaultangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("cold_link: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("cold_link: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (rettokenangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("cold_link: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("cold_link: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retphaseangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("cold_link: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("cold_link: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retpulseangle stamp; Soft≠product)\n");

/* Grep: cold_link: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("cold_link: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("cold_link: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retboundangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("cold_link: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("cold_link: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbladeangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("cold_link: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("cold_link: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retarcangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("cold_link: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("cold_link: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("cold_link: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("cold_link: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("cold_link: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("cold_link: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retellipseangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("cold_link: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("cold_link: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("cold_link: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("cold_link: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (rethelixangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("cold_link: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("cold_link: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retknotangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("cold_link: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("cold_link: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retkleinangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("cold_link: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("cold_link: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retaffineangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("cold_link: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("cold_link: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("cold_link: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("cold_link: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retcubicangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("cold_link: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("cold_link: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retquinticangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("cold_link: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("cold_link: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbezierangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("cold_link: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("cold_link: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("cold_link: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("cold_link: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retbsplineangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retmeshangle — Wave 110 return-meshangle honesty */
kprintf("cold_link: soft retmeshangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retmeshangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retgridangle — Wave 110 exclusive gridangle stamp */
kprintf("cold_link: soft retgridangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retgridangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retvoxelangle — Wave 111 return-voxelangle honesty */
kprintf("cold_link: soft retvoxelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retvoxelangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft rettexelangle — Wave 111 exclusive texelangle stamp */
kprintf("cold_link: soft rettexelangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (rettexelangle stamp; Soft≠product)\n");
/* Grep: cold_link: soft retfragmentangle — Wave 112 return-fragmentangle honesty */
kprintf("cold_link: soft retfragmentangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=112 (retfragmentangle honesty; Soft≠product; not bar3)\n");
/* Grep: cold_link: soft retvertexangle — Wave 112 exclusive vertexangle stamp */
kprintf("cold_link: soft retvertexangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=112 (retvertexangle stamp; Soft≠product)\n");
