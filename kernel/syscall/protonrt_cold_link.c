...
#define GJ_PROTONRT_SOFT_WAVE  29u
...
/*
 * Soft product inventory (Wave 29 exclusive deepen).
...
/**
 * Greppable soft cold personality inventory (Wave 29 exclusive deepen).
...
protonrt_soft_inventory_log(void)
{
    ...
    kprintf("protonrt: soft note milestone=wave29 exclusive=1 "
    ...
    kprintf("protonrt: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=29\n");
 ...
 * Soft≠product; not bar3.
    ...
    kprintf("protonrt: soft deepen wave=%u areas=%u logs=%llu enter=%llu "
            ...
            "(Wave 29 exclusive; cold link soft; not bar3)\n",
            (unsigned)GJ_PROTONRT_SOFT_WAVE,
            (unsigned)GJ_PROTONRT_SOFT_AREAS,
            (unsigned long long)g_u64PrtSoftLogN,
            (unsigned long long)g_u64PrtSoftEnter,
            ...
            */
            ...
            kprintf("cold_link: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("cold_link: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: cold_link: soft retglyph — Wave 29 return-glyph honesty */
                            kprintf("cold_link: soft retglyph soft_only=1 product_gate=0 soft_ne_product=1 "
                                    "never_blocks_m0=1 wave=%u "
                                    "(retglyph honesty; Soft≠product; not bar3)\n",
                                    (unsigned)GJ_PROTONRT_SOFT_WAVE);
                            /* Grep: cold_link: soft retscepter — Wave 29 exclusive scepter stamp */
