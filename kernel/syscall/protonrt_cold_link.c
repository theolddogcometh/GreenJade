...
protonrt_soft_inventory_log(void)
{
    ...
    kprintf("protonrt: soft note milestone=wave55 exclusive=1 "
    ...
    kprintf("protonrt: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=55\n");
