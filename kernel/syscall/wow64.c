 ...
 */
#define GJ_WOW64_SOFT_WAVE 109u
#define GJ_WOW64_SOFT_AREAS 192u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=109\n");
...
kprintf("wow64: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("wow64: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("wow64: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("wow64: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("wow64: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("wow64: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("wow64: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("wow64: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbastionangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("wow64: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("wow64: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retparapetangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("wow64: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("wow64: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retowerangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("wow64: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("wow64: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retwallangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("wow64: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("wow64: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retholdangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("wow64: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("wow64: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retfortressangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("wow64: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("wow64: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("wow64: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("wow64: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: wow64: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("wow64: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("wow64: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("wow64: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("wow64: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retaegisangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("wow64: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("wow64: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retsigilangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("wow64: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("wow64: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retglyphangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("wow64: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("wow64: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retshardangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("wow64: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("wow64: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retprismangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("wow64: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("wow64: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retcipherangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("wow64: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("wow64: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retledgerangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("wow64: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("wow64: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retvaultangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("wow64: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("wow64: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (rettokenangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("wow64: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("wow64: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retphaseangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("wow64: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("wow64: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retpulseangle stamp; Soft≠product)\n");

/* Grep: wow64: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("wow64: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("wow64: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retboundangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("wow64: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("wow64: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbladeangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("wow64: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("wow64: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retarcangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retsectorangle — Wave 96 return-sectorangle honesty */
kprintf("wow64: soft retsectorangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retsectorangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp */
kprintf("wow64: soft retwedgeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retwedgeangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retradiusangle — Wave 97 return-radiusangle honesty */
kprintf("wow64: soft retradiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retradiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retdiameterangle — Wave 97 exclusive diameterangle stamp */
kprintf("wow64: soft retdiameterangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retdiameterangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcircumangle — Wave 98 return-circumangle honesty */
kprintf("wow64: soft retcircumangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retcircumangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retellipseangle — Wave 98 exclusive ellipseangle stamp */
kprintf("wow64: soft retellipseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retellipseangle stamp; Soft≠product)\n");
/* Grep: wow64: soft rethyperangle — Wave 99 return-hyperangle honesty */
kprintf("wow64: soft rethyperangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (rethyperangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retparabolaangle — Wave 99 exclusive parabolaangle stamp */
kprintf("wow64: soft retparabolaangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retparabolaangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retspiralangle — Wave 100 return-spiralangle honesty */
kprintf("wow64: soft retspiralangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retspiralangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft rethelixangle — Wave 100 exclusive helixangle stamp */
kprintf("wow64: soft rethelixangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (rethelixangle stamp; Soft≠product)\n");
/* Grep: wow64: soft rettorusangle — Wave 101 return-torusangle honesty */
kprintf("wow64: soft rettorusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (rettorusangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retknotangle — Wave 101 exclusive knotangle stamp */
kprintf("wow64: soft retknotangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retknotangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmoebiusangle — Wave 102 return-moebiusangle honesty */
kprintf("wow64: soft retmoebiusangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retmoebiusangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retkleinangle — Wave 102 exclusive kleinangle stamp */
kprintf("wow64: soft retkleinangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retkleinangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retprojectangle — Wave 103 return-projectangle honesty */
kprintf("wow64: soft retprojectangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retprojectangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retaffineangle — Wave 103 exclusive affineangle stamp */
kprintf("wow64: soft retaffineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retaffineangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retlinearangle — Wave 104 return-linearangle honesty */
kprintf("wow64: soft retlinearangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retlinearangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbilinearangle — Wave 104 exclusive bilinearangle stamp */
kprintf("wow64: soft retbilinearangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbilinearangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retquadraticangle — Wave 105 return-quadraticangle honesty */
kprintf("wow64: soft retquadraticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retquadraticangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retcubicangle — Wave 105 exclusive cubicangle stamp */
kprintf("wow64: soft retcubicangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retcubicangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retquarticangle — Wave 106 return-quarticangle honesty */
kprintf("wow64: soft retquarticangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retquarticangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retquinticangle — Wave 106 exclusive quinticangle stamp */
kprintf("wow64: soft retquinticangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retquinticangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retsplineangle — Wave 107 return-splineangle honesty */
kprintf("wow64: soft retsplineangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retsplineangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbezierangle — Wave 107 exclusive bezierangle stamp */
kprintf("wow64: soft retbezierangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbezierangle stamp; Soft≠product)\n");
/* Grep: wow64: soft rethurmitangle — Wave 108 return-hermitangle honesty */
kprintf("wow64: soft rethurmitangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (rethurmitangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retcatmullangle — Wave 108 exclusive catmullangle stamp */
kprintf("wow64: soft retcatmullangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retcatmullangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retnurbsangle — Wave 109 return-nurbsangle honesty */
kprintf("wow64: soft retnurbsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=109 (retnurbsangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbsplineangle — Wave 109 exclusive bsplineangle stamp */
kprintf("wow64: soft retbsplineangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=109 (retbsplineangle stamp; Soft≠product)\n");
