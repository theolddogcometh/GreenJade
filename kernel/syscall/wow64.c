 ...
 *
 * Soft inventory (Wave 14 base; Wave 32 exclusive deepen) —
 ...
 */
#define GJ_WOW64_SOFT_WAVE 32u
#define GJ_WOW64_SOFT_AREAS 42u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave32 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=32\n");
 ...
 * Soft≠product; not bar3.
 */
/* Grep: wow64: soft retbulwark — Wave 32 return-bulwark honesty */
kprintf("wow64: soft retbulwark soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbulwark honesty; Soft≠product; not bar3)\n",
        (unsigned)GJ_WOW64_SOFT_WAVE);
/* Grep: wow64: soft retpanoply — Wave 32 exclusive panoply stamp */
