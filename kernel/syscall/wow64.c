 ...
 *
 * Soft inventory (Wave 14 base; Wave 27 exclusive deepen) —
 ...
 */
#define GJ_WOW64_SOFT_WAVE  27u
#define GJ_WOW64_SOFT_AREAS 34u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave27 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=27\n");
 ...
 * Soft≠product; not bar3.
            */
            ...
            kprintf("wow64: soft retflame exclusive=1 soft_ne_product=1 "
                     ...
                     * Soft≠product; not bar3.
                     */
                    /* Grep: wow64: soft retprism — Wave 27 return-prism honesty */
                    kprintf("wow64: soft retprism soft_only=1 product_gate=0 soft_ne_product=1 "
                            "never_blocks_m0=1 wave=%u "
                            "(retprism honesty; Soft≠product; not bar3)\n",
                            (unsigned)GJ_WOW64_SOFT_WAVE);
                    /* Grep: wow64: soft retforge — Wave 27 exclusive forge stamp */
