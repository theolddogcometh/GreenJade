 ...
 *
 * Soft inventory (Wave 14 base; Wave 33 exclusive deepen) —
 ...
 */
#define GJ_WOW64_SOFT_WAVE 33u
#define GJ_WOW64_SOFT_AREAS 44u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave33 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=33\n");
 ...
 * Soft≠product; not bar3.
 */
/* Grep: wow64: soft retbastion — Wave 33 return-bastion honesty */
kprintf("wow64: soft retbastion soft_only=1 product_gate=0 soft_ne_product=1 "
        "never_blocks_m0=1 wave=%u "
        "(retbastion honesty; Soft≠product; not bar3)\n",
        (unsigned)GJ_WOW64_SOFT_WAVE);
/* Grep: wow64: soft retcitadel — Wave 33 exclusive citadel stamp */
