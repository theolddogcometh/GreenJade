 ...
 *
 * Soft inventory (Wave 14 base; Wave 18 exclusive deepen) —
 ...
 *   wow64: soft path …
 *   wow64: soft rates …      (Wave 18)
 *   wow64: soft honesty …    (Wave 18)
 *   wow64: soft last …       (Wave 18)
 *   wow64: soft surfaces …   (Wave 18)
 *   wow64: soft catalog …    (Wave 18)
 *   wow64: soft note …       (Wave 18)
 *   wow64: soft deepen …
...
/*
 * Soft product inventory (Wave 14 base; Wave 18 deepen). Cumulative path
 ...
 */
#define GJ_WOW64_SOFT_WAVE  18u
#define GJ_WOW64_SOFT_AREAS 16u
...
/**
 * Greppable soft WoW64 inventory (product / smoke; Wave 18 deepen).
 ...
 *   wow64: soft surfaces      — Wave 18 surface count lamp
 *   wow64: soft catalog       — Wave 18 area name rollup
 *   wow64: soft note          — Wave 16 milestone note
 *   wow64: soft deepen        — Wave 18 stamp
 *   wow64: soft inventory PASS / soft PASS
 * greppable: wow64: soft
...
soft_inventory_log(void)
{
    ...
    /* Grep: wow64: soft rates (Wave 18 deepen) */
    ...
    /* Grep: wow64: soft honesty (Wave 18 deepen) */
    ...
    /* Grep: wow64: soft last (Wave 18 deepen) */
    ...
    /* Grep: wow64: soft surfaces (Wave 18 deepen) */
    ...
    /* Grep: wow64: soft catalog (Wave 18 deepen) */
    ...
    /* Grep: wow64: soft note (Wave 18 deepen) */
    kprintf("wow64: soft note milestone=wave18 exclusive=1 "
            "soft_only=1 not_bar3=1 calls=%u map=%u wave=%u\n",
            g_u32Calls, g_u32MapHits, (unsigned)GJ_WOW64_SOFT_WAVE);

    /* Grep: wow64: soft return (Wave 18 deepen) */
    ...
    /* Grep: wow64: soft retmap — Wave 18 return-surface map */
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=18\n");
...
wow64_set(int fOn)
{
    ...
    /* Wave 18: greppable soft inventory on personality flip. */
