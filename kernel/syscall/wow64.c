 ...
 *
 * Soft inventory (Wave 14 base; Wave 23 exclusive deepen) —
 ...
 */
#define GJ_WOW64_SOFT_WAVE  23u
#define GJ_WOW64_SOFT_AREAS 26u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave23 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=23\n");
 ...
 * Soft≠product; not bar3.
            */
            /* Grep: wow64: soft rettoken — Wave 23 return-token honesty */
            kprintf("wow64: soft rettoken soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(rettoken honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_WOW64_SOFT_WAVE);
            /* Grep: wow64: soft retcrest — Wave 23 exclusive crest stamp */
