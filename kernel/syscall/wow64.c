 ...
 */
#define GJ_WOW64_SOFT_WAVE 52u
#define GJ_WOW64_SOFT_AREAS 78u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave52 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=52\n");
