 ...
 */
#define GJ_WOW64_SOFT_WAVE 95u
#define GJ_WOW64_SOFT_AREAS 164u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave95 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=95\n");
...
kprintf("wow64: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("wow64: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("wow64: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("wow64: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("wow64: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("wow64: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("wow64: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("wow64: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("wow64: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("wow64: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retparapetangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("wow64: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("wow64: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retowerangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("wow64: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("wow64: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retwallangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("wow64: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("wow64: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retholdangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("wow64: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("wow64: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retfortressangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("wow64: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("wow64: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("wow64: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("wow64: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: wow64: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("wow64: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("wow64: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("wow64: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("wow64: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retaegisangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("wow64: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("wow64: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retsigilangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("wow64: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("wow64: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retglyphangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("wow64: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("wow64: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retshardangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("wow64: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("wow64: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retprismangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("wow64: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("wow64: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retcipherangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retbeaconangle — Wave 88 return-beaconangle honesty */
kprintf("wow64: soft retbeaconangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbeaconangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retledgerangle — Wave 88 exclusive ledgerangle stamp */
kprintf("wow64: soft retledgerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retledgerangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retbannerangle — Wave 89 return-bannerangle honesty */
kprintf("wow64: soft retbannerangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbannerangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retvaultangle — Wave 89 exclusive vaultangle stamp */
kprintf("wow64: soft retvaultangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retvaultangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcrestangle — Wave 90 return-crestangle honesty */
kprintf("wow64: soft retcrestangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retcrestangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft rettokenangle — Wave 90 exclusive tokenangle stamp */
kprintf("wow64: soft rettokenangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (rettokenangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retbadgeangle — Wave 91 return-badgeangle honesty */
kprintf("wow64: soft retbadgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retbadgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retphaseangle — Wave 91 exclusive phaseangle stamp */
kprintf("wow64: soft retphaseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retphaseangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmarkangle — Wave 92 return-markangle honesty */
kprintf("wow64: soft retmarkangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retmarkangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retpulseangle — Wave 92 exclusive pulseangle stamp */
kprintf("wow64: soft retpulseangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retpulseangle stamp; Soft≠product)\n");

/* Grep: wow64: soft retsealangle — Wave 93 return-sealangle honesty */
kprintf("wow64: soft retsealangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retsealangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retboundangle — Wave 93 exclusive boundangle stamp */
kprintf("wow64: soft retboundangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retboundangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retstemangle — Wave 94 return-stemangle honesty */
kprintf("wow64: soft retstemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retstemangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbladeangle — Wave 94 exclusive bladeangle stamp */
kprintf("wow64: soft retbladeangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retbladeangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retchordangle — Wave 95 return-chordangle honesty */
kprintf("wow64: soft retchordangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=95 (retchordangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retarcangle — Wave 95 exclusive arcangle stamp */
kprintf("wow64: soft retarcangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=95 (retarcangle stamp; Soft≠product)\n");
