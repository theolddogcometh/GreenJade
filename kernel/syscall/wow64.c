 ...
 *
 * Soft inventory (Wave 14 base; Wave 24 exclusive deepen) —
 ...
 */
#define GJ_WOW64_SOFT_WAVE  24u
#define GJ_WOW64_SOFT_AREAS 28u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave24 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=24\n");
 ...
 * Soft≠product; not bar3.
            */
             ...
             * Soft≠product; not bar3.
             */
            /* Grep: wow64: soft retvault — Wave 24 return-vault honesty */
            kprintf("wow64: soft retvault soft_only=1 product_gate=0 soft_ne_product=1 "
                    "never_blocks_m0=1 wave=%u "
                    "(retvault honesty; Soft≠product; not bar3)\n",
                    (unsigned)GJ_WOW64_SOFT_WAVE);
            /* Grep: wow64: soft retbanner — Wave 24 exclusive banner stamp */
