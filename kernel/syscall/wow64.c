 ...
 */
#define GJ_WOW64_SOFT_WAVE 87u
#define GJ_WOW64_SOFT_AREAS 148u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave87 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=87\n");
...
kprintf("wow64: soft retfosseangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retfosseangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retcounterscarple — Wave 70 exclusive counterscarple stamp */
kprintf("wow64: soft retcounterscarple exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retcounterscarple stamp; Soft≠product)\n");
/*
...
kprintf("wow64: soft retsallyportangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retsallyportangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retreentrantangle — Wave 71 exclusive reentrantangle stamp */
kprintf("wow64: soft retreentrantangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retreentrantangle stamp; Soft≠product)\n");
/*
...
kprintf("wow64: soft retplaceofarmsangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retplaceofarmsangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp */
kprintf("wow64: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retdoubletenailleangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcurtainface — Wave 73 return-curtainface honesty */
kprintf("wow64: soft retcurtainface soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcurtainface honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbastionangle — Wave 73 exclusive bastionangle stamp */
kprintf("wow64: soft retbastionangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbastionangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retglacisangle — Wave 74 return-glacisangle honesty */
kprintf("wow64: soft retglacisangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retglacisangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retparapetangle — Wave 74 exclusive parapetangle stamp */
kprintf("wow64: soft retparapetangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retparapetangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmoatangle — Wave 75 return-moatangle honesty */
kprintf("wow64: soft retmoatangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retmoatangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retowerangle — Wave 75 exclusive towerangle stamp */
kprintf("wow64: soft retowerangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retowerangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retgateangle — Wave 76 return-gateangle honesty */
kprintf("wow64: soft retgateangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retgateangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retwallangle — Wave 76 exclusive wallangle stamp */
kprintf("wow64: soft retwallangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retwallangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retspireangle — Wave 77 return-spireangle honesty */
kprintf("wow64: soft retspireangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retspireangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retholdangle — Wave 77 exclusive holdangle stamp */
kprintf("wow64: soft retholdangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retholdangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retpalaceangle — Wave 78 return-palaceangle honesty */
kprintf("wow64: soft retpalaceangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retpalaceangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retfortressangle — Wave 78 exclusive fortressangle stamp */
kprintf("wow64: soft retfortressangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retfortressangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retkeepangle — Wave 79 return-keepangle honesty */
kprintf("wow64: soft retkeepangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retkeepangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp */
kprintf("wow64: soft retredoubtangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retredoubtangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcitadelangle — Wave 80 return-citadelangle honesty */
kprintf("wow64: soft retcitadelangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcitadelangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbastionkeep — Wave 80 exclusive bastionkeep stamp */
kprintf("wow64: soft retbastionkeep exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbastionkeep stamp; Soft≠product)\n");
/* Grep: wow64: soft retpanoplyangle — Wave 81 return-panoplyangle honesty */
kprintf("wow64: soft retpanoplyangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retpanoplyangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retbulwarkangle — Wave 81 exclusive bulwarkangle stamp */
kprintf("wow64: soft retbulwarkangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retbulwarkangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retmantleangle — Wave 82 return-mantleangle honesty */
kprintf("wow64: soft retmantleangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retmantleangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retaegisangle — Wave 82 exclusive aegisangle stamp */
kprintf("wow64: soft retaegisangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retaegisangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retemblemangle — Wave 83 return-emblemangle honesty */
kprintf("wow64: soft retemblemangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retemblemangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retsigilangle — Wave 83 exclusive sigilangle stamp */
kprintf("wow64: soft retsigilangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retsigilangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retscepterangle — Wave 84 return-scepterangle honesty */
kprintf("wow64: soft retscepterangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retscepterangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retglyphangle — Wave 84 exclusive glyphangle stamp */
kprintf("wow64: soft retglyphangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retglyphangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retcrownangle — Wave 85 return-crownangle honesty */
kprintf("wow64: soft retcrownangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retcrownangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retshardangle — Wave 85 exclusive shardangle stamp */
kprintf("wow64: soft retshardangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retshardangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retforgeangle — Wave 86 return-forgeangle honesty */
kprintf("wow64: soft retforgeangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retforgeangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retprismangle — Wave 86 exclusive prismangle stamp */
kprintf("wow64: soft retprismangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retprismangle stamp; Soft≠product)\n");
/* Grep: wow64: soft retflameangle — Wave 87 return-flameangle honesty */
kprintf("wow64: soft retflameangle soft_only=1 product_gate=0 soft_ne_product=1 never_blocks_m0=1 wave=87 (retflameangle honesty; Soft≠product; not bar3)\n");
/* Grep: wow64: soft retcipherangle — Wave 87 exclusive cipherangle stamp */
kprintf("wow64: soft retcipherangle exclusive=1 soft_ne_product=1 product_kernel=OPEN bar3=0 wave=87 (retcipherangle stamp; Soft≠product)\n");

                            kprintf("wow64: soft deepen wave=%u areas=%u calls=%u map=%u "
            "thunk=%u adjust=%u logs=%u "
            "(Wave 87 exclusive; not bar3)\n",
            (unsigned)GJ_WOW64_SOFT_WAVE,
            (unsigned)GJ_WOW64_SOFT_AREAS,
            g_u32Calls, g_u32MapHits, g_u32ThunkHits,
            g_u32SoftAdjustEnter, g_u32SoftLogN);
