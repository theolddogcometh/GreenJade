 ...
 *
 * Soft inventory (Wave 14 base; Wave 28 exclusive deepen) —
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave28 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=28\n");
            ...
            */
            ...
            kprintf("wow64: soft retflame exclusive=1 soft_ne_product=1 "
                    ...
                    kprintf("wow64: soft retforge exclusive=1 soft_ne_product=1 "
                             ...
                             * Soft≠product; not bar3.
                             */
                            /* Grep: wow64: soft retshard — Wave 28 return-shard honesty */
                            kprintf("wow64: soft retshard soft_only=1 product_gate=0 soft_ne_product=1 "
                                "never_blocks_m0=1 wave=%u "
                                "(retshard honesty; Soft≠product; not bar3)\n",
                                (unsigned)GJ_WOW64_SOFT_WAVE);
                            /* Grep: wow64: soft retcrown — Wave 28 exclusive crown stamp */
