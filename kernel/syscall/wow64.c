 ...
 *
 * Soft inventory (Wave 14 base; Wave 34 exclusive deepen) —
 ...
 */
#define GJ_WOW64_SOFT_WAVE 34u
#define GJ_WOW64_SOFT_AREAS 46u
...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave34 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=34\n");
