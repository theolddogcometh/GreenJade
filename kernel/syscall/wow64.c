...
soft_inventory_log(void)
{
    ...
    kprintf("wow64: soft note milestone=wave42 exclusive=1 "
    ...
    kprintf("wow64: soft retmap ok|fail|inval|nodev|busy|nomem product_gate=0 soft_only=1 wave=42\n");
