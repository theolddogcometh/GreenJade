...
# *decade* is a closed batch range ending at a milestone M (e.g. M=24500
# → exclusive wave 24401–24500). Soft host probes
...
#      Example generator for the 24500 wave (Wave 103 exclusive continuum track):
#        user/libcgj/src/_gen_milestone_24500.py
#        python3 user/libcgj/src/_gen_milestone_24500.py --dry-run
#      (prior Wave 101: _gen_milestone_24300.py / M=24300; Wave 100: _gen_milestone_24200.py / M=24200; Wave 99: _gen_milestone_24100.py / M=24100; Wave 98: _gen_milestone_24000.py / M=24000; Wave 97: _gen_milestone_23900.py / M=23900; Wave 96: _gen_milestone_23800.py / M=23800; Wave 95: _gen_milestone_23700.py / M=23700; Wave 94: _gen_milestone_23600.py / M=23600; Wave 93: _gen_milestone_23500.py / M=23500; Wave 92: _gen_milestone_23400.py / M=23400; Wave 91: _gen_milestone_23300.py / M=23300; Wave 90: _gen_milestone_23200.py / M=23200; Wave 89: _gen_milestone_23100.py / M=23100; Wave 88: _gen_milestone_23000.py / M=23000; Wave 86: _gen_milestone_22800.py / M=22800; Wave 85: _gen_milestone_22700.py / M=22700; Wave 84: _gen_milestone_22600.py / M=22600; Wave 83: _gen_milestone_22500.py / M=22500; Wave 82: _gen_milestone_22400.py / M=22400; Wave 81: _gen_milestone_22300.py / M=22300)
...
# graph_batch24500.c (and beyond) once those basenames are wired.
#
# Wave 103 soft note (24500-era): the exclusive target decade is M=24500
# (CREATE-ONLY 24401–24500; extension identity 24401–24450 ahead of the
# decade identity/fill/marker bands). Soft deepen surfaces this wave
# (docs/userland soft stamps): retprojectangle / retaffineangle (CREATE-ONLY soft
# names only — not product). Until parent pastes those basenames into
# CGJ_SRCS, ``--max`` may still report the prior high-water
# (e.g. makefile_max=24400). **Scan is the source of truth** — do not
# hardcode a false makefile_max here or in side panels. Soft high-water
# may be described as **advancing toward 24500** while the honest scan
...
# reports. Soft graph growth through graph_batch24500.c is **not** bar3,
# not Deck Top-50 title runs, and not product score (gj_bar3_ready_24500
# and gj_product_score_24500 remain 0 by design). Soft ≠ product complete.
#
# Decade paste hygiene (24500-era / Wave 103 example)
# ------------------------------------------------
# After CREATE-ONLY wave 24401–24500 exists on disk:
#
...
#   ./scripts/gj-continuum-makefile-snippet.sh --exist-only 24451 24500
#
...
#   user/libcgj/src/graph_batch24301.c \   ← Wave 103 helper output starts here
#   … through graph_batch24500.c once CREATE-ONLY + parent wire land
#
...
#   user/libcgj/src/_gen_milestone_24500.py   (Wave 103 CREATE-ONLY emitter, when present)
...
makefile_max honesty:
  ...
  Scan has no artificial cap (supports through graph_batch24500.c and beyond).
  High-water is whatever the scan prints (source of truth) — do not hardcode.
  Wave 103 exclusive target decade: M=24500 (soft graph only — not bar3 /
  Steam client / Top-50 titles). Soft deepen surfaces: retprojectangle /
  retaffineangle (CREATE-ONLY soft names only). Until parent wires 24401–24500,
  --max may still report prior tip (e.g. makefile_max=24400). Soft high-water
  may advance toward 24500 while scan remains at prior tip.

Workflow:
  1. Land CREATE-ONLY TUs (e.g. user/libcgj/src/_gen_milestone_24500.py)
...
Decade bands for milestone M=24500 (docs only; helper emits paths only):
  extension 24401-24450 | identity 24451-24475 | fill 24476-24490 | markers 24491-24500
