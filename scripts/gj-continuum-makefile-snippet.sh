...
# *decade* is a closed batch range ending at a milestone M (e.g. M=18600
# → exclusive wave 18551–18600). Soft host probes
...
#      Example generator for the 18600 wave (Wave 44 exclusive continuum track):
#        user/libcgj/src/_gen_milestone_18600.py
#        python3 user/libcgj/src/_gen_milestone_18600.py --dry-run
#      (prior Wave 43: _gen_milestone_18500.py / M=18500)
...
# graph_batch18600.c (and beyond) once those basenames are wired.
#
# Wave 44 soft note (18600-era): the exclusive target decade is M=18600
# (CREATE-ONLY 18551–18600; optional extension 18501–18550). Soft deepen
# surfaces this wave (docs/userland soft stamps): retmerlon / retembrasure
...
# (e.g. makefile_max=18500). **Scan is the source of truth** — do not
# hardcode a false makefile_max here or in side panels. Soft high-water
# may be described as **advancing toward 18600** while the honest scan
...
# reports. Soft graph growth through graph_batch18600.c is **not** bar3,
# not Deck Top-50 title runs, and not product score (gj_bar3_ready_18600
# and gj_product_score_18600 remain 0 by design). Soft ≠ product complete.
#
# Decade paste hygiene (18600-era / Wave 44 example)
# ------------------------------------------------
# After CREATE-ONLY wave 18551–18600 exists on disk (optional extension
# 18501–18550 may land ahead of the decade bands):
#
...
#   ./scripts/gj-continuum-makefile-snippet.sh 18551 18600
#
...
#
# For M=18600 that is identity 18551–18575, fill 18576–18590,
# markers 18591–18600. Continuum extension 18501–18550 sits ahead of
# the decade bands. Prior decade M=18500: identity 18451–18475,
# fill 18476–18490, markers 18491–18500.
# See _gen_milestone_18600.py module docstring (when present) and
# user/libcgj/tests/NOTES_milestone_18600.txt (when present).
#
# Usage:
...
#   user/libcgj/src/graph_batch18500.c \   ← prior high-water (if still tip)
#   user/libcgj/src/graph_batch18501.c \   ← Wave 44 helper output starts here
#   … through graph_batch18600.c once CREATE-ONLY + parent wire land
#
...
#
# See also:
#   user/libcgj/src/_gen_milestone_18500.py   (prior Wave 43 CREATE-ONLY emitter)
#   user/libcgj/src/_gen_milestone_18600.py   (Wave 44 CREATE-ONLY emitter, when present)
...
makefile_max honesty:
  ...
  Scan has no artificial cap (supports through graph_batch18600.c and beyond).
  High-water is whatever the scan prints (source of truth) — do not hardcode.
  Wave 44 exclusive target decade: M=18600 (soft graph only — not bar3 /
  Steam client / Top-50 titles). Soft deepen surfaces: retmerlon /
  retembrasure (CREATE-ONLY soft names only). Until parent wires 18501–18600,
  --max may still report prior tip (e.g. makefile_max=18500). Soft high-water
  may advance toward 18600 while scan remains at prior tip.

Workflow:
  1. Land CREATE-ONLY TUs (e.g. user/libcgj/src/_gen_milestone_18600.py)
...
Decade bands for milestone M=18600 (docs only; helper emits paths only):
  identity 18551-18575 | fill 18576-18590 | markers 18591-18600
  extension 18501-18550 (pre-decade; may land ahead of identity/fill/markers)
  (prior M=18500: identity 18451-18475 | fill 18476-18490 | markers 18491-18500)
