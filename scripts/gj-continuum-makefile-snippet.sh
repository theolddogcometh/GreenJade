...
# *decade* is a closed batch range ending at a milestone M (e.g. M=24600
# → exclusive wave 24501–24600). Soft host probes
...
#      Example generator for the 24600 wave (Wave 104 exclusive continuum track):
#        user/libcgj/src/_gen_milestone_24600.py
...
# graph_batch24600.c (and beyond) once those basenames are wired.
#
# Wave 104 soft note (24600-era): the exclusive target decade is M=24600
# (CREATE-ONLY 24501–24600; extension identity 24501–24550 ahead of the
...
# reports. Soft graph growth through graph_batch24600.c is **not** bar3,
# not Deck Top-50 title runs, and not product score (gj_bar3_ready_24600
# and gj_product_score_24600 remain 0 by design). Soft ≠ product complete.
#
# Decade paste hygiene (24600-era / Wave 104 example)
# ------------------------------------------------
# After CREATE-ONLY wave 24501–24600 exists on disk:
#
...
#   ./scripts/gj-continuum-makefile-snippet.sh --exist-only 24551 24600
#
...
#   user/libcgj/src/graph_batch24301.c \   ← Wave 104 helper output starts here
#   … through graph_batch24600.c once CREATE-ONLY + parent wire land
#
...
#   user/libcgj/src/_gen_milestone_24600.py   (Wave 104 CREATE-ONLY emitter, when present)
...
makefile_max honesty:
  ...
  Scan has no artificial cap (supports through graph_batch24600.c and beyond).
...
Decade bands for milestone M=24600 (docs only; helper emits paths only):
  extension 24501-24550 | identity 24551-24575 | fill 24576-24590 | markers 24591-24600
  (prior M=24500: identity 24351-24375 | fill 24376-24390 | markers 24391-24500)
