...
# ---------------------------------------------------------------------------
# Wave 17 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=15900.
#   Honest scan may still report makefile_max=15800 until parent wires 15900.
...
echo "gj-soak-large-ram: honesty  Wave 17 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=15900; may be 15800)"
