...
# ---------------------------------------------------------------------------
# Wave 30 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17200.
#   Honest scan may still report makefile_max=17100 until parent wires 17200.
...
echo "gj-soak-large-ram: honesty  Wave 30 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17200; may be 17100)"
