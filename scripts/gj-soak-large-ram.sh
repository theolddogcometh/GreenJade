...
# ---------------------------------------------------------------------------
# Wave 72 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=21400.
#   Honest scan may still report makefile_max=21300 until parent wires 21400.
#   Soft deepen retplaceofarmsangle/retdoubletenailleangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 72 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=21400; may be 21300)"
