...
# ---------------------------------------------------------------------------
# Wave 91 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=23300.
#   Honest scan may still report makefile_max=23200 until parent wires 23300.
#   Soft deepen retbadgeangle/retphaseangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 91 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=23300; may be 23200)"
