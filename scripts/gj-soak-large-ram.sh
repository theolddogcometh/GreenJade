...
# ---------------------------------------------------------------------------
# Wave 15 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=15700.
#   Honest scan may still report makefile_max=15600 until parent wires 15700.
...
echo "gj-soak-large-ram: honesty  Wave 15 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=15700; may be 15600)"
