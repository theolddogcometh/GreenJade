...
# ---------------------------------------------------------------------------
# Wave 89 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=23100.
#   Honest scan may still report makefile_max=23000 until parent wires 23100.
#   Soft deepen retbannerangle/retvaultangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 89 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=23100; may be 23000)"
