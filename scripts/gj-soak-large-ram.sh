...
# ---------------------------------------------------------------------------
# Wave 24 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=16600.
#   Honest scan may still report makefile_max=16500 until parent wires 16600.
...
echo "gj-soak-large-ram: honesty  Wave 24 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=16600; may be 16500)"
