...
# ---------------------------------------------------------------------------
# Wave 53 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19500.
#   Honest scan may still report makefile_max=19400 until parent wires 19500.
#   Soft deepen retravelin/retlunette are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 53 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19500; may be 19400)"
