...
# ---------------------------------------------------------------------------
# Wave 60 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=20200.
#   Honest scan may still report makefile_max=20100 until parent wires 20200.
#   Soft deepen retplace/retenvelope are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 60 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=20200; may be 20100)"
