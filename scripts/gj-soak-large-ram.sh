...
# ---------------------------------------------------------------------------
# Wave 69 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=21100.
#   Honest scan may still report makefile_max=21000 until parent wires 21100.
#   Soft deepen retdemiluneangle/retcoveredwayangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 69 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=21100; may be 21000)"
