...
# ---------------------------------------------------------------------------
# Wave 54 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19600.
#   Honest scan may still report makefile_max=19500 until parent wires 19600.
#   Soft deepen retcaponier/retredan are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 54 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19600; may be 19500)"
