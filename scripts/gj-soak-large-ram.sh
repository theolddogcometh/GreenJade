...
# ---------------------------------------------------------------------------
# Wave 79 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=22100.
#   Honest scan may still report makefile_max=22000 until parent wires 22100.
#   Soft deepen retkeepangle/retredoubtangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 79 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=22100; may be 22000)"
