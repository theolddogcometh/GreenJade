...
# ---------------------------------------------------------------------------
# Wave 41 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=18300.
#   Honest scan may still report makefile_max=18200 until parent wires 18300.
#   Soft deepen retravelin/retditch are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 41 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=18300; may be 18200)"
