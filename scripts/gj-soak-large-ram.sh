...
# ---------------------------------------------------------------------------
# Wave 108 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=25000.
#   Honest scan may still report makefile_max=24900 until parent wires 24900.
#   Soft deepen rethurmitangle/retcatmullangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 108 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=25000; may be 24800)"
