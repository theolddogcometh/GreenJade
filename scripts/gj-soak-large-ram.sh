...
# ---------------------------------------------------------------------------
# Wave 71 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=21300.
#   Honest scan may still report makefile_max=21200 until parent wires 21300.
#   Soft deepen retsallyportangle/retreentrantangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 71 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=21300; may be 21200)"
