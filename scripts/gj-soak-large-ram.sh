...
# ---------------------------------------------------------------------------
# Wave 26 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=16800.
#   Honest scan may still report makefile_max=16700 until parent wires 16800.
...
echo "gj-soak-large-ram: honesty  Wave 26 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=16800; may be 16700)"
