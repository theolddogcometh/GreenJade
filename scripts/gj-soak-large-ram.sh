...
# ---------------------------------------------------------------------------
# Wave 46 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=18800.
#   Honest scan may still report makefile_max=18700 until parent wires 18800.
#   Soft deepen retbailey/retpostern are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 46 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=18800; may be 18700)"
