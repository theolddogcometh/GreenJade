...
# ---------------------------------------------------------------------------
# Wave 34 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17600.
#   Honest scan may still report makefile_max=17500 until parent wires 17600.
...
echo "gj-soak-large-ram: honesty  Wave 34 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17600; may be 17500)"
