...
# ---------------------------------------------------------------------------
# Wave 44 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=18600.
#   Honest scan may still report makefile_max=18500 until parent wires 18600.
#   Soft deepen retmerlon/retembrasure are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 44 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=18600; may be 18500)"
