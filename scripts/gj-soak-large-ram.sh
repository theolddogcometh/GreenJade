...
# ---------------------------------------------------------------------------
# Wave 61 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=20300.
#   Honest scan may still report makefile_max=20200 until parent wires 20300.
#   Soft deepen retcounterguard/retcoveredface are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 61 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=20300; may be 20200)"
