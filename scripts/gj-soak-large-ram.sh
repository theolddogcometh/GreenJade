...
# ---------------------------------------------------------------------------
# Wave 52 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19400.
#   Honest scan may still report makefile_max=19300 until parent wires 19400.
#   Soft deepen rettenaille/retdemilune are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 52 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19400; may be 19300)"
