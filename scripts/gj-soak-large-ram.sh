...
#   Honest scan may still report makefile_max=23900 until parent wires 24000.
...
echo "gj-soak-large-ram: honesty  Wave 98 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=24000; may be 23900)"
