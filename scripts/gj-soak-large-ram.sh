...
# ---------------------------------------------------------------------------
# Wave 78 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=22000.
#   Honest scan may still report makefile_max=21900 until parent wires 22000.
#   Soft deepen retpalaceangle/retfortressangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 78 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=22000; may be 21900)"
