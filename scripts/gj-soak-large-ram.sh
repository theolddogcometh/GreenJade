...
# ---------------------------------------------------------------------------
# Wave 22 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=16400.
#   Honest scan may still report makefile_max=16300 until parent wires 16400.
...
echo "gj-soak-large-ram: honesty  Wave 22 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=16400; may be 16300)"
