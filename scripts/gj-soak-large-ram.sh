...
# ---------------------------------------------------------------------------
# Wave 35 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17700.
#   Honest scan may still report makefile_max=17600 until parent wires 17700.
#   Soft deepen retfortress/retpalace are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 35 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17700; may be 17600)"
