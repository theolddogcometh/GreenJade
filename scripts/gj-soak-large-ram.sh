...
# ---------------------------------------------------------------------------
# Wave 85 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=22700.
#   Honest scan may still report makefile_max=22600 until parent wires 22700.
#   Soft deepen retcrownangle/retshardangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 85 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=22700; may be 22600)"
