...
# ---------------------------------------------------------------------------
# Wave 115 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=25700.
#   Honest scan may still report makefile_max=25600 until parent wires 25700.
#   Soft deepen retpresentangle/retvsyncangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 115 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=25700; may be 25500)"
