...
# ---------------------------------------------------------------------------
# Wave 31 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17300.
#   Honest scan may still report makefile_max=17200 until parent wires 17300.
...
echo "gj-soak-large-ram: honesty  Wave 31 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17300; may be 17200)"
