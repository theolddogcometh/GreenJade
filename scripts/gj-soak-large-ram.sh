...
# ---------------------------------------------------------------------------
# Wave 32 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17400.
#   Honest scan may still report makefile_max=17300 until parent wires 17400.
...
echo "gj-soak-large-ram: honesty  Wave 32 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17400; may be 17300)"
