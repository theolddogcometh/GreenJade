...
# ---------------------------------------------------------------------------
# Wave 122 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=26400.
#   Honest scan may still report makefile_max=26300 until parent wires 26400.
#   Soft deepen retframeangle/retwindowangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 122 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=26400; may be 26300)"
