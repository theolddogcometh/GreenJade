...
# ---------------------------------------------------------------------------
# Wave 23 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=16500.
#   Honest scan may still report makefile_max=16400 until parent wires 16500.
...
echo "gj-soak-large-ram: honesty  Wave 23 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=16500; may be 16400)"
