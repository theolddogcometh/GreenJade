...
# ---------------------------------------------------------------------------
# Wave 51 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19300.
#   Honest scan may still report makefile_max=19200 until parent wires 19300.
#   Soft deepen retfosse/retcoveredway are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 51 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19300; may be 19200)"
