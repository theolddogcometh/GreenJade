...
# ---------------------------------------------------------------------------
# Wave 67 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=20900.
#   Honest scan may still report makefile_max=20800 until parent wires 20900.
#   Soft deepen retcaponierangle/retredanangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 67 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=20900; may be 20800)"
