...
# ---------------------------------------------------------------------------
# Wave 48 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19000.
#   Honest scan may still report makefile_max=18900 until parent wires 19000.
#   Soft deepen retchevaux/retpalisade are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 48 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19000; may be 18900)"
