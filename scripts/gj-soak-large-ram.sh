...
# ---------------------------------------------------------------------------
# Wave 73 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=21500.
#   Honest scan may still report makefile_max=21400 until parent wires 21500.
#   Soft deepen retcurtainface/retbastionangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 73 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=21500; may be 21400)"
