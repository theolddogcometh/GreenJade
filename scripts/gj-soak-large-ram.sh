...
# ---------------------------------------------------------------------------
# Wave 95 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=23700.
#   Honest scan may still report makefile_max=23600 until parent wires 23700.
#   Soft deepen retchordangle/retarcangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 95 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=23700; may be 23600)"
