...
# ---------------------------------------------------------------------------
# Wave 49 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19100.
#   Honest scan may still report makefile_max=19000 until parent wires 19100.
#   Soft deepen retglacisgate/retoutwork are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 49 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19100; may be 19000)"
