...
# ---------------------------------------------------------------------------
# Wave 103 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=24500.
#   Honest scan may still report makefile_max=24400 until parent wires 24500.
#   Soft deepen retprojectangle/retaffineangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 103 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=24500; may be 24400)"
