...
# ---------------------------------------------------------------------------
# Wave 25 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=16700.
#   Honest scan may still report makefile_max=16600 until parent wires 16700.
...
echo "gj-soak-large-ram: honesty  Wave 25 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=16700; may be 16600)"
