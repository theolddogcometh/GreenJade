...
# ---------------------------------------------------------------------------
# Wave 37 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17900.
#   Honest scan may still report makefile_max=17800 until parent wires 17900.
#   Soft deepen retwall/retgate are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 37 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17900; may be 17800)"
