...
# ---------------------------------------------------------------------------
# Wave 106 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=24800.
#   Honest scan may still report makefile_max=24700 until parent wires 24800.
#   Soft deepen retquarticangle/retquinticangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 106 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=24800; may be 24700)"
