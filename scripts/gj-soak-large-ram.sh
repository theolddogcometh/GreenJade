...
# ---------------------------------------------------------------------------
# Wave 76 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=21800.
#   Honest scan may still report makefile_max=21700 until parent wires 21800.
#   Soft deepen retgateangle/retwallangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 76 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=21800; may be 21700)"
