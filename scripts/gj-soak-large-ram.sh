...
# ---------------------------------------------------------------------------
# Wave 42 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=18400.
#   Honest scan may still report makefile_max=18300 until parent wires 18400.
#   Soft deepen retportcullis/retbattlement are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 42 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=18400; may be 18300)"
