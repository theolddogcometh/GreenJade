...
# ---------------------------------------------------------------------------
# Wave 18 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=16000.
#   Honest scan may still report makefile_max=15900 until parent wires 16000.
...
echo "gj-soak-large-ram: honesty  Wave 18 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=16000; may be 15800)"
