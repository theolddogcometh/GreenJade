...
# ---------------------------------------------------------------------------
# Wave 124 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=26600.
#   Honest scan may still report makefile_max=26500 until parent wires 26600.
#   Soft deepen retbrushangle/retinkangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 124 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=26600; may be 26500)"
