...
# ---------------------------------------------------------------------------
# Wave 57 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19900.
#   Honest scan may still report makefile_max=19800 until parent wires 19900.
#   Soft deepen retraverse/retcasemate are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 57 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19900; may be 19800)"
