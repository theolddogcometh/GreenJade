...
# ---------------------------------------------------------------------------
# Wave 92 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=23400.
#   Honest scan may still report makefile_max=23300 until parent wires 23400.
#   Soft deepen retmarkangle/retpulseangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 92 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=23400; may be 23300)"
