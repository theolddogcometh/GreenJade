...
# ---------------------------------------------------------------------------
# Wave 120 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=26200.
#   Honest scan may still report makefile_max=26100 until parent wires 26200.
#   Soft deepen retchannelangle/retmailboxangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 120 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=26200; may be 26100)"
