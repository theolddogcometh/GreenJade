...
# ---------------------------------------------------------------------------
# Wave 38 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=18000.
#   Honest scan may still report makefile_max=17900 until parent wires 18000.
#   Soft deepen retmoat/retower are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 38 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=18000; may be 17900)"
