...
# ---------------------------------------------------------------------------
# Wave 65 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=20700.
#   Honest scan may still report makefile_max=20600 until parent wires 20700.
#   Soft deepen retgorgeangle/retshoulderangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 65 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=20700; may be 20600)"
