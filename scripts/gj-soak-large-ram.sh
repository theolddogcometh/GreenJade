...
# ---------------------------------------------------------------------------
# Wave 109 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=25100.
#   Honest scan may still report makefile_max=25000 until parent wires 25000.
#   Soft deepen retnurbsangle/retbsplineangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 109 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=25100; may be 25000)"
