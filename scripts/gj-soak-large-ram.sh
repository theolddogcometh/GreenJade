...
# ---------------------------------------------------------------------------
# Wave 28 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17000.
#   Honest scan may still report makefile_max=16900 until parent wires 17000.
...
echo "gj-soak-large-ram: honesty  Wave 28 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17000; may be 16900)"
