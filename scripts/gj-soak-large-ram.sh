...
# ---------------------------------------------------------------------------
# Wave 66 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=20800.
#   Honest scan may still report makefile_max=20700 until parent wires 20800.
#   Soft deepen retflankangle/retfaceangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 66 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=20800; may be 20700)"
