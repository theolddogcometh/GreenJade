...
# ---------------------------------------------------------------------------
# Wave 114 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=25600.
#   Honest scan may still report makefile_max=25500 until parent wires 25600.
#   Soft deepen retframebufferangle/retswapchainangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 114 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=25600; may be 25500)"
