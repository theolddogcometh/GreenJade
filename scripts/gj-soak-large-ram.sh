...
# ---------------------------------------------------------------------------
# Wave 116 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=25800.
#   Honest scan may still report makefile_max=25700 until parent wires 25800.
#   Soft deepen retfenceangle/retsemaphoreangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 116 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=25800; may be 25700)"
