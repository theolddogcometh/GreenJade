...
# ---------------------------------------------------------------------------
# Wave 43 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=18500.
#   Honest scan may still report makefile_max=18400 until parent wires 18500.
#   Soft deepen retmachicolation/retarrowslit are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 43 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=18500; may be 18400)"
