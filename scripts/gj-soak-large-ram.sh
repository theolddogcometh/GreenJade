...
# ---------------------------------------------------------------------------
# Wave 119 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=26100.
#   Honest scan may still report makefile_max=26000 until parent wires 26100.
#   Soft deepen retqueueangle/reteventangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 119 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=26100; may be 26000)"
