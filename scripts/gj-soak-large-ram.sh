...
# ---------------------------------------------------------------------------
# Wave 83 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=22500.
#   Honest scan may still report makefile_max=22400 until parent wires 22500.
#   Soft deepen retemblemangle/retsigilangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 83 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=22500; may be 22400)"
