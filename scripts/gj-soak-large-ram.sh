...
# ---------------------------------------------------------------------------
# Wave 29 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17100.
#   Honest scan may still report makefile_max=17000 until parent wires 17100.
...
echo "gj-soak-large-ram: honesty  Wave 29 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17100; may be 17000)"
