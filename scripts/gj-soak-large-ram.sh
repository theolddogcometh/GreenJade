...
# ---------------------------------------------------------------------------
# Wave 118 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=26000.
#   Honest scan may still report makefile_max=25900 until parent wires 26000.
#   Soft deepen retbarrierangle/retatomicangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 118 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=26000; may be 25900)"
