...
# ---------------------------------------------------------------------------
# Wave 50 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19200.
#   Honest scan may still report makefile_max=19100 until parent wires 19200.
#   Soft deepen retsally/retcounterscarp are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 50 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19200; may be 19100)"
