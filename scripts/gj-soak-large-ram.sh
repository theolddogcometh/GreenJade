...
# ---------------------------------------------------------------------------
# Wave 77 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=21900.
#   Honest scan may still report makefile_max=21800 until parent wires 21900.
#   Soft deepen retspireangle/retholdangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 77 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=21900; may be 21800)"
