...
# ---------------------------------------------------------------------------
# Wave 21 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=16300.
#   Honest scan may still report makefile_max=16000 until parent wires 16300.
...
echo "gj-soak-large-ram: honesty  Wave 21 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=16300; may be 16000)"
