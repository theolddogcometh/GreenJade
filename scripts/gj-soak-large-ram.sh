...
# ---------------------------------------------------------------------------
# Wave 113 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=25500.
#   Honest scan may still report makefile_max=25400 until parent wires 25500.
#   Soft deepen retshaderangle/retpipelineangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 113 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=25500; may be 25400)"
