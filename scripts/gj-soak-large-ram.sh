...
# ---------------------------------------------------------------------------
# Wave 36 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17800.
#   Honest scan may still report makefile_max=17700 until parent wires 17800.
#   Soft deepen rethold/retspire are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 36 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17800; may be 17700)"
