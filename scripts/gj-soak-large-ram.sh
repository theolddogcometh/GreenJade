...
# ---------------------------------------------------------------------------
# Wave 107 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=24900.
#   Honest scan may still report makefile_max=24800 until parent wires 24900.
#   Soft deepen retsplineangle/retbezierangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 107 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=24900; may be 24700)"
