...
# ---------------------------------------------------------------------------
# Wave 68 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=21000.
#   Honest scan may still report makefile_max=20900 until parent wires 21000.
#   Soft deepen retlunetteangle/rettenailleangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 68 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=21000; may be 20900)"
