...
# ---------------------------------------------------------------------------
# Wave 16 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=15800.
#   Honest scan may still report makefile_max=15700 until parent wires 15800.
...
echo "gj-soak-large-ram: honesty  Wave 16 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=15800; may be 15700)"
