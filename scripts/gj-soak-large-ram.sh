...
# ---------------------------------------------------------------------------
# Wave 62 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=20400.
#   Honest scan may still report makefile_max=20300 until parent wires 20400.
#   Soft deepen retbastionface/retcurtainangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 62 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=20400; may be 20300)"
