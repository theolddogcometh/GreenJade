...
# ---------------------------------------------------------------------------
# Wave 125 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=26700.
#   Honest scan may still report makefile_max=26600 until parent wires 26700.
#   Soft deepen retpaletteangle/retstrokeangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 125 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=26700; may be 26600)"
