...
# ---------------------------------------------------------------------------
# Wave 33 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=17500.
#   Honest scan may still report makefile_max=17400 until parent wires 17500.
...
echo "gj-soak-large-ram: honesty  Wave 33 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=17500; may be 17400)"
