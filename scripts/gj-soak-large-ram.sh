...
# ---------------------------------------------------------------------------
# Wave 70 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=21200.
#   Honest scan may still report makefile_max=21100 until parent wires 21200.
#   Soft deepen retfosseangle/retcounterscarple are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 70 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=21200; may be 21100)"
