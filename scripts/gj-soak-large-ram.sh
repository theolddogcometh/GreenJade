...
# ---------------------------------------------------------------------------
# Wave 56 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19800.
#   Honest scan may still report makefile_max=19700 until parent wires 19800.
#   Soft deepen retgorge/retshoulder are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 56 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19800; may be 19700)"
