...
# ---------------------------------------------------------------------------
# Wave 45 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=18700.
#   Honest scan may still report makefile_max=18600 until parent wires 18700.
#   Soft deepen retkeepgate/retouterward are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 45 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=18700; may be 18600)"
