...
# ---------------------------------------------------------------------------
# Wave 55 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=19700.
#   Honest scan may still report makefile_max=19600 until parent wires 19700.
#   Soft deepen retflank/retface are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 55 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=19700; may be 19600)"
