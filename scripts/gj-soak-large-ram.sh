...
# ---------------------------------------------------------------------------
# Wave 27 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=16900.
#   Honest scan may still report makefile_max=16800 until parent wires 16900.
...
echo "gj-soak-large-ram: honesty  Wave 27 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=16900; may be 16800)"
