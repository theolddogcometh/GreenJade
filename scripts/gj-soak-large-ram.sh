...
# ---------------------------------------------------------------------------
# Wave 90 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=23200.
#   Honest scan may still report makefile_max=23100 until parent wires 23200.
#   Soft deepen retcrestangle/rettokenangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 90 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=23200; may be 23100)"
