...
# ---------------------------------------------------------------------------
# Wave 96 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=23800.
#   Honest scan may still report makefile_max=23700 until parent wires 23800.
#   Soft deepen retsectorangle/retwedgeangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 96 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=23800; may be 23700)"
