...
# ---------------------------------------------------------------------------
# Wave 47 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=18900.
#   Honest scan may still report makefile_max=18800 until parent wires 18900.
#   Soft deepen retinnerward/retdonjon are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 47 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=18900; may be 18800)"
