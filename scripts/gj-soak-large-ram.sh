...
#   Honest scan may still report makefile_max=24500 until parent wires 24600.
...
echo "gj-soak-large-ram: honesty  Wave 104 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=24600; may be 24500)"
