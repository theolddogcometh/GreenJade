...
# ---------------------------------------------------------------------------
# Wave 84 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=22600.
#   Honest scan may still report makefile_max=22500 until parent wires 22600.
#   Soft deepen retscepterangle/retglyphangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 84 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=22600; may be 22500)"
