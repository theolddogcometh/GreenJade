...
# ---------------------------------------------------------------------------
# Wave 110 soft note (continuum / product side panel):
#   Soft product-summary may note continuum high-water advancing toward M=25200.
#   Honest scan may still report makefile_max=25100 until parent wires 25100.
#   Soft deepen retmeshangle/retgridangle are CREATE-ONLY soft names only (≠ product).
...
echo "gj-soak-large-ram: honesty  Wave 110 soft  soak ≠ bar3/Top50; continuum makefile_max=scan (toward M=25200; may be 25100)"
