...
#   continuum high-water via product-summary (Wave 59: toward M=20100;
#     greppable 20100 when scan ≥20100, prior tip 20000 when ≥20000 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retcrownwork/rethornwork CREATE-ONLY only;
...
# (Wave 59: continuum high-water side panel notes toward M=20100; greppable
#  20100 when scan ≥20100, prior tip 20000 when ≥20000 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 59 continuum side panel) ---"
