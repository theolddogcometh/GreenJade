...
#   continuum high-water via product-summary (Wave 103: toward M=24500;
#     greppable 24500 when scan ≥24400, prior tip 24400 when ≥24300 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retprojectangle/retaffineangle CREATE-ONLY only;
...
# (Wave 103: continuum high-water side panel notes toward M=24500; greppable
#  24300 when scan ≥24400, prior tip 24400 when ≥24300 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 103 continuum side panel) ---"
