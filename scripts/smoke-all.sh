...
#     greppable 24000 when scan ≥24000, prior tip 23800 when ≥23800 — not a hard gate;
...
#  24000 when scan ≥24000, prior tip 23800 when ≥23800 — hard gates stay hard; soft graph ≠ product bar)
