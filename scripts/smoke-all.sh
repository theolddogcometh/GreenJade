...
#   continuum high-water via product-summary (Wave 65: toward M=20700;
#     greppable 20700 when scan ≥20700, prior tip 20600 when ≥20600 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retgorgeangle/retshoulderangle CREATE-ONLY only;
...
# (Wave 65: continuum high-water side panel notes toward M=20700; greppable
#  20700 when scan ≥20700, prior tip 20600 when ≥20600 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 65 continuum side panel) ---"
