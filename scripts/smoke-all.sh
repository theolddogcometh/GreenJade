...
#   continuum high-water via product-summary (Wave 32: toward M=17400;
#     greppable 17300 only when scan says so — not a hard gate; ≠ bar3/Top50;
...
# (Wave 32: continuum high-water side panel notes toward M=17400; greppable
#  17300 only when scan ≥17300 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 32 continuum side panel) ---"
