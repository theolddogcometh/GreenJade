...
#   continuum high-water via product-summary (Wave 66: toward M=20800;
#     greppable 20800 when scan ≥20800, prior tip 20700 when ≥20700 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retflankangle/retfaceangle CREATE-ONLY only;
...
# (Wave 66: continuum high-water side panel notes toward M=20800; greppable
#  20800 when scan ≥20800, prior tip 20700 when ≥20700 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 66 continuum side panel) ---"
