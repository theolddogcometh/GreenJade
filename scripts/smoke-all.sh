...
#   continuum high-water via product-summary (Wave 88: toward M=23000;
#     greppable 23000 when scan ≥23000, prior tip 22900 when ≥22900 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retbeaconangle/retledgerangle CREATE-ONLY only;
...
# (Wave 88: continuum high-water side panel notes toward M=23000; greppable
#  23000 when scan ≥23000, prior tip 22900 when ≥22900 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 88 continuum side panel) ---"
