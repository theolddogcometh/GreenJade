...
#   continuum high-water via product-summary (Wave 23: toward M=16500;
#     greppable 16400 only when scan says so — not a hard gate; ≠ bar3/Top50;
...
# (Wave 23: continuum high-water side panel notes toward M=16500; greppable
#  16400 only when scan ≥16400 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 23 continuum side panel) ---"
