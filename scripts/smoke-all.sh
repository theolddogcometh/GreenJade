...
#   continuum high-water via product-summary (Wave 43: toward M=18500;
#     greppable 18500 only when scan says so — not a hard gate; ≠ bar3/Top50;
#     soft deepen retmachicolation/retarrowslit CREATE-ONLY only; soft ≠ product complete;
...
# (Wave 43: continuum high-water side panel notes toward M=18500; greppable
#  18500 only when scan ≥18500 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 43 continuum side panel) ---"
