...
#   continuum high-water via product-summary (Wave 91: toward M=23300;
#     greppable 23300 when scan ≥23300, prior tip 23200 when ≥23200 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retbadgeangle/retphaseangle CREATE-ONLY only;
...
# (Wave 91: continuum high-water side panel notes toward M=23300; greppable
#  23300 when scan ≥23300, prior tip 23200 when ≥23200 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 91 continuum side panel) ---"
