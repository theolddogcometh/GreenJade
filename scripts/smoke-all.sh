...
#   continuum high-water via product-summary (Wave 67: toward M=20900;
#     greppable 20900 when scan ≥20900, prior tip 20800 when ≥20800 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retcaponierangle/retredanangle CREATE-ONLY only;
...
# (Wave 67: continuum high-water side panel notes toward M=20900; greppable
#  20900 when scan ≥20900, prior tip 20800 when ≥20800 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 67 continuum side panel) ---"
