...
#   continuum high-water via product-summary (Wave 108: toward M=25000;
#     greppable 24800 when scan ≥24800, prior tip 24700 when ≥24700 — not a hard gate;
#     ≠ bar3/Top50; soft deepen rethurmitangle/retcatmullangle CREATE-ONLY only;
...
# (Wave 108: continuum high-water side panel notes toward M=25000; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 108 continuum side panel) ---"
