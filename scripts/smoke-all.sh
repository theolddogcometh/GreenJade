...
#   continuum high-water via product-summary (Wave 55: toward M=19700;
#     greppable 19700 when scan ≥19700, prior tip 19600 when ≥19600 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retflank/retface CREATE-ONLY only;
...
# (Wave 55: continuum high-water side panel notes toward M=19700; greppable
#  19700 when scan ≥19700, prior tip 19600 when ≥19600 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 55 continuum side panel) ---"
