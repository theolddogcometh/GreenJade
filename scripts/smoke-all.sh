...
#   continuum high-water via product-summary (Wave 106: toward M=24800;
#     greppable 24800 when scan ≥24800, prior tip 24700 when ≥24700 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retquarticangle/retquinticangle CREATE-ONLY only;
...
# (Wave 106: continuum high-water side panel notes toward M=24800; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 106 continuum side panel) ---"
