...
#   continuum high-water via product-summary (Wave 109: toward M=25100;
#     greppable 24800 when scan ≥24800, prior tip 24700 when ≥24700 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retnurbsangle/retbsplineangle CREATE-ONLY only;
...
# (Wave 109: continuum high-water side panel notes toward M=25100; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 109 continuum side panel) ---"
