...
#   continuum high-water via product-summary (Wave 33: toward M=17500;
#     greppable 17400 only when scan says so — not a hard gate; ≠ bar3/Top50;
...
# (Wave 33: continuum high-water side panel notes toward M=17500; greppable
#  17400 only when scan ≥17400 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 33 continuum side panel) ---"
