...
#   continuum high-water via product-summary (Wave 44: toward M=18600;
#     greppable 18500 only when scan says so — not a hard gate; ≠ bar3/Top50;
#     soft deepen retmerlon/retembrasure CREATE-ONLY only; soft ≠ product complete;
...
# (Wave 44: continuum high-water side panel notes toward M=18600; greppable
#  18500 only when scan ≥18600 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 44 continuum side panel) ---"
