...
#     greppable 24600 when scan ≥24600, prior tip 24600 when ≥24500 — not a hard gate;
...
#  24300 when scan ≥24600, prior tip 24600 when ≥24500 — hard gates stay hard; soft graph ≠ product bar)
