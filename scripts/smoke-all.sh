...
#   continuum high-water via product-summary (Wave 28: toward M=17000;
#     greppable 16900 only when scan says so — not a hard gate; ≠ bar3/Top50;
...
# (Wave 28: continuum high-water side panel notes toward M=17000; greppable
#  16900 only when scan ≥16900 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 28 continuum side panel) ---"
