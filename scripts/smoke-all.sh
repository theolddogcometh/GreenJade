...
#   continuum high-water via product-summary (Wave 22: toward M=16400;
#     greppable 16300 only when scan says so — not a hard gate; ≠ bar3/Top50;
...
# (Wave 22: continuum high-water side panel notes toward M=16400; greppable
#  16300 only when scan ≥16300 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 22 continuum side panel) ---"
