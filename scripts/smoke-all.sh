...
#   continuum high-water via product-summary (Wave 24: toward M=16600;
...
# (Wave 24: continuum high-water side panel notes toward M=16600; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 24 continuum side panel) ---"
