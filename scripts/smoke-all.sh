...
#   continuum high-water via product-summary (Wave 86: toward M=22800;
#     greppable 22800 when scan ≥22800, prior tip 22700 when ≥22700 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retforgeangle/retprismangle CREATE-ONLY only;
...
# (Wave 86: continuum high-water side panel notes toward M=22800; greppable
#  22800 when scan ≥22800, prior tip 22700 when ≥22700 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 86 continuum side panel) ---"
