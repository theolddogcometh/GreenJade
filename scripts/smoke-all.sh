...
#   continuum high-water via product-summary (Wave 107: toward M=24900;
#     greppable 24800 when scan ≥24800, prior tip 24700 when ≥24700 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retsplineangle/retbezierangle CREATE-ONLY only;
...
# (Wave 107: continuum high-water side panel notes toward M=24900; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 107 continuum side panel) ---"
