...
#   continuum high-water via product-summary (Wave 110: toward M=25200;
#     greppable 24800 when scan ≥24800, prior tip 24700 when ≥24700 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retmeshangle/retgridangle CREATE-ONLY only;
...
# (Wave 110: continuum high-water side panel notes toward M=25200; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 110 continuum side panel) ---"
