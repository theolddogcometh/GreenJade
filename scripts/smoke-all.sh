...
#   continuum high-water via product-summary (Wave 75: toward M=21700;
#     greppable 21700 when scan ≥21700, prior tip 21600 when ≥21600 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retmoatangle/retowerangle CREATE-ONLY only;
...
# (Wave 75: continuum high-water side panel notes toward M=21700; greppable
#  21700 when scan ≥21700, prior tip 21600 when ≥21600 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 75 continuum side panel) ---"
