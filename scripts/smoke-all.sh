...
#   continuum high-water via product-summary (Wave 20: toward M=16200;
#     greppable 16000 only when scan says so — not a hard gate; ≠ bar3/Top50;
...
# (Wave 20: continuum high-water side panel notes toward M=16200; greppable
#  15900 only when scan ≥15900 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 20 continuum side panel) ---"
