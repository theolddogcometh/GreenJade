...
#   continuum high-water via product-summary (Wave 58: toward M=20000;
#     greppable 20000 when scan ≥20000, prior tip 19900 when ≥19900 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retorillon/retbonnette CREATE-ONLY only;
...
# (Wave 58: continuum high-water side panel notes toward M=20000; greppable
#  20000 when scan ≥20000, prior tip 19900 when ≥19900 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 58 continuum side panel) ---"
