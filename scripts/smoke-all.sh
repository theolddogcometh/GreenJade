...
#   continuum high-water via product-summary (Wave 68: toward M=21000;
#     greppable 21000 when scan ≥21000, prior tip 20900 when ≥20900 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retlunetteangle/rettenailleangle CREATE-ONLY only;
...
# (Wave 68: continuum high-water side panel notes toward M=21000; greppable
#  21000 when scan ≥21000, prior tip 20900 when ≥20900 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 68 continuum side panel) ---"
