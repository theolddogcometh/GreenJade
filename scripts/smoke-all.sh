...
#   continuum high-water via product-summary (Wave 18: toward M=16000;
...
# (Wave 18: continuum high-water side panel notes toward M=16000; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 18 continuum side panel) ---"
