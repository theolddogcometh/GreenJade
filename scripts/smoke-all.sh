...
#   continuum high-water via product-summary (Wave 31: toward M=17300;
#     greppable 17200 only when scan says so — not a hard gate; ≠ bar3/Top50;
...
# (Wave 31: continuum high-water side panel notes toward M=17300; greppable
#  17200 only when scan ≥17200 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 31 continuum side panel) ---"
