...
#   continuum high-water via product-summary (Wave 87: toward M=22900;
#     greppable 22900 when scan ≥22900, prior tip 22800 when ≥22800 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retflameangle/retcipherangle CREATE-ONLY only;
...
# (Wave 87: continuum high-water side panel notes toward M=22900; greppable
#  22900 when scan ≥22900, prior tip 22800 when ≥22800 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 87 continuum side panel) ---"
