...
#   continuum high-water via product-summary (Wave 41: toward M=18300;
#     greppable 18300 only when scan says so — not a hard gate; ≠ bar3/Top50;
#     soft deepen retravelin/retditch CREATE-ONLY only; soft ≠ product complete;
...
# (Wave 41: continuum high-water side panel notes toward M=18300; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 41 continuum side panel) ---"
