...
#   continuum high-water via product-summary (Wave 19: toward M=16100;
...
# (Wave 19: continuum high-water side panel notes toward M=16100; greppable
...
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 19 continuum side panel) ---"
