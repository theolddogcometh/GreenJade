...
#   continuum high-water via product-summary (Wave 21: toward M=16300;
#     greppable 16200 only when scan says so — not a hard gate; ≠ bar3/Top50;
...
# (Wave 21: continuum high-water side panel notes toward M=16300; greppable
#  16200 only when scan ≥16200 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 21 continuum side panel) ---"
