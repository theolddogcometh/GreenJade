...
#   continuum high-water via product-summary (Wave 96: toward M=23800;
#     greppable 23800 when scan ≥23800, prior tip 23700 when ≥23700 — not a hard gate;
#     ≠ bar3/Top50; soft deepen retsectorangle/retwedgeangle CREATE-ONLY only;
...
# (Wave 96: continuum high-water side panel notes toward M=23800; greppable
#  23700 when scan ≥23800, prior tip 23700 when ≥23700 — hard gates stay hard; soft graph ≠ product bar)
if [ -x scripts/gj-product-summary.sh ] || [ -f scripts/gj-product-summary.sh ]; then
    echo "  --- gj-product-summary (soft; wave 96 continuum side panel) ---"
