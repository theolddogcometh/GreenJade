...
#
# Wave 51 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19300 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retfosse / retcoveredway (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19200 until parent wires 19300.
#   Do not hardcode false makefile_max=19300. Product lamps remain 0.
...
echo "  note:   Wave 51 soft  continuum toward M=19300 ≠ bar3; makefile_max=scan truth (may be 19200); retfosse/retcoveredway soft only"
