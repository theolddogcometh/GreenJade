...
#
# Wave 71 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21300 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retsallyportangle / retreentrantangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21200 until parent wires 21300.
#   Do not hardcode false makefile_max=21300. Product lamps remain 0.
...
echo "  note:   Wave 71 soft  continuum toward M=21300 ≠ bar3; makefile_max=scan truth (may be 21200); retsallyportangle/retreentrantangle soft only"
