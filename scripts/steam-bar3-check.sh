...
#
# Wave 23 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=16500 (CREATE-ONLY soft graph).
#   Honest makefile_max is a Makefile scan — may still report 16400 until parent wires.
#   Do not hardcode false makefile_max=16500. Product lamps remain 0.
...
echo "  note:   Wave 23 soft  continuum toward M=16500 ≠ bar3; makefile_max=scan truth (may be 16400)"
