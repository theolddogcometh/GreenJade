...
#
# Wave 69 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21100 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retdemiluneangle / retcoveredwayangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21000 until parent wires 21100.
#   Do not hardcode false makefile_max=21100. Product lamps remain 0.
...
echo "  note:   Wave 69 soft  continuum toward M=21100 ≠ bar3; makefile_max=scan truth (may be 21000); retdemiluneangle/retcoveredwayangle soft only"
