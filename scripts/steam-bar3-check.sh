...
#
# Wave 109 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=25100 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retnurbsangle / retbsplineangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 25000 until parent wires 25000.
#   Do not hardcode false makefile_max=25100 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 109 soft  continuum toward M=25100 ≠ bar3; makefile_max=scan truth; retnurbsangle/retbsplineangle soft only"
