...
#
# Wave 106 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=24800 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retquarticangle / retquinticangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 24700 until parent wires 24800.
#   Do not hardcode false makefile_max=24800 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 106 soft  continuum toward M=24800 ≠ bar3; makefile_max=scan truth; retquarticangle/retquinticangle soft only"
