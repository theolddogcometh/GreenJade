...
#
# Wave 44 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=18600 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retmerlon / retembrasure (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18400 until parent wires 18600.
#   Do not hardcode false makefile_max=18600. Product lamps remain 0.
...
echo "  note:   Wave 44 soft  continuum toward M=18600 ≠ bar3; makefile_max=scan truth (may be 18500); retmerlon/retembrasure soft only"
