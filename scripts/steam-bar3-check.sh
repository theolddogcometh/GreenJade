...
#
# Wave 46 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=18800 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retbailey / retpostern (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18700 until parent wires 18800.
#   Do not hardcode false makefile_max=18800. Product lamps remain 0.
...
echo "  note:   Wave 46 soft  continuum toward M=18800 ≠ bar3; makefile_max=scan truth (may be 18700); retbailey/retpostern soft only"
