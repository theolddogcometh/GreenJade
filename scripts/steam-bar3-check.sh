...
#
# Wave 18 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=16000 (CREATE-ONLY soft graph).
#   Honest makefile_max is a Makefile scan — may still report 15900 until parent wires.
#   Do not hardcode false makefile_max=16000. Product lamps remain 0.
...
echo "  note:   Wave 18 soft  continuum toward M=16000 ≠ bar3; makefile_max=scan truth (may be 15800)"
