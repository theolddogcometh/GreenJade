...
#
# Wave 58 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=20000 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retorillon / retbonnette (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19900 until parent wires 20000.
#   Do not hardcode false makefile_max=20000. Product lamps remain 0.
...
echo "  note:   Wave 58 soft  continuum toward M=20000 ≠ bar3; makefile_max=scan truth (may be 19900); retorillon/retbonnette soft only"
