...
#
# Wave 55 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19700 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retflank / retface (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19600 until parent wires 19700.
#   Do not hardcode false makefile_max=19700. Product lamps remain 0.
...
echo "  note:   Wave 55 soft  continuum toward M=19700 ≠ bar3; makefile_max=scan truth (may be 19600); retflank/retface soft only"
