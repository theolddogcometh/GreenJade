...
#
# Wave 37 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=17900 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retwall / retgate (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 17800 until parent wires.
#   Do not hardcode false makefile_max=17900. Product lamps remain 0.
...
echo "  note:   Wave 37 soft  continuum toward M=17900 ≠ bar3; makefile_max=scan truth (may be 17800); retwall/retgate soft only"
