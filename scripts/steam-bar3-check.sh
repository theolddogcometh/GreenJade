...
#
# Wave 53 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19500 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retravelin / retlunette (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19400 until parent wires 19500.
#   Do not hardcode false makefile_max=19500. Product lamps remain 0.
...
echo "  note:   Wave 53 soft  continuum toward M=19500 ≠ bar3; makefile_max=scan truth (may be 19400); retravelin/retlunette soft only"
