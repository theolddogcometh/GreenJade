...
#
# Wave 56 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19800 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retgorge / retshoulder (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19700 until parent wires 19800.
#   Do not hardcode false makefile_max=19800. Product lamps remain 0.
...
echo "  note:   Wave 56 soft  continuum toward M=19800 ≠ bar3; makefile_max=scan truth (may be 19700); retgorge/retshoulder soft only"
