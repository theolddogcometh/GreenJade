...
#
# Wave 72 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21400 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retplaceofarmsangle / retdoubletenailleangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21300 until parent wires 21400.
#   Do not hardcode false makefile_max=21400. Product lamps remain 0.
...
echo "  note:   Wave 72 soft  continuum toward M=21400 ≠ bar3; makefile_max=scan truth (may be 21300); retplaceofarmsangle/retdoubletenailleangle soft only"
