...
#
# Wave 77 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21900 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retspireangle / retholdangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21800 until parent wires 21900.
#   Do not hardcode false makefile_max=21900. Product lamps remain 0.
...
echo "  note:   Wave 77 soft  continuum toward M=21900 ≠ bar3; makefile_max=scan truth (may be 21800); retspireangle/retholdangle soft only"
