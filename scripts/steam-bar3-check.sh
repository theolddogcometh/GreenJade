...
#
# Wave 103 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=24500 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retprojectangle / retaffineangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 24400 until parent wires 24500.
#   Do not hardcode false makefile_max=24500. Product lamps remain 0.
...
echo "  note:   Wave 103 soft  continuum toward M=24500 ≠ bar3; makefile_max=scan truth (24400); retprojectangle/retaffineangle soft only"
