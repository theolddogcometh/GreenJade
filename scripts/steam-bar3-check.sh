...
#
# Wave 89 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=23100 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retbannerangle / retvaultangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 23000 until parent wires 23100.
#   Do not hardcode false makefile_max=23100. Product lamps remain 0.
...
echo "  note:   Wave 89 soft  continuum toward M=23100 ≠ bar3; makefile_max=scan truth (may be 23000); retbannerangle/retvaultangle soft only"
