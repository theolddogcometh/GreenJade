...
#
# Wave 33 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=17500 (CREATE-ONLY soft graph).
#   Honest makefile_max is a Makefile scan — may still report 17400 until parent wires.
#   Do not hardcode false makefile_max=17500. Product lamps remain 0.
...
echo "  note:   Wave 33 soft  continuum toward M=17500 ≠ bar3; makefile_max=scan truth (may be 17400)"
