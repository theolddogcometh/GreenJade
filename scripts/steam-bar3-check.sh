...
#
# Wave 22 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=16400 (CREATE-ONLY soft graph).
#   Honest makefile_max is a Makefile scan — may still report 16300 until parent wires.
#   Do not hardcode false makefile_max=16400. Product lamps remain 0.
...
echo "  note:   Wave 22 soft  continuum toward M=16400 ≠ bar3; makefile_max=scan truth (may be 16300)"
