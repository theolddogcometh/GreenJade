...
#
# Wave 43 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=18500 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retmachicolation / retarrowslit (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18400 until parent wires 18500.
#   Do not hardcode false makefile_max=18500. Product lamps remain 0.
...
echo "  note:   Wave 43 soft  continuum toward M=18500 ≠ bar3; makefile_max=scan truth (may be 18400); retmachicolation/retarrowslit soft only"
