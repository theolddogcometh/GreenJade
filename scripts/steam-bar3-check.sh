...
#
# Wave 90 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=23200 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retcrestangle / rettokenangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 23100 until parent wires 23200.
#   Do not hardcode false makefile_max=23200. Product lamps remain 0.
...
echo "  note:   Wave 90 soft  continuum toward M=23200 ≠ bar3; makefile_max=scan truth (23100); retcrestangle/rettokenangle soft only"
