...
#
# Wave 41 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=18300 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retravelin / retditch (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18200 until parent wires 18300.
#   Do not hardcode false makefile_max=18300. Product lamps remain 0.
...
echo "  note:   Wave 41 soft  continuum toward M=18300 ≠ bar3; makefile_max=scan truth (may be 18200); retravelin/retditch soft only"
