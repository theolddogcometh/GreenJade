...
#
# Wave 97 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=23900 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retradiusangle / retdiameterangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 23800 until parent wires 23900.
#   Do not hardcode false makefile_max=23900. Product lamps remain 0.
...
echo "  note:   Wave 97 soft  continuum toward M=23900 ≠ bar3; makefile_max=scan truth (23700); retradiusangle/retdiameterangle soft only"
