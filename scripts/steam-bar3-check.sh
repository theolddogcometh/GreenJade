...
#
# Wave 50 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19200 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retsally / retcounterscarp (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19100 until parent wires 19200.
#   Do not hardcode false makefile_max=19200. Product lamps remain 0.
...
echo "  note:   Wave 50 soft  continuum toward M=19200 ≠ bar3; makefile_max=scan truth (may be 19100); retsally/retcounterscarp soft only"
