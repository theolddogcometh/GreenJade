...
#
# Wave 88 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=23000 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retbeaconangle / retledgerangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 22900 until parent wires 23000.
#   Do not hardcode false makefile_max=23000. Product lamps remain 0.
...
echo "  note:   Wave 88 soft  continuum toward M=23000 ≠ bar3; makefile_max=scan truth (may be 22900); retbeaconangle/retledgerangle soft only"
