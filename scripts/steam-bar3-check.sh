...
#
# Wave 45 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=18700 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retkeepgate / retouterward (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18600 until parent wires 18700.
#   Do not hardcode false makefile_max=18700. Product lamps remain 0.
...
echo "  note:   Wave 45 soft  continuum toward M=18700 ≠ bar3; makefile_max=scan truth (may be 18600); retkeepgate/retouterward soft only"
