...
#
# Wave 47 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=18900 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retinnerward / retdonjon (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18800 until parent wires 18900.
#   Do not hardcode false makefile_max=18900. Product lamps remain 0.
...
echo "  note:   Wave 47 soft  continuum toward M=18900 ≠ bar3; makefile_max=scan truth (may be 18800); retinnerward/retdonjon soft only"
