...
#
# Wave 17 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=15900 (CREATE-ONLY soft graph).
#   Honest makefile_max is a Makefile scan — may still report 15800 until parent wires.
#   Do not hardcode false makefile_max=15900. Product lamps remain 0.
...
echo "  note:   Wave 17 soft  continuum toward M=15900 ≠ bar3; makefile_max=scan truth (may be 15800)"
