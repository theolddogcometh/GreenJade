...
#
# Wave 57 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19900 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retraverse / retcasemate (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19800 until parent wires 19900.
#   Do not hardcode false makefile_max=19900. Product lamps remain 0.
...
echo "  note:   Wave 57 soft  continuum toward M=19900 ≠ bar3; makefile_max=scan truth (may be 19800); retraverse/retcasemate soft only"
