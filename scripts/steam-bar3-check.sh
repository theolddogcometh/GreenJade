...
#
# Wave 32 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=17400 (CREATE-ONLY soft graph).
#   Honest makefile_max is a Makefile scan — may still report 17300 until parent wires.
#   Do not hardcode false makefile_max=17400. Product lamps remain 0.
...
echo "  note:   Wave 32 soft  continuum toward M=17400 ≠ bar3; makefile_max=scan truth (may be 17300)"
