...
#
# Wave 126 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=26800 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retgradientangle / retblendangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 26600 until parent wires 26700.
#   Do not hardcode false makefile_max=26800 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 126 soft  continuum toward M=26800 ≠ bar3; makefile_max=scan truth; retgradientangle/retblendangle soft only"
