...
#
# Wave 79 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=22100 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retkeepangle / retredoubtangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 22000 until parent wires 22100.
#   Do not hardcode false makefile_max=22100. Product lamps remain 0.
...
echo "  note:   Wave 79 soft  continuum toward M=22100 ≠ bar3; makefile_max=scan truth (may be 22000); retkeepangle/retredoubtangle soft only"
