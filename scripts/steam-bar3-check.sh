...
#
# Wave 76 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21800 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retgateangle / retwallangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21700 until parent wires 21800.
#   Do not hardcode false makefile_max=21800. Product lamps remain 0.
...
echo "  note:   Wave 76 soft  continuum toward M=21800 ≠ bar3; makefile_max=scan truth (may be 21700); retgateangle/retwallangle soft only"
