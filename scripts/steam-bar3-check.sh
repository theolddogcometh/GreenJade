...
#
# Wave 80 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=22200 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retcitadelangle / retbastionkeep (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 22100 until parent wires 22200.
#   Do not hardcode false makefile_max=22200. Product lamps remain 0.
...
echo "  note:   Wave 80 soft  continuum toward M=22200 ≠ bar3; makefile_max=scan truth (may be 22100); retcitadelangle/retbastionkeep soft only"
