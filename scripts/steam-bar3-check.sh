...
#
# Wave 91 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=23300 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retbadgeangle / retphaseangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 23200 until parent wires 23300.
#   Do not hardcode false makefile_max=23300. Product lamps remain 0.
...
echo "  note:   Wave 91 soft  continuum toward M=23300 ≠ bar3; makefile_max=scan truth (23200); retbadgeangle/retphaseangle soft only"
