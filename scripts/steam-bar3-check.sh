...
#
# Wave 113 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=25500 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retshaderangle / retpipelineangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 25400 until parent wires 25500.
#   Do not hardcode false makefile_max=25500 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 113 soft  continuum toward M=25500 ≠ bar3; makefile_max=scan truth; retshaderangle/retpipelineangle soft only"
