...
#
# Wave 40 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=18200 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retcurtain / retparapet (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18100 until parent wires.
#   Do not hardcode false makefile_max=18200. Product lamps remain 0.
...
echo "  note:   Wave 40 soft  continuum toward M=18200 ≠ bar3; makefile_max=scan truth (may be 18100); retcurtain/retparapet soft only"
