...
#
# Wave 64 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=20600 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retreentrant / retsallyport (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 20500 until parent wires 20600.
#   Do not hardcode false makefile_max=20600. Product lamps remain 0.
...
echo "  note:   Wave 64 soft  continuum toward M=20600 ≠ bar3; makefile_max=scan truth (may be 20500); retreentrant/retsallyport soft only"
