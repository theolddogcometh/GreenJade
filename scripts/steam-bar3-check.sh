...
#
# Wave 92 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=23400 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retmarkangle / retpulseangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 23300 until parent wires 23400.
#   Do not hardcode false makefile_max=23400. Product lamps remain 0.
...
echo "  note:   Wave 92 soft  continuum toward M=23400 ≠ bar3; makefile_max=scan truth (23300); retmarkangle/retpulseangle soft only"
