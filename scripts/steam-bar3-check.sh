...
#
# Wave 73 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21500 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retcurtainface / retbastionangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21400 until parent wires 21500.
#   Do not hardcode false makefile_max=21500. Product lamps remain 0.
...
echo "  note:   Wave 73 soft  continuum toward M=21500 ≠ bar3; makefile_max=scan truth (may be 21400); retcurtainface/retbastionangle soft only"
