...
#
# Wave 21 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=16300 (CREATE-ONLY soft graph).
#   Honest makefile_max is a Makefile scan — may still report 16200 until parent wires.
#   Do not hardcode false makefile_max=16300. Product lamps remain 0.
...
echo "  note:   Wave 21 soft  continuum toward M=16300 ≠ bar3; makefile_max=scan truth (may be 16200)"
