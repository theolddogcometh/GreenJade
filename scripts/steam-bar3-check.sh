...
#
# Wave 108 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=25000 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: rethurmitangle / retcatmullangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 24800 until parent wires 24900.
#   Do not hardcode false makefile_max=25000 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 108 soft  continuum toward M=25000 ≠ bar3; makefile_max=scan truth; rethurmitangle/retcatmullangle soft only"
