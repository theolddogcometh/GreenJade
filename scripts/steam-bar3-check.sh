...
#
# Wave 118 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=26000 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retbarrierangle / retatomicangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 25900 until parent wires 26000.
#   Do not hardcode false makefile_max=26000 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 118 soft  continuum toward M=26000 ≠ bar3; makefile_max=scan truth; retbarrierangle/retatomicangle soft only"
