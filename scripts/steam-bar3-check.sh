...
#
# Wave 110 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=25200 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retmeshangle / retgridangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 25100 until parent wires 25100.
#   Do not hardcode false makefile_max=25200 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 110 soft  continuum toward M=25200 ≠ bar3; makefile_max=scan truth; retmeshangle/retgridangle soft only"
