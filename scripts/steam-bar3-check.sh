...
#
# Wave 75 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21700 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retmoatangle / retowerangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21600 until parent wires 21700.
#   Do not hardcode false makefile_max=21700. Product lamps remain 0.
...
echo "  note:   Wave 75 soft  continuum toward M=21700 ≠ bar3; makefile_max=scan truth (may be 21600); retmoatangle/retowerangle soft only"
