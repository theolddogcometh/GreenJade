...
#
# Wave 48 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19000 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retchevaux / retpalisade (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18900 until parent wires 19000.
#   Do not hardcode false makefile_max=19000. Product lamps remain 0.
...
echo "  note:   Wave 48 soft  continuum toward M=19000 ≠ bar3; makefile_max=scan truth (may be 18900); retchevaux/retpalisade soft only"
