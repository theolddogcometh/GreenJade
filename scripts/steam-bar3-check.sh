...
#
# Wave 122 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=26400 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retframeangle / retwindowangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 26300 until parent wires 26400.
#   Do not hardcode false makefile_max=26400 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 122 soft  continuum toward M=26400 ≠ bar3; makefile_max=scan truth; retframeangle/retwindowangle soft only"
