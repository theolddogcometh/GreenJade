...
#
# Wave 66 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=20800 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retflankangle / retfaceangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 20700 until parent wires 20800.
#   Do not hardcode false makefile_max=20800. Product lamps remain 0.
...
echo "  note:   Wave 66 soft  continuum toward M=20800 ≠ bar3; makefile_max=scan truth (may be 20700); retflankangle/retfaceangle soft only"
