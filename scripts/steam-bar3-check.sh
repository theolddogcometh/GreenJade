...
#
# Wave 70 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21200 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retfosseangle / retcounterscarple (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21100 until parent wires 21200.
#   Do not hardcode false makefile_max=21200. Product lamps remain 0.
...
echo "  note:   Wave 70 soft  continuum toward M=21200 ≠ bar3; makefile_max=scan truth (may be 21100); retfosseangle/retcounterscarple soft only"
