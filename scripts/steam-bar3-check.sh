...
#
# Wave 54 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19600 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retcaponier / retredan (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19500 until parent wires 19600.
#   Do not hardcode false makefile_max=19600. Product lamps remain 0.
...
echo "  note:   Wave 54 soft  continuum toward M=19600 ≠ bar3; makefile_max=scan truth (may be 19500); retcaponier/retredan soft only"
