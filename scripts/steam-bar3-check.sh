...
#
# Wave 61 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=20300 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retcounterguard / retcoveredface (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 20200 until parent wires 20300.
#   Do not hardcode false makefile_max=20300. Product lamps remain 0.
...
echo "  note:   Wave 61 soft  continuum toward M=20300 ≠ bar3; makefile_max=scan truth (may be 20200); retcounterguard/retcoveredface soft only"
