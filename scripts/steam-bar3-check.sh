...
#
# Wave 36 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=17800 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: rethold / retspire (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 17700 until parent wires.
#   Do not hardcode false makefile_max=17800. Product lamps remain 0.
...
echo "  note:   Wave 36 soft  continuum toward M=17800 ≠ bar3; makefile_max=scan truth (may be 17700); rethold/retspire soft only"
