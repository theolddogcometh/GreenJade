...
#
# Wave 107 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=24900 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retsplineangle / retbezierangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 24800 until parent wires 24900.
#   Do not hardcode false makefile_max=24900 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 107 soft  continuum toward M=24900 ≠ bar3; makefile_max=scan truth; retsplineangle/retbezierangle soft only"
