...
#
# Wave 52 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19400 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: rettenaille / retdemilune (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19300 until parent wires 19400.
#   Do not hardcode false makefile_max=19400. Product lamps remain 0.
...
echo "  note:   Wave 52 soft  continuum toward M=19400 ≠ bar3; makefile_max=scan truth (may be 19300); rettenaille/retdemilune soft only"
