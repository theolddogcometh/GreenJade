...
#
# Wave 42 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=18400 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retportcullis / retbattlement (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 18300 until parent wires 18400.
#   Do not hardcode false makefile_max=18400. Product lamps remain 0.
...
echo "  note:   Wave 42 soft  continuum toward M=18400 ≠ bar3; makefile_max=scan truth (may be 18300); retportcullis/retbattlement soft only"
