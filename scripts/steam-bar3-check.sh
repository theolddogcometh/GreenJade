...
#
# Wave 68 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21000 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retlunetteangle / rettenailleangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 20900 until parent wires 21000.
#   Do not hardcode false makefile_max=21000. Product lamps remain 0.
...
echo "  note:   Wave 68 soft  continuum toward M=21000 ≠ bar3; makefile_max=scan truth (may be 20900); retlunetteangle/rettenailleangle soft only"
