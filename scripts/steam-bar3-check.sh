...
#
# Wave 84 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=22600 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retscepterangle / retglyphangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 22500 until parent wires 22600.
#   Do not hardcode false makefile_max=22600. Product lamps remain 0.
...
echo "  note:   Wave 84 soft  continuum toward M=22600 ≠ bar3; makefile_max=scan truth (may be 22500); retscepterangle/retglyphangle soft only"
