...
#
# Wave 112 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=25400 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retfragmentangle / retvertexangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 25300 until parent wires 25400.
#   Do not hardcode false makefile_max=25400 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 112 soft  continuum toward M=25400 ≠ bar3; makefile_max=scan truth; retfragmentangle/retvertexangle soft only"
