...
#
# Wave 67 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=20900 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retcaponierangle / retredanangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 20800 until parent wires 20900.
#   Do not hardcode false makefile_max=20900. Product lamps remain 0.
...
echo "  note:   Wave 67 soft  continuum toward M=20900 ≠ bar3; makefile_max=scan truth (may be 20800); retcaponierangle/retredanangle soft only"
