...
#
# Wave 111 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=25300 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retvoxelangle / rettexelangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 25200 until parent wires 25300.
#   Do not hardcode false makefile_max=25300 if scan still prior tip. Product lamps remain 0.
...
echo "  note:   Wave 111 soft  continuum toward M=25300 ≠ bar3; makefile_max=scan truth; retvoxelangle/rettexelangle soft only"
