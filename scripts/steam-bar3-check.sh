...
#
# Wave 78 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=22000 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retpalaceangle / retfortressangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21900 until parent wires 22000.
#   Do not hardcode false makefile_max=22000. Product lamps remain 0.
...
echo "  note:   Wave 78 soft  continuum toward M=22000 ≠ bar3; makefile_max=scan truth (may be 21900); retpalaceangle/retfortressangle soft only"
