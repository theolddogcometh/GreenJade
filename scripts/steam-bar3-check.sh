...
#
# Wave 74 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=21600 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retglacisangle / retparapetangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 21500 until parent wires 21600.
#   Do not hardcode false makefile_max=21600. Product lamps remain 0.
...
echo "  note:   Wave 74 soft  continuum toward M=21600 ≠ bar3; makefile_max=scan truth (may be 21500); retglacisangle/retparapetangle soft only"
