...
#
# Wave 49 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=19100 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retglacisgate / retoutwork (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 19000 until parent wires 19100.
#   Do not hardcode false makefile_max=19100. Product lamps remain 0.
...
echo "  note:   Wave 49 soft  continuum toward M=19100 ≠ bar3; makefile_max=scan truth (may be 19000); retglacisgate/retoutwork soft only"
