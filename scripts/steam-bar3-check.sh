...
#
# Wave 65 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=20700 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retgorgeangle / retshoulderangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 20600 until parent wires 20700.
#   Do not hardcode false makefile_max=20700. Product lamps remain 0.
...
echo "  note:   Wave 65 soft  continuum toward M=20700 ≠ bar3; makefile_max=scan truth (may be 20600); retgorgeangle/retshoulderangle soft only"
