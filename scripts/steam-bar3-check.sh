...
#
# Wave 83 soft note (exclusive scripts high-water era):
#   Continuum soft high-water advancing toward M=22500 (CREATE-ONLY soft graph).
#   Soft deepen surfaces: retemblemangle / retsigilangle (CREATE-ONLY soft names only).
#   Honest makefile_max is a Makefile scan — may still report 22400 until parent wires 22500.
#   Do not hardcode false makefile_max=22500. Product lamps remain 0.
...
echo "  note:   Wave 83 soft  continuum toward M=22500 ≠ bar3; makefile_max=scan truth (may be 22400); retemblemangle/retsigilangle soft only"
