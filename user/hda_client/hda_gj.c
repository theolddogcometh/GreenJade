 ...
 *
 * Soft inventory (Wave 42 exclusive deepen):
 ...
 *   hda_client: soft deepen wave=42 areas=… ok=… skip=… played=…
...
/*
 * Wave stamp + inventory area count (Wave 42 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 42 greppable steps line). */
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 42: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 42: peak q/p/u across soft STATS. */
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 42 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 42 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 42 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 42 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 42 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 42 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 42 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 42 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 42; never bar3) */
    msg("hda_client: soft honesty not-bar3 not-pipewire not-product-audio "
        "soft-inventory-only multi_server=0 confine=0 bar3=0 product_kernel=OPEN wave=42\n");
...
soft_suite(void)
{
    ...
    /* Wave 42 exclusive soft door deepen. */
    ...
    /* Wave 42 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
