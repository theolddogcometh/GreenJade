 ...
 *
 * Soft inventory (Wave 74 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 74 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 74 greppable steps line). */
...
/*
 * Soft product inventory (Wave 74 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 74: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 74: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 74 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 74 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 74 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 74 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 74 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 74 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 74 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 74 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 74 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 74; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 74 exclusive soft door deepen. */
    ...
    /* Wave 74 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
