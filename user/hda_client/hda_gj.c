 ...
 *
 * Soft inventory (Wave 116 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 116 exclusive deepen).
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 111: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 111: peak q/p/u across soft STATS. */
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 111 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 111 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 111 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 111 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 111 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 111 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 111 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 111 stamp) */
    o = 0;
...
soft_suite(void)
{
    ...
    /* Wave 116 exclusive soft door deepen. */
    ...
    /* Wave 116 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
