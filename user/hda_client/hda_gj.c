 ...
 *
 * Soft inventory (Wave 84 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 84 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 84 greppable steps line). */
...
/*
 * Soft product inventory (Wave 84 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 84: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 84: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 84 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 84 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 84 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 84 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 84 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 84 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 84 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 84 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 84 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 84; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 84 exclusive soft door deepen. */
    ...
    /* Wave 84 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
