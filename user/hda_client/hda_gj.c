 ...
 *
 * Soft inventory (Wave 45 exclusive deepen):
 ...
 *   hda_client: soft deepen wave=45 areas=… ok=… skip=… played=…
...
/*
 * Wave stamp + inventory area count (Wave 45 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 45 greppable steps line). */
...
/*
 * Soft product inventory (Wave 45 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 45: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 45: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 45 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 45 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 45 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 45 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 45 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 45 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 45 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 45 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 45 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 45; never bar3) */
    msg("hda_client: soft honesty not-bar3 not-pipewire not-product-audio "
        "soft-inventory-only multi_server=0 confine=0 bar3=0 product_kernel=OPEN wave=45\n");
...
soft_suite(void)
{
    ...
    /* Wave 45 exclusive soft door deepen. */
    ...
    /* Wave 45 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
