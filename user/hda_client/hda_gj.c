 ...
 *
 * Soft inventory (Wave 48 exclusive deepen):
 ...
 *   hda_client: soft deepen wave=48 areas=… ok=… skip=… played=…
...
/*
 * Wave stamp + inventory area count (Wave 48 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 48 greppable steps line). */
...
/*
 * Soft product inventory (Wave 48 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 48: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 48: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 48 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 48 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 48 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 48 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 48 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 48 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 48 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 48 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 48 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 48; never bar3) */
    msg("hda_client: soft honesty not-bar3 not-pipewire not-product-audio "
        "soft-inventory-only multi_server=0 confine=0 bar3=0 product_kernel=OPEN wave=48\n");
...
soft_suite(void)
{
    ...
    /* Wave 48 exclusive soft door deepen. */
    ...
    /* Wave 48 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
