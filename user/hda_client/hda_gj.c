...
/*
 * Wave stamp + inventory area count (Wave 115 exclusive deepen).
...
soft_suite(void)
{
    ...
    /* Wave 115 exclusive soft door deepen. */
    ...
    /* Wave 115 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
