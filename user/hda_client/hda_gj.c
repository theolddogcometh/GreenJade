 ...
 *
 * Soft inventory (Wave 100 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 100 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 100 greppable steps line). */
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 100: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 100: peak q/p/u across soft STATS. */
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 100 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 100 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 100 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 100 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 100 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 100 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 100 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 100 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 100; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 100 exclusive soft door deepen. */
    ...
    /* Wave 100 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
