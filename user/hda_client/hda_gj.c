...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 110: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 110: peak q/p/u across soft STATS. */
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 110 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 110 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 110 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 110 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 110 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 110 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 110 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 110 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 110; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 110 exclusive soft door deepen. */
    ...
    /* Wave 110 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
