 ...
 *   hda_client: soft deepen wave=31 areas=… ok=… skip=… played=…
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 31: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 31: peak q/p/u across soft STATS. */
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 31 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 31 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 31 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 31 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 31 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 31 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 31 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 31 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 31; never bar3) */
    msg("hda_client: soft honesty not-bar3 not-pipewire not-product-audio "
        "soft-inventory-only multi_server=0 confine=0 bar3=0 product_kernel=OPEN wave=31\n");
...
soft_suite(void)
{
    ...
    /* Wave 31 exclusive soft door deepen. */
    ...
    /* Wave 31 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
