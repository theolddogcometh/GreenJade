 ...
 *
 * Soft inventory (Wave 109 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 109 exclusive deepen).
 * Areas: suite door played inventory steps miss last deepen path
 *        ops first peak format ratio honesty
 */
#define HDA_SOFT_WAVE 70u
#define HDA_SOFT_AREAS  15u

/* Soft suite sub-step bits (Wave 109 greppable steps line). */
...
/*
 * Soft product inventory (Wave 109 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 109: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 109: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 109 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 109 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 109 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 109 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 109 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 109 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 109 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 109 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 109 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 109; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 109 exclusive soft door deepen. */
    ...
    /* Wave 109 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
