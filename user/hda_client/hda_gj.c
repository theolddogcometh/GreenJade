 ...
 *
 * Soft inventory (Wave 98 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 98 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 98 greppable steps line). */
...
/*
 * Soft product inventory (Wave 98 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 98: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 98: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 98 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 98 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 98 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 98 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 98 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 98 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 98 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 98 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 98 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 98; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 98 exclusive soft door deepen. */
    ...
    /* Wave 98 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
