 ...
 *
 * Soft inventory (Wave 86 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 86 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 86 greppable steps line). */
...
/*
 * Soft product inventory (Wave 86 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 86: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 86: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 86 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 86 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 86 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 86 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 86 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 86 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 86 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 86 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 86 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 86; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 86 exclusive soft door deepen. */
    ...
    /* Wave 86 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
