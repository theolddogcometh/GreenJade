 ...
 *
 * Soft inventory (Wave 80 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 80 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 80 greppable steps line). */
...
/*
 * Soft product inventory (Wave 80 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 80: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 80: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 80 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 80 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 80 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 80 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 80 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 80 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 80 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 80 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 80 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 80; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 80 exclusive soft door deepen. */
    ...
    /* Wave 80 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
