 ...
 *
 * Soft inventory (Wave 43 exclusive deepen):
 ...
 *   hda_client: soft deepen wave=43 areas=… ok=… skip=… played=…
...
/*
 * Wave stamp + inventory area count (Wave 43 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 43 greppable steps line). */
...
/*
 * Soft product inventory (Wave 43 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 43: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 43: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 43 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 43 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 43 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 43 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 43 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 43 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 43 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 43 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 43 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 43; never bar3) */
    msg("hda_client: soft honesty not-bar3 not-pipewire not-product-audio "
        "soft-inventory-only multi_server=0 confine=0 bar3=0 product_kernel=OPEN wave=43\n");
...
soft_suite(void)
{
    ...
    /* Wave 43 exclusive soft door deepen. */
    ...
    /* Wave 43 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
