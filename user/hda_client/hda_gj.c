 ...
 *
 * Soft inventory (Wave 101 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 101 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 101 greppable steps line). */
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 101: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 101: peak q/p/u across soft STATS. */
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 101 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 101 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 101 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 101 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 101 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 101 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 101 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 101 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 101; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 101 exclusive soft door deepen. */
    ...
    /* Wave 101 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
