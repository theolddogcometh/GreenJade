 ...
 *
 * Soft inventory (Wave 29 exclusive deepen):
 ...
 *   hda_client: soft deepen wave=29 areas=… ok=… skip=… played=…
...
/*
 * Wave stamp + inventory area count (Wave 29 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 29 greppable steps line). */
...
/*
 * Soft product inventory (Wave 29 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 29: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 29: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 29 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 29 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 29 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 29 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 29 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 29 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 29 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 29 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 29 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 29; never bar3) */
    msg("hda_client: soft honesty not-bar3 not-pipewire not-product-audio "
        "soft-inventory-only multi_server=0 confine=0 bar3=0 product_kernel=OPEN wave=29\n");
...
soft_suite(void)
{
    ...
    /* Wave 29 exclusive soft door deepen. */
    ...
    /* Wave 29 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
