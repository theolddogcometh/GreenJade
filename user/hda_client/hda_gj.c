 ...
 *   hda_client: soft deepen wave=39 areas=… ok=… skip=… played=…
...
/*
 * Wave stamp + inventory area count (Wave 39 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 39 greppable steps line). */
...
/*
 * Soft product inventory (Wave 39 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 39: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 39: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 39 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 39 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 39 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 39 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 39 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 39 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 39 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 39 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 39 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 39; never bar3) */
    msg("hda_client: soft honesty not-bar3 not-pipewire not-product-audio "
        "soft-inventory-only multi_server=0 confine=0 bar3=0 product_kernel=OPEN wave=39\n");
...
soft_suite(void)
{
    ...
    /* Wave 39 exclusive soft door deepen. */
    ...
    /* Wave 39 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
