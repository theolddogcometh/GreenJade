...
/*
 * Wave stamp + inventory area count (Wave 126 exclusive deepen).
...
soft_suite(void)
{
    ...
    /* Wave 126 exclusive soft door deepen. */
    ...
    /* Wave 126 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
