 ...
 *   hda_client: soft deepen wave=22 areas=… ok=… skip=… played=…
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 22: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 22: peak q/p/u across soft STATS. */
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 22 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 22 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 22 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 22 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 22 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 22 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 22 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 22 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 22; never bar3) */
    msg("hda_client: soft honesty not-bar3 not-pipewire not-product-audio "
        "soft-inventory-only multi_server=0 confine=0 bar3=0 product_kernel=OPEN wave=22\n");
...
soft_suite(void)
{
    ...
    /* Wave 22 exclusive soft door deepen. */
    ...
    /* Wave 22 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
