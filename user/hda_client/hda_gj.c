...
/*
 * Wave stamp + inventory area count (Wave 114 exclusive deepen).
...
soft_suite(void)
{
    ...
    /* Wave 114 exclusive soft door deepen. */
    ...
    /* Wave 114 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
