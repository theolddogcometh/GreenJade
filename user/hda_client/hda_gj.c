 ...
 *
 * Soft inventory (Wave 122 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 122 exclusive deepen).
...
soft_suite(void)
{
    ...
    /* Wave 122 exclusive soft door deepen. */
    ...
    /* Wave 122 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
