 ...
 *
 * Soft inventory (Wave 108 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 108 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 108 greppable steps line). */
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 108: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 108: peak q/p/u across soft STATS. */
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 108 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 108 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 108 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 108 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 108 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 108 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 108 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 108 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 108; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 108 exclusive soft door deepen. */
    ...
    /* Wave 108 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
