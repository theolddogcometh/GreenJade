 ...
 *
 * Soft inventory (Wave 77 exclusive deepen):
...
/*
 * Wave stamp + inventory area count (Wave 77 exclusive deepen).
...
/* Soft suite sub-step bits (Wave 77 greppable steps line). */
...
/*
 * Soft product inventory (Wave 77 exclusive deepen). Cumulative for this
...
soft_stats(const char *tag, unsigned *aSt)
{
    ...
    /* Wave 77: first successful STATS snapshot. */
    if (g_fSoftFirst == 0u) {
    ...
    /* Wave 77: peak q/p/u across soft STATS. */
...
/*
 * Greppable soft inventory (Wave 77 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: hda_client: soft inventory (Wave 77 rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft steps (Wave 77 per-sub-step lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft first (Wave 77 first STATS) */
    o = 0;
    ...
    /* Grep: hda_client: soft peak (Wave 77 peak q/p/u) */
    o = 0;
    ...
    /* Grep: hda_client: soft ops (Wave 77 total door op attempts) */
    o = 0;
    ...
    /* Grep: hda_client: soft format (Wave 77 format lamps) */
    o = 0;
    ...
    /* Grep: hda_client: soft ratio (Wave 77 ok/skip + door rollup) */
    o = 0;
    ...
    /* Grep: hda_client: soft deepen (Wave 77 stamp) */
    o = 0;
    ...
    /* Grep: hda_client: soft honesty (Wave 77; never bar3) */
...
soft_suite(void)
{
    ...
    /* Wave 77 exclusive soft door deepen. */
    ...
    /* Wave 77 soft inventory — greppable hda_client: soft / hda-gj: soft. */
    soft_inventory_log();
