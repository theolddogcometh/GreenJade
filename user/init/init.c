 ...
 *
 * Soft deepen Wave 85 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 85: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 85 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 85 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 85 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retcrownangle — Wave 85 return-scepterangle honesty
     * Soft inventory only; continuum toward 22700; Soft≠product; not bar3.
     */
    gj_puts("init: soft retcrownangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=22700 "
            "(retcrownangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retshardangle — Wave 85 exclusive glyphangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retshardangle exclusive=1 soft_ne_product=1 "
