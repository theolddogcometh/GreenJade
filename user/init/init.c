 ...
 *
 * Soft deepen Wave 84 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 84: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 84 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 84 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 84 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retscepterangle — Wave 84 return-scepterangle honesty
     * Soft inventory only; continuum toward 22600; Soft≠product; not bar3.
     */
    gj_puts("init: soft retscepterangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=22600 "
            "(retscepterangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retglyphangle — Wave 84 exclusive glyphangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retglyphangle exclusive=1 soft_ne_product=1 "
