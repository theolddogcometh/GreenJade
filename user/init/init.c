 ...
 *
 * Soft deepen Wave 124 (never hard-fails boot; exclusive soft inventory):
...
soft_inventory_log(void)
{
    ...
    /* Grep: init: soft clocks (Wave 124) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /* Grep: init: soft rlimit (Wave 124) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /*
     * Grep: init: soft honesty (Wave 124 exclusive deepen).
    ...
    /*
     * Grep: init: soft exclusive (Wave 124 exclusive deepen).
    ...
    /*
     * Grep: init: soft retbrushangle — Wave 124 return-brushangle honesty
     * Soft inventory only; continuum toward 26600; Soft≠product; not bar3.
     */
    gj_puts("init: soft retbrushangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=26600 wave=124 "
            "(retbrushangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retinkangle — Wave 124 exclusive inkangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retinkangle exclusive=1 soft_ne_product=1 "
