 ...
 *
 * Soft deepen Wave 80 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 80: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 80 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 80 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 80 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retcitadelangle — Wave 80 return-keepangle honesty
     * Soft inventory only; continuum toward 22200; Soft≠product; not bar3.
     */
    gj_puts("init: soft retcitadelangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=22200 "
            "(retcitadelangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retbastionkeep — Wave 80 exclusive redoubtangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retbastionkeep exclusive=1 soft_ne_product=1 "
