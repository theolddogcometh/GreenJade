 ...
 *
 * Soft deepen Wave 75 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 75: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 75 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 75 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 75 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retmoatangle — Wave 75 return-moatangle honesty
     * Soft inventory only; continuum toward 21700; Soft≠product; not bar3.
     */
    gj_puts("init: soft retmoatangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=21700 "
            "(retmoatangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retowerangle — Wave 75 exclusive towerangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retowerangle exclusive=1 soft_ne_product=1 "
