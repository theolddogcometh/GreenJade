 ...
 *
 * Soft deepen Wave 72 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 72: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 72 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 72 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 72 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retplaceofarmsangle — Wave 72 return-placeofarmsangle honesty
     * Soft inventory only; continuum toward 21400; Soft≠product; not bar3.
     */
    gj_puts("init: soft retplaceofarmsangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=21400 "
            "(retplaceofarmsangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retdoubletenailleangle — Wave 72 exclusive doubletenailleangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retdoubletenailleangle exclusive=1 soft_ne_product=1 "
