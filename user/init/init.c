 ...
 *
 * Soft deepen Wave 96 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 96: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 96 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 96 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 96 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retsectorangle — Wave 96 return-sectorangle honesty
     * Soft inventory only; continuum toward 23800; Soft≠product; not bar3.
     */
    gj_puts("init: soft retsectorangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=23800 wave=96 "
            "(retsectorangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retwedgeangle — Wave 96 exclusive wedgeangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retwedgeangle exclusive=1 soft_ne_product=1 "
