 ...
 *
 * Soft deepen Wave 73 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 73: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 73 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 73 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 73 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retcurtainface — Wave 73 return-placeofarmsangle honesty
     * Soft inventory only; continuum toward 21500; Soft≠product; not bar3.
     */
    gj_puts("init: soft retcurtainface soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=21500 "
            "(retcurtainface honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retbastionangle — Wave 73 exclusive doubletenailleangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retbastionangle exclusive=1 soft_ne_product=1 "
