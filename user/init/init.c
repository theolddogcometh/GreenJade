 ...
 *
 * Soft deepen Wave 83 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 83: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 83 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 83 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 83 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retemblemangle — Wave 83 return-emblemangle honesty
     * Soft inventory only; continuum toward 22500; Soft≠product; not bar3.
     */
    gj_puts("init: soft retemblemangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=22500 "
            "(retemblemangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retsigilangle — Wave 83 exclusive sigilangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retsigilangle exclusive=1 soft_ne_product=1 "
