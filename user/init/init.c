 ...
 *
 * Soft deepen Wave 76 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 76: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 76 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 76 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 76 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retgateangle — Wave 76 return-gateangle honesty
     * Soft inventory only; continuum toward 21800; Soft≠product; not bar3.
     */
    gj_puts("init: soft retgateangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=21800 "
            "(retgateangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retwallangle — Wave 76 exclusive wallangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retwallangle exclusive=1 soft_ne_product=1 "
