 ...
 *
 * Soft deepen Wave 95 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 95: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 95 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 95 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 95 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retchordangle — Wave 95 return-chordangle honesty
     * Soft inventory only; continuum toward 23700; Soft≠product; not bar3.
     */
    gj_puts("init: soft retchordangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=23700 wave=95 "
            "(retchordangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retarcangle — Wave 95 exclusive arcangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retarcangle exclusive=1 soft_ne_product=1 "
