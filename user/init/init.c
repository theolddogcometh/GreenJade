 ...
 *
 * Soft deepen Wave 119 (never hard-fails boot; exclusive soft inventory):
...
soft_inventory_log(void)
{
    ...
    /* Grep: init: soft clocks (Wave 119) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /* Grep: init: soft rlimit (Wave 119) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /*
     * Grep: init: soft honesty (Wave 119 exclusive deepen).
    ...
    /*
     * Grep: init: soft exclusive (Wave 119 exclusive deepen).
    ...
    /*
     * Grep: init: soft retqueueangle — Wave 119 return-queueangle honesty
     * Soft inventory only; continuum toward 26100; Soft≠product; not bar3.
     */
    gj_puts("init: soft retqueueangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=26100 wave=119 "
            "(retqueueangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft reteventangle — Wave 119 exclusive eventangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft reteventangle exclusive=1 soft_ne_product=1 "
            "continuum_toward=26100 wave=119 (reteventangle stamp; Soft!=product)\n");
}
