 ...
 *
 * Soft deepen Wave 74 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 74: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 74 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 74 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 74 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retglacisangle — Wave 74 return-glacisangle honesty
     * Soft inventory only; continuum toward 21600; Soft≠product; not bar3.
     */
    gj_puts("init: soft retglacisangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=21600 "
            "(retglacisangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retparapetangle — Wave 74 exclusive parapetangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retparapetangle exclusive=1 soft_ne_product=1 "
