 ...
 *
 * Soft deepen Wave 108 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 108: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /* Grep: init: soft clocks (Wave 108) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /* Grep: init: soft rlimit (Wave 108) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /*
     * Grep: init: soft path (Wave 108 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 108 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 108 open-lamp rollup).
    ...
    /*
     * Grep: init: soft rethurmitangle — Wave 108 return-hermitangle honesty
     * Soft inventory only; continuum toward 25000; Soft≠product; not bar3.
     */
    gj_puts("init: soft rethurmitangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=25000 wave=108 "
            "(rethurmitangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retcatmullangle — Wave 108 exclusive catmullangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retcatmullangle exclusive=1 soft_ne_product=1 "
