 ...
 *
 * Soft deepen Wave 79 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 79: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 79 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 79 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 79 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retkeepangle — Wave 79 return-keepangle honesty
     * Soft inventory only; continuum toward 22100; Soft≠product; not bar3.
     */
    gj_puts("init: soft retkeepangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=22100 "
            "(retkeepangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retredoubtangle — Wave 79 exclusive redoubtangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retredoubtangle exclusive=1 soft_ne_product=1 "
