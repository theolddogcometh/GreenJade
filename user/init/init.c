 ...
 *
 * Soft deepen Wave 81 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 81: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 81 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 81 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 81 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retpanoplyangle — Wave 81 return-keepangle honesty
     * Soft inventory only; continuum toward 22300; Soft≠product; not bar3.
     */
    gj_puts("init: soft retpanoplyangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=22300 "
            "(retpanoplyangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retbulwarkangle — Wave 81 exclusive redoubtangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retbulwarkangle exclusive=1 soft_ne_product=1 "
