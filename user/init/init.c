 ...
 *
 * Soft deepen Wave 82 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 82: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 82 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 82 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 82 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retmantleangle — Wave 82 return-keepangle honesty
     * Soft inventory only; continuum toward 22400; Soft≠product; not bar3.
     */
    gj_puts("init: soft retmantleangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=22400 "
            "(retmantleangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retaegisangle — Wave 82 exclusive redoubtangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retaegisangle exclusive=1 soft_ne_product=1 "
