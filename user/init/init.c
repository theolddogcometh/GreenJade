 ...
 *
 * Soft deepen Wave 98 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 98: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 98 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 98 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 98 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retcircumangle — Wave 98 return-circumangle honesty
     * Soft inventory only; continuum toward 24000; Soft≠product; not bar3.
     */
    gj_puts("init: soft retcircumangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=24000 wave=98 "
            "(retcircumangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retellipseangle — Wave 98 exclusive ellipseangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retellipseangle exclusive=1 soft_ne_product=1 "
