 ...
 *
 * Soft deepen Wave 123 (never hard-fails boot; exclusive soft inventory):
...
soft_inventory_log(void)
{
    ...
    /* Grep: init: soft clocks (Wave 123) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /* Grep: init: soft rlimit (Wave 123) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /*
     * Grep: init: soft honesty (Wave 123 exclusive deepen).
    ...
    /*
     * Grep: init: soft exclusive (Wave 123 exclusive deepen).
    ...
    /*
     * Grep: init: soft retlayerangle — Wave 123 return-layerangle honesty
     * Soft inventory only; continuum toward 26500; Soft≠product; not bar3.
     */
    gj_puts("init: soft retlayerangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=26500 wave=123 "
            "(retlayerangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retcanvasangle — Wave 123 exclusive canvasangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retcanvasangle exclusive=1 soft_ne_product=1 "
            "continuum_toward=26500 wave=123 (retcanvasangle stamp; Soft!=product)\n");
}
