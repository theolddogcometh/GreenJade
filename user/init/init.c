 ...
 *
 * Soft deepen Wave 100 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 100: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /* Grep: init: soft clocks (Wave 100) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /* Grep: init: soft rlimit (Wave 100) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /*
     * Grep: init: soft path (Wave 100 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 100 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 100 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retspiralangle — Wave 100 return-spiralangle honesty
     * Soft inventory only; continuum toward 24200; Soft≠product; not bar3.
     */
    gj_puts("init: soft retspiralangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=24200 wave=100 "
            "(retspiralangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft rethelixangle — Wave 100 exclusive helixangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft rethelixangle exclusive=1 soft_ne_product=1 "
