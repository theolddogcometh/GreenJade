 ...
 *
 * Soft deepen Wave 107 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 107: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /* Grep: init: soft clocks (Wave 107) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /* Grep: init: soft rlimit (Wave 107) */
    (void)gj_snprintf(aLine, sizeof(aLine),
    ...
    /*
     * Grep: init: soft path (Wave 107 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 107 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 107 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retsplineangle — Wave 107 return-splineangle honesty
     * Soft inventory only; continuum toward 24900; Soft≠product; not bar3.
     */
    gj_puts("init: soft retsplineangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=24900 wave=107 "
            "(retsplineangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retbezierangle — Wave 107 exclusive bezierangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retbezierangle exclusive=1 soft_ne_product=1 "
