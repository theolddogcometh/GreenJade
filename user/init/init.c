 ...
 *
 * Soft deepen Wave 88 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 88: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 88 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 88 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 88 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retbeaconangle — Wave 88 return-beaconangle honesty
     * Soft inventory only; continuum toward 23000; Soft≠product; not bar3.
     */
    gj_puts("init: soft retbeaconangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=23000 "
            "(retbeaconangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retledgerangle — Wave 88 exclusive ledgerangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retledgerangle exclusive=1 soft_ne_product=1 "
