 ...
 *
 * Soft deepen Wave 97 (never hard-fails boot; exclusive soft inventory):
 ...
 * Wave 97: ids/clocks/fds/rlimit + path honesty + deepen wave stamp.
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: init: soft path (Wave 97 honesty).
    ...
    /*
     * Grep: init: soft exclusive (Wave 97 exclusive deepen).
    ...
    /*
     * Grep: init: soft open (Wave 97 open-lamp rollup).
    ...
    /*
     * Grep: init: soft retradiusangle — Wave 97 return-radiusangle honesty
     * Soft inventory only; continuum toward 23900; Soft≠product; not bar3.
     */
    gj_puts("init: soft retradiusangle soft_only=1 product_gate=0 "
            "soft_ne_product=1 continuum_toward=23900 wave=97 "
            "(retradiusangle honesty; Soft!=product; not bar3)\n");

    /*
     * Grep: init: soft retdiameterangle — Wave 97 exclusive diameterangle stamp
     * Soft inventory only; Soft≠product.
     */
    gj_puts("init: soft retdiameterangle exclusive=1 soft_ne_product=1 "
