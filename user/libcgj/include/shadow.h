 ...
 *   - spwd stubs/soft fills; not product auth stack or shadow database DoD
 *   - Soft!=product: libcgj shadow surface != UDX/DDI product close
 ...
 * Grep: libcgj shadow.h: soft residual lean Soft!=product
 */
#pragma once
