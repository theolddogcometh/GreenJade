 ...
 *   - Linux capability version shapes; soft fills != product cap mint DoD
 *   - Soft!=product: libcgj sys/capability surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/capability.h: soft residual lean Soft!=product
 */
#pragma once
