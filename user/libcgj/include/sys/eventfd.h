 ...
 *   - eventfd flag surface; soft fills may ENOSYS until hybrid ABI
 *   - Soft!=product: libcgj sys/eventfd surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/eventfd.h: soft residual lean Soft!=product
 */
#pragma once
