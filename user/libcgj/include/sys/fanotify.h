 ...
 *   - fanotify event catalog surface; soft fills != product fsnotify DoD
 *   - Soft!=product: libcgj sys/fanotify surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/fanotify.h: soft residual lean Soft!=product
 */
#pragma once
