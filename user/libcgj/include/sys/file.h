 ...
 *   - flock LOCK_* catalog; soft fills may ENOSYS until hybrid ABI
 *   - Soft!=product: libcgj sys/file surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/file.h: soft residual lean Soft!=product
 */
#pragma once
