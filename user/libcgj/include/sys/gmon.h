 ...
 *   - gmon/profil stubs; not product profiler DoD
 *   - Soft!=product: libcgj sys/gmon surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/gmon.h: soft residual lean Soft!=product
 */
#pragma once
