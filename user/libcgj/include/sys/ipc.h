 ...
 *   - SysV IPC_CREAT/EXCL/NOWAIT catalog; soft fills until hybrid ABI
 *   - Soft!=product: libcgj sys/ipc surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/ipc.h: soft residual lean Soft!=product
 */
#pragma once
