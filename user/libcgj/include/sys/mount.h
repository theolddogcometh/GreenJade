 ...
 * matching glibc-shaped include path <sys/mount.h>. Constants and type sizes
 ...
 *   - mount flag catalog; soft fills != product VFS mount DoD
 *   - Soft!=product: libcgj sys/mount surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/mount.h: soft residual lean Soft!=product
 */
#pragma once
