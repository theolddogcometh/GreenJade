 ...
 *   - SysV msg queue surface; soft fills may ENOSYS until hybrid ABI
 *   - Soft!=product: libcgj sys/msg surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/msg.h: soft residual lean Soft!=product
 */
#pragma once
