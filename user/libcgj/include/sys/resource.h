 ...
 * matching glibc-shaped include path <sys/resource.h>. Constants and type sizes
 ...
 *   - rusage/rlimit catalog; soft fills may ENOSYS until hybrid ABI
 *   - Soft!=product: libcgj sys/resource surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/resource.h: soft residual lean Soft!=product
 */
#pragma once
