 ...
 *   - seccomp graph node; soft fills != product filter DoD
 *   - Soft!=product: libcgj sys/seccomp surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/seccomp.h: soft residual lean Soft!=product
 */
#pragma once
