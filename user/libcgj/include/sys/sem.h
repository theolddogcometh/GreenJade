 ...
 *   - SysV semget/semop surface; soft fills may ENOSYS until hybrid ABI
 *   - Soft!=product: libcgj sys/sem surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/sem.h: soft residual lean Soft!=product
 */
#pragma once
