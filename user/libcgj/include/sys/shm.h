 ...
 *   - SysV shm surface; soft fills may ENOSYS until hybrid ABI
 *   - Soft!=product: libcgj sys/shm surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/shm.h: soft residual lean Soft!=product
 */
#pragma once
