 ...
 *   - statvfs surface; soft fills may ENOSYS until VFS doors
 *   - Soft!=product: libcgj sys/statvfs surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/statvfs.h: soft residual lean Soft!=product
 */
#pragma once
...
/*
 * Linux f_flag bits (same numbers as MS_*). OpenSSH sftp-server
 * tests ST_RDONLY. Dual DoD B OPEN.
 */
#ifndef ST_RDONLY
#define ST_RDONLY      1
#endif
