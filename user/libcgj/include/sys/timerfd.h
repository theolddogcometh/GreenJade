 ...
 *   - timerfd create/settime surface; soft fills may ENOSYS until hybrid ABI
 *   - Soft!=product: libcgj sys/timerfd surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/timerfd.h: soft residual lean Soft!=product
 */
#pragma once
