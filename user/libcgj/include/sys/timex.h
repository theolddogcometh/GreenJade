 ...
 *   - adjtimex/ntp_adjtime shape; soft fills != product PHC DoD
 *   - Soft!=product: libcgj sys/timex surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/timex.h: soft residual lean Soft!=product
 */
#pragma once
