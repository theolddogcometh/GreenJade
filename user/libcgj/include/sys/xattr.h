 ...
 * matching glibc-shaped include path <sys/xattr.h>. Constants and type sizes
 ...
 *   - xattr set/get/list surface; soft fills may ENOSYS until VFS doors
 *   - Soft!=product: libcgj sys/xattr surface != UDX/DDI product close
 ...
 * Grep: libcgj sys/xattr.h: soft residual lean Soft!=product
 */
#pragma once
