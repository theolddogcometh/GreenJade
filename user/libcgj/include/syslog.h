 ...
 * matching glibc-shaped include path <syslog.h>. Constants and type sizes
 ...
 *   - syslog priority stubs; not product log daemon DoD
 *   - Soft!=product: libcgj syslog surface != UDX/DDI product close
 ...
 * Grep: libcgj syslog.h: soft residual lean Soft!=product
 */
#pragma once
