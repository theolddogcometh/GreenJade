 ...
 *
 * Clean-room glibc-shaped ucontext.h (x86_64 bring-up). Not GNU glibc. Integer GPRs only (no SSE/x87 state).
 * Not GNU glibc source; dual MIT OR Apache-2.0 only.
 *
 * Scope
 * -----
 * Public declarations for the libcgj (GreenJade freestanding libc) surface
 * matching glibc-shaped include path <ucontext.h>. Constants and type sizes
