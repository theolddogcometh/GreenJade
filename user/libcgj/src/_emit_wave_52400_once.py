...
"""One-shot CREATE-ONLY: graph_batch52101.c .. graph_batch52400.c via O_EXCL.
...
def main() -> int:
    ...
    # write result for parent agents that cannot capture stdout
    (OUT / "_emit_wave_52400_result.txt").write_text(
