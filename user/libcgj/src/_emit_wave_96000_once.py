...
"""One-shot CREATE-ONLY: graph_batch92001.c .. graph_batch96000.c via O_EXCL.
Pattern: graph_batch25850 simple + decade lamps (xx91-xx00) at each *00.
Matches high-range rewire style used for 88001..92000 (template from 25850/25891-25900).
"""
...
def main() -> int:
    ...
    print(line)
    (OUT / "_emit_wave_96000_result.txt").write_text(
        line
