 ...
 *
 * Desktop glibc graph batch10041: gamescope ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_gamescope_ok_u_10041(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       gamescope runtime probe for the bar3-related continuum.
 *   uint32_t __gj_gamescope_ok_u_10041  (alias)
 *   __libcgj_batch10041_marker = "libcgj-batch10041"
 *
...
const char __libcgj_batch10041_marker[] = "libcgj-batch10041";

/* Soft gamescope-ok lamp: always off (not a real runtime probe). */
#define B10041_GAMESCOPE_OK  0u
...
uint32_t __gj_gamescope_ok_u_10041(void)
    __attribute__((alias("gj_gamescope_ok_u_10041")));
