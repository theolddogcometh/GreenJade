 ...
 *
 * Desktop glibc graph batch10078: resume ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_resume_ok_u_10078(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       resume/wake probe for the power/thermal continuum.
 *   uint32_t __gj_resume_ok_u_10078  (alias)
 *   __libcgj_batch10078_marker = "libcgj-batch10078"
 *
...
const char __libcgj_batch10078_marker[] = "libcgj-batch10078";

/* Soft resume-ok lamp: always off (not a real resume probe). */
#define B10078_RESUME_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b10078_resume_ok(void)
{
	return B10078_RESUME_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_resume_ok_u_10078 - resume ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe wake sources
 * or call libc. No parent wires.
 */
uint32_t
gj_resume_ok_u_10078(void)
{
	(void)NULL;
	return b10078_resume_ok();
}
...
uint32_t __gj_resume_ok_u_10078(void)
    __attribute__((alias("gj_resume_ok_u_10078")));
