 ...
 *
 * Desktop glibc graph batch10161: udev soft-id stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_udev_ok_u_10161(void);
 ...
 *   uint32_t __gj_udev_ok_u_10161  (alias)
 *   __libcgj_batch10161_marker = "libcgj-batch10161"
 *
 ...
 * Unique gj_udev_ok_u_10161 surface only; no multi-def. Soft stub —
...
const char __libcgj_batch10161_marker[] = "libcgj-batch10161";

/* Soft unavailable / not-detected udev lamp. */
#define B10161_UDEV_OK  0u
...
uint32_t __gj_udev_ok_u_10161(void)
    __attribute__((alias("gj_udev_ok_u_10161")));
