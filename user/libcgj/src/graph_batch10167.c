 ...
 *
 * Desktop glibc graph batch10167: device_db soft-id stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_device_db_ok_u_10167(void);
 ...
 *   uint32_t __gj_device_db_ok_u_10167  (alias)
 *   __libcgj_batch10167_marker = "libcgj-batch10167"
 *
 ...
 * Unique gj_device_db_ok_u_10167 surface only; no multi-def. Soft stub —
...
const char __libcgj_batch10167_marker[] = "libcgj-batch10167";

/* Soft unavailable / not-detected device_db lamp. */
#define B10167_DEVICE_DB_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b10167_device_db_ok(void)
{
	return B10167_DEVICE_DB_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_device_db_ok_u_10167 - device_db soft-id lamp.
 *
 * Always returns 0. Soft pure-data device database presence tag. Does
 * not probe udev db or call libc. No parent wires.
 */
uint32_t
gj_device_db_ok_u_10167(void)
{
	(void)NULL;
	return b10167_device_db_ok();
}
...
uint32_t __gj_device_db_ok_u_10167(void)
    __attribute__((alias("gj_device_db_ok_u_10167")));
