 ...
 *
 * Desktop glibc graph batch10173: iwd soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_iwd_ok_u_10173(void);
 *     - Always returns 0. Soft stub for bluez/networkmanager soft-id
 *       continuum; iwd path is intentionally not reported ok.
 *   uint32_t __gj_iwd_ok_u_10173  (alias)
 *   __libcgj_batch10173_marker = "libcgj-batch10173"
 *
...
const char __libcgj_batch10173_marker[] = "libcgj-batch10173";

/* Soft iwd-ok lamp: always off for this continuum. */
#define B10173_IWD_OK  0u
...
b10173_iwd_ok(void)
{
	return B10173_IWD_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_iwd_ok_u_10173 - iwd soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not open iwd or call
 * libc. No parent wires.
 */
uint32_t
gj_iwd_ok_u_10173(void)
{
	(void)NULL;
	return b10173_iwd_ok();
}
...
uint32_t __gj_iwd_ok_u_10173(void)
    __attribute__((alias("gj_iwd_ok_u_10173")));
