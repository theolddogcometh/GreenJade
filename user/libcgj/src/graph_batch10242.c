 ...
 *
 * Desktop glibc graph batch10242: soft steamui product-ok unit (open).
 *
 * Surface (unique symbols):
 *   uint32_t gj_steamui_ok_u_10242(void);
 ...
 *   uint32_t __gj_steamui_ok_u_10242  (alias)
 *   __libcgj_batch10242_marker = "libcgj-batch10242"
 *
 ...
 * no multi-def. Distinct from gj_gamescope_ok_u_10241 and related
...
const char __libcgj_batch10242_marker[] = "libcgj-batch10242";

/* SteamUI soft product-ok lamp for continuum 10241-10250 (still open). */
#define B10242_STEAMUI_OK  0u
...
uint32_t __gj_steamui_ok_u_10242(void)
    __attribute__((alias("gj_steamui_ok_u_10242")));
