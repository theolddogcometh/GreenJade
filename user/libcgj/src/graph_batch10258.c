 ...
 *
 * Desktop glibc graph batch10258: gyro ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_gyro_ok_u_10258(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       gyroscope/IMU probe for the controller/input continuum.
 *   uint32_t __gj_gyro_ok_u_10258  (alias)
 *   __libcgj_batch10258_marker = "libcgj-batch10258"
 *
...
const char __libcgj_batch10258_marker[] = "libcgj-batch10258";

/* Soft gyro-ok lamp: always off (not a real gyro/IMU probe). */
#define B10258_GYRO_OK  0u
...
b10258_gyro_ok(void)
{
	return B10258_GYRO_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_gyro_ok_u_10258 - gyro ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not read IMU axes or
 * call libc. No parent wires.
 */
uint32_t
gj_gyro_ok_u_10258(void)
{
	(void)NULL;
	return b10258_gyro_ok();
}
...
uint32_t __gj_gyro_ok_u_10258(void)
    __attribute__((alias("gj_gyro_ok_u_10258")));
