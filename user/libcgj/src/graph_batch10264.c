 ...
 *
 * Desktop glibc graph batch10264: DNS connectivity soft product stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_dns_ok_u_10264(void);
 ...
 *   uint32_t __gj_dns_ok_u_10264  (alias)
 *   __libcgj_batch10264_marker = "libcgj-batch10264"
 *
 * Net/connectivity soft product CREATE-ONLY (10261-10270). Unique
 * gj_dns_ok_u_10264 surface only; no multi-def. Distinct from
...
const char __libcgj_batch10264_marker[] = "libcgj-batch10264";

/* Soft dns-ok product lamp (unset / not probed). */
#define B10264_DNS_OK  0u
...
b10264_dns_ok(void)
{
	return B10264_DNS_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_dns_ok_u_10264 - report soft DNS connectivity ok lamp.
 *
...
uint32_t __gj_dns_ok_u_10264(void)
    __attribute__((alias("gj_dns_ok_u_10264")));
