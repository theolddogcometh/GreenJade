 ...
 *
 * Desktop glibc graph batch10274: thermal ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_thermal_ok_u_10274(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       thermal zone / temperature sensor runtime probe for the
 *       power/thermal soft product continuum.
 *   uint32_t __gj_thermal_ok_u_10274  (alias)
 *   __libcgj_batch10274_marker = "libcgj-batch10274"
 *
...
const char __libcgj_batch10274_marker[] = "libcgj-batch10274";

/* Soft thermal-ok lamp: always off (not a real thermal-zone probe). */
#define B10274_THERMAL_OK  0u
...
b10274_ok(void)
{
	return B10274_THERMAL_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_thermal_ok_u_10274 - thermal ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe thermal zones
 * or call libc. No parent wires.
 */
uint32_t
gj_thermal_ok_u_10274(void)
{
	(void)NULL;
	return b10274_ok();
}
...
uint32_t __gj_thermal_ok_u_10274(void)
    __attribute__((alias("gj_thermal_ok_u_10274")));
