 ...
 *
 * Desktop glibc graph batch10321: mesa ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_mesa_ok_u_10321(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       mesa runtime probe for the bar3-related continuum.
 *   uint32_t __gj_mesa_ok_u_10321  (alias)
 *   __libcgj_batch10321_marker = "libcgj-batch10321"
 *
...
const char __libcgj_batch10321_marker[] = "libcgj-batch10321";

/* Soft mesa-ok lamp: always off (not a real runtime probe). */
#define B10321_MESA_OK  0u
...
uint32_t __gj_mesa_ok_u_10321(void)
    __attribute__((alias("gj_mesa_ok_u_10321")));
