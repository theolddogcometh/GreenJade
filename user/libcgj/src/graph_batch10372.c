 ...
 *
 * Desktop glibc graph batch10372: TDP ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_tdp_ok_u_10372(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       thermal design power probe for the power soft continuum.
 *   uint32_t __gj_tdp_ok_u_10372  (alias)
 *   __libcgj_batch10372_marker = "libcgj-batch10372"
 *
...
const char __libcgj_batch10372_marker[] = "libcgj-batch10372";

/* Soft TDP-ok lamp: always off (not a real power probe). */
#define B10372_TDP_OK  0u
...
b10372_tdp_ok(void)
{
	return B10372_TDP_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_tdp_ok_u_10372 - TDP ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe RAPL/TDP or
 * call libc. No parent wires.
 */
uint32_t
gj_tdp_ok_u_10372(void)
{
	(void)NULL;
	return b10372_tdp_ok();
}
...
uint32_t __gj_tdp_ok_u_10372(void)
    __attribute__((alias("gj_tdp_ok_u_10372")));
