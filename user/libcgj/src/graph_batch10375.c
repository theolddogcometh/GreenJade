 ...
 *
 * Desktop glibc graph batch10375: fan ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_fan_ok_u_10375(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       fan/tachometer probe for the power soft continuum.
 *   uint32_t __gj_fan_ok_u_10375  (alias)
 *   __libcgj_batch10375_marker = "libcgj-batch10375"
 *
...
const char __libcgj_batch10375_marker[] = "libcgj-batch10375";

/* Soft fan-ok lamp: always off (not a real fan probe). */
#define B10375_FAN_OK  0u
...
b10375_fan_ok(void)
{
	return B10375_FAN_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_fan_ok_u_10375 - fan ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe fan hwmon or
 * call libc. No parent wires.
 */
uint32_t
gj_fan_ok_u_10375(void)
{
	(void)NULL;
	return b10375_fan_ok();
}
...
uint32_t __gj_fan_ok_u_10375(void)
    __attribute__((alias("gj_fan_ok_u_10375")));
