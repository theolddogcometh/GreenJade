 ...
 *
 * Desktop glibc graph batch10443: logind ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_logind_ok_u_10443(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       logind runtime probe for the dbus soft continuum.
 *   uint32_t __gj_logind_ok_u_10443  (alias)
 *   __libcgj_batch10443_marker = "libcgj-batch10443"
 *
...
const char __libcgj_batch10443_marker[] = "libcgj-batch10443";

/* Soft logind-ok lamp: always off (not a real runtime probe). */
#define B10443_LOGIND_OK  0u
...
b10443_ok(void)
{
	return B10443_LOGIND_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_logind_ok_u_10443 - logind ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe logind
 * presence or call libc. No parent wires.
 */
uint32_t
gj_logind_ok_u_10443(void)
{
	(void)NULL;
	return b10443_ok();
}
...
uint32_t __gj_logind_ok_u_10443(void)
    __attribute__((alias("gj_logind_ok_u_10443")));
