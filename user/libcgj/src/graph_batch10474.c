 ...
 *
 * Desktop glibc graph batch10474: wpa_supplicant ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_wpa_supplicant_ok_u_10474(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       wpa_supplicant runtime probe for the netmgr soft path.
 *   uint32_t __gj_wpa_supplicant_ok_u_10474  (alias)
 *   __libcgj_batch10474_marker = "libcgj-batch10474"
 *
...
const char __libcgj_batch10474_marker[] = "libcgj-batch10474";

/* Soft wpa_supplicant-ok lamp: always off (not a real runtime probe). */
#define B10474_WPA_SUPPLICANT_OK  0u
...
b10474_ok(void)
{
	return B10474_WPA_SUPPLICANT_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_wpa_supplicant_ok_u_10474 - wpa_supplicant ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe wpa_supplicant
 * daemon presence or call libc. No parent wires.
 */
uint32_t
gj_wpa_supplicant_ok_u_10474(void)
{
	(void)NULL;
	return b10474_ok();
}
...
uint32_t __gj_wpa_supplicant_ok_u_10474(void)
    __attribute__((alias("gj_wpa_supplicant_ok_u_10474")));
