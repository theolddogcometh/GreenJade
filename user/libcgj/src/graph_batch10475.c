 ...
 *
 * Desktop glibc graph batch10475: ModemManager ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_modemmanager_ok_u_10475(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       ModemManager runtime probe for the netmgr soft path.
 *   uint32_t __gj_modemmanager_ok_u_10475  (alias)
 *   __libcgj_batch10475_marker = "libcgj-batch10475"
 *
...
const char __libcgj_batch10475_marker[] = "libcgj-batch10475";

/* Soft ModemManager-ok lamp: always off (not a real runtime probe). */
#define B10475_MODEMMANAGER_OK  0u
...
b10475_ok(void)
{
	return B10475_MODEMMANAGER_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_modemmanager_ok_u_10475 - ModemManager ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe ModemManager
 * daemon presence or call libc. No parent wires.
 */
uint32_t
gj_modemmanager_ok_u_10475(void)
{
	(void)NULL;
	return b10475_ok();
}
...
uint32_t __gj_modemmanager_ok_u_10475(void)
    __attribute__((alias("gj_modemmanager_ok_u_10475")));
