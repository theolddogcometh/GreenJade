 ...
 *
 * Desktop glibc graph batch10477: Avahi ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_avahi_ok_u_10477(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Avahi mDNS/DNS-SD runtime probe for the netmgr soft path.
 *   uint32_t __gj_avahi_ok_u_10477  (alias)
 *   __libcgj_batch10477_marker = "libcgj-batch10477"
 *
...
const char __libcgj_batch10477_marker[] = "libcgj-batch10477";

/* Soft Avahi-ok lamp: always off (not a real runtime probe). */
#define B10477_AVAHI_OK  0u
...
b10477_ok(void)
{
	return B10477_AVAHI_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_avahi_ok_u_10477 - Avahi ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Avahi daemon
 * presence or call libc. No parent wires.
 */
uint32_t
gj_avahi_ok_u_10477(void)
{
	(void)NULL;
	return b10477_ok();
}
...
uint32_t __gj_avahi_ok_u_10477(void)
    __attribute__((alias("gj_avahi_ok_u_10477")));
