 ...
 *
 * Desktop glibc graph batch10518: vkd3d ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_vkd3d_ok_u_10518(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       VKD3D runtime probe for the proton soft continuum.
 *   uint32_t __gj_vkd3d_ok_u_10518  (alias)
 *   __libcgj_batch10518_marker = "libcgj-batch10518"
 *
...
const char __libcgj_batch10518_marker[] = "libcgj-batch10518";

/* Soft vkd3d-ok lamp: always off (not a real runtime probe). */
#define B10518_VKD3D_OK  0u
...
b10518_ok(void)
{
	return B10518_VKD3D_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_vkd3d_ok_u_10518 - vkd3d ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe VKD3D
 * presence or call libc. No parent wires.
 */
uint32_t
gj_vkd3d_ok_u_10518(void)
{
	(void)NULL;
	return b10518_ok();
}
...
uint32_t __gj_vkd3d_ok_u_10518(void)
    __attribute__((alias("gj_vkd3d_ok_u_10518")));
