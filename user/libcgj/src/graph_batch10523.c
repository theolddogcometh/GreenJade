 ...
 *
 * Desktop glibc graph batch10523: radeonsi ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_radeonsi_ok_u_10523(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       radeonsi runtime probe for the bar3-related continuum.
 *   uint32_t __gj_radeonsi_ok_u_10523  (alias)
 *   __libcgj_batch10523_marker = "libcgj-batch10523"
 *
...
const char __libcgj_batch10523_marker[] = "libcgj-batch10523";

/* Soft radeonsi-ok lamp: always off (not a real runtime probe). */
#define B10523_RADEONSI_OK  0u
...
uint32_t __gj_radeonsi_ok_u_10523(void)
    __attribute__((alias("gj_radeonsi_ok_u_10523")));
