 ...
 *
 * Desktop glibc graph batch10539: audio soft continuum lamp (on).
 *
 * Surface (unique symbols):
 *   uint32_t gj_audio_soft_ready_u_10539(void);
 ...
 *   uint32_t __gj_audio_soft_ready_u_10539  (alias)
 *   __libcgj_batch10539_marker = "libcgj-batch10539"
 *
 ...
 * audio_latency/bluetooth_audio/hdmi_audio ok units remain 0. No
...
const char __libcgj_batch10539_marker[] = "libcgj-batch10539";

/* Soft continuum lamp: surfaces present (soft ready only). */
#define B10539_SOFT_READY  1u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b10539_soft_ready(void)
{
	return B10539_SOFT_READY;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_audio_soft_ready_u_10539 - audio soft continuum ready lamp.
 *
 * Always returns 1. Soft pure-data product tag that exclusive wave
 * 10531-10540 surfaces are present. Does not claim pipewire/
 * wireplumber/pulse_compat/alsa/jack/audio_latency/bluetooth_audio/
 * hdmi_audio ok and does not call libc. No parent wires.
 */
uint32_t
gj_audio_soft_ready_u_10539(void)
{
	(void)NULL;
	return b10539_soft_ready();
}
...
uint32_t __gj_audio_soft_ready_u_10539(void)
    __attribute__((alias("gj_audio_soft_ready_u_10539")));
