 ...
 *
 * Desktop glibc graph batch10626: FriBidi soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_fribidi_ok_u_10626(void);
 *     - Always returns 0. Soft stub for fontconfig/freetype soft-id
 *       continuum; FriBidi is intentionally not reported ok.
 *   uint32_t __gj_fribidi_ok_u_10626  (alias)
 *   __libcgj_batch10626_marker = "libcgj-batch10626"
 *
...
const char __libcgj_batch10626_marker[] = "libcgj-batch10626";

/* Soft FriBidi-ok lamp: always off for this continuum. */
#define B10626_FRIBIDI_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b10626_fribidi_ok(void)
{
	return B10626_FRIBIDI_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_fribidi_ok_u_10626 - FriBidi soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not run bidi algorithms
 * or call FriBidi/libc. No parent wires.
 */
uint32_t
gj_fribidi_ok_u_10626(void)
{
	(void)NULL;
	return b10626_fribidi_ok();
}
...
uint32_t __gj_fribidi_ok_u_10626(void)
    __attribute__((alias("gj_fribidi_ok_u_10626")));
