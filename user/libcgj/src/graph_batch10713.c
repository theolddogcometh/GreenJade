 ...
 *
 * Desktop glibc graph batch10713: Proton-GE ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_proton_ge_ok_u_10713(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Proton-GE runtime probe for the proton/wine continuum.
 *   uint32_t __gj_proton_ge_ok_u_10713  (alias)
 *   __libcgj_batch10713_marker = "libcgj-batch10713"
 *
 ...
 * and gj_proton_ge_ok_u_10213 (batch10213). No parent wires. No
...
const char __libcgj_batch10713_marker[] = "libcgj-batch10713";

/* Soft Proton-GE-ok lamp: always off (not a real Proton-GE probe). */
#define B10713_PROTON_GE_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b10713_proton_ge_ok(void)
{
	return B10713_PROTON_GE_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_proton_ge_ok_u_10713 - Proton-GE ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not inspect Proton-GE or
 * call libc. No parent wires.
 */
uint32_t
gj_proton_ge_ok_u_10713(void)
{
	(void)NULL;
	return b10713_proton_ge_ok();
}
...
uint32_t __gj_proton_ge_ok_u_10713(void)
    __attribute__((alias("gj_proton_ge_ok_u_10713")));
