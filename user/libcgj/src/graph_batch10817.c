 ...
 *
 * Desktop glibc graph batch10817: notification portal ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_notification_portal_ok_u_10817(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Notification portal probe for the flatpak/portal continuum.
 *   uint32_t __gj_notification_portal_ok_u_10817  (alias)
 *   __libcgj_batch10817_marker = "libcgj-batch10817"
 *
...
const char __libcgj_batch10817_marker[] = "libcgj-batch10817";

/* Soft notification-portal-ok lamp: always off (not a real probe). */
#define B10817_NOTIFICATION_PORTAL_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b10817_notification_portal_ok(void)
{
	return B10817_NOTIFICATION_PORTAL_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_notification_portal_ok_u_10817 - notification portal ok soft unit.
 *
 * Always returns 0. Soft continuum stub; does not probe Notification
 * portal or call libc. No parent wires.
 */
uint32_t
gj_notification_portal_ok_u_10817(void)
{
	(void)NULL;
	return b10817_notification_portal_ok();
}
...
uint32_t __gj_notification_portal_ok_u_10817(void)
    __attribute__((alias("gj_notification_portal_ok_u_10817")));
