 ...
 *
 * Desktop glibc graph batch10821: fontconfig soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_fontconfig_ok_u_10821(void);
 *     - Always returns 0. Soft stub for fontconfig/freetype soft-id
 *       continuum; fontconfig is intentionally not reported ok.
 *   uint32_t __gj_fontconfig_ok_u_10821  (alias)
 *   __libcgj_batch10821_marker = "libcgj-batch10821"
 *
...
const char __libcgj_batch10821_marker[] = "libcgj-batch10821";

/* Soft fontconfig-ok lamp: always off for this continuum. */
#define B10821_FONTCONFIG_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b10821_fontconfig_ok(void)
{
	return B10821_FONTCONFIG_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_fontconfig_ok_u_10821 - fontconfig soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not open FcConfig or call
 * fontconfig/libc. No parent wires.
 */
uint32_t
gj_fontconfig_ok_u_10821(void)
{
	(void)NULL;
	return b10821_fontconfig_ok();
}
...
uint32_t __gj_fontconfig_ok_u_10821(void)
    __attribute__((alias("gj_fontconfig_ok_u_10821")));
