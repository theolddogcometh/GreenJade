 ...
 *
 * Desktop glibc graph batch10845: resolved ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_resolved_ok_u_10845(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       systemd-resolved runtime probe for the dbus soft continuum.
 *   uint32_t __gj_resolved_ok_u_10845  (alias)
 *   __libcgj_batch10845_marker = "libcgj-batch10845"
 *
...
const char __libcgj_batch10845_marker[] = "libcgj-batch10845";

/* Soft resolved-ok lamp: always off (not a real runtime probe). */
#define B10845_RESOLVED_OK  0u
...
uint32_t __gj_resolved_ok_u_10845(void)
    __attribute__((alias("gj_resolved_ok_u_10845")));
