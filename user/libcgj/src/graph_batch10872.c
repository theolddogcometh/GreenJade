 ...
 *
 * Desktop glibc graph batch10872: NetworkManager soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_networkmanager_ok_u_10872(void);
 *     - Always returns 0. Soft stub for bluez/networkmanager soft-id
 *       continuum; NetworkManager path is intentionally not reported ok.
 *   uint32_t __gj_networkmanager_ok_u_10872  (alias)
 *   __libcgj_batch10872_marker = "libcgj-batch10872"
 *
...
const char __libcgj_batch10872_marker[] = "libcgj-batch10872";

/* Soft NetworkManager-ok lamp: always off for this continuum. */
#define B10872_NETWORKMANAGER_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b10872_networkmanager_ok(void)
{
	return B10872_NETWORKMANAGER_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_networkmanager_ok_u_10872 - NetworkManager soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not open BlueZ/
 * NetworkManager paths or call libc. No parent wires.
 */
uint32_t
gj_networkmanager_ok_u_10872(void)
{
	(void)NULL;
	return b10872_networkmanager_ok();
}
...
uint32_t __gj_networkmanager_ok_u_10872(void)
    __attribute__((alias("gj_networkmanager_ok_u_10872")));
