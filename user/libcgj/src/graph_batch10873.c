 ...
 *
 * Desktop glibc graph batch10873: iwd soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_iwd_ok_u_10873(void);
 *     - Always returns 0. Soft stub for bluez/networkmanager soft-id
 *       continuum; iwd path is intentionally not reported ok.
 *   uint32_t __gj_iwd_ok_u_10873  (alias)
 *   __libcgj_batch10873_marker = "libcgj-batch10873"
 *
...
const char __libcgj_batch10873_marker[] = "libcgj-batch10873";

/* Soft iwd-ok lamp: always off for this continuum. */
#define B10873_IWD_OK  0u
...
uint32_t __gj_iwd_ok_u_10873(void)
    __attribute__((alias("gj_iwd_ok_u_10873")));
