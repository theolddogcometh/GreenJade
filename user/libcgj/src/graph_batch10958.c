 ...
 *
 * Desktop glibc graph batch10958: gyro ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_gyro_ok_u_10958(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       gyroscope/IMU probe for the controller soft continuum.
 *   uint32_t __gj_gyro_ok_u_10958  (alias)
 *   __libcgj_batch10958_marker = "libcgj-batch10958"
 *
...
const char __libcgj_batch10958_marker[] = "libcgj-batch10958";

/* Soft gyro-ok lamp: always off (not a real gyro/IMU probe). */
#define B10958_GYRO_OK  0u
...
b10958_gyro_ok(void)
{
	return B10958_GYRO_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_gyro_ok_u_10958 - gyro ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not read IMU axes or
 * call libc. No parent wires.
 */
uint32_t
gj_gyro_ok_u_10958(void)
{
	(void)NULL;
	return b10958_gyro_ok();
}
...
uint32_t __gj_gyro_ok_u_10958(void)
    __attribute__((alias("gj_gyro_ok_u_10958")));
