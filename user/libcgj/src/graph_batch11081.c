 ...
 *
 * Desktop glibc graph batch11081: CUPS ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_cups_ok_u_11081(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       cups/cupsd probe for the cups/print continuum.
 *   uint32_t __gj_cups_ok_u_11081  (alias)
 *   __libcgj_batch11081_marker = "libcgj-batch11081"
 *
 ...
 * gj_cups_ok_u_10881 (batch10881), gj_cups_ok_u_10181 (batch10181),
...
const char __libcgj_batch11081_marker[] = "libcgj-batch11081";

/* Soft CUPS-ok lamp: always off (not a real cups probe). */
#define B11081_CUPS_OK  0u
...
b11081_cups_ok(void)
{
	return B11081_CUPS_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_cups_ok_u_11081 - CUPS ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not inspect cupsd or
 * call libc. No parent wires.
 */
uint32_t
gj_cups_ok_u_11081(void)
{
	(void)NULL;
	return b11081_cups_ok();
}
...
uint32_t __gj_cups_ok_u_11081(void)
    __attribute__((alias("gj_cups_ok_u_11081")));
