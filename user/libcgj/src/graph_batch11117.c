 ...
 *
 * Desktop glibc graph batch11117: DXVK ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_dxvk_ok_u_11117(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       DXVK/D3D→Vulkan probe for the proton/wine continuum.
 *   uint32_t __gj_dxvk_ok_u_11117  (alias)
 *   __libcgj_batch11117_marker = "libcgj-batch11117"
 *
 ...
 * and gj_dxvk_ok_u_10717 (batch10717). No parent wires. No __int128.
...
const char __libcgj_batch11117_marker[] = "libcgj-batch11117";

/* Soft DXVK-ok lamp: always off (not a real DXVK probe). */
#define B11117_DXVK_OK  0u
...
b11117_dxvk_ok(void)
{
	return B11117_DXVK_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_dxvk_ok_u_11117 - DXVK ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not inspect DXVK or
 * call libc. No parent wires.
 */
uint32_t
gj_dxvk_ok_u_11117(void)
{
	(void)NULL;
	return b11117_dxvk_ok();
}
...
uint32_t __gj_dxvk_ok_u_11117(void)
    __attribute__((alias("gj_dxvk_ok_u_11117")));
