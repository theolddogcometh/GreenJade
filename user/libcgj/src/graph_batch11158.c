 ...
 *
 * Desktop glibc graph batch11158: gyro ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_gyro_ok_u_11158(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       gyroscope/IMU probe for the controller soft continuum.
 *   uint32_t __gj_gyro_ok_u_11158  (alias)
 *   __libcgj_batch11158_marker = "libcgj-batch11158"
 *
...
const char __libcgj_batch11158_marker[] = "libcgj-batch11158";

/* Soft gyro-ok lamp: always off (not a real gyro/IMU probe). */
#define B11158_GYRO_OK  0u
...
b11158_gyro_ok(void)
{
	return B11158_GYRO_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_gyro_ok_u_11158 - gyro ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not read IMU axes or
 * call libc. No parent wires.
 */
uint32_t
gj_gyro_ok_u_11158(void)
{
	(void)NULL;
	return b11158_gyro_ok();
}
...
uint32_t __gj_gyro_ok_u_11158(void)
    __attribute__((alias("gj_gyro_ok_u_11158")));
