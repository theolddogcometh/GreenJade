 ...
 *
 * Desktop glibc graph batch11285: PPD ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_ppd_ok_u_11285(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       PostScript Printer Description probe for the cups/print
 *       continuum.
 *   uint32_t __gj_ppd_ok_u_11285  (alias)
 *   __libcgj_batch11285_marker = "libcgj-batch11285"
 *
...
const char __libcgj_batch11285_marker[] = "libcgj-batch11285";

/* Soft PPD-ok lamp: always off (not a real PPD probe). */
#define B11285_PPD_OK  0u
...
b11285_ppd_ok(void)
{
	return B11285_PPD_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_ppd_ok_u_11285 - PPD ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not parse PPD files or
 * call libc. No parent wires.
 */
uint32_t
gj_ppd_ok_u_11285(void)
{
	(void)NULL;
	return b11285_ppd_ok();
}
...
uint32_t __gj_ppd_ok_u_11285(void)
    __attribute__((alias("gj_ppd_ok_u_11285")));
