 ...
 *
 * Desktop glibc graph batch11289: print soft continuum lamp (on).
 *
 * Surface (unique symbols):
 *   uint32_t gj_print_soft_ready_u_11289(void);
 ...
 *       ok.
 *   uint32_t __gj_print_soft_ready_u_11289  (alias)
 *   __libcgj_batch11289_marker = "libcgj-batch11289"
 *
 ...
 * batch_id_11290). Unique surface only; no multi-def. cups/ipp/
...
const char __libcgj_batch11289_marker[] = "libcgj-batch11289";

/* Soft continuum lamp: surfaces present (soft ready only). */
#define B11289_SOFT_READY  1u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b11289_soft_ready(void)
{
	return B11289_SOFT_READY;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_print_soft_ready_u_11289 - print soft continuum ready lamp.
 *
 * Always returns 1. Soft pure-data product tag that exclusive wave
 * 11281-11290 surfaces are present. Does not claim cups/ipp/print_job/
 * printer_discover/ppd/filter/spool/usb_print ok and does not call
 * libc. No parent wires.
 */
uint32_t
gj_print_soft_ready_u_11289(void)
{
	(void)NULL;
	return b11289_soft_ready();
}
...
uint32_t __gj_print_soft_ready_u_11289(void)
    __attribute__((alias("gj_print_soft_ready_u_11289")));
