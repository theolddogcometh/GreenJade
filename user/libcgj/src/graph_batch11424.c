 ...
 *
 * Desktop glibc graph batch11424: cairo ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_cairo_ok_u_11424(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Cairo runtime probe for the font soft continuum.
 *   uint32_t __gj_cairo_ok_u_11424  (alias)
 *   __libcgj_batch11424_marker = "libcgj-batch11424"
 *
...
const char __libcgj_batch11424_marker[] = "libcgj-batch11424";

/* Soft cairo-ok lamp: always off (not a real runtime probe). */
#define B11424_CAIRO_OK  0u
...
b11424_ok(void)
{
	return B11424_CAIRO_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_cairo_ok_u_11424 - cairo ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Cairo
 * presence or call libc. No parent wires.
 */
uint32_t
gj_cairo_ok_u_11424(void)
{
	(void)NULL;
	return b11424_ok();
}
...
uint32_t __gj_cairo_ok_u_11424(void)
    __attribute__((alias("gj_cairo_ok_u_11424")));
