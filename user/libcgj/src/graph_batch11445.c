 ...
 *
 * Desktop glibc graph batch11445: resolved ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_resolved_ok_u_11445(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       systemd-resolved runtime probe for the dbus soft continuum.
 *   uint32_t __gj_resolved_ok_u_11445  (alias)
 *   __libcgj_batch11445_marker = "libcgj-batch11445"
 *
 ...
 * no multi-def. Distinct from gj_resolved_ok_u_11245 /
 * gj_resolved_ok_u_11045 / gj_resolved_ok_u_10845 /
...
const char __libcgj_batch11445_marker[] = "libcgj-batch11445";

/* Soft resolved-ok lamp: always off (not a real runtime probe). */
#define B11445_RESOLVED_OK  0u
...
b11445_ok(void)
{
	return B11445_RESOLVED_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_resolved_ok_u_11445 - resolved ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe systemd-resolved
 * presence or call libc. No parent wires.
 */
uint32_t
gj_resolved_ok_u_11445(void)
{
	(void)NULL;
	return b11445_ok();
}
...
uint32_t __gj_resolved_ok_u_11445(void)
    __attribute__((alias("gj_resolved_ok_u_11445")));
