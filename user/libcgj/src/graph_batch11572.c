 ...
 *
 * Desktop glibc graph batch11572: TDP ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_tdp_ok_u_11572(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       thermal design power probe for the power soft continuum.
 *   uint32_t __gj_tdp_ok_u_11572  (alias)
 *   __libcgj_batch11572_marker = "libcgj-batch11572"
 *
...
const char __libcgj_batch11572_marker[] = "libcgj-batch11572";

/* Soft TDP-ok lamp: always off (not a real power probe). */
#define B11572_TDP_OK  0u
...
b11572_tdp_ok(void)
{
	return B11572_TDP_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_tdp_ok_u_11572 - TDP ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe RAPL/TDP or
 * call libc. No parent wires.
 */
uint32_t
gj_tdp_ok_u_11572(void)
{
	(void)NULL;
	return b11572_tdp_ok();
}
...
uint32_t __gj_tdp_ok_u_11572(void)
    __attribute__((alias("gj_tdp_ok_u_11572")));
