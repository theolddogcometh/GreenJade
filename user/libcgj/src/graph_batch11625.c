 ...
 *
 * Desktop glibc graph batch11625: Pango soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_pango_ok_u_11625(void);
 *     - Always returns 0. Soft stub for fontconfig/freetype soft-id
 *       continuum; Pango is intentionally not reported ok.
 *   uint32_t __gj_pango_ok_u_11625  (alias)
 *   __libcgj_batch11625_marker = "libcgj-batch11625"
 *
...
const char __libcgj_batch11625_marker[] = "libcgj-batch11625";

/* Soft Pango-ok lamp: always off for this continuum. */
#define B11625_PANGO_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b11625_pango_ok(void)
{
	return B11625_PANGO_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_pango_ok_u_11625 - Pango soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not create layouts or
 * call Pango/libc. No parent wires.
 */
uint32_t
gj_pango_ok_u_11625(void)
{
	(void)NULL;
	return b11625_pango_ok();
}
...
uint32_t __gj_pango_ok_u_11625(void)
    __attribute__((alias("gj_pango_ok_u_11625")));
