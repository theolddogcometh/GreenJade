 ...
 *
 * Desktop glibc graph batch11719: proton soft continuum lamp (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_proton_soft_ready_u_11719(void);
 ...
 *   uint32_t __gj_proton_soft_ready_u_11719  (alias)
 *   __libcgj_batch11719_marker = "libcgj-batch11719"
 *
 ...
 * gj_proton_soft_ready_u_11519 (batch11519), gj_proton_soft_ready_u_11319
 * (batch11319), and gj_proton_soft_ready_u_11119 (batch11119). No
...
const char __libcgj_batch11719_marker[] = "libcgj-batch11719";

/* Soft continuum lamp: off (soft-ready unit is intentionally 0). */
#define B11719_SOFT_READY  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b11719_soft_ready(void)
{
	return B11719_SOFT_READY;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_proton_soft_ready_u_11719 - proton soft continuum ready lamp.
 *
 * Always returns 0. Soft pure-data product tag for exclusive wave
 * 11711-11720; does not claim proton/wine/proton_ge/steam_runtime/
 * pressure_vessel/compat_tool/dxvk/vkd3d ok and does not call libc.
 * No parent wires.
 */
uint32_t
gj_proton_soft_ready_u_11719(void)
{
	(void)NULL;
	return b11719_soft_ready();
}
...
uint32_t __gj_proton_soft_ready_u_11719(void)
    __attribute__((alias("gj_proton_soft_ready_u_11719")));
