 ...
 *
 * Desktop glibc graph batch11912: Wine ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_wine_ok_u_11912(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Wine runtime probe for the proton/wine continuum.
 *   uint32_t __gj_wine_ok_u_11912  (alias)
 *   __libcgj_batch11912_marker = "libcgj-batch11912"
 *
 ...
 * gj_wine_ok_u_11712 (batch11712), gj_wine_ok_u_11512 (batch11512),
 * and gj_wine_ok_u_11312 (batch11312). No parent wires. No __int128.
...
const char __libcgj_batch11912_marker[] = "libcgj-batch11912";

/* Soft Wine-ok lamp: always off (not a real Wine probe). */
#define B11912_WINE_OK  0u
...
b11912_wine_ok(void)
{
	return B11912_WINE_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_wine_ok_u_11912 - Wine ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not inspect Wine or
 * call libc. No parent wires.
 */
uint32_t
gj_wine_ok_u_11912(void)
{
	(void)NULL;
	return b11912_wine_ok();
}
...
uint32_t __gj_wine_ok_u_11912(void)
    __attribute__((alias("gj_wine_ok_u_11912")));
