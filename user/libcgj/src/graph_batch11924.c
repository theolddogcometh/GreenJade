 ...
 *
 * Desktop glibc graph batch11924: Intel ANV soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_anv_ok_u_11924(void);
 *     - Returns 0 (Intel ANV soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live anv/Vulkan ICD probe.
 *   uint32_t __gj_anv_ok_u_11924  (alias)
 *   __libcgj_batch11924_marker = "libcgj-batch11924"
 *
 * Exclusive continuum CREATE-ONLY (11921-11930: mesa soft stubs —
 * all soft lamps →0; batch_id→11930). Unique gj_anv_ok_u_11924
 * surface only; no multi-def. Distinct from gj_anv_ok_u_11724,
...
const char __libcgj_batch11924_marker[] = "libcgj-batch11924";

/* Soft lamp: Intel ANV ok stub (not asserted). */
#define B11924_ANV_OK  0u
...
b11924_anv_ok(void)
{
	return B11924_ANV_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_anv_ok_u_11924 - Intel ANV soft id ok stub.
 *
...
uint32_t __gj_anv_ok_u_11924(void)
    __attribute__((alias("gj_anv_ok_u_11924")));
