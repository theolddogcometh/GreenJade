 ...
 *
 * Desktop glibc graph batch11938: PipeWire module soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_pw_module_ok_u_11938(void);
 *     - Always returns 0. Soft stub for pipewire/wireplumber soft-id
 *       continuum; PipeWire module path is intentionally not reported
 *       ok.
 *   uint32_t __gj_pw_module_ok_u_11938  (alias)
 *   __libcgj_batch11938_marker = "libcgj-batch11938"
 *
...
const char __libcgj_batch11938_marker[] = "libcgj-batch11938";

/* Soft PipeWire module-ok lamp: always off for this continuum. */
#define B11938_PW_MODULE_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b11938_pw_module_ok(void)
{
	return B11938_PW_MODULE_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_pw_module_ok_u_11938 - PipeWire module soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not load modules or call
 * libc. No parent wires.
 */
uint32_t
gj_pw_module_ok_u_11938(void)
{
	(void)NULL;
	return b11938_pw_module_ok();
}
...
uint32_t __gj_pw_module_ok_u_11938(void)
    __attribute__((alias("gj_pw_module_ok_u_11938")));
