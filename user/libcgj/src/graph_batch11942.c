 ...
 *
 * Desktop glibc graph batch11942: steamui ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_steamui_ok_u_11942(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Steam UI runtime probe for the bar3-related continuum.
 *   uint32_t __gj_steamui_ok_u_11942  (alias)
 *   __libcgj_batch11942_marker = "libcgj-batch11942"
 *
...
const char __libcgj_batch11942_marker[] = "libcgj-batch11942";

/* Soft steamui-ok lamp: always off (not a real UI probe). */
#define B11942_STEAMUI_OK  0u
...
b11942_ok(void)
{
	return B11942_STEAMUI_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_steamui_ok_u_11942 - steamui ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Steam UI
 * presence or call libc. No parent wires.
 */
uint32_t
gj_steamui_ok_u_11942(void)
{
	(void)NULL;
	return b11942_ok();
}
...
uint32_t __gj_steamui_ok_u_11942(void)
    __attribute__((alias("gj_steamui_ok_u_11942")));
