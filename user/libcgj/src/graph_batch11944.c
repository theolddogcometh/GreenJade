 ...
 *
 * Desktop glibc graph batch11944: deckui ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_deckui_ok_u_11944(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Steam Deck UI runtime probe for the bar3-related continuum.
 *   uint32_t __gj_deckui_ok_u_11944  (alias)
 *   __libcgj_batch11944_marker = "libcgj-batch11944"
 *
...
const char __libcgj_batch11944_marker[] = "libcgj-batch11944";

/* Soft deckui-ok lamp: always off (not a real Deck UI probe). */
#define B11944_DECKUI_OK  0u
...
b11944_ok(void)
{
	return B11944_DECKUI_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_deckui_ok_u_11944 - deckui ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Steam Deck UI
 * presence or call libc. No parent wires.
 */
uint32_t
gj_deckui_ok_u_11944(void)
{
	(void)NULL;
	return b11944_ok();
}
...
uint32_t __gj_deckui_ok_u_11944(void)
    __attribute__((alias("gj_deckui_ok_u_11944")));
