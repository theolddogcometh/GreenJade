 ...
 *
 * Desktop glibc graph batch11946: overlay ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_overlay_ok_u_11946(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       gamescope/steam overlay probe for the bar3-related continuum.
 *   uint32_t __gj_overlay_ok_u_11946  (alias)
 *   __libcgj_batch11946_marker = "libcgj-batch11946"
 *
...
const char __libcgj_batch11946_marker[] = "libcgj-batch11946";

/* Soft overlay-ok lamp: always off (not a real overlay probe). */
#define B11946_OVERLAY_OK  0u
...
b11946_ok(void)
{
	return B11946_OVERLAY_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_overlay_ok_u_11946 - overlay ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe overlay
 * presence or call libc. No parent wires.
 */
uint32_t
gj_overlay_ok_u_11946(void)
{
	(void)NULL;
	return b11946_ok();
}
...
uint32_t __gj_overlay_ok_u_11946(void)
    __attribute__((alias("gj_overlay_ok_u_11946")));
