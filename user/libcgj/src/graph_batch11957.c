 ...
 *
 * Desktop glibc graph batch11957: controller soft xpad ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_xpad_ok_u_11957(void);
 *     - Returns 0 (soft stub: xpad/Xbox controller slot is soft/unprobed;
 *       not a runtime xpad module or Xbox HID probe).
 *   uint32_t __gj_xpad_ok_u_11957  (alias)
 *   __libcgj_batch11957_marker = "libcgj-batch11957"
 *
 ...
 * batch_id_11960). Unique gj_xpad_ok_u_11957 surface only; no
 * multi-def. Distinct from gj_xpad_ok_u_11757 (batch11757),
 * gj_xpad_ok_u_11557 (batch11557), and sibling controller soft ok_u
...
const char __libcgj_batch11957_marker[] = "libcgj-batch11957";

/* Soft-stub xpad ok value (unprobed). */
#define B11957_XPAD_OK  0u
...
uint32_t __gj_xpad_ok_u_11957(void)
    __attribute__((alias("gj_xpad_ok_u_11957")));
