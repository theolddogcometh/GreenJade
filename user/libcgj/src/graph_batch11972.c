 ...
 *
 * Desktop glibc graph batch11972: tdp ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_tdp_ok_u_11972(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       TDP / thermal design power probe for the power soft continuum.
 *   uint32_t __gj_tdp_ok_u_11972  (alias)
 *   __libcgj_batch11972_marker = "libcgj-batch11972"
 *
...
const char __libcgj_batch11972_marker[] = "libcgj-batch11972";

/* Soft tdp-ok lamp: always off (not a real TDP probe). */
#define B11972_TDP_OK  0u
...
b11972_tdp_ok(void)
{
return B11972_TDP_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_tdp_ok_u_11972 - tdp ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe TDP/RAPL or
 * call libc. No parent wires.
 */
uint32_t
gj_tdp_ok_u_11972(void)
{
(void)NULL;
return b11972_tdp_ok();
}
...
uint32_t __gj_tdp_ok_u_11972(void)
    __attribute__((alias("gj_tdp_ok_u_11972")));
