 ...
 *
 * Desktop glibc graph batch11975: fan ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_fan_ok_u_11975(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       fan / cooling-device probe for the power soft continuum.
 *   uint32_t __gj_fan_ok_u_11975  (alias)
 *   __libcgj_batch11975_marker = "libcgj-batch11975"
 *
...
const char __libcgj_batch11975_marker[] = "libcgj-batch11975";

/* Soft fan-ok lamp: always off (not a real cooling-device probe). */
#define B11975_FAN_OK  0u
...
b11975_fan_ok(void)
{
return B11975_FAN_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_fan_ok_u_11975 - fan ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe fan hardware
 * or call libc. No parent wires.
 */
uint32_t
gj_fan_ok_u_11975(void)
{
(void)NULL;
return b11975_fan_ok();
}
...
uint32_t __gj_fan_ok_u_11975(void)
    __attribute__((alias("gj_fan_ok_u_11975")));
