 ...
 *
 * Desktop glibc graph batch12152: seatd soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_seatd_ok_u_12152(void);
 *     - Returns 0 (seatd soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live seatd/libseat probe.
 *   uint32_t __gj_seatd_ok_u_12152  (alias)
 *   __libcgj_batch12152_marker = "libcgj-batch12152"
 *
 ...
 * batch_id_12160). Unique gj_seatd_ok_u_12152 surface only; no
...
const char __libcgj_batch12152_marker[] = "libcgj-batch12152";

/* Soft lamp: not asserted. */
#define B12152_SEATD_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b12152_seatd_ok(void)
{
	return B12152_SEATD_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_seatd_ok_u_12152 - seatd soft id ok stub.
 *
...
uint32_t __gj_seatd_ok_u_12152(void)
    __attribute__((alias("gj_seatd_ok_u_12152")));
