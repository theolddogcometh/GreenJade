 ...
 *
 * Desktop glibc graph batch12245: cec ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_cec_ok_u_12245(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       HDMI-CEC runtime probe for the bar3-related continuum.
 *   uint32_t __gj_cec_ok_u_12245  (alias)
 *   __libcgj_batch12245_marker = "libcgj-batch12245"
 *
 ...
 * only; no multi-def. Distinct from gj_cec_ok_u_11945 /
 * gj_cec_ok_u_11745 / gj_cec_ok_u_11545. No parent wires. No __int128.
...
const char __libcgj_batch12245_marker[] = "libcgj-batch12245";

/* Soft cec-ok lamp: always off (not a real CEC probe). */
#define B12245_CEC_OK  0u
...
uint32_t __gj_cec_ok_u_12245(void)
    __attribute__((alias("gj_cec_ok_u_12245")));
