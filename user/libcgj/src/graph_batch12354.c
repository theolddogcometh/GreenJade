 ...
 *
 * Desktop glibc graph batch12354: PAM soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_pam_ok_u_12354(void);
 *     - Returns 0 (PAM soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live libpam probe.
 *   uint32_t __gj_pam_ok_u_12354  (alias)
 *   __libcgj_batch12354_marker = "libcgj-batch12354"
 *
 ...
 * batch_id_12360). Unique gj_pam_ok_u_12354 surface only; no
...
const char __libcgj_batch12354_marker[] = "libcgj-batch12354";

/* Soft lamp: not asserted. */
#define B12354_PAM_OK  0u
...
b12354_pam_ok(void)
{
	return B12354_PAM_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_pam_ok_u_12354 - PAM soft id ok stub.
 *
...
uint32_t __gj_pam_ok_u_12354(void)
    __attribute__((alias("gj_pam_ok_u_12354")));
