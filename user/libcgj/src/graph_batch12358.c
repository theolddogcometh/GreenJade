 ...
 *
 * Desktop glibc graph batch12358: seat soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_seat_ok_u_12358(void);
 *     - Returns 0 (seat soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live seat/device probe.
 *   uint32_t __gj_seat_ok_u_12358  (alias)
 *   __libcgj_batch12358_marker = "libcgj-batch12358"
 *
 ...
 * batch_id_12360). Unique gj_seat_ok_u_12358 surface only; no
...
const char __libcgj_batch12358_marker[] = "libcgj-batch12358";

/* Soft lamp: not asserted. */
#define B12358_SEAT_OK  0u
...
b12358_seat_ok(void)
{
	return B12358_SEAT_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_seat_ok_u_12358 - seat soft id ok stub.
 *
...
uint32_t __gj_seat_ok_u_12358(void)
    __attribute__((alias("gj_seat_ok_u_12358")));
