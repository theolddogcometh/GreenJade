 ...
 *
 * Desktop glibc graph batch12361: udev soft-id stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_udev_ok_u_12361(void);
 ...
 *   uint32_t __gj_udev_ok_u_12361  (alias)
 *   __libcgj_batch12361_marker = "libcgj-batch12361"
 *
 ...
 * Unique gj_udev_ok_u_12361 surface only; no multi-def. Soft stub —
...
const char __libcgj_batch12361_marker[] = "libcgj-batch12361";

/* Soft unavailable / not-detected udev lamp. */
#define B12361_UDEV_OK  0u
...
uint32_t __gj_udev_ok_u_12361(void)
    __attribute__((alias("gj_udev_ok_u_12361")));
