 ...
 *
 * Desktop glibc graph batch12373: iwd soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_iwd_ok_u_12373(void);
 *     - Always returns 0. Soft stub for bluez/networkmanager soft-id
 *       continuum; iwd path is intentionally not reported ok.
 *   uint32_t __gj_iwd_ok_u_12373  (alias)
 *   __libcgj_batch12373_marker = "libcgj-batch12373"
 *
...
const char __libcgj_batch12373_marker[] = "libcgj-batch12373";

/* Soft iwd-ok lamp: always off for this continuum. */
#define B12373_IWD_OK  0u
...
b12373_iwd_ok(void)
{
	return B12373_IWD_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_iwd_ok_u_12373 - iwd soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not open iwd or call
 * libc. No parent wires.
 */
uint32_t
gj_iwd_ok_u_12373(void)
{
	(void)NULL;
	return b12373_iwd_ok();
}
...
uint32_t __gj_iwd_ok_u_12373(void)
    __attribute__((alias("gj_iwd_ok_u_12373")));
