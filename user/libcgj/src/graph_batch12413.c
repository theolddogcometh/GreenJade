 ...
 *
 * Desktop glibc graph batch12413: Proton-GE ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_proton_ge_ok_u_12413(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Proton-GE runtime probe for the proton soft continuum.
 *   uint32_t __gj_proton_ge_ok_u_12413  (alias)
 *   __libcgj_batch12413_marker = "libcgj-batch12413"
 *
 ...
 * _10213 / _10011 and gj_proton_ok_u_12411 (batch12411). No parent
...
const char __libcgj_batch12413_marker[] = "libcgj-batch12413";

/* Soft Proton-GE-ok lamp: always off (not a real Proton-GE probe). */
#define B12413_PROTON_GE_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b12413_proton_ge_ok(void)
{
	return B12413_PROTON_GE_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_proton_ge_ok_u_12413 - Proton-GE ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not inspect Proton-GE or
 * call libc. No parent wires.
 */
uint32_t
gj_proton_ge_ok_u_12413(void)
{
	(void)NULL;
	return b12413_proton_ge_ok();
}
...
uint32_t __gj_proton_ge_ok_u_12413(void)
    __attribute__((alias("gj_proton_ge_ok_u_12413")));
