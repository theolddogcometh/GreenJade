 ...
 *
 * Desktop glibc graph batch12445: cec ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_cec_ok_u_12445(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       HDMI-CEC runtime probe for the gamescope soft continuum.
 *   uint32_t __gj_cec_ok_u_12445  (alias)
 *   __libcgj_batch12445_marker = "libcgj-batch12445"
 *
 ...
 * only; no multi-def. Distinct from gj_cec_ok_u_12245 /
 * gj_cec_ok_u_12045 / gj_cec_ok_u_11945. No parent wires. No __int128.
...
const char __libcgj_batch12445_marker[] = "libcgj-batch12445";

/* Soft cec-ok lamp: always off (not a real CEC probe). */
#define B12445_CEC_OK  0u
...
uint32_t __gj_cec_ok_u_12445(void)
    __attribute__((alias("gj_cec_ok_u_12445")));
