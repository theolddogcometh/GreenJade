 ...
 *
 * Desktop glibc graph batch12555: shadow soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_shadow_ok_u_12555(void);
 *     - Returns 0 (shadow soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live shadow/libshadow probe.
 *   uint32_t __gj_shadow_ok_u_12555  (alias)
 *   __libcgj_batch12555_marker = "libcgj-batch12555"
 *
 ...
 * batch_id_12560). Unique gj_shadow_ok_u_12555 surface only; no
...
const char __libcgj_batch12555_marker[] = "libcgj-batch12555";

/* Soft lamp: not asserted. */
#define B12555_SHADOW_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b12555_shadow_ok(void)
{
	return B12555_SHADOW_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_shadow_ok_u_12555 - shadow soft id ok stub.
 *
...
uint32_t __gj_shadow_ok_u_12555(void)
    __attribute__((alias("gj_shadow_ok_u_12555")));
