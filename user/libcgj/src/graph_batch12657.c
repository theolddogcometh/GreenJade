 ...
 *
 * Desktop glibc graph batch12657: controller soft xpad ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_xpad_ok_u_12657(void);
 *     - Returns 0 (soft stub: xpad/Xbox controller slot is soft/unprobed;
 *       not a runtime xpad module or Xbox HID probe).
 *   uint32_t __gj_xpad_ok_u_12657  (alias)
 *   __libcgj_batch12657_marker = "libcgj-batch12657"
 *
 ...
 * batch_id_12660). Unique gj_xpad_ok_u_12657 surface only; no
 * multi-def. Distinct from gj_xpad_ok_u_12457 (batch12457),
 * gj_xpad_ok_u_12057 (batch12057), gj_xpad_ok_u_11957 (batch11957),
...
const char __libcgj_batch12657_marker[] = "libcgj-batch12657";

/* Soft-stub xpad ok value (unprobed). */
#define B12657_XPAD_OK  0u
...
uint32_t __gj_xpad_ok_u_12657(void)
    __attribute__((alias("gj_xpad_ok_u_12657")));
