 ...
 *
 * Desktop glibc graph batch12754: PAM soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_pam_ok_u_12754(void);
 *     - Returns 0 (PAM soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live libpam probe.
 *   uint32_t __gj_pam_ok_u_12754  (alias)
 *   __libcgj_batch12754_marker = "libcgj-batch12754"
 *
 ...
 * batch_id_12760). Unique gj_pam_ok_u_12754 surface only; no
...
const char __libcgj_batch12754_marker[] = "libcgj-batch12754";

/* Soft lamp: not asserted. */
#define B12754_PAM_OK  0u
...
b12754_pam_ok(void)
{
	return B12754_PAM_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_pam_ok_u_12754 - PAM soft id ok stub.
 *
...
uint32_t __gj_pam_ok_u_12754(void)
    __attribute__((alias("gj_pam_ok_u_12754")));
