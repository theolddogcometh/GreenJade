 ...
 *
 * Desktop glibc graph batch12771: bluez ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_bluez_ok_u_12771(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       bluez/Bluetooth daemon runtime probe for the netmgr soft path.
 *   uint32_t __gj_bluez_ok_u_12771  (alias)
 *   __libcgj_batch12771_marker = "libcgj-batch12771"
 *
...
const char __libcgj_batch12771_marker[] = "libcgj-batch12771";

/* Soft bluez-ok lamp: always off (not a real runtime probe). */
#define B12771_BLUEZ_OK  0u
...
uint32_t __gj_bluez_ok_u_12771(void)
    __attribute__((alias("gj_bluez_ok_u_12771")));
