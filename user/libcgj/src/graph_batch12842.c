 ...
 *
 * Desktop glibc graph batch12842: steamui ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_steamui_ok_u_12842(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Steam UI runtime probe for the gamescope soft continuum.
 *   uint32_t __gj_steamui_ok_u_12842  (alias)
 *   __libcgj_batch12842_marker = "libcgj-batch12842"
 *
 ...
 * gj_steamui_ok_u_12242 / gj_steamui_ok_u_12142. No parent wires.
...
const char __libcgj_batch12842_marker[] = "libcgj-batch12842";

/* Soft steamui-ok lamp: always off (not a real UI probe). */
#define B12842_STEAMUI_OK  0u
...
b12842_ok(void)
{
	return B12842_STEAMUI_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_steamui_ok_u_12842 - steamui ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Steam UI
 * presence or call libc. No parent wires.
 */
uint32_t
gj_steamui_ok_u_12842(void)
{
	(void)NULL;
	return b12842_ok();
}
...
uint32_t __gj_steamui_ok_u_12842(void)
    __attribute__((alias("gj_steamui_ok_u_12842")));
