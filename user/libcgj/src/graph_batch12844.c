 ...
 *
 * Desktop glibc graph batch12844: deckui ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_deckui_ok_u_12844(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Steam Deck UI runtime probe for the gamescope soft continuum.
 *   uint32_t __gj_deckui_ok_u_12844  (alias)
 *   __libcgj_batch12844_marker = "libcgj-batch12844"
 *
 ...
 * gj_deckui_ok_u_12244 / gj_deckui_ok_u_12144. No parent wires.
...
const char __libcgj_batch12844_marker[] = "libcgj-batch12844";

/* Soft deckui-ok lamp: always off (not a real Deck UI probe). */
#define B12844_DECKUI_OK  0u
...
b12844_ok(void)
{
	return B12844_DECKUI_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_deckui_ok_u_12844 - deckui ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Steam Deck UI
 * presence or call libc. No parent wires.
 */
uint32_t
gj_deckui_ok_u_12844(void)
{
	(void)NULL;
	return b12844_ok();
}
...
uint32_t __gj_deckui_ok_u_12844(void)
    __attribute__((alias("gj_deckui_ok_u_12844")));
