 ...
 *
 * Desktop glibc graph batch12846: overlay ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_overlay_ok_u_12846(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       gamescope/steam overlay probe for the gamescope soft continuum.
 *   uint32_t __gj_overlay_ok_u_12846  (alias)
 *   __libcgj_batch12846_marker = "libcgj-batch12846"
 *
 ...
 * gj_overlay_ok_u_12246 / gj_overlay_ok_u_12146. No parent wires.
...
const char __libcgj_batch12846_marker[] = "libcgj-batch12846";

/* Soft overlay-ok lamp: always off (not a real overlay probe). */
#define B12846_OVERLAY_OK  0u
...
b12846_ok(void)
{
	return B12846_OVERLAY_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_overlay_ok_u_12846 - overlay ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe overlay
 * presence or call libc. No parent wires.
 */
uint32_t
gj_overlay_ok_u_12846(void)
{
	(void)NULL;
	return b12846_ok();
}
...
uint32_t __gj_overlay_ok_u_12846(void)
    __attribute__((alias("gj_overlay_ok_u_12846")));
