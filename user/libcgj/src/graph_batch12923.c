 ...
 *
 * Desktop glibc graph batch12923: HarfBuzz soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_harfbuzz_ok_u_12923(void);
 *     - Always returns 0. Soft stub for fontconfig/freetype soft-id
 *       continuum; HarfBuzz is intentionally not reported ok.
 *   uint32_t __gj_harfbuzz_ok_u_12923  (alias)
 *   __libcgj_batch12923_marker = "libcgj-batch12923"
 *
 ...
 * gj_harfbuzz_ok_u_12723 (batch12723), gj_harfbuzz_ok_u_12523
 * (batch12523), gj_harfbuzz_ok_u_12323 (batch12323),
...
const char __libcgj_batch12923_marker[] = "libcgj-batch12923";

/* Soft HarfBuzz-ok lamp: always off for this continuum. */
#define B12923_HARFBUZZ_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b12923_harfbuzz_ok(void)
{
	return B12923_HARFBUZZ_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_harfbuzz_ok_u_12923 - HarfBuzz soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not shape text or call
 * HarfBuzz/libc. No parent wires.
 */
uint32_t
gj_harfbuzz_ok_u_12923(void)
{
	(void)NULL;
	return b12923_harfbuzz_ok();
}
...
uint32_t __gj_harfbuzz_ok_u_12923(void)
    __attribute__((alias("gj_harfbuzz_ok_u_12923")));
