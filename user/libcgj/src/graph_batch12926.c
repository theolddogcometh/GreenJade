 ...
 *
 * Desktop glibc graph batch12926: FriBidi soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_fribidi_ok_u_12926(void);
 *     - Always returns 0. Soft stub for fontconfig/freetype soft-id
 *       continuum; FriBidi is intentionally not reported ok.
 *   uint32_t __gj_fribidi_ok_u_12926  (alias)
 *   __libcgj_batch12926_marker = "libcgj-batch12926"
 *
 ...
 * gj_fribidi_ok_u_12726 (batch12726), gj_fribidi_ok_u_12526
 * (batch12526), gj_fribidi_ok_u_12326 (batch12326) and
...
const char __libcgj_batch12926_marker[] = "libcgj-batch12926";

/* Soft FriBidi-ok lamp: always off for this continuum. */
#define B12926_FRIBIDI_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b12926_fribidi_ok(void)
{
	return B12926_FRIBIDI_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_fribidi_ok_u_12926 - FriBidi soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not run bidi algorithms
 * or call FriBidi/libc. No parent wires.
 */
uint32_t
gj_fribidi_ok_u_12926(void)
{
	(void)NULL;
	return b12926_fribidi_ok();
}
...
uint32_t __gj_fribidi_ok_u_12926(void)
    __attribute__((alias("gj_fribidi_ok_u_12926")));
