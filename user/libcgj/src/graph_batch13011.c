 ...
 *
 * Desktop glibc graph batch13011: Proton ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_proton_ok_u_13011(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Proton/Wine runtime probe for the proton soft continuum.
 *   uint32_t __gj_proton_ok_u_13011  (alias)
 *   __libcgj_batch13011_marker = "libcgj-batch13011"
 *
 ...
 * multi-def. Distinct from gj_proton_ok_u_10311 / gj_proton_ok_u_10211.
...
const char __libcgj_batch13011_marker[] = "libcgj-batch13011";

/* Soft Proton-ok lamp: always off (not a real Proton probe). */
#define B13011_PROTON_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13011_proton_ok(void)
{
	return B13011_PROTON_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_proton_ok_u_13011 - Proton ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not inspect Proton or
 * call libc. No parent wires.
 */
uint32_t
gj_proton_ok_u_13011(void)
{
	(void)NULL;
	return b13011_proton_ok();
}
...
uint32_t __gj_proton_ok_u_13011(void)
    __attribute__((alias("gj_proton_ok_u_13011")));
