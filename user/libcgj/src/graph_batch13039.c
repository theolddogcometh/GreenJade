 ...
 *
 * Desktop glibc graph batch13039: audio soft continuum lamp (on).
 *
 * Surface (unique symbols):
 *   uint32_t gj_audio_soft_ready_u_13039(void);
 ...
 *   uint32_t __gj_audio_soft_ready_u_13039  (alias)
 *   __libcgj_batch13039_marker = "libcgj-batch13039"
 *
 ...
 * Distinct from gj_audio_soft_ready_u_12839 (batch12839),
 * gj_audio_soft_ready_u_12639 (batch12639),
 * gj_audio_soft_ready_u_12439 (batch12439),
 * gj_audio_soft_ready_u_12239 (batch12239),
 * gj_audio_soft_ready_u_12039 (batch12039), and
 * gj_audio_soft_ready_u_10239 (batch10239). No parent wires. No
 * __int128.
 *
...
const char __libcgj_batch13039_marker[] = "libcgj-batch13039";

/* Soft continuum lamp: surfaces present (soft ready only). */
#define B13039_SOFT_READY  1u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13039_soft_ready(void)
{
	return B13039_SOFT_READY;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_audio_soft_ready_u_13039 - audio soft continuum ready lamp.
 *
 * Always returns 1. Soft pure-data product tag that exclusive wave
 * 13031-13040 surfaces are present. Does not claim pipewire/
 * wireplumber/pulse_compat/alsa/jack/audio_latency/bluetooth_audio/
 * hdmi_audio ok and does not call libc. No parent wires.
 */
uint32_t
gj_audio_soft_ready_u_13039(void)
{
	(void)NULL;
	return b13039_soft_ready();
}
...
uint32_t __gj_audio_soft_ready_u_13039(void)
    __attribute__((alias("gj_audio_soft_ready_u_13039")));
