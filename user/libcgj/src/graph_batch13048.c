 ...
 *
 * Desktop glibc graph batch13048: hdr ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_hdr_ok_u_13048(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       HDR display/runtime probe for the gamescope soft continuum.
 *   uint32_t __gj_hdr_ok_u_13048  (alias)
 *   __libcgj_batch13048_marker = "libcgj-batch13048"
 *
 ...
 * only; no multi-def. Distinct from gj_hdr_ok_u_12848 /
 * gj_hdr_ok_u_12648 / gj_hdr_ok_u_12448. No parent wires. No __int128.
...
const char __libcgj_batch13048_marker[] = "libcgj-batch13048";

/* Soft hdr-ok lamp: always off (not a real HDR probe). */
#define B13048_HDR_OK  0u
...
uint32_t __gj_hdr_ok_u_13048(void)
    __attribute__((alias("gj_hdr_ok_u_13048")));
