 ...
 *
 * Desktop glibc graph batch13156: sudo ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_sudo_ok_u_13156(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       sudo probe for the auth soft continuum.
 *   uint32_t __gj_sudo_ok_u_13156  (alias)
 *   __libcgj_batch13156_marker = "libcgj-batch13156"
 *
 ...
 * gj_sudo_ok_u_12956 (batch12956), gj_sudo_ok_u_12756 (batch12756),
...
const char __libcgj_batch13156_marker[] = "libcgj-batch13156";

/* Soft sudo-ok lamp: always off (not a real sudo probe). */
#define B13156_SUDO_OK  0u
...
b13156_sudo_ok(void)
{
	return B13156_SUDO_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_sudo_ok_u_13156 - sudo ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not invoke sudo or call
 * libc. No parent wires.
 */
uint32_t
gj_sudo_ok_u_13156(void)
{
	(void)NULL;
	return b13156_sudo_ok();
}
...
uint32_t __gj_sudo_ok_u_13156(void)
    __attribute__((alias("gj_sudo_ok_u_13156")));
