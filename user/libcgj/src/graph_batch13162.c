 ...
 *
 * Desktop glibc graph batch13162: libinput soft ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_libinput_ok_u_13162(void);
 *     - Returns 0 (soft stub: libinput stack slot is soft/unprobed;
 *       not a runtime libinput or seat probe).
 *   uint32_t __gj_libinput_ok_u_13162  (alias)
 *   __libcgj_batch13162_marker = "libcgj-batch13162"
 *
 ...
 * batch_id_13170). Unique gj_libinput_ok_u_13162 surface only; no
...
const char __libcgj_batch13162_marker[] = "libcgj-batch13162";

/* Soft-stub libinput ok value (unprobed). */
#define B13162_LIBINPUT_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13162_libinput_ok(void)
{
	return B13162_LIBINPUT_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_libinput_ok_u_13162 - soft libinput stack ok stub.
 *
 * Always returns 0 (soft/unprobed libinput slot). Does not call libc or
 * probe seats/devices. No parent wires.
 */
uint32_t
gj_libinput_ok_u_13162(void)
{
	(void)NULL;
	return b13162_libinput_ok();
}
...
uint32_t __gj_libinput_ok_u_13162(void)
    __attribute__((alias("gj_libinput_ok_u_13162")));
