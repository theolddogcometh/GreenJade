 ...
 *
 * Desktop glibc graph batch13325: Pango soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_pango_ok_u_13325(void);
 *     - Always returns 0. Soft stub for fontconfig/freetype soft-id
 *       continuum; Pango is intentionally not reported ok.
 *   uint32_t __gj_pango_ok_u_13325  (alias)
 *   __libcgj_batch13325_marker = "libcgj-batch13325"
 *
...
const char __libcgj_batch13325_marker[] = "libcgj-batch13325";

/* Soft Pango-ok lamp: always off for this continuum. */
#define B13325_PANGO_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13325_pango_ok(void)
{
	return B13325_PANGO_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_pango_ok_u_13325 - Pango soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not create layouts or
 * call Pango/libc. No parent wires.
 */
uint32_t
gj_pango_ok_u_13325(void)
{
	(void)NULL;
	return b13325_pango_ok();
}
...
uint32_t __gj_pango_ok_u_13325(void)
    __attribute__((alias("gj_pango_ok_u_13325")));
