 ...
 *
 * Desktop glibc graph batch13326: FriBidi soft-ok unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_fribidi_ok_u_13326(void);
 *     - Always returns 0. Soft stub for fontconfig/freetype soft-id
 *       continuum; FriBidi is intentionally not reported ok.
 *   uint32_t __gj_fribidi_ok_u_13326  (alias)
 *   __libcgj_batch13326_marker = "libcgj-batch13326"
 *
...
const char __libcgj_batch13326_marker[] = "libcgj-batch13326";

/* Soft FriBidi-ok lamp: always off for this continuum. */
#define B13326_FRIBIDI_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13326_fribidi_ok(void)
{
	return B13326_FRIBIDI_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_fribidi_ok_u_13326 - FriBidi soft-ok unit flag.
 *
 * Always returns 0. Soft pure-data stub; does not run bidi algorithms
 * or call FriBidi/libc. No parent wires.
 */
uint32_t
gj_fribidi_ok_u_13326(void)
{
	(void)NULL;
	return b13326_fribidi_ok();
}
...
uint32_t __gj_fribidi_ok_u_13326(void)
    __attribute__((alias("gj_fribidi_ok_u_13326")));
