 ...
 *
 * Desktop glibc graph batch13354: PAM soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_pam_ok_u_13354(void);
 *     - Returns 0 (PAM soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live libpam probe.
 *   uint32_t __gj_pam_ok_u_13354  (alias)
 *   __libcgj_batch13354_marker = "libcgj-batch13354"
 *
 ...
 * batch_id_13360). Unique gj_pam_ok_u_13354 surface only; no
...
const char __libcgj_batch13354_marker[] = "libcgj-batch13354";

/* Soft lamp: not asserted. */
#define B13354_PAM_OK  0u
...
b13354_pam_ok(void)
{
	return B13354_PAM_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_pam_ok_u_13354 - PAM soft id ok stub.
 *
...
uint32_t __gj_pam_ok_u_13354(void)
    __attribute__((alias("gj_pam_ok_u_13354")));
