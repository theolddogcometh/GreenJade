 ...
 *
 * Desktop glibc graph batch13355: shadow soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_shadow_ok_u_13355(void);
 *     - Returns 0 (shadow soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live shadow/libshadow probe.
 *   uint32_t __gj_shadow_ok_u_13355  (alias)
 *   __libcgj_batch13355_marker = "libcgj-batch13355"
 *
 ...
 * batch_id_13360). Unique gj_shadow_ok_u_13355 surface only; no
...
const char __libcgj_batch13355_marker[] = "libcgj-batch13355";

/* Soft lamp: not asserted. */
#define B13355_SHADOW_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13355_shadow_ok(void)
{
	return B13355_SHADOW_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_shadow_ok_u_13355 - shadow soft id ok stub.
 *
...
uint32_t __gj_shadow_ok_u_13355(void)
    __attribute__((alias("gj_shadow_ok_u_13355")));
