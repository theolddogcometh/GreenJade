 ...
 *
 * Desktop glibc graph batch13382: IPP ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_ipp_ok_u_13382(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Internet Printing Protocol probe for the cups/print continuum.
 *   uint32_t __gj_ipp_ok_u_13382  (alias)
 *   __libcgj_batch13382_marker = "libcgj-batch13382"
 *
 ...
 * gj_ipp_ok_u_13182 (batch13182), gj_ipp_ok_u_12982 (batch12982),
 * gj_ipp_ok_u_12782 (batch12782), gj_ipp_ok_u_12582 (batch12582),
 * gj_ipp_ok_u_12382 (batch12382), gj_ipp_ok_u_10182 (batch10182) and
...
const char __libcgj_batch13382_marker[] = "libcgj-batch13382";

/* Soft IPP-ok lamp: always off (not a real IPP probe). */
#define B13382_IPP_OK  0u
...
b13382_ipp_ok(void)
{
	return B13382_IPP_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_ipp_ok_u_13382 - IPP ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not open IPP sockets or
 * call libc. No parent wires.
 */
uint32_t
gj_ipp_ok_u_13382(void)
{
	(void)NULL;
	return b13382_ipp_ok();
}
...
uint32_t __gj_ipp_ok_u_13382(void)
    __attribute__((alias("gj_ipp_ok_u_13382")));
