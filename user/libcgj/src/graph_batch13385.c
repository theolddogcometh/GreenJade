 ...
 *
 * Desktop glibc graph batch13385: PPD ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_ppd_ok_u_13385(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       PostScript Printer Description probe for the cups/print
 *       continuum.
 *   uint32_t __gj_ppd_ok_u_13385  (alias)
 *   __libcgj_batch13385_marker = "libcgj-batch13385"
 *
 ...
 * gj_ppd_ok_u_13185 (batch13185), gj_ppd_ok_u_12985 (batch12985),
 * gj_ppd_ok_u_12785 (batch12785), gj_ppd_ok_u_12585 (batch12585),
 * gj_ppd_ok_u_12385 (batch12385), gj_ppd_ok_u_10185 (batch10185) and
...
const char __libcgj_batch13385_marker[] = "libcgj-batch13385";

/* Soft PPD-ok lamp: always off (not a real PPD probe). */
#define B13385_PPD_OK  0u
...
b13385_ppd_ok(void)
{
	return B13385_PPD_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_ppd_ok_u_13385 - PPD ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not parse PPD files or
 * call libc. No parent wires.
 */
uint32_t
gj_ppd_ok_u_13385(void)
{
	(void)NULL;
	return b13385_ppd_ok();
}
...
uint32_t __gj_ppd_ok_u_13385(void)
    __attribute__((alias("gj_ppd_ok_u_13385")));
