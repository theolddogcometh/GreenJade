 ...
 *
 * Desktop glibc graph batch13389: print soft continuum lamp (on).
 *
 * Surface (unique symbols):
 *   uint32_t gj_print_soft_ready_u_13389(void);
 ...
 *       ok.
 *   uint32_t __gj_print_soft_ready_u_13389  (alias)
 *   __libcgj_batch13389_marker = "libcgj-batch13389"
 *
 ...
 * remain 0. Distinct from gj_print_soft_ready_u_13189 (batch13189),
...
const char __libcgj_batch13389_marker[] = "libcgj-batch13389";

/* Soft continuum lamp: surfaces present (soft ready only). */
#define B13389_SOFT_READY  1u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13389_soft_ready(void)
{
	return B13389_SOFT_READY;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_print_soft_ready_u_13389 - print soft continuum ready lamp.
 *
 * Always returns 1. Soft pure-data product tag that exclusive wave
 * 13381-13390 surfaces are present. Does not claim cups/ipp/print_job/
 * printer_discover/ppd/filter/spool/usb_print ok and does not call
 * libc. No parent wires.
 */
uint32_t
gj_print_soft_ready_u_13389(void)
{
	(void)NULL;
	return b13389_soft_ready();
}
...
uint32_t __gj_print_soft_ready_u_13389(void)
    __attribute__((alias("gj_print_soft_ready_u_13389")));
