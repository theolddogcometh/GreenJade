 ...
 *
 * Desktop glibc graph batch13457: haptics ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_haptics_ok_u_13457(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       haptics/rumble probe for the controller/input continuum.
 *   uint32_t __gj_haptics_ok_u_13457  (alias)
 *   __libcgj_batch13457_marker = "libcgj-batch13457"
 *
...
const char __libcgj_batch13457_marker[] = "libcgj-batch13457";

/* Soft haptics-ok lamp: always off (not a real haptics probe). */
#define B13457_HAPTICS_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13457_haptics_ok(void)
{
	return B13457_HAPTICS_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_haptics_ok_u_13457 - haptics ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not drive FF/rumble or
 * call libc. No parent wires.
 */
uint32_t
gj_haptics_ok_u_13457(void)
{
	(void)NULL;
	return b13457_haptics_ok();
}
...
uint32_t __gj_haptics_ok_u_13457(void)
    __attribute__((alias("gj_haptics_ok_u_13457")));
