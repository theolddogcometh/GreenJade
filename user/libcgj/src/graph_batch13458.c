 ...
 *
 * Desktop glibc graph batch13458: gyro ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_gyro_ok_u_13458(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       gyroscope/IMU probe for the controller/input continuum.
 *   uint32_t __gj_gyro_ok_u_13458  (alias)
 *   __libcgj_batch13458_marker = "libcgj-batch13458"
 *
...
const char __libcgj_batch13458_marker[] = "libcgj-batch13458";

/* Soft gyro-ok lamp: always off (not a real gyro/IMU probe). */
#define B13458_GYRO_OK  0u
...
b13458_gyro_ok(void)
{
	return B13458_GYRO_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_gyro_ok_u_13458 - gyro ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not read IMU axes or
 * call libc. No parent wires.
 */
uint32_t
gj_gyro_ok_u_13458(void)
{
	(void)NULL;
	return b13458_gyro_ok();
}
...
uint32_t __gj_gyro_ok_u_13458(void)
    __attribute__((alias("gj_gyro_ok_u_13458")));
