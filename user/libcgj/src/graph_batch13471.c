 ...
 *
 * Desktop glibc graph batch13471: power ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_power_ok_u_13471(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       power-rail / power-domain runtime probe for the power/thermal
 *       soft product continuum.
 *   uint32_t __gj_power_ok_u_13471  (alias)
 *   __libcgj_batch13471_marker = "libcgj-batch13471"
 *
...
const char __libcgj_batch13471_marker[] = "libcgj-batch13471";

/* Soft power-ok lamp: always off (not a real power-domain probe). */
#define B13471_POWER_OK  0u
...
b13471_ok(void)
{
	return B13471_POWER_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_power_ok_u_13471 - power ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe power rails
 * or call libc. No parent wires.
 */
uint32_t
gj_power_ok_u_13471(void)
{
	(void)NULL;
	return b13471_ok();
}
...
uint32_t __gj_power_ok_u_13471(void)
    __attribute__((alias("gj_power_ok_u_13471")));
