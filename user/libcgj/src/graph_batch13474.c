 ...
 *
 * Desktop glibc graph batch13474: thermal ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_thermal_ok_u_13474(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       thermal zone / temperature sensor runtime probe for the
 *       power/thermal soft product continuum.
 *   uint32_t __gj_thermal_ok_u_13474  (alias)
 *   __libcgj_batch13474_marker = "libcgj-batch13474"
 *
...
const char __libcgj_batch13474_marker[] = "libcgj-batch13474";

/* Soft thermal-ok lamp: always off (not a real thermal-zone probe). */
#define B13474_THERMAL_OK  0u
...
b13474_ok(void)
{
	return B13474_THERMAL_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_thermal_ok_u_13474 - thermal ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe thermal zones
 * or call libc. No parent wires.
 */
uint32_t
gj_thermal_ok_u_13474(void)
{
	(void)NULL;
	return b13474_ok();
}
...
uint32_t __gj_thermal_ok_u_13474(void)
    __attribute__((alias("gj_thermal_ok_u_13474")));
