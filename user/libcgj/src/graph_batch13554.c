 ...
 *
 * Desktop glibc graph batch13554: PAM soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_pam_ok_u_13554(void);
 *     - Returns 0 (PAM soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live libpam probe.
 *   uint32_t __gj_pam_ok_u_13554  (alias)
 *   __libcgj_batch13554_marker = "libcgj-batch13554"
 *
 ...
 * batch_id_13560). Unique gj_pam_ok_u_13554 surface only; no
...
const char __libcgj_batch13554_marker[] = "libcgj-batch13554";

/* Soft lamp: not asserted. */
#define B13554_PAM_OK  0u
...
b13554_pam_ok(void)
{
	return B13554_PAM_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_pam_ok_u_13554 - PAM soft id ok stub.
 *
...
uint32_t __gj_pam_ok_u_13554(void)
    __attribute__((alias("gj_pam_ok_u_13554")));
