 ...
 *
 * Desktop glibc graph batch13555: shadow soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_shadow_ok_u_13555(void);
 *     - Returns 0 (shadow soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live shadow/libshadow probe.
 *   uint32_t __gj_shadow_ok_u_13555  (alias)
 *   __libcgj_batch13555_marker = "libcgj-batch13555"
 *
 ...
 * batch_id_13560). Unique gj_shadow_ok_u_13555 surface only; no
...
const char __libcgj_batch13555_marker[] = "libcgj-batch13555";

/* Soft lamp: not asserted. */
#define B13555_SHADOW_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13555_shadow_ok(void)
{
	return B13555_SHADOW_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_shadow_ok_u_13555 - shadow soft id ok stub.
 *
...
uint32_t __gj_shadow_ok_u_13555(void)
    __attribute__((alias("gj_shadow_ok_u_13555")));
