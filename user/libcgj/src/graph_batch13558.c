 ...
 *
 * Desktop glibc graph batch13558: seat soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_seat_ok_u_13558(void);
 *     - Returns 0 (seat soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live seat/device probe.
 *   uint32_t __gj_seat_ok_u_13558  (alias)
 *   __libcgj_batch13558_marker = "libcgj-batch13558"
 *
 ...
 * batch_id_13560). Unique gj_seat_ok_u_13558 surface only; no
...
const char __libcgj_batch13558_marker[] = "libcgj-batch13558";

/* Soft lamp: not asserted. */
#define B13558_SEAT_OK  0u
...
b13558_seat_ok(void)
{
	return B13558_SEAT_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_seat_ok_u_13558 - seat soft id ok stub.
 *
...
uint32_t __gj_seat_ok_u_13558(void)
    __attribute__((alias("gj_seat_ok_u_13558")));
