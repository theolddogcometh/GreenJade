 ...
 *
 * Desktop glibc graph batch13581: CUPS ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_cups_ok_u_13581(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       cups/cupsd probe for the cups/print continuum.
 *   uint32_t __gj_cups_ok_u_13581  (alias)
 *   __libcgj_batch13581_marker = "libcgj-batch13581"
 *
 ...
 * gj_cups_ok_u_13381 (batch13381), gj_cups_ok_u_13181 (batch13181),
...
const char __libcgj_batch13581_marker[] = "libcgj-batch13581";

/* Soft CUPS-ok lamp: always off (not a real cups probe). */
#define B13581_CUPS_OK  0u
...
b13581_cups_ok(void)
{
	return B13581_CUPS_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_cups_ok_u_13581 - CUPS ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not inspect cupsd or
 * call libc. No parent wires.
 */
uint32_t
gj_cups_ok_u_13581(void)
{
	(void)NULL;
	return b13581_cups_ok();
}
...
uint32_t __gj_cups_ok_u_13581(void)
    __attribute__((alias("gj_cups_ok_u_13581")));
