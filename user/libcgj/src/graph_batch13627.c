 ...
 *
 * Desktop glibc graph batch13627: zink ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_zink_ok_u_13627(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       zink GL-on-Vulkan probe for the mesa soft continuum.
 *   uint32_t __gj_zink_ok_u_13627  (alias)
 *   __libcgj_batch13627_marker = "libcgj-batch13627"
 *
 ...
 * Unique surface only; no multi-def. Distinct from gj_zink_ok_u_13427,
 * gj_zink_ok_u_13226, gj_zink_ok_u_13026, gj_zink_ok_u_12826,
 ...
 * gj_zink_ok_u_10926, gj_zink_ok_u_10726, gj_zink_ok_u_10527,
 * gj_zink_ok_u_10327, gj_zink_ok_u_10227, gj_zink_ok_u_10026 and
...
const char __libcgj_batch13627_marker[] = "libcgj-batch13627";

/* Soft zink-ok lamp: always off (not a real runtime probe). */
#define B13627_ZINK_OK  0u
...
b13627_ok(void)
{
	return B13627_ZINK_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_zink_ok_u_13627 - zink ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not load zink GL-on-Vulkan
 * or call libc. No parent wires.
 */
uint32_t
gj_zink_ok_u_13627(void)
{
	(void)NULL;
	return b13627_ok();
}
...
uint32_t __gj_zink_ok_u_13627(void)
    __attribute__((alias("gj_zink_ok_u_13627")));
