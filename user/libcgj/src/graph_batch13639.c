 ...
 *
 * Desktop glibc graph batch13639: audio soft continuum lamp (on).
 *
 * Surface (unique symbols):
 *   uint32_t gj_audio_soft_ready_u_13639(void);
 ...
 *   uint32_t __gj_audio_soft_ready_u_13639  (alias)
 *   __libcgj_batch13639_marker = "libcgj-batch13639"
 *
 ...
 * Distinct from gj_audio_soft_ready_u_13439 (batch13439),
 * gj_audio_soft_ready_u_13239 (batch13239),
 * gj_audio_soft_ready_u_13039 (batch13039),
 * gj_audio_soft_ready_u_12839 (batch12839),
 * gj_audio_soft_ready_u_12639 (batch12639), and
 * gj_audio_soft_ready_u_12439 (batch12439). No parent wires. No
 * __int128.
 *
...
const char __libcgj_batch13639_marker[] = "libcgj-batch13639";

/* Soft continuum lamp: surfaces present (soft ready only). */
#define B13639_SOFT_READY  1u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13639_soft_ready(void)
{
	return B13639_SOFT_READY;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_audio_soft_ready_u_13639 - audio soft continuum ready lamp.
 *
 * Always returns 1. Soft pure-data product tag that exclusive wave
 * 13631-13640 surfaces are present. Does not claim pipewire/
 * wireplumber/pulse_compat/alsa/jack/audio_latency/bluetooth_audio/
 * hdmi_audio ok and does not call libc. No parent wires.
 */
uint32_t
gj_audio_soft_ready_u_13639(void)
{
	(void)NULL;
	return b13639_soft_ready();
}
...
uint32_t __gj_audio_soft_ready_u_13639(void)
    __attribute__((alias("gj_audio_soft_ready_u_13639")));
