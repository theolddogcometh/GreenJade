 ...
 *
 * Desktop glibc graph batch13641: gamescope ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_gamescope_ok_u_13641(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       gamescope runtime probe for the bar3-related continuum.
 *   uint32_t __gj_gamescope_ok_u_13641  (alias)
 *   __libcgj_batch13641_marker = "libcgj-batch13641"
 *
...
const char __libcgj_batch13641_marker[] = "libcgj-batch13641";

/* Soft gamescope-ok lamp: always off (not a real runtime probe). */
#define B13641_GAMESCOPE_OK  0u
...
uint32_t __gj_gamescope_ok_u_13641(void)
    __attribute__((alias("gj_gamescope_ok_u_13641")));
