 ...
 *
 * Desktop glibc graph batch13643: bigpicture ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_bigpicture_ok_u_13643(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Big Picture mode probe for the bar3-related continuum.
 *   uint32_t __gj_bigpicture_ok_u_13643  (alias)
 *   __libcgj_batch13643_marker = "libcgj-batch13643"
 *
...
const char __libcgj_batch13643_marker[] = "libcgj-batch13643";

/* Soft bigpicture-ok lamp: always off (not a real mode probe). */
#define B13643_BIGPICTURE_OK  0u
...
b13643_ok(void)
{
	return B13643_BIGPICTURE_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_bigpicture_ok_u_13643 - bigpicture ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Big Picture
 * mode or call libc. No parent wires.
 */
uint32_t
gj_bigpicture_ok_u_13643(void)
{
	(void)NULL;
	return b13643_ok();
}
...
uint32_t __gj_bigpicture_ok_u_13643(void)
    __attribute__((alias("gj_bigpicture_ok_u_13643")));
