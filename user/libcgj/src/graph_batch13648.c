 ...
 *
 * Desktop glibc graph batch13648: hdr ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_hdr_ok_u_13648(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       HDR display/runtime probe for the bar3-related continuum.
 *   uint32_t __gj_hdr_ok_u_13648  (alias)
 *   __libcgj_batch13648_marker = "libcgj-batch13648"
 *
...
const char __libcgj_batch13648_marker[] = "libcgj-batch13648";

/* Soft hdr-ok lamp: always off (not a real HDR probe). */
#define B13648_HDR_OK  0u
...
uint32_t __gj_hdr_ok_u_13648(void)
    __attribute__((alias("gj_hdr_ok_u_13648")));
