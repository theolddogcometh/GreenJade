 ...
 *
 * Desktop glibc graph batch13746: networkd ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_networkd_ok_u_13746(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       systemd-networkd runtime probe for the dbus soft continuum.
 *   uint32_t __gj_networkd_ok_u_13746  (alias)
 *   __libcgj_batch13746_marker = "libcgj-batch13746"
 *
...
const char __libcgj_batch13746_marker[] = "libcgj-batch13746";

/* Soft networkd-ok lamp: always off (not a real runtime probe). */
#define B13746_NETWORKD_OK  0u
...
uint32_t __gj_networkd_ok_u_13746(void)
    __attribute__((alias("gj_networkd_ok_u_13746")));
