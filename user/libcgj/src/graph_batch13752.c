 ...
 *
 * Desktop glibc graph batch13752: seatd soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_seatd_ok_u_13752(void);
 *     - Returns 0 (seatd soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live seatd/libseat probe.
 *   uint32_t __gj_seatd_ok_u_13752  (alias)
 *   __libcgj_batch13752_marker = "libcgj-batch13752"
 *
 ...
 * batch_id_13760). Unique gj_seatd_ok_u_13752 surface only; no
...
const char __libcgj_batch13752_marker[] = "libcgj-batch13752";

/* Soft lamp: not asserted. */
#define B13752_SEATD_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13752_seatd_ok(void)
{
	return B13752_SEATD_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_seatd_ok_u_13752 - seatd soft id ok stub.
 *
...
uint32_t __gj_seatd_ok_u_13752(void)
    __attribute__((alias("gj_seatd_ok_u_13752")));
