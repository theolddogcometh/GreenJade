 ...
 *
 * Desktop glibc graph batch13755: shadow soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_shadow_ok_u_13755(void);
 *     - Returns 0 (shadow soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live shadow/libshadow probe.
 *   uint32_t __gj_shadow_ok_u_13755  (alias)
 *   __libcgj_batch13755_marker = "libcgj-batch13755"
 *
 ...
 * batch_id_13760). Unique gj_shadow_ok_u_13755 surface only; no
...
const char __libcgj_batch13755_marker[] = "libcgj-batch13755";

/* Soft lamp: not asserted. */
#define B13755_SHADOW_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13755_shadow_ok(void)
{
	return B13755_SHADOW_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_shadow_ok_u_13755 - shadow soft id ok stub.
 *
...
uint32_t __gj_shadow_ok_u_13755(void)
    __attribute__((alias("gj_shadow_ok_u_13755")));
