 ...
 *
 * Desktop glibc graph batch13758: seat soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_seat_ok_u_13758(void);
 *     - Returns 0 (seat soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live seat/device probe.
 *   uint32_t __gj_seat_ok_u_13758  (alias)
 *   __libcgj_batch13758_marker = "libcgj-batch13758"
 *
 ...
 * batch_id_13760). Unique gj_seat_ok_u_13758 surface only; no
...
const char __libcgj_batch13758_marker[] = "libcgj-batch13758";

/* Soft lamp: not asserted. */
#define B13758_SEAT_OK  0u
...
b13758_seat_ok(void)
{
	return B13758_SEAT_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_seat_ok_u_13758 - seat soft id ok stub.
 *
...
uint32_t __gj_seat_ok_u_13758(void)
    __attribute__((alias("gj_seat_ok_u_13758")));
