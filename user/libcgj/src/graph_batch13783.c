 ...
 *
 * Desktop glibc graph batch13783: job ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_job_ok_u_13783(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       print-job validity probe.
 *   uint32_t __gj_job_ok_u_13783  (alias)
 *   __libcgj_batch13783_marker = "libcgj-batch13783"
 *
...
const char __libcgj_batch13783_marker[] = "libcgj-batch13783";

/* Soft job-ok lamp: always off (not a real job probe). */
#define B13783_JOB_OK  0u
...
uint32_t __gj_job_ok_u_13783(void)
    __attribute__((alias("gj_job_ok_u_13783")));
