 ...
 *
 * Desktop glibc graph batch13785: PPD ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_ppd_ok_u_13785(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       PPD file validity probe.
 *   uint32_t __gj_ppd_ok_u_13785  (alias)
 *   __libcgj_batch13785_marker = "libcgj-batch13785"
 *
...
const char __libcgj_batch13785_marker[] = "libcgj-batch13785";

/* Soft PPD-ok lamp: always off (not a real PPD probe). */
#define B13785_PPD_OK  0u
...
uint32_t __gj_ppd_ok_u_13785(void)
    __attribute__((alias("gj_ppd_ok_u_13785")));
