 ...
 *
 * Desktop glibc graph batch13821: mesa ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_mesa_ok_u_13821(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       mesa runtime probe for the mesa soft continuum.
 *   uint32_t __gj_mesa_ok_u_13821  (alias)
 *   __libcgj_batch13821_marker = "libcgj-batch13821"
 *
 ...
 * Unique surface only; no multi-def. Distinct from gj_mesa_ok_u_13621,
 * gj_mesa_ok_u_13421, gj_mesa_ok_u_13221, gj_mesa_ok_u_13021,
 ...
 * gj_mesa_ok_u_10521, gj_mesa_ok_u_10321, gj_mesa_ok_u_10221 and
 * gj_mesa_ok_u_10021. No parent wires. No __int128. No Mesa
 * implementation.
 *
...
const char __libcgj_batch13821_marker[] = "libcgj-batch13821";

/* Soft mesa-ok lamp: always off (not a real runtime probe). */
#define B13821_MESA_OK  0u
...
b13821_ok(void)
{
	return B13821_MESA_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_mesa_ok_u_13821 - mesa ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe mesa stack
 * presence or call libc. No parent wires.
 */
uint32_t
gj_mesa_ok_u_13821(void)
{
	(void)NULL;
	return b13821_ok();
}
...
uint32_t __gj_mesa_ok_u_13821(void)
    __attribute__((alias("gj_mesa_ok_u_13821")));
