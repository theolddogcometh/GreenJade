 ...
 *
 * Desktop glibc graph batch13856: evdev ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_evdev_ok_u_13856(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Linux evdev probe for the controller soft continuum.
 *   uint32_t __gj_evdev_ok_u_13856  (alias)
 *   __libcgj_batch13856_marker = "libcgj-batch13856"
 *
 ...
 * gj_evdev_ok_u_13656 (batch13656), gj_evdev_ok_u_13456
 * (batch13456).
...
const char __libcgj_batch13856_marker[] = "libcgj-batch13856";

/* Soft evdev-ok lamp: always off (not a real /dev/input probe). */
#define B13856_EVDEV_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13856_evdev_ok(void)
{
	return B13856_EVDEV_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_evdev_ok_u_13856 - evdev ok soft unit flag.
 *
...
uint32_t __gj_evdev_ok_u_13856(void)
    __attribute__((alias("gj_evdev_ok_u_13856")));
