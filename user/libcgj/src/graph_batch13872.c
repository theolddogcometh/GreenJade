 ...
 *
 * Desktop glibc graph batch13872: TDP ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_tdp_ok_u_13872(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       thermal design power probe for the power soft continuum.
 *   uint32_t __gj_tdp_ok_u_13872  (alias)
 *   __libcgj_batch13872_marker = "libcgj-batch13872"
 *
...
const char __libcgj_batch13872_marker[] = "libcgj-batch13872";

/* Soft TDP-ok lamp: always off (not a real power probe). */
#define B13872_TDP_OK  0u
...
b13872_tdp_ok(void)
{
	return B13872_TDP_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_tdp_ok_u_13872 - TDP ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe RAPL/TDP or
 * call libc. No parent wires.
 */
uint32_t
gj_tdp_ok_u_13872(void)
{
	(void)NULL;
	return b13872_tdp_ok();
}
...
uint32_t __gj_tdp_ok_u_13872(void)
    __attribute__((alias("gj_tdp_ok_u_13872")));
