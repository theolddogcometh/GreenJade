 ...
 *
 * Desktop glibc graph batch13952: seatd soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_seatd_ok_u_13952(void);
 *     - Returns 0 (seatd soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live seatd/libseat probe.
 *   uint32_t __gj_seatd_ok_u_13952  (alias)
 *   __libcgj_batch13952_marker = "libcgj-batch13952"
 *
 ...
 * batch_id_13960). Unique gj_seatd_ok_u_13952 surface only; no
...
const char __libcgj_batch13952_marker[] = "libcgj-batch13952";

/* Soft lamp: not asserted. */
#define B13952_SEATD_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b13952_seatd_ok(void)
{
	return B13952_SEATD_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_seatd_ok_u_13952 - seatd soft id ok stub.
 *
...
uint32_t __gj_seatd_ok_u_13952(void)
    __attribute__((alias("gj_seatd_ok_u_13952")));
