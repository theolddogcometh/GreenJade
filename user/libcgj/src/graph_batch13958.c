 ...
 *
 * Desktop glibc graph batch13958: seat soft id ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_seat_ok_u_13958(void);
 *     - Returns 0 (seat soft id stub not asserted ready). Soft
 *       compile-time product tag; not a live seat/device probe.
 *   uint32_t __gj_seat_ok_u_13958  (alias)
 *   __libcgj_batch13958_marker = "libcgj-batch13958"
 *
 ...
 * batch_id_13960). Unique gj_seat_ok_u_13958 surface only; no
...
const char __libcgj_batch13958_marker[] = "libcgj-batch13958";

/* Soft lamp: not asserted. */
#define B13958_SEAT_OK  0u
...
b13958_seat_ok(void)
{
	return B13958_SEAT_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_seat_ok_u_13958 - seat soft id ok stub.
 *
...
uint32_t __gj_seat_ok_u_13958(void)
    __attribute__((alias("gj_seat_ok_u_13958")));
