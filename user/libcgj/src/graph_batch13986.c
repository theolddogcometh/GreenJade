 ...
 *
 * Desktop glibc graph batch13986: IPP ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_ipp_ok_u_13986(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       IPP request / response validity probe.
 *   uint32_t __gj_ipp_ok_u_13986  (alias)
 *   __libcgj_batch13986_marker = "libcgj-batch13986"
 *
...
const char __libcgj_batch13986_marker[] = "libcgj-batch13986";

/* Soft IPP-ok lamp: always off (not a real IPP probe). */
#define B13986_IPP_OK  0u
...
uint32_t __gj_ipp_ok_u_13986(void)
    __attribute__((alias("gj_ipp_ok_u_13986")));
