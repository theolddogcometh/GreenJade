 ...
 *
 * Desktop glibc graph batch14073: job ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_job_ok_u_14073(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       print-job validity probe.
 *   uint32_t __gj_job_ok_u_14073  (alias)
 *   __libcgj_batch14073_marker = "libcgj-batch14073"
 *
...
const char __libcgj_batch14073_marker[] = "libcgj-batch14073";

/* Soft job-ok lamp: always off (not a real job probe). */
#define B14073_JOB_OK  0u
...
uint32_t __gj_job_ok_u_14073(void)
    __attribute__((alias("gj_job_ok_u_14073")));
