 ...
 *
 * Desktop glibc graph batch14171: TDP ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_tdp_ok_u_14171(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       thermal design power probe for the power/thermal continuum.
 *   uint32_t __gj_tdp_ok_u_14171  (alias)
 *   __libcgj_batch14171_marker = "libcgj-batch14171"
 *
...
const char __libcgj_batch14171_marker[] = "libcgj-batch14171";

/* Soft TDP-ok lamp: always off (not a real power probe). */
#define B14171_TDP_OK  0u
...
b14171_tdp_ok(void)
{
	return B14171_TDP_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_tdp_ok_u_14171 - TDP ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe RAPL/TDP or
 * call libc. No parent wires.
 */
uint32_t
gj_tdp_ok_u_14171(void)
{
	(void)NULL;
	return b14171_tdp_ok();
}
...
uint32_t __gj_tdp_ok_u_14171(void)
    __attribute__((alias("gj_tdp_ok_u_14171")));
