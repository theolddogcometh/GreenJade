 ...
 *
 * Desktop glibc graph batch14172: fan ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_fan_ok_u_14172(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       fan/tachometer probe for the power/thermal continuum.
 *   uint32_t __gj_fan_ok_u_14172  (alias)
 *   __libcgj_batch14172_marker = "libcgj-batch14172"
 *
...
const char __libcgj_batch14172_marker[] = "libcgj-batch14172";

/* Soft fan-ok lamp: always off (not a real fan probe). */
#define B14172_FAN_OK  0u
...
b14172_fan_ok(void)
{
	return B14172_FAN_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_fan_ok_u_14172 - fan ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe fan hwmon or
 * call libc. No parent wires.
 */
uint32_t
gj_fan_ok_u_14172(void)
{
	(void)NULL;
	return b14172_fan_ok();
}
...
uint32_t __gj_fan_ok_u_14172(void)
    __attribute__((alias("gj_fan_ok_u_14172")));
