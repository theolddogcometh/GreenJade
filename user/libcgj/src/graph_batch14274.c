 ...
 *
 * Desktop glibc graph batch14274: dest ok soft unit (off).
 *
 * Surface (unique symbols):
 *   uint32_t gj_dest_ok_u_14274(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       print destination validity probe.
 *   uint32_t __gj_dest_ok_u_14274  (alias)
 *   __libcgj_batch14274_marker = "libcgj-batch14274"
 *
 ...
 * multi-def. Distinct from gj_dest_ok_u_14074 (batch14074). No parent
...
const char __libcgj_batch14274_marker[] = "libcgj-batch14274";

/* Soft dest-ok lamp: always off (not a real dest probe). */
#define B14274_DEST_OK  0u
...
uint32_t __gj_dest_ok_u_14274(void)
    __attribute__((alias("gj_dest_ok_u_14274")));
