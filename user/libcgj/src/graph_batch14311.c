 ...
 *
 * Desktop glibc graph batch14311: proton ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_proton_ok_u_14311(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Proton runtime probe for the proton soft continuum.
 *   uint32_t __gj_proton_ok_u_14311  (alias)
 *   __libcgj_batch14311_marker = "libcgj-batch14311"
 *
...
const char __libcgj_batch14311_marker[] = "libcgj-batch14311";

/* Soft proton-ok lamp: always off (not a real runtime probe). */
#define B14311_PROTON_OK  0u
...
b14311_ok(void)
{
	return B14311_PROTON_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_proton_ok_u_14311 - proton ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Proton
 * presence or call libc. No parent wires.
 */
uint32_t
gj_proton_ok_u_14311(void)
{
	(void)NULL;
	return b14311_ok();
}
...
uint32_t __gj_proton_ok_u_14311(void)
    __attribute__((alias("gj_proton_ok_u_14311")));
