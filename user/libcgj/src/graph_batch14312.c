 ...
 *
 * Desktop glibc graph batch14312: wine ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_wine_ok_u_14312(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Wine runtime probe for the proton soft continuum.
 *   uint32_t __gj_wine_ok_u_14312  (alias)
 *   __libcgj_batch14312_marker = "libcgj-batch14312"
 *
...
const char __libcgj_batch14312_marker[] = "libcgj-batch14312";

/* Soft wine-ok lamp: always off (not a real runtime probe). */
#define B14312_WINE_OK  0u
...
b14312_ok(void)
{
	return B14312_WINE_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_wine_ok_u_14312 - wine ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Wine
 * presence or call libc. No parent wires.
 */
uint32_t
gj_wine_ok_u_14312(void)
{
	(void)NULL;
	return b14312_ok();
}
...
uint32_t __gj_wine_ok_u_14312(void)
    __attribute__((alias("gj_wine_ok_u_14312")));
