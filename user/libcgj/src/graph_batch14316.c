 ...
 *
 * Desktop glibc graph batch14316: compat-tool ok soft unit (not a probe).
 *
 * Surface (unique symbols):
 *   uint32_t gj_compat_tool_ok_u_14316(void);
 *     - Always returns 0. Soft stub only; intentionally not a real
 *       Steam compat-tool probe for the proton soft continuum.
 *   uint32_t __gj_compat_tool_ok_u_14316  (alias)
 *   __libcgj_batch14316_marker = "libcgj-batch14316"
 *
...
const char __libcgj_batch14316_marker[] = "libcgj-batch14316";

/* Soft compat-tool-ok lamp: always off (not a real runtime probe). */
#define B14316_COMPAT_TOOL_OK  0u
...
b14316_ok(void)
{
	return B14316_COMPAT_TOOL_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_compat_tool_ok_u_14316 - compat-tool ok soft unit flag.
 *
 * Always returns 0. Soft continuum stub; does not probe Steam
 * compatibility tool presence or call libc. No parent wires.
 */
uint32_t
gj_compat_tool_ok_u_14316(void)
{
	(void)NULL;
	return b14316_ok();
}
...
uint32_t __gj_compat_tool_ok_u_14316(void)
    __attribute__((alias("gj_compat_tool_ok_u_14316")));
