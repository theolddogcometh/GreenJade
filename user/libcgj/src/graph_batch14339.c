 ...
 *
 * Desktop glibc graph batch14339: audio soft continuum lamp (on).
 *
 * Surface (unique symbols):
 *   uint32_t gj_audio_soft_ready_u_14339(void);
 ...
 *   uint32_t __gj_audio_soft_ready_u_14339  (alias)
 *   __libcgj_batch14339_marker = "libcgj-batch14339"
 *
 ...
 * gj_audio_soft_ready_u_10339 (batch10339). No parent wires. No
 * __int128.
 *
...
const char __libcgj_batch14339_marker[] = "libcgj-batch14339";

/* Soft continuum lamp: surfaces present (soft ready only). */
#define B14339_SOFT_READY  1u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b14339_soft_ready(void)
{
	return B14339_SOFT_READY;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_audio_soft_ready_u_14339 - audio soft continuum ready lamp.
 *
 * Always returns 1. Soft pure-data product tag that exclusive wave
 * 14331-14340 surfaces are present. Does not claim pipewire/
 * wireplumber/pulse_compat/alsa/jack/audio_latency/bluetooth_audio/
 * hdmi_audio ok and does not call libc. No parent wires.
 */
uint32_t
gj_audio_soft_ready_u_14339(void)
{
	(void)NULL;
	return b14339_soft_ready();
}
...
uint32_t __gj_audio_soft_ready_u_14339(void)
    __attribute__((alias("gj_audio_soft_ready_u_14339")));
