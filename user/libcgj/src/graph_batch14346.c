 ...
 *
 * Desktop glibc graph batch14346: gamescope soft overlay ok stub.
 *
 * Surface (unique symbols):
 *   uint32_t gj_overlay_ok_u_14346(void);
 *     - Returns 0 (soft stub: gamescope/Steam overlay slot is
 *       soft/unprobed; not a runtime overlay inject probe).
 *   uint32_t __gj_overlay_ok_u_14346  (alias)
 *   __libcgj_batch14346_marker = "libcgj-batch14346"
 *
 ...
 * batch_id_14350). Unique gj_overlay_ok_u_14346 surface only; no
 * multi-def. Distinct from gj_overlay_ok_u_13446 (batch13446), and
...
const char __libcgj_batch14346_marker[] = "libcgj-batch14346";

/* Soft-stub overlay ok value (unprobed). */
#define B14346_OVERLAY_OK  0u

/* ---- freestanding helpers ---------------------------------------------- */

static uint32_t
b14346_overlay_ok(void)
{
	return B14346_OVERLAY_OK;
}

/* ---- public surface ---------------------------------------------------- */

/*
 * gj_overlay_ok_u_14346 - soft overlay ok stub.
 *
 * Always returns 0 (soft/unprobed overlay slot). Does not call libc or
 * probe gamescope/Steam overlays. No parent wires.
 */
uint32_t
gj_overlay_ok_u_14346(void)
{
	(void)NULL;
	return b14346_overlay_ok();
}
...
uint32_t __gj_overlay_ok_u_14346(void)
    __attribute__((alias("gj_overlay_ok_u_14346")));
