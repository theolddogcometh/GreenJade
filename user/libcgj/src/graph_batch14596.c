 ...
 *
 * Desktop glibc graph batch14596: smoke soft PASS lamp (wave 14600).
 *
 ...
 * gj_smoke_soft_14600 surface only; no multi-def. Distinct from gj_*_14500 /
...
/*
 * gj_smoke_soft_14600 - smoke soft PASS lamp for wave 14600
 *
 * Always returns 1u. Soft pure-data smoke-ready tag. Does not call
 * libc. Not a live host smoke execution. No parent wires.
 */
uint32_t
