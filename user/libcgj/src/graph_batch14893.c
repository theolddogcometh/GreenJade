 ...
 *
 * Desktop glibc graph batch14893: product bar3 readiness gate (wave 14900).
 *
 * Surface (unique symbols):
 *   uint32_t gj_bar3_ready_14900(void);
 *     - Returns 0 (bar3 readiness not complete for the milestone 14900
