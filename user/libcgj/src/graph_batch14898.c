 ...
 *
 * Desktop glibc graph batch14898: milestone 14900 product tag.
 *
 * Surface (unique symbols):
 *   uint32_t gj_milestone_tag_14900(void);
 *     - Returns the milestone tag for the milestone 14900 continuum
 *       (always 14900u). Soft compile-time product identity tag.
