 ...
 *
 * Desktop glibc graph batch378: absolute value of int64_t as uint64_t.
 *
 * Surface (unique symbols):
 *   uint64_t gj_abs_i64(int64_t x);
 ...
 *       value in uint64_t.
 *   uint64_t __gj_abs_i64  (alias)
 *   __libcgj_batch378_marker = "libcgj-batch378"
 *
...
uint64_t __gj_abs_i64(int64_t i64X)
    __attribute__((alias("gj_abs_i64")));
