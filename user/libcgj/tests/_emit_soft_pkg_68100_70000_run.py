#!/usr/bin/env python3
"""One-shot runner: import emitter main and execute (CREATE-ONLY 68100..70000)."""
from pathlib import Path
import sys

# Inline full emitter so a single `python3` run creates all packages.
HERE = Path(__file__).resolve().parent


def gen_c(m: int) -> str:
    b = [m - 9 + i for i in range(9)] + [m]
 ...
 *     cgj_soft_milestone_14500.c .. cgj_soft_milestone_25700.c
 *     (sibling decade soft probes; mirror 25800).
...
# Auto-run on import/exec so parent can: python3 thisfile
