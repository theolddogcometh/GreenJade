 ...
 *
 * Coherent soft package (see NOTES_milestone_14900.txt):
 *   - this TU (libcgj continuum dyn/direct soft KATs)
 *   - NOTES_milestone_14900.txt
 *
 * Test harness note:
 ...
 *   catalog    = shell/libcgj green + continuum + batch markers for m14900
 ...
 * greppable: libcgj: soft residual m14900
 * greppable: libcgj: soft residual m14900 Soft!=product
