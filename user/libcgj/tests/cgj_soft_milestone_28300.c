 ...
 * greppable: libcgj: soft residual m28300
...
main(void)
{
	...
	printf("libcgj: soft residual m28300 DIRECT PASS "
	...
	if (h == NULL) {
		...
		fprintf(stderr,
		        ...
		        dlerror());
		printf("libcgj: soft residual m28300 SOFT-SKIP "
	...
	printf("libcgj: soft residual m28300 PASS path=%s checked=%d "
