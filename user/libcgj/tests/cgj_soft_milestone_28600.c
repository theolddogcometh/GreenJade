 ...
 * greppable: libcgj: soft residual m28600
...
main(void)
{
	...
	printf("libcgj: soft residual m28600 DIRECT PASS "
	...
	if (h == NULL) {
		...
		fprintf(stderr,
		        ...
		        dlerror());
		printf("libcgj: soft residual m28600 SOFT-SKIP "
	...
	printf("libcgj: soft residual m28600 PASS path=%s checked=%d "
