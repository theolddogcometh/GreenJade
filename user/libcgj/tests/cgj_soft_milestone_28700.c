 ...
 * greppable: libcgj: soft residual m28700
...
main(void)
{
	...
	printf("libcgj: soft residual m28700 DIRECT PASS "
	...
	if (h == NULL) {
		...
		fprintf(stderr,
		        ...
		        dlerror());
		printf("libcgj: soft residual m28700 SOFT-SKIP "
	...
	printf("libcgj: soft residual m28700 PASS path=%s checked=%d "
