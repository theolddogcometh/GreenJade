 ...
 * greppable: libcgj: soft residual m29000
...
main(void)
{
	...
	printf("libcgj: soft residual m29000 DIRECT PASS "
	...
	if (h == NULL) {
		...
		fprintf(stderr,
		        ...
		        dlerror());
		printf("libcgj: soft residual m29000 SOFT-SKIP "
	...
	printf("libcgj: soft residual m29000 PASS path=%s checked=%d "
