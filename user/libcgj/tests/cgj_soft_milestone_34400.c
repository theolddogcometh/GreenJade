 ...
 *
 * Soft host gates for continuum MILESTONE 34400 markers (CREATE-ONLY).
 *
 * Coherent soft package (see NOTES_milestone_34400.txt):
 *   - this TU (libcgj continuum dyn/direct soft KATs)
 *   - NOTES_milestone_34400.txt
 *
 * Test harness note:
 ...
 *   cc -std=c11 -Wall -Wextra -O2 -o build/cgj_soft_milestone_34400 \
 *     user/libcgj/tests/cgj_soft_milestone_34400.c -ldl
 *   ./build/cgj_soft_milestone_34400
 *
 * Optional hard unit check (link pure graph batches directly; no SO map):
 *   cc -std=c11 -Wall -Wextra -O2 -DCGJ_SOFT_M34400_DIRECT \
 *     -o build/cgj_soft_milestone_34400_direct \
 *     user/libcgj/tests/cgj_soft_milestone_34400.c \
 *     user/libcgj/src/graph_batch34391.c \
 *     user/libcgj/src/graph_batch34392.c \
 *     user/libcgj/src/graph_batch34393.c \
 *     user/libcgj/src/graph_batch34394.c \
 *     user/libcgj/src/graph_batch34395.c \
 *     user/libcgj/src/graph_batch34396.c \
 *     user/libcgj/src/graph_batch34397.c \
 *     user/libcgj/src/graph_batch34398.c \
 *     user/libcgj/src/graph_batch34399.c \
 *     user/libcgj/src/graph_batch34400.c
 *   ./build/cgj_soft_milestone_34400_direct
 *
 * Expected soft KATs (wave 34391–34400 exclusive continuum markers):
 *   gj_shell_green_34400      → 1
 *   gj_libcgj_green_34400     → 1
 *   gj_bar3_ready_34400       → 0   (bar3 still open)
 *   gj_product_score_34400    → 0   (product score still open)
 *   gj_continuum_ready_34400  → 1
 *   gj_smoke_soft_34400       → 1
 *   gj_dyn_soft_34400         → 1
 *   gj_milestone_tag_34400    → 34400
 *   gj_continuum_wave_34400   → 34400
 *   gj_batch_id_34400         → 34400
 *   gj_graph_milestone_34400  → 34400
 *   __libcgj_batch34391_marker … __libcgj_batch34400_marker
 *     → "libcgj-batchNNNNN" string match when present
 *
 * Notes for parent wiring (outside this soft exclusive scope):
 *   - Sources graph_batch34391.c … graph_batch34400.c (and fill
 *     34376–34390 / identity 34351–34375) are CREATE-ONLY; wire into
 *     CGJ_SRCS when parent advances makefile_max to 34400.
 *   - libc.map may lag milestone 34400 globals; add 34400 symbols to the
...
extern uint32_t gj_product_score_34400(void);
extern uint32_t gj_continuum_ready_34400(void);
extern uint32_t gj_smoke_soft_34400(void);
extern uint32_t gj_dyn_soft_34400(void);
extern uint32_t gj_milestone_tag_34400(void);
extern uint32_t gj_continuum_wave_34400(void);
extern uint32_t gj_batch_id_34400(void);
extern uint32_t gj_graph_milestone_34400(void);
extern const char __libcgj_batch34391_marker[];
extern const char __libcgj_batch34392_marker[];
extern const char __libcgj_batch34393_marker[];
extern const char __libcgj_batch34394_marker[];
extern const char __libcgj_batch34395_marker[];
extern const char __libcgj_batch34396_marker[];
extern const char __libcgj_batch34397_marker[];
extern const char __libcgj_batch34398_marker[];
extern const char __libcgj_batch34399_marker[];
extern const char __libcgj_batch34400_marker[];
...
direct_check(void)
{
	...
	if (gj_shell_green_34400() != 1u) {
		fprintf(stderr, "libcgj: direct gj_shell_green_34400 fail\n");
		nFail++;
	}
	if (gj_libcgj_green_34400() != 1u) {
		fprintf(stderr, "libcgj: direct gj_libcgj_green_34400 fail\n");
		nFail++;
	}
	if (gj_bar3_ready_34400() != 0u) {
		fprintf(stderr, "libcgj: direct gj_bar3_ready_34400 fail\n");
		nFail++;
	}
	if (gj_product_score_34400() != 0u) {
		fprintf(stderr, "libcgj: direct gj_product_score_34400 fail\n");
		nFail++;
	}
	if (gj_continuum_ready_34400() != 1u) {
		fprintf(stderr, "libcgj: direct gj_continuum_ready_34400 fail\n");
		nFail++;
	}
	if (gj_smoke_soft_34400() != 1u) {
		fprintf(stderr, "libcgj: direct gj_smoke_soft_34400 fail\n");
		nFail++;
	}
	if (gj_dyn_soft_34400() != 1u) {
		fprintf(stderr, "libcgj: direct gj_dyn_soft_34400 fail\n");
		nFail++;
	}
	if (gj_milestone_tag_34400() != 34400u) {
		fprintf(stderr, "libcgj: direct gj_milestone_tag_34400 fail\n");
		nFail++;
	}
	if (gj_continuum_wave_34400() != 34400u) {
		fprintf(stderr, "libcgj: direct gj_continuum_wave_34400 fail\n");
		nFail++;
	}
	if (gj_batch_id_34400() != 34400u) {
		fprintf(stderr, "libcgj: direct gj_batch_id_34400 fail\n");
		nFail++;
	}
	if (gj_graph_milestone_34400() != 34400u) {
		fprintf(stderr,
		        "libcgj: direct gj_graph_milestone_34400 fail\n");
		nFail++;
	}
	if (strcmp(__libcgj_batch34391_marker, "libcgj-batch34391") != 0 ||
	    strcmp(__libcgj_batch34392_marker, "libcgj-batch34392") != 0 ||
	    strcmp(__libcgj_batch34393_marker, "libcgj-batch34393") != 0 ||
	    strcmp(__libcgj_batch34394_marker, "libcgj-batch34394") != 0 ||
	    strcmp(__libcgj_batch34395_marker, "libcgj-batch34395") != 0 ||
	    strcmp(__libcgj_batch34396_marker, "libcgj-batch34396") != 0 ||
	    strcmp(__libcgj_batch34397_marker, "libcgj-batch34397") != 0 ||
	    strcmp(__libcgj_batch34398_marker, "libcgj-batch34398") != 0 ||
	    strcmp(__libcgj_batch34399_marker, "libcgj-batch34399") != 0 ||
	    strcmp(__libcgj_batch34400_marker, "libcgj-batch34400") != 0) {
		fprintf(stderr, "libcgj: direct m34400 marker string fail\n");
		nFail++;
	}
	return nFail;
}
#else /* !CGJ_SOFT_M34400_DIRECT — dyn soft path */
...
soft_u32(void *h, const char *szName, uint32_t u32Expect, int *pChecked)
{
	...
	if (u32Got != u32Expect) {
		fprintf(stderr,
		        "libcgj: soft m34400 %s KAT fail got=%u expect=%u\n",
...
soft_marker(void *h, const char *szSym, const char *szExpect, int *pChecked)
{
	...
	if (strcmp(szGot, szExpect) != 0) {
		fprintf(stderr,
		        "libcgj: soft m34400 %s marker fail got=\"%s\" "
		        "expect=\"%s\"\n",
...
main(void)
{
	...
	nFail += soft_u32(h, "gj_shell_green_34400", 1u, &nChecked);
	nFail += soft_u32(h, "gj_libcgj_green_34400", 1u, &nChecked);
	nFail += soft_u32(h, "gj_bar3_ready_34400", 0u, &nChecked);
	nFail += soft_u32(h, "gj_product_score_34400", 0u, &nChecked);
	nFail += soft_u32(h, "gj_continuum_ready_34400", 1u, &nChecked);
	nFail += soft_u32(h, "gj_smoke_soft_34400", 1u, &nChecked);
	nFail += soft_u32(h, "gj_dyn_soft_34400", 1u, &nChecked);
	nFail += soft_u32(h, "gj_milestone_tag_34400", 34400u, &nChecked);
	nFail += soft_u32(h, "gj_continuum_wave_34400", 34400u, &nChecked);
	nFail += soft_u32(h, "gj_batch_id_34400", 34400u, &nChecked);
	nFail += soft_u32(h, "gj_graph_milestone_34400", 34400u, &nChecked);

	nFail += soft_marker(h, "__libcgj_batch34391_marker",
	                     "libcgj-batch34391", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34392_marker",
	                     "libcgj-batch34392", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34393_marker",
	                     "libcgj-batch34393", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34394_marker",
	                     "libcgj-batch34394", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34395_marker",
	                     "libcgj-batch34395", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34396_marker",
	                     "libcgj-batch34396", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34397_marker",
	                     "libcgj-batch34397", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34398_marker",
	                     "libcgj-batch34398", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34399_marker",
	                     "libcgj-batch34399", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch34400_marker",
	                     "libcgj-batch34400", &nChecked);

	if (nFail != 0) {
		(void)dlclose(h);
		fprintf(stderr,
		        "libcgj: soft m34400 FAIL path=%s fails=%d checked=%d\n",
