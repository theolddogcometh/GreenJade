 ...
 *
 * Soft host gates for continuum MILESTONE 36100 markers (CREATE-ONLY).
 *
 * Coherent soft package (see NOTES_milestone_36100.txt):
 *   - this TU (libcgj continuum dyn/direct soft KATs)
 *   - NOTES_milestone_36100.txt
 *
 * Test harness note:
 ...
 *   cc -std=c11 -Wall -Wextra -O2 -o build/cgj_soft_milestone_36100 \
 *     user/libcgj/tests/cgj_soft_milestone_36100.c -ldl
 *   ./build/cgj_soft_milestone_36100
 *
 * Optional hard unit check (link pure graph batches directly; no SO map):
 *   cc -std=c11 -Wall -Wextra -O2 -DCGJ_SOFT_M36100_DIRECT \
 *     -o build/cgj_soft_milestone_36100_direct \
 *     user/libcgj/tests/cgj_soft_milestone_36100.c \
 *     user/libcgj/src/graph_batch36091.c \
 *     user/libcgj/src/graph_batch36092.c \
 *     user/libcgj/src/graph_batch36093.c \
 *     user/libcgj/src/graph_batch36094.c \
 *     user/libcgj/src/graph_batch36095.c \
 *     user/libcgj/src/graph_batch36096.c \
 *     user/libcgj/src/graph_batch36097.c \
 *     user/libcgj/src/graph_batch36098.c \
 *     user/libcgj/src/graph_batch36099.c \
 *     user/libcgj/src/graph_batch36100.c
 *   ./build/cgj_soft_milestone_36100_direct
 *
 * Expected soft KATs (wave 36091–36100 exclusive continuum markers):
 *   gj_shell_green_36100      → 1
 *   gj_libcgj_green_36100     → 1
 *   gj_bar3_ready_36100       → 0   (bar3 still open)
 *   gj_product_score_36100    → 0   (product score still open)
 *   gj_continuum_ready_36100  → 1
 *   gj_smoke_soft_36100       → 1
 *   gj_dyn_soft_36100         → 1
 *   gj_milestone_tag_36100    → 36100
 *   gj_continuum_wave_36100   → 36100
 *   gj_batch_id_36100         → 36100
 *   gj_graph_milestone_36100  → 36100
 *   __libcgj_batch36091_marker … __libcgj_batch36100_marker
 *     → "libcgj-batchNNNNN" string match when present
 *
 * Notes for parent wiring (outside this soft exclusive scope):
 *   - Sources graph_batch36091.c … graph_batch36100.c (and fill
 *     36076–36090 / identity 36051–36075) are CREATE-ONLY; wire into
 *     CGJ_SRCS when parent advances makefile_max to 36100.
 *   - libc.map may lag milestone 36100 globals; add 36100 symbols to the
 *     GLIBC_2.2.5 global list so dyn dlsym can see them.
 *   - Optional: fold these soft gates into cgj_dyn_smoke.c /
 *     cgj_smoke.c continuum soft blocks (same skip-if-missing rule).
 *   - Soft gates; bar3 still open (gj_bar3_ready_36100 == 0).
 ...
 *     continuum/smoke/dyn soft=1; milestone/wave/batch/graph = 36100.
 */
...
/* Grep: libcgj soft m36100 residual Soft!=product dual_dod_ab=OPEN G-AC-1 */
static const char g_szSoftHonesty[] =
	"libcgj: soft m36100 residual honesty Soft!=product dual_dod_a=OPEN "
...
#ifndef CGJ_SOFT_M36100_DIRECT
#include <dlfcn.h>
#endif

#ifdef CGJ_SOFT_M36100_DIRECT
/* Direct-link path: continuum soft pure markers (Soft!=product). */
extern uint32_t gj_shell_green_36100(void);
extern uint32_t gj_libcgj_green_36100(void);
extern uint32_t gj_bar3_ready_36100(void);
extern uint32_t gj_product_score_36100(void);
extern uint32_t gj_continuum_ready_36100(void);
extern uint32_t gj_smoke_soft_36100(void);
extern uint32_t gj_dyn_soft_36100(void);
extern uint32_t gj_milestone_tag_36100(void);
extern uint32_t gj_continuum_wave_36100(void);
extern uint32_t gj_batch_id_36100(void);
extern uint32_t gj_graph_milestone_36100(void);
extern const char __libcgj_batch36091_marker[];
extern const char __libcgj_batch36092_marker[];
extern const char __libcgj_batch36093_marker[];
extern const char __libcgj_batch36094_marker[];
extern const char __libcgj_batch36095_marker[];
extern const char __libcgj_batch36096_marker[];
extern const char __libcgj_batch36097_marker[];
extern const char __libcgj_batch36098_marker[];
extern const char __libcgj_batch36099_marker[];
extern const char __libcgj_batch36100_marker[];
...
direct_check(void)
{
	...
	if (gj_shell_green_36100() != 1u) {
		fprintf(stderr, "libcgj: direct gj_shell_green_36100 fail\n");
		nFail++;
	}
	if (gj_libcgj_green_36100() != 1u) {
		fprintf(stderr, "libcgj: direct gj_libcgj_green_36100 fail\n");
		nFail++;
	}
	if (gj_bar3_ready_36100() != 0u) {
		fprintf(stderr, "libcgj: direct gj_bar3_ready_36100 fail\n");
		nFail++;
	}
	if (gj_product_score_36100() != 0u) {
		fprintf(stderr, "libcgj: direct gj_product_score_36100 fail\n");
		nFail++;
	}
	if (gj_continuum_ready_36100() != 1u) {
		fprintf(stderr, "libcgj: direct gj_continuum_ready_36100 fail\n");
		nFail++;
	}
	if (gj_smoke_soft_36100() != 1u) {
		fprintf(stderr, "libcgj: direct gj_smoke_soft_36100 fail\n");
		nFail++;
	}
	if (gj_dyn_soft_36100() != 1u) {
		fprintf(stderr, "libcgj: direct gj_dyn_soft_36100 fail\n");
		nFail++;
	}
	if (gj_milestone_tag_36100() != 36100u) {
		fprintf(stderr, "libcgj: direct gj_milestone_tag_36100 fail\n");
		nFail++;
	}
	if (gj_continuum_wave_36100() != 36100u) {
		fprintf(stderr, "libcgj: direct gj_continuum_wave_36100 fail\n");
		nFail++;
	}
	if (gj_batch_id_36100() != 36100u) {
		fprintf(stderr, "libcgj: direct gj_batch_id_36100 fail\n");
		nFail++;
	}
	if (gj_graph_milestone_36100() != 36100u) {
		fprintf(stderr,
		        "libcgj: direct gj_graph_milestone_36100 fail\n");
		nFail++;
	}
	if (strcmp(__libcgj_batch36091_marker, "libcgj-batch36091") != 0 ||
	    strcmp(__libcgj_batch36092_marker, "libcgj-batch36092") != 0 ||
	    strcmp(__libcgj_batch36093_marker, "libcgj-batch36093") != 0 ||
	    strcmp(__libcgj_batch36094_marker, "libcgj-batch36094") != 0 ||
	    strcmp(__libcgj_batch36095_marker, "libcgj-batch36095") != 0 ||
	    strcmp(__libcgj_batch36096_marker, "libcgj-batch36096") != 0 ||
	    strcmp(__libcgj_batch36097_marker, "libcgj-batch36097") != 0 ||
	    strcmp(__libcgj_batch36098_marker, "libcgj-batch36098") != 0 ||
	    strcmp(__libcgj_batch36099_marker, "libcgj-batch36099") != 0 ||
	    strcmp(__libcgj_batch36100_marker, "libcgj-batch36100") != 0) {
		fprintf(stderr, "libcgj: direct m36100 marker string fail\n");
		nFail++;
	}
	return nFail;
}
#else /* !CGJ_SOFT_M36100_DIRECT — dyn soft path */
...
soft_u32(void *h, const char *szName, uint32_t u32Expect, int *pChecked)
{
	...
	if (u32Got != u32Expect) {
		fprintf(stderr,
		        "libcgj: soft m36100 %s KAT fail got=%u expect=%u\n",
...
soft_marker(void *h, const char *szSym, const char *szExpect, int *pChecked)
{
	...
	if (strcmp(szGot, szExpect) != 0) {
		fprintf(stderr,
		        "libcgj: soft m36100 %s marker fail got=\"%s\" "
		        "expect=\"%s\"\n",
...
main(void)
{
	...
	if (nFail != 0) {
		fprintf(stderr,
		        "libcgj: soft m36100 DIRECT FAIL fails=%d\n", nFail);
		return 1;
	}
	printf("libcgj: soft m36100 DIRECT PASS (all 11 lamps + markers; "
	...
	if (h == NULL) {
		 ...
		 */
		fprintf(stderr,
		        "libcgj: soft m36100 skip (dlopen fail: %s)\n",
		        dlerror());
		printf("libcgj: soft m36100 SOFT-SKIP (no SO; Soft!=product; "
	...
	nFail += soft_u32(h, "gj_shell_green_36100", 1u, &nChecked);
	nFail += soft_u32(h, "gj_libcgj_green_36100", 1u, &nChecked);
	nFail += soft_u32(h, "gj_bar3_ready_36100", 0u, &nChecked);
	nFail += soft_u32(h, "gj_product_score_36100", 0u, &nChecked);
	nFail += soft_u32(h, "gj_continuum_ready_36100", 1u, &nChecked);
	nFail += soft_u32(h, "gj_smoke_soft_36100", 1u, &nChecked);
	nFail += soft_u32(h, "gj_dyn_soft_36100", 1u, &nChecked);
	nFail += soft_u32(h, "gj_milestone_tag_36100", 36100u, &nChecked);
	nFail += soft_u32(h, "gj_continuum_wave_36100", 36100u, &nChecked);
	nFail += soft_u32(h, "gj_batch_id_36100", 36100u, &nChecked);
	nFail += soft_u32(h, "gj_graph_milestone_36100", 36100u, &nChecked);

	nFail += soft_marker(h, "__libcgj_batch36091_marker",
	                     "libcgj-batch36091", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36092_marker",
	                     "libcgj-batch36092", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36093_marker",
	                     "libcgj-batch36093", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36094_marker",
	                     "libcgj-batch36094", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36095_marker",
	                     "libcgj-batch36095", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36096_marker",
	                     "libcgj-batch36096", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36097_marker",
	                     "libcgj-batch36097", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36098_marker",
	                     "libcgj-batch36098", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36099_marker",
	                     "libcgj-batch36099", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch36100_marker",
	                     "libcgj-batch36100", &nChecked);

	if (nFail != 0) {
		(void)dlclose(h);
		fprintf(stderr,
		        "libcgj: soft m36100 FAIL path=%s fails=%d checked=%d\n",
		        szPath, nFail, nChecked);
		return 2;
	}

	printf("libcgj: soft m36100 PASS path=%s checked=%d "
