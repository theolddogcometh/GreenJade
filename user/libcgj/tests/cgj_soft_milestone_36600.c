 ...
 *     continuum/smoke/dyn soft=1; milestone/wave/batch/graph = 36600.
 */
...
/* Grep: libcgj soft m36600 residual Soft!=product dual_dod_ab=OPEN G-AC-1 */
static const char g_szSoftHonesty[] =
	"libcgj: soft m36600 residual honesty Soft!=product dual_dod_a=OPEN "
...
main(void)
{
	...
	if (h == NULL) {
		...
		fprintf(stderr,
		        ...
		        dlerror());
		printf("libcgj: soft m36600 SOFT-SKIP (no SO; Soft!=product; "
