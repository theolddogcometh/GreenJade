 ...
 *
 * Soft host gates for continuum MILESTONE 49500 markers (CREATE-ONLY).
 *
 * Coherent soft package (see NOTES_milestone_49500.txt):
 *   - this TU (libcgj continuum dyn/direct soft KATs)
 *   - NOTES_milestone_49500.txt
 *
 * Test harness note:
 ...
 *     cgj_soft_milestone_46000.c /
 *     cgj_soft_milestone_46100.c / cgj_soft_milestone_46200.c /
 *     cgj_soft_milestone_46300.c / cgj_soft_milestone_46400.c /
 *     cgj_soft_milestone_46500.c / cgj_soft_milestone_46600.c /
 *     cgj_soft_milestone_46700.c / cgj_soft_milestone_46800.c /
 *     cgj_soft_milestone_46900.c / cgj_soft_milestone_47000.c /
 *     cgj_soft_milestone_47100.c / cgj_soft_milestone_47200.c /
 *     cgj_soft_milestone_47300.c / cgj_soft_milestone_47400.c /
 *     cgj_soft_milestone_47500.c / cgj_soft_milestone_47600.c /
 *     cgj_soft_milestone_47700.c / cgj_soft_milestone_47800.c /
 *     cgj_soft_milestone_47900.c / cgj_soft_milestone_48000.c /
 *     cgj_soft_milestone_48100.c / cgj_soft_milestone_48200.c /
 *     cgj_soft_milestone_48300.c / cgj_soft_milestone_48400.c /
 *     cgj_soft_milestone_48500.c / cgj_soft_milestone_48600.c /
 *     cgj_soft_milestone_48700.c / cgj_soft_milestone_48800.c /
 *     cgj_soft_milestone_48900.c / cgj_soft_milestone_49000.c /
 *     cgj_soft_milestone_49100.c / cgj_soft_milestone_49200.c /
 *     cgj_soft_milestone_49300.c / cgj_soft_milestone_49400.c /
 ...
 *   cc -std=c11 -Wall -Wextra -O2 -o build/cgj_soft_milestone_49500 \
 *     user/libcgj/tests/cgj_soft_milestone_49500.c -ldl
 *   ./build/cgj_soft_milestone_49500
 *
 * Optional hard unit check (link pure graph batches directly; no SO map):
 *   cc -std=c11 -Wall -Wextra -O2 -DCGJ_SOFT_M49500_DIRECT \
 *     -o build/cgj_soft_milestone_49500_direct \
 *     user/libcgj/tests/cgj_soft_milestone_49500.c \
 *     user/libcgj/src/graph_batch49491.c \
 *     user/libcgj/src/graph_batch49492.c \
 *     user/libcgj/src/graph_batch49493.c \
 *     user/libcgj/src/graph_batch49494.c \
 *     user/libcgj/src/graph_batch49495.c \
 *     user/libcgj/src/graph_batch49496.c \
 *     user/libcgj/src/graph_batch49497.c \
 *     user/libcgj/src/graph_batch49498.c \
 *     user/libcgj/src/graph_batch49499.c \
 *     user/libcgj/src/graph_batch49500.c
 *   ./build/cgj_soft_milestone_49500_direct
 *
 * Expected soft KATs (wave 49491–49500 exclusive continuum markers):
 *   gj_shell_green_49500      → 1
 *   gj_libcgj_green_49500     → 1
 *   gj_bar3_ready_49500       → 0   (bar3 still open)
 *   gj_product_score_49500    → 0   (product score still open)
 *   gj_continuum_ready_49500  → 1
 *   gj_smoke_soft_49500       → 1
 *   gj_dyn_soft_49500         → 1
 *   gj_milestone_tag_49500    → 49500
 *   gj_continuum_wave_49500   → 49500
 *   gj_batch_id_49500         → 49500
 *   gj_graph_milestone_49500  → 49500
 *   __libcgj_batch49491_marker … __libcgj_batch49500_marker
 *     → "libcgj-batchNNNNN" string match when present
 *
 * Notes for parent wiring (outside this soft exclusive scope):
 *   - Sources graph_batch49491.c … graph_batch49500.c (and fill
 *     49476–49490 / identity 49451–49475) are CREATE-ONLY; wire into
 *     CGJ_SRCS when parent advances makefile_max to 49500.
 *   - libc.map may lag milestone 49500 globals; add 49500 symbols to the
 *     GLIBC_2.2.5 global list so dyn dlsym can see them.
 *   - Optional: fold these soft gates into cgj_dyn_smoke.c /
 *     cgj_smoke.c continuum soft blocks (same skip-if-missing rule).
 *   - Soft gates; bar3 still open (gj_bar3_ready_49500 == 0).
 *
 ...
 *     continuum/smoke/dyn soft=1; tag/wave/batch/graph = 49500.
 * greppable: libcgj: soft m49500 residual Soft!=product
 * greppable: libcgj: soft m49500 Dual DoD A/B OPEN
 * greppable: libcgj: soft m49500 G-AC-1
 */
...
#ifndef CGJ_SOFT_M49500_DIRECT
#include <dlfcn.h>
#endif

#ifdef CGJ_SOFT_M49500_DIRECT
/* Direct-link path: call product pure markers without dlopen. */
extern uint32_t gj_shell_green_49500(void);
extern uint32_t gj_libcgj_green_49500(void);
extern uint32_t gj_bar3_ready_49500(void);
extern uint32_t gj_product_score_49500(void);
extern uint32_t gj_continuum_ready_49500(void);
extern uint32_t gj_smoke_soft_49500(void);
extern uint32_t gj_dyn_soft_49500(void);
extern uint32_t gj_milestone_tag_49500(void);
extern uint32_t gj_continuum_wave_49500(void);
extern uint32_t gj_batch_id_49500(void);
extern uint32_t gj_graph_milestone_49500(void);
extern const char __libcgj_batch49491_marker[];
extern const char __libcgj_batch49492_marker[];
extern const char __libcgj_batch49493_marker[];
extern const char __libcgj_batch49494_marker[];
extern const char __libcgj_batch49495_marker[];
extern const char __libcgj_batch49496_marker[];
extern const char __libcgj_batch49497_marker[];
extern const char __libcgj_batch49498_marker[];
extern const char __libcgj_batch49499_marker[];
extern const char __libcgj_batch49500_marker[];
...
direct_check(void)
{
	...
	if (gj_shell_green_49500() != 1u) {
		fprintf(stderr, "libcgj: direct gj_shell_green_49500 fail\n");
		nFail++;
	}
	if (gj_libcgj_green_49500() != 1u) {
		fprintf(stderr, "libcgj: direct gj_libcgj_green_49500 fail\n");
		nFail++;
	}
	if (gj_bar3_ready_49500() != 0u) {
		fprintf(stderr, "libcgj: direct gj_bar3_ready_49500 fail\n");
		nFail++;
	}
	if (gj_product_score_49500() != 0u) {
		fprintf(stderr, "libcgj: direct gj_product_score_49500 fail\n");
		nFail++;
	}
	if (gj_continuum_ready_49500() != 1u) {
		fprintf(stderr, "libcgj: direct gj_continuum_ready_49500 fail\n");
		nFail++;
	}
	if (gj_smoke_soft_49500() != 1u) {
		fprintf(stderr, "libcgj: direct gj_smoke_soft_49500 fail\n");
		nFail++;
	}
	if (gj_dyn_soft_49500() != 1u) {
		fprintf(stderr, "libcgj: direct gj_dyn_soft_49500 fail\n");
		nFail++;
	}
	if (gj_milestone_tag_49500() != 49500u) {
		fprintf(stderr, "libcgj: direct gj_milestone_tag_49500 fail\n");
		nFail++;
	}
	if (gj_continuum_wave_49500() != 49500u) {
		fprintf(stderr, "libcgj: direct gj_continuum_wave_49500 fail\n");
		nFail++;
	}
	if (gj_batch_id_49500() != 49500u) {
		fprintf(stderr, "libcgj: direct gj_batch_id_49500 fail\n");
		nFail++;
	}
	if (gj_graph_milestone_49500() != 49500u) {
		fprintf(stderr,
		        "libcgj: direct gj_graph_milestone_49500 fail\n");
		nFail++;
	}
	if (strcmp(__libcgj_batch49491_marker, "libcgj-batch49491") != 0 ||
	    strcmp(__libcgj_batch49492_marker, "libcgj-batch49492") != 0 ||
	    strcmp(__libcgj_batch49493_marker, "libcgj-batch49493") != 0 ||
	    strcmp(__libcgj_batch49494_marker, "libcgj-batch49494") != 0 ||
	    strcmp(__libcgj_batch49495_marker, "libcgj-batch49495") != 0 ||
	    strcmp(__libcgj_batch49496_marker, "libcgj-batch49496") != 0 ||
	    strcmp(__libcgj_batch49497_marker, "libcgj-batch49497") != 0 ||
	    strcmp(__libcgj_batch49498_marker, "libcgj-batch49498") != 0 ||
	    strcmp(__libcgj_batch49499_marker, "libcgj-batch49499") != 0 ||
	    strcmp(__libcgj_batch49500_marker, "libcgj-batch49500") != 0) {
		fprintf(stderr, "libcgj: direct m49500 marker string fail\n");
		nFail++;
	}
	return nFail;
}
#else /* !CGJ_SOFT_M49500_DIRECT — dyn soft path */
...
soft_u32(void *h, const char *szName, uint32_t u32Expect, int *pChecked)
{
	...
	if (u32Got != u32Expect) {
		fprintf(stderr,
		        "libcgj: soft m49500 %s KAT fail got=%u expect=%u\n",
...
soft_marker(void *h, const char *szSym, const char *szExpect, int *pChecked)
{
	...
	if (strcmp(szGot, szExpect) != 0) {
		fprintf(stderr,
		        "libcgj: soft m49500 %s marker fail got=\"%s\" "
		        "expect=\"%s\"\n",
...
main(void)
{
	...
	if (nFail != 0) {
		fprintf(stderr,
		        "libcgj: soft m49500 DIRECT FAIL fails=%d\n", nFail);
		return 1;
	}
	printf("libcgj: soft m49500 DIRECT PASS (all 11 lamps + markers; "
	...
	if (h == NULL) {
		 ...
		 */
		fprintf(stderr,
		        "libcgj: soft m49500 skip (dlopen fail: %s)\n",
		        dlerror());
		printf("libcgj: soft m49500 SOFT-SKIP (no product SO; "
		       "Soft!=product; Dual DoD A/B OPEN; G-AC-1)\n");
		return 0;
	}

	/* Continuum soft gates: skip if missing, hard fail if wrong. */
	nFail += soft_u32(h, "gj_shell_green_49500", 1u, &nChecked);
	nFail += soft_u32(h, "gj_libcgj_green_49500", 1u, &nChecked);
	nFail += soft_u32(h, "gj_bar3_ready_49500", 0u, &nChecked);
	nFail += soft_u32(h, "gj_product_score_49500", 0u, &nChecked);
	nFail += soft_u32(h, "gj_continuum_ready_49500", 1u, &nChecked);
	nFail += soft_u32(h, "gj_smoke_soft_49500", 1u, &nChecked);
	nFail += soft_u32(h, "gj_dyn_soft_49500", 1u, &nChecked);
	nFail += soft_u32(h, "gj_milestone_tag_49500", 49500u, &nChecked);
	nFail += soft_u32(h, "gj_continuum_wave_49500", 49500u, &nChecked);
	nFail += soft_u32(h, "gj_batch_id_49500", 49500u, &nChecked);
	nFail += soft_u32(h, "gj_graph_milestone_49500", 49500u, &nChecked);

	nFail += soft_marker(h, "__libcgj_batch49491_marker",
	                     "libcgj-batch49491", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49492_marker",
	                     "libcgj-batch49492", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49493_marker",
	                     "libcgj-batch49493", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49494_marker",
	                     "libcgj-batch49494", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49495_marker",
	                     "libcgj-batch49495", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49496_marker",
	                     "libcgj-batch49496", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49497_marker",
	                     "libcgj-batch49497", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49498_marker",
	                     "libcgj-batch49498", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49499_marker",
	                     "libcgj-batch49499", &nChecked);
	nFail += soft_marker(h, "__libcgj_batch49500_marker",
	                     "libcgj-batch49500", &nChecked);

	if (nFail != 0) {
		(void)dlclose(h);
		fprintf(stderr,
		        "libcgj: soft m49500 FAIL path=%s fails=%d checked=%d\n",
		        szPath, nFail, nChecked);
		return 2;
	}

	printf("libcgj: soft m49500 PASS path=%s checked=%d "
