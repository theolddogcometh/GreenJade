...
/* Wave 120 exclusive soft inventory stamp. */
...
/*
 * Cold soft inventory accessor (Wave 120).
 * greppable: GJ_GNU_SOFT_INVENTORY
 * Grep: libgj-gnu: soft inventory
 */
const char *
...
/*
 * Cold soft deepen stamp (Wave 120).
 * greppable: GJ_GNU_SOFT_DEEPEN
 * Grep: libgj-gnu: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 120 exclusive).
 * Grep: libgj-gnu: soft honesty
 */
const char *
...
/*
 * Soft note extend (Wave 120): deepen + path call counters.
 * Grep: libgj-gnu: soft note
 */
void
