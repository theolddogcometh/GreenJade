 ...
 *   libgj-gnu: soft inventory wave=38 surfaces=12 caps=0xf stamp=GNU1
 *   libgj-gnu: soft deepen wave=38 areas=export,stamp,caps,get,id,probe,
...
/* Wave 38 exclusive soft inventory stamp. */
#define GJ_GNU_SOFT_WAVE        37u
...
static const char g_szGnuSoftInventory[] =
    "libgj-gnu: soft inventory wave=38 surfaces=12 areas=12 "
...
static const char g_szGnuSoftDeepen[] =
    "libgj-gnu: soft deepen wave=38 areas=12 "
...
/*
 * Cold soft inventory accessor (Wave 38).
 * greppable: GJ_GNU_SOFT_INVENTORY
 * Grep: libgj-gnu: soft inventory
 */
const char *
...
/*
 * Cold soft deepen stamp (Wave 38).
 * greppable: GJ_GNU_SOFT_DEEPEN
 * Grep: libgj-gnu: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 38 exclusive).
 * Grep: libgj-gnu: soft honesty
 */
const char *
...
/*
 * Soft wave stamp (37). greppable: GJ_GNU_SOFT_WAVE
...
/*
 * Soft area catalog size (Wave 38 deepen areas).
...
/*
 * Soft note extend (Wave 38): deepen + path call counters.
 * Grep: libgj-gnu: soft note
 */
void
