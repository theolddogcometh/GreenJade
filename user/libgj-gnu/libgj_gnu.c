 ...
 *   libgj-gnu: soft inventory wave=30 surfaces=12 caps=0xf stamp=GNU1
 *   libgj-gnu: soft deepen wave=30 areas=export,stamp,caps,get,id,probe,
...
/* Wave 30 exclusive soft inventory stamp. */
#define GJ_GNU_SOFT_WAVE        30u
...
static const char g_szGnuSoftInventory[] =
    "libgj-gnu: soft inventory wave=30 surfaces=12 areas=12 "
...
static const char g_szGnuSoftDeepen[] =
    "libgj-gnu: soft deepen wave=30 areas=12 "
...
/*
 * Cold soft inventory accessor (Wave 30).
 * greppable: GJ_GNU_SOFT_INVENTORY
 * Grep: libgj-gnu: soft inventory
 */
const char *
...
/*
 * Cold soft deepen stamp (Wave 30).
 * greppable: GJ_GNU_SOFT_DEEPEN
 * Grep: libgj-gnu: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 30 exclusive).
 * Grep: libgj-gnu: soft honesty
 */
const char *
...
/*
 * Soft area catalog size (Wave 30 deepen areas).
...
/*
 * Soft note extend (Wave 30): deepen + path call counters.
 * Grep: libgj-gnu: soft note
 */
void
