...
/* Wave 100 exclusive soft inventory stamp. */
...
/*
 * Cold soft inventory accessor (Wave 100).
 * greppable: GJ_GNU_SOFT_INVENTORY
 * Grep: libgj-gnu: soft inventory
 */
const char *
...
/*
 * Cold soft deepen stamp (Wave 100).
 * greppable: GJ_GNU_SOFT_DEEPEN
 * Grep: libgj-gnu: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 100 exclusive).
 * Grep: libgj-gnu: soft honesty
 */
const char *
...
/*
 * Soft area catalog size (Wave 100 deepen areas).
...
/*
 * Soft note extend (Wave 100): deepen + path call counters.
 * Grep: libgj-gnu: soft note
 */
void
