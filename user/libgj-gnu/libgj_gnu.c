...
/* Wave 113 exclusive soft inventory stamp. */
...
/*
 * Cold soft inventory accessor (Wave 113).
 * greppable: GJ_GNU_SOFT_INVENTORY
 * Grep: libgj-gnu: soft inventory
 */
const char *
...
/*
 * Cold soft deepen stamp (Wave 113).
 * greppable: GJ_GNU_SOFT_DEEPEN
 * Grep: libgj-gnu: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 113 exclusive).
 * Grep: libgj-gnu: soft honesty
 */
const char *
...
/*
 * Soft note extend (Wave 113): deepen + path call counters.
 * Grep: libgj-gnu: soft note
 */
void
