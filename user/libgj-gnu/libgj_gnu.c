...
/* Wave 75 exclusive soft inventory stamp. */
...
/*
 * Cold soft inventory accessor (Wave 75).
 * greppable: GJ_GNU_SOFT_INVENTORY
 * Grep: libgj-gnu: soft inventory
 */
const char *
...
/*
 * Cold soft deepen stamp (Wave 75).
 * greppable: GJ_GNU_SOFT_DEEPEN
 * Grep: libgj-gnu: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 75 exclusive).
 * Grep: libgj-gnu: soft honesty
 */
const char *
...
/*
 * Soft area catalog size (Wave 75 deepen areas).
...
/*
 * Soft note extend (Wave 75): deepen + path call counters.
 * Grep: libgj-gnu: soft note
 */
void
