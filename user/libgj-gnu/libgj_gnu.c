...
/* Wave 70 exclusive soft inventory stamp. */
...
/*
 * Cold soft inventory accessor (Wave 70).
 * greppable: GJ_GNU_SOFT_INVENTORY
 * Grep: libgj-gnu: soft inventory
 */
const char *
...
/*
 * Cold soft deepen stamp (Wave 70).
 * greppable: GJ_GNU_SOFT_DEEPEN
 * Grep: libgj-gnu: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 70 exclusive).
 * Grep: libgj-gnu: soft honesty
 */
const char *
...
/*
 * Soft area catalog size (Wave 70 deepen areas).
...
/*
 * Soft note extend (Wave 70): deepen + path call counters.
 * Grep: libgj-gnu: soft note
 */
void
