 ...
 *
 * Soft surface (Wave 47 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 47 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=47
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 47u

/* greppable: libgj-gnu: soft batch1 wave=47 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=47 areas=6 "
...
/* Cold soft inventory: Wave 47 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
