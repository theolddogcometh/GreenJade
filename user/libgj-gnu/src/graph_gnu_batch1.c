 ...
 *
 * Soft surface (Wave 55 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 55 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=55
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 55u

/* greppable: libgj-gnu: soft batch1 wave=55 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=55 areas=6 "
...
/* Cold soft inventory: Wave 55 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
