 ...
 *
 * Soft surface (Wave 56 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 56 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=56
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=56 areas=6 "
...
/* Cold soft inventory: Wave 56 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
