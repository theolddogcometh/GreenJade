 ...
 *
 * Soft surface (Wave 38 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 38 stamp (37)
 ...
 * greppable: libgj-gnu: soft batch1 wave=38
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=38 areas=6 "
...
/* Cold soft inventory: Wave 38 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
