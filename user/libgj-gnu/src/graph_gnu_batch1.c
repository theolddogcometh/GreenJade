 ...
 *
 * Soft surface (Wave 65 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 65 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=65
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 65u

/* greppable: libgj-gnu: soft batch1 wave=65 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=65 areas=6 "
...
/* Cold soft inventory: Wave 65 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
