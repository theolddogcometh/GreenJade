 ...
 *
 * Soft surface (Wave 36 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 36 stamp (36)
 ...
 * greppable: libgj-gnu: soft batch1 wave=36
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   36u

/* greppable: libgj-gnu: soft batch1 wave=36 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=36 areas=6 "
...
/* Cold soft inventory: Wave 36 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
