 ...
 *
 * Soft surface (Wave 62 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 62 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=62
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 62u

/* greppable: libgj-gnu: soft batch1 wave=62 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=62 areas=6 "
...
/* Cold soft inventory: Wave 62 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
