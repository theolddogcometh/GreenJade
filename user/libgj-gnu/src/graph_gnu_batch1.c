 ...
 *
 * Soft surface (Wave 26 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 26 stamp (17)
 ...
 * greppable: libgj-gnu: soft batch1 wave=26
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=26 areas=6 "
...
/* Cold soft inventory: Wave 26 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
