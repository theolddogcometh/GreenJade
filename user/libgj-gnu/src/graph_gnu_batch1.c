 ...
 *
 * Soft surface (Wave 33 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 33 stamp (32)
 ...
 * greppable: libgj-gnu: soft batch1 wave=33
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   33u

/* greppable: libgj-gnu: soft batch1 wave=33 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=33 areas=6 "
...
/* Cold soft inventory: Wave 33 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
