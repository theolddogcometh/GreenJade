 ...
 *
 * Soft surface (Wave 59 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 59 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=59
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 59u

/* greppable: libgj-gnu: soft batch1 wave=59 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=59 areas=6 "
...
/* Cold soft inventory: Wave 59 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
