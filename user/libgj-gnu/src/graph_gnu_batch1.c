 ...
 *
 * Soft surface (Wave 66 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 66 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=66
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 66u

/* greppable: libgj-gnu: soft batch1 wave=66 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=66 areas=6 "
...
/* Cold soft inventory: Wave 66 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
