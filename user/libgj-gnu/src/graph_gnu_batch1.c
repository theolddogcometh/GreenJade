 ...
 *
 * Soft surface (Wave 58 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 58 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=58
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 58u

/* greppable: libgj-gnu: soft batch1 wave=58 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=58 areas=6 "
...
/* Cold soft inventory: Wave 58 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
