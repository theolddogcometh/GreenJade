 ...
 *
 * Soft surface (Wave 67 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 67 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=67
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 67u

/* greppable: libgj-gnu: soft batch1 wave=67 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=67 areas=6 "
...
/* Cold soft inventory: Wave 67 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
