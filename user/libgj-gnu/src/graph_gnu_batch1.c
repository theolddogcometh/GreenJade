 ...
 *
 * Soft surface (Wave 50 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 50 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=50
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 50u

/* greppable: libgj-gnu: soft batch1 wave=50 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=50 areas=6 "
...
/* Cold soft inventory: Wave 50 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
