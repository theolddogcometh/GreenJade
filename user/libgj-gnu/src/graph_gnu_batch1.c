 ...
 *
 * Soft surface (Wave 19 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 19 stamp (17)
 ...
 * greppable: libgj-gnu: soft batch1 wave=19
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   19u

/* greppable: libgj-gnu: soft batch1 wave=19 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=19 areas=6 "
...
/* Cold soft inventory: Wave 19 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
