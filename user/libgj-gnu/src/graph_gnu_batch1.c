 ...
 *
 * Soft surface (Wave 51 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 51 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=51
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 51u

/* greppable: libgj-gnu: soft batch1 wave=51 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=51 areas=6 "
...
/* Cold soft inventory: Wave 51 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
