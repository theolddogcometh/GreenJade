 ...
 *
 * Soft surface (Wave 69 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 69 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=69
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 69u

/* greppable: libgj-gnu: soft batch1 wave=69 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=69 areas=6 "
...
/* Cold soft inventory: Wave 69 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
