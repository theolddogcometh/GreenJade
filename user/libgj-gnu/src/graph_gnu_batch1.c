 ...
 *
 * Soft surface (Wave 60 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 60 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=60
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 60u

/* greppable: libgj-gnu: soft batch1 wave=60 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=60 areas=6 "
...
/* Cold soft inventory: Wave 60 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
