 ...
 *
 * Soft surface (Wave 35 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 35 stamp (32)
 ...
 * greppable: libgj-gnu: soft batch1 wave=35
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=35 areas=6 "
...
/* Cold soft inventory: Wave 35 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
