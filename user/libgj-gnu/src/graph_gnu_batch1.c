 ...
 *
 * Soft surface (Wave 46 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 46 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=46
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 46u

/* greppable: libgj-gnu: soft batch1 wave=46 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=46 areas=6 "
...
/* Cold soft inventory: Wave 46 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
