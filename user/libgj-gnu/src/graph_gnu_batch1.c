 ...
 *
 * Soft surface (Wave 63 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 63 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=63
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 63u

/* greppable: libgj-gnu: soft batch1 wave=63 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=63 areas=6 "
...
/* Cold soft inventory: Wave 63 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
