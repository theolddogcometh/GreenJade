 ...
 *
 * Soft surface (Wave 44 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 44 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=44
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE  40u

/* greppable: libgj-gnu: soft batch1 wave=44 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=44 areas=6 "
...
/* Cold soft inventory: Wave 44 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
