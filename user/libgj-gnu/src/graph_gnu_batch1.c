 ...
 *
 * Soft surface (Wave 29 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 29 stamp (17)
 ...
 * greppable: libgj-gnu: soft batch1 wave=29
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   25u

/* greppable: libgj-gnu: soft batch1 wave=29 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=29 areas=6 "
...
/* Cold soft inventory: Wave 29 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
