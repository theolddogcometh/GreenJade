 ...
 *
 * Soft surface (Wave 54 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 54 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=54
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 54u

/* greppable: libgj-gnu: soft batch1 wave=54 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=54 areas=6 "
...
/* Cold soft inventory: Wave 54 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
