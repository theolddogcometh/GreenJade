 ...
 *
 * Soft surface (Wave 64 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 64 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=64
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 64u

/* greppable: libgj-gnu: soft batch1 wave=64 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=64 areas=6 "
...
/* Cold soft inventory: Wave 64 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
