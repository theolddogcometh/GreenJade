 ...
 *
 * Soft surface (Wave 57 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 57 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=57
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=57 areas=6 "
...
/* Cold soft inventory: Wave 57 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
