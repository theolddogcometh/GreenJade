 ...
 *
 * Soft surface (Wave 24 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 24 stamp (17)
 ...
 * greppable: libgj-gnu: soft batch1 wave=24
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   24u

/* greppable: libgj-gnu: soft batch1 wave=24 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=24 areas=6 "
...
/* Cold soft inventory: Wave 24 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
