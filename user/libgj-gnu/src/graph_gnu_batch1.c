 ...
 *
 * Soft surface (Wave 32 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 32 stamp (32)
 ...
 * greppable: libgj-gnu: soft batch1 wave=32
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   32u

/* greppable: libgj-gnu: soft batch1 wave=32 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=32 areas=6 "
...
/* Cold soft inventory: Wave 32 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
