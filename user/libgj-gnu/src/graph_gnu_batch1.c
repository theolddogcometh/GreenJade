 ...
 *
 * Soft surface (Wave 37 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 37 stamp (37)
 ...
 * greppable: libgj-gnu: soft batch1 wave=37
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   37u

/* greppable: libgj-gnu: soft batch1 wave=37 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=37 areas=6 "
...
/* Cold soft inventory: Wave 37 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
