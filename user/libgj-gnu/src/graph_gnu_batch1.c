 ...
 *
 * Soft surface (Wave 27 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 27 stamp (17)
 ...
 * greppable: libgj-gnu: soft batch1 wave=27
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=27 areas=6 "
...
/* Cold soft inventory: Wave 27 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
