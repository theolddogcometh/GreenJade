 ...
 *
 * Soft surface (Wave 61 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 61 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=61
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 61u

/* greppable: libgj-gnu: soft batch1 wave=61 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=61 areas=6 "
...
/* Cold soft inventory: Wave 61 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
