 ...
 *
 * Soft surface (Wave 41 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 41 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=41
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=41 areas=6 "
...
/* Cold soft inventory: Wave 41 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
