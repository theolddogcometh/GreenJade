 ...
 *
 * Soft surface (Wave 39 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 39 stamp (39)
 ...
 * greppable: libgj-gnu: soft batch1 wave=39
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE  39u

/* greppable: libgj-gnu: soft batch1 wave=39 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=39 areas=6 "
...
/* Cold soft inventory: Wave 39 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
