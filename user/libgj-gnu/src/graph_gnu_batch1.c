 ...
 *
 * Soft surface (Wave 68 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 68 stamp (40)
 ...
 * greppable: libgj-gnu: soft batch1 wave=68
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE 68u

/* greppable: libgj-gnu: soft batch1 wave=68 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=68 areas=6 "
...
/* Cold soft inventory: Wave 68 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
