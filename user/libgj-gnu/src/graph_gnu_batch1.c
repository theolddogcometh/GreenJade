 ...
 *
 * Soft surface (Wave 31 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 31 stamp (17)
 ...
 * greppable: libgj-gnu: soft batch1 wave=31
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   31u

/* greppable: libgj-gnu: soft batch1 wave=31 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=31 areas=6 "
...
/* Cold soft inventory: Wave 31 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
