 ...
 *
 * Soft surface (Wave 30 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 30 stamp (17)
 ...
 * greppable: libgj-gnu: soft batch1 wave=30
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   30u

/* greppable: libgj-gnu: soft batch1 wave=30 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=30 areas=6 "
...
/* Cold soft inventory: Wave 30 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
