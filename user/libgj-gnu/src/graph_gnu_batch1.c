 ...
 *
 * Soft surface (Wave 23 exclusive deepen):
 *   gj_gnu_batch1_soft_wave      — Wave 23 stamp (17)
 ...
 * greppable: libgj-gnu: soft batch1 wave=23
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_GNU_BATCH1_SOFT_WAVE   23u

/* greppable: libgj-gnu: soft batch1 wave=23 */
static const char g_szGnuBatch1SoftInventory[] =
	"libgj-gnu: soft batch1 wave=23 areas=6 "
...
/* Cold soft inventory: Wave 23 stamp. Grep: libgj-gnu: soft batch1 wave= */
unsigned
