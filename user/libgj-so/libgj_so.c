 ...
 *
 * Soft deepen surface (Wave 86 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 86 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retforgeangle=1 retprismangle=1 continuum_toward=22800";
...
/*
 * Soft honesty line (Wave 86 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retforgeangle / retprismangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retforgeangle=1 retprismangle=1 continuum_toward=22800 soft_ne_product=1";

/* Soft area name catalog (Wave 86; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 86). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 86 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 86 stamp. Grep: libgj-so: soft wave= */
unsigned
