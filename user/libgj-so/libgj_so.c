 ...
 *
 * Soft deepen surface (Wave 43 exclusive; extra dynsyms enrich DT_HASH
 ...
 *   greppable: libgj-so: soft deepen wave=43
 * Soft batches live under src/ (unwired). Diagnostics only — not bar3.
 *
 * Soft inventory (Wave 43 exclusive deepen):
 *   libgj-so: soft inventory wave=43 surfaces=12 caps=0x1f stamp=SYSV
 *   libgj-so: soft deepen wave=43 areas=export,init,get,hash,stamp,caps,
...
/* Wave 43 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftInventory[] =
    ...
    "stamp=SYSV caps=0x1f areas=12 wave=43 surfaces=12 "
...
/*
 * Wave 43 soft deepen stamp.
 * Grep: libgj-so: soft deepen
 * greppable: GJ_SO_SOFT_DEEPEN / libgj-so: soft deepen wave=43
 */
static const char g_szSoSoftDeepen[] =
    "libgj-so: soft deepen wave=43 areas=12 "
    ...
    "retmachicolation=1 retarrowslit=1 continuum_toward=18500";
...
/*
 * Soft honesty line (Wave 43 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retmachicolation / retarrowslit (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retmachicolation=1 retarrowslit=1 continuum_toward=18500 soft_ne_product=1";
...
/*
 * Cold soft deepen stamp (Wave 43). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 43 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 43 stamp. Grep: libgj-so: soft wave= */
unsigned
