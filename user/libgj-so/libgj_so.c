 ...
 *
 * Soft deepen surface (Wave 77 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 77 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retspireangle=1 retholdangle=1 continuum_toward=21900";
...
/*
 * Soft honesty line (Wave 77 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retspireangle / retholdangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retspireangle=1 retholdangle=1 continuum_toward=21900 soft_ne_product=1";

/* Soft area name catalog (Wave 77; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 77). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 77 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 77 stamp. Grep: libgj-so: soft wave= */
unsigned
