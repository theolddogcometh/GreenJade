 ...
 *
 * Soft deepen surface (Wave 75 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 75 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retmoatangle=1 retowerangle=1 continuum_toward=21700";
...
/*
 * Soft honesty line (Wave 75 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retmoatangle / retowerangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retmoatangle=1 retowerangle=1 continuum_toward=21700 soft_ne_product=1";

/* Soft area name catalog (Wave 75; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 75). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 75 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 75 stamp. Grep: libgj-so: soft wave= */
unsigned
