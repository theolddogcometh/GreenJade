 ...
 *
 * Soft deepen surface (Wave 122 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 122 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retframeangle=1 retwindowangle=1 continuum_toward=26400 soft_ne_product=1 wave=122";
/*
...
/*
 * Soft honesty line (Wave 122 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retframeangle / retwindowangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 122). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 122 exclusive). Grep: libgj-so: soft honesty
 */
const char *
