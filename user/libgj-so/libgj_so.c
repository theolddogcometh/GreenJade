 ...
 *
 * Soft deepen surface (Wave 112 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 112 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retfragmentangle=1 retvertexangle=1 continuum_toward=25400 soft_ne_product=1 wave=112";
...
/*
 * Soft honesty line (Wave 112 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retfragmentangle / retvertexangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 112). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 112 exclusive). Grep: libgj-so: soft honesty
 */
const char *
