 ...
 *
 * Soft deepen surface (Wave 120 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 120 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retchannelangle=1 retmailboxangle=1 continuum_toward=26200 soft_ne_product=1 wave=120";
/*
...
/*
 * Soft honesty line (Wave 120 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retchannelangle / retmailboxangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 120). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 120 exclusive). Grep: libgj-so: soft honesty
 */
const char *
