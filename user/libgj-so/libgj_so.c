 ...
 *
 * Soft deepen surface (Wave 103 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 103 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retprojectangle=1 retaffineangle=1 continuum_toward=24500 soft_ne_product=1 wave=103";
...
/*
 * Soft honesty line (Wave 103 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retprojectangle / retaffineangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 103; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 103). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 103 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 103 stamp. Grep: libgj-so: soft wave= */
unsigned
