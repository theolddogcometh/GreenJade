 ...
 *
 * Soft deepen surface (Wave 113 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 113 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retshaderangle=1 retpipelineangle=1 continuum_toward=25500 soft_ne_product=1 wave=113";
...
/*
 * Soft honesty line (Wave 113 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retshaderangle / retpipelineangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 113). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 113 exclusive). Grep: libgj-so: soft honesty
 */
const char *
