 ...
 *
 * Soft deepen surface (Wave 111 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 111 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retvoxelangle=1 rettexelangle=1 continuum_toward=25300 soft_ne_product=1 wave=111";
...
/*
 * Soft honesty line (Wave 111 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retvoxelangle / rettexelangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 111). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 111 exclusive). Grep: libgj-so: soft honesty
 */
const char *
