 ...
 *
 * Soft deepen surface (Wave 25 exclusive; extra dynsyms enrich DT_HASH
 ...
 *   greppable: libgj-so: soft deepen wave=25
 * Soft batches live under src/ (unwired). Diagnostics only — not bar3.
 *
 * Soft inventory (Wave 25 exclusive deepen):
 *   libgj-so: soft inventory wave=25 surfaces=12 caps=0x1f stamp=SYSV
 *   libgj-so: soft deepen wave=25 areas=export,init,get,hash,stamp,caps,
...
/* Wave 25 soft inventory stamp (source greppable; not a smoke contract). */
#define GJ_SO_SOFT_WAVE         25u
...
static const char g_szSoSoftInventory[] =
    ...
    "stamp=SYSV caps=0x1f areas=12 wave=25 surfaces=12 "
...
/*
 * Wave 25 soft deepen stamp.
 * Grep: libgj-so: soft deepen
 * greppable: GJ_SO_SOFT_DEEPEN / libgj-so: soft deepen wave=25
 */
static const char g_szSoSoftDeepen[] =
    "libgj-so: soft deepen wave=25 areas=12 "
...
/*
 * Soft honesty line (Wave 25 exclusive).
...
static const char g_szSoSoftHonesty[] =
    ...
    "soft=1 product_kernel=OPEN wave=25";

/* Soft area name catalog (Wave 25; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 25). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 25 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 25 stamp. Grep: libgj-so: soft wave= */
unsigned
