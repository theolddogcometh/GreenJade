 ...
 *
 * Soft deepen surface (Wave 114 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 114 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retframebufferangle=1 retswapchainangle=1 continuum_toward=25600 soft_ne_product=1 wave=114";
 ...
 * Grep: libgj-so: soft retframebufferangle / retswapchainangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 114). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 114 exclusive). Grep: libgj-so: soft honesty
 */
const char *
