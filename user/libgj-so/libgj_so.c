 ...
 *
 * Soft deepen surface (Wave 71 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 71 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retsallyportangle=1 retreentrantangle=1 continuum_toward=21300";
...
/*
 * Soft honesty line (Wave 71 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retsallyportangle / retreentrantangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retsallyportangle=1 retreentrantangle=1 continuum_toward=21300 soft_ne_product=1";

/* Soft area name catalog (Wave 71; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 71). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 71 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 71 stamp. Grep: libgj-so: soft wave= */
unsigned
