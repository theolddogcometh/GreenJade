 ...
 *
 * Soft deepen surface (Wave 119 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 119 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retqueueangle=1 reteventangle=1 continuum_toward=26100 soft_ne_product=1 wave=119";
/*
...
/*
 * Soft honesty line (Wave 119 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retqueueangle / reteventangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 119). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 119 exclusive). Grep: libgj-so: soft honesty
 */
const char *
