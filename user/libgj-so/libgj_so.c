 ...
 *
 * Soft deepen surface (Wave 29 exclusive; extra dynsyms enrich DT_HASH
 ...
 *   greppable: libgj-so: soft deepen wave=29
 * Soft batches live under src/ (unwired). Diagnostics only — not bar3.
 *
 * Soft inventory (Wave 29 exclusive deepen):
 *   libgj-so: soft inventory wave=29 surfaces=12 caps=0x1f stamp=SYSV
 *   libgj-so: soft deepen wave=29 areas=export,init,get,hash,stamp,caps,
...
/* Wave 29 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftInventory[] =
    ...
    "stamp=SYSV caps=0x1f areas=12 wave=29 surfaces=12 "
...
/*
 * Wave 29 soft deepen stamp.
 * Grep: libgj-so: soft deepen
 * greppable: GJ_SO_SOFT_DEEPEN / libgj-so: soft deepen wave=29
 */
static const char g_szSoSoftDeepen[] =
    "libgj-so: soft deepen wave=29 areas=12 "
...
/*
 * Soft honesty line (Wave 29 exclusive).
...
static const char g_szSoSoftHonesty[] =
    ...
    "soft=1 product_kernel=OPEN wave=29";

/* Soft area name catalog (Wave 29; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 29). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 29 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 29 stamp. Grep: libgj-so: soft wave= */
unsigned
