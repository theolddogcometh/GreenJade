 ...
 *
 * Soft deepen surface (Wave 125 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 125 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retpaletteangle=1 retstrokeangle=1 continuum_toward=26700 soft_ne_product=1 wave=125";
/*
...
/*
 * Soft honesty line (Wave 125 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retpaletteangle / retstrokeangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 125). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 125 exclusive). Grep: libgj-so: soft honesty
 */
const char *
