 ...
 *
 * Soft deepen surface (Wave 109 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 109 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retnurbsangle=1 retbsplineangle=1 continuum_toward=25100 soft_ne_product=1 wave=109";
...
/*
 * Soft honesty line (Wave 109 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retnurbsangle / retbsplineangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 109; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 109). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 109 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 109 stamp. Grep: libgj-so: soft wave= */
unsigned
