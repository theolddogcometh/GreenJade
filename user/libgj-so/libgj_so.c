 ...
 *
 * Soft deepen surface (Wave 88 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 88 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retbeaconangle=1 retledgerangle=1 continuum_toward=23000";
...
/*
 * Soft honesty line (Wave 88 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retbeaconangle / retledgerangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retbeaconangle=1 retledgerangle=1 continuum_toward=23000 soft_ne_product=1";

/* Soft area name catalog (Wave 88; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 88). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 88 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 88 stamp. Grep: libgj-so: soft wave= */
unsigned
