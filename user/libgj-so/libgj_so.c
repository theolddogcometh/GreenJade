 ...
 *
 * Soft deepen surface (Wave 92 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 92 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retmarkangle=1 retpulseangle=1 continuum_toward=23400";
...
/*
 * Soft honesty line (Wave 92 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retmarkangle / retpulseangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retmarkangle=1 retpulseangle=1 continuum_toward=23400 soft_ne_product=1";

/* Soft area name catalog (Wave 92; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 92). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 92 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 92 stamp. Grep: libgj-so: soft wave= */
unsigned
