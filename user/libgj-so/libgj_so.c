 ...
 *
 * Soft deepen surface (Wave 76 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 76 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retgateangle=1 retwallangle=1 continuum_toward=21800";
...
/*
 * Soft honesty line (Wave 76 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retgateangle / retwallangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retgateangle=1 retwallangle=1 continuum_toward=21800 soft_ne_product=1";

/* Soft area name catalog (Wave 76; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 76). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 76 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 76 stamp. Grep: libgj-so: soft wave= */
unsigned
