 ...
 *
 * Soft deepen surface (Wave 87 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 87 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retflameangle=1 retcipherangle=1 continuum_toward=22900";
...
/*
 * Soft honesty line (Wave 87 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retflameangle / retcipherangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retflameangle=1 retcipherangle=1 continuum_toward=22900 soft_ne_product=1";

/* Soft area name catalog (Wave 87; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 87). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 87 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 87 stamp. Grep: libgj-so: soft wave= */
unsigned
