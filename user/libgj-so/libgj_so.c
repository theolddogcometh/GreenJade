 ...
 *
 * Soft deepen surface (Wave 82 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 82 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retmantleangle=1 retaegisangle=1 continuum_toward=22400";
...
/*
 * Soft honesty line (Wave 82 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retmantleangle / retaegisangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retmantleangle=1 retaegisangle=1 continuum_toward=22400 soft_ne_product=1";

/* Soft area name catalog (Wave 82; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 82). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 82 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 82 stamp. Grep: libgj-so: soft wave= */
unsigned
