 ...
 *
 * Soft deepen surface (Wave 124 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 124 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retbrushangle=1 retinkangle=1 continuum_toward=26600 soft_ne_product=1 wave=124";
/*
...
/*
 * Soft honesty line (Wave 124 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retbrushangle / retinkangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 124). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 124 exclusive). Grep: libgj-so: soft honesty
 */
const char *
