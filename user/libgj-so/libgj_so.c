 ...
 *
 * Soft deepen surface (Wave 81 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 81 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retpanoplyangle=1 retbulwarkangle=1 continuum_toward=22300";
...
/*
 * Soft honesty line (Wave 81 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retpanoplyangle / retbulwarkangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retpanoplyangle=1 retbulwarkangle=1 continuum_toward=22300 soft_ne_product=1";

/* Soft area name catalog (Wave 81; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 81). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 81 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 81 stamp. Grep: libgj-so: soft wave= */
unsigned
