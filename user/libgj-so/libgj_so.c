 ...
 *
 * Soft deepen surface (Wave 72 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 72 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retplaceofarmsangle=1 retdoubletenailleangle=1 continuum_toward=21400";
...
/*
 * Soft honesty line (Wave 72 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retplaceofarmsangle / retdoubletenailleangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retplaceofarmsangle=1 retdoubletenailleangle=1 continuum_toward=21400 soft_ne_product=1";

/* Soft area name catalog (Wave 72; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 72). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 72 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 72 stamp. Grep: libgj-so: soft wave= */
unsigned
