 ...
 *
 * Soft deepen surface (Wave 116 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 116 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retfenceangle=1 retsemaphoreangle=1 continuum_toward=25800 soft_ne_product=1 wave=116";
...
/*
 * Soft honesty line (Wave 116 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retfenceangle / retsemaphoreangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 116). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 116 exclusive). Grep: libgj-so: soft honesty
 */
const char *
