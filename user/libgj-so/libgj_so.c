 ...
 *
 * Soft deepen surface (Wave 115 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 115 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retpresentangle=1 retvsyncangle=1 continuum_toward=25700 soft_ne_product=1 wave=115";
 ...
 * Grep: libgj-so: soft retpresentangle / retvsyncangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 115). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 115 exclusive). Grep: libgj-so: soft honesty
 */
const char *
