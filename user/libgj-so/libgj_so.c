 ...
 *
 * Soft deepen surface (Wave 33 exclusive; extra dynsyms enrich DT_HASH
 ...
 *   greppable: libgj-so: soft deepen wave=33
 * Soft batches live under src/ (unwired). Diagnostics only — not bar3.
 *
 * Soft inventory (Wave 33 exclusive deepen):
 *   libgj-so: soft inventory wave=33 surfaces=12 caps=0x1f stamp=SYSV
 *   libgj-so: soft deepen wave=33 areas=export,init,get,hash,stamp,caps,
...
/* Wave 33 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftInventory[] =
    ...
    "stamp=SYSV caps=0x1f areas=12 wave=33 surfaces=12 "
...
/*
 * Wave 33 soft deepen stamp.
 * Grep: libgj-so: soft deepen
 * greppable: GJ_SO_SOFT_DEEPEN / libgj-so: soft deepen wave=33
 */
static const char g_szSoSoftDeepen[] =
    "libgj-so: soft deepen wave=33 areas=12 "
...
/*
 * Soft honesty line (Wave 33 exclusive).
...
/*
 * Cold soft deepen stamp (Wave 33). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 33 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 33 stamp. Grep: libgj-so: soft wave= */
unsigned
