 ...
 *
 * Soft deepen surface (Wave 100 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 100 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retspiralangle=1 rethelixangle=1 continuum_toward=24200 soft_ne_product=1 wave=100";
...
/*
 * Soft honesty line (Wave 100 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retspiralangle / rethelixangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 100; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 100). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 100 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 100 stamp. Grep: libgj-so: soft wave= */
unsigned
