 ...
 *
 * Soft deepen surface (Wave 74 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 74 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retglacisangle=1 retparapetangle=1 continuum_toward=21600";
...
/*
 * Soft honesty line (Wave 74 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retglacisangle / retparapetangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retglacisangle=1 retparapetangle=1 continuum_toward=21600 soft_ne_product=1";

/* Soft area name catalog (Wave 74; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 74). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 74 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 74 stamp. Grep: libgj-so: soft wave= */
unsigned
