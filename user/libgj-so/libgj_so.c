 ...
 *
 * Soft deepen surface (Wave 108 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 108 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "rethurmitangle=1 retcatmullangle=1 continuum_toward=25000 soft_ne_product=1 wave=108";
...
/*
 * Soft honesty line (Wave 108 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft rethurmitangle / retcatmullangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 108). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 108 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 108 stamp. Grep: libgj-so: soft wave= */
unsigned
