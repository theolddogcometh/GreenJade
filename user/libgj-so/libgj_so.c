 ...
 *
 * Soft deepen surface (Wave 95 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 95 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retchordangle=1 retarcangle=1 continuum_toward=23700 soft_ne_product=1 wave=95";
...
/*
 * Soft honesty line (Wave 95 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retchordangle / retarcangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 95; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 95). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 95 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 95 stamp. Grep: libgj-so: soft wave= */
unsigned
