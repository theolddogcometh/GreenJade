 ...
 *
 * Soft deepen surface (Wave 17 exclusive; extra dynsyms enrich DT_HASH
 ...
 *   greppable: libgj-so: soft deepen wave=17
 * Soft batches live under src/ (unwired). Diagnostics only — not bar3.
 *
 * Soft inventory (Wave 17 exclusive deepen):
 *   libgj-so: soft inventory wave=17 surfaces=12 caps=0x1f stamp=SYSV
 *   libgj-so: soft deepen wave=17 areas=export,init,get,hash,stamp,caps,
...
/* Wave 17 soft inventory stamp (source greppable; not a smoke contract). */
#define GJ_SO_SOFT_WAVE         17u
...
static const char g_szSoSoftInventory[] =
    ...
    "stamp=SYSV caps=0x1f areas=12 wave=17 surfaces=12 "
...
/*
 * Wave 17 soft deepen stamp.
 * Grep: libgj-so: soft deepen
 * greppable: GJ_SO_SOFT_DEEPEN / libgj-so: soft deepen wave=17
 */
static const char g_szSoSoftDeepen[] =
    "libgj-so: soft deepen wave=17 areas=12 "
...
/*
 * Soft honesty line (Wave 17 exclusive).
...
static const char g_szSoSoftHonesty[] =
    ...
    "soft=1 product_kernel=OPEN wave=17";

/* Soft area name catalog (Wave 17; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 17). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 17 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 17 stamp. Grep: libgj-so: soft wave= */
unsigned
