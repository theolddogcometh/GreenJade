 ...
 *
 * Soft deepen surface (Wave 126 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 126 soft inventory stamp (source greppable; not a smoke contract). */
...
/*
 * Cold soft deepen stamp (Wave 126). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 126 exclusive). Grep: libgj-so: soft honesty
 */
const char *
