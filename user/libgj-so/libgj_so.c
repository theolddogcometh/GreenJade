 ...
 *
 * Soft deepen surface (Wave 96 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 96 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retsectorangle=1 retwedgeangle=1 continuum_toward=23800 soft_ne_product=1 wave=96";
...
/*
 * Soft honesty line (Wave 96 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retsectorangle / retwedgeangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 96; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 96). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 96 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 96 stamp. Grep: libgj-so: soft wave= */
unsigned
