 ...
 *
 * Soft deepen surface (Wave 104 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 104 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retlinearangle=1 retbilinearangle=1 continuum_toward=24600 soft_ne_product=1 wave=104";
...
/*
 * Soft honesty line (Wave 104 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retlinearangle / retbilinearangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 104; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 104). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 104 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 104 stamp. Grep: libgj-so: soft wave= */
unsigned
