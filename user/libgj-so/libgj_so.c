 ...
 *
 * Soft deepen surface (Wave 101 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 101 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "rettorusangle=1 retknotangle=1 continuum_toward=24300 soft_ne_product=1 wave=101";
...
/*
 * Soft honesty line (Wave 101 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft rettorusangle / retknotangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 101; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 101). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 101 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 101 stamp. Grep: libgj-so: soft wave= */
unsigned
