 ...
 *
 * Soft deepen surface (Wave 118 exclusive; extra dynsyms enrich DT_HASH
 ...
 *
 * Soft inventory (Wave 118 exclusive deepen):
...
/* Wave 118 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retbarrierangle=1 retatomicangle=1 continuum_toward=26000 soft_ne_product=1 wave=118";
/*
...
/*
 * Soft honesty line (Wave 118 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retbarrierangle / retatomicangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 118). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 118 exclusive). Grep: libgj-so: soft honesty
 */
const char *
