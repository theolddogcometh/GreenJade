 ...
 *
 * Soft deepen surface (Wave 91 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 91 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retbadgeangle=1 retphaseangle=1 continuum_toward=23300";
...
/*
 * Soft honesty line (Wave 91 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retbadgeangle / retphaseangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retbadgeangle=1 retphaseangle=1 continuum_toward=23300 soft_ne_product=1";
...
/*
 * Cold soft deepen stamp (Wave 91). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 91 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 91 stamp. Grep: libgj-so: soft wave= */
unsigned
