 ...
 *
 * Soft deepen surface (Wave 20 exclusive; extra dynsyms enrich DT_HASH
 ...
 *   greppable: libgj-so: soft deepen wave=20
 * Soft batches live under src/ (unwired). Diagnostics only — not bar3.
 *
 * Soft inventory (Wave 20 exclusive deepen):
 *   libgj-so: soft inventory wave=20 surfaces=12 caps=0x1f stamp=SYSV
 *   libgj-so: soft deepen wave=20 areas=export,init,get,hash,stamp,caps,
...
/* Wave 20 soft inventory stamp (source greppable; not a smoke contract). */
#define GJ_SO_SOFT_WAVE         19u
...
static const char g_szSoSoftInventory[] =
    ...
    "stamp=SYSV caps=0x1f areas=12 wave=20 surfaces=12 "
...
/*
 * Wave 20 soft deepen stamp.
 * Grep: libgj-so: soft deepen
 * greppable: GJ_SO_SOFT_DEEPEN / libgj-so: soft deepen wave=20
 */
static const char g_szSoSoftDeepen[] =
    "libgj-so: soft deepen wave=20 areas=12 "
...
/*
 * Soft honesty line (Wave 20 exclusive).
...
static const char g_szSoSoftHonesty[] =
    ...
    "soft=1 product_kernel=OPEN wave=20";

/* Soft area name catalog (Wave 20; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 20). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 20 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 20 stamp. Grep: libgj-so: soft wave= */
unsigned
