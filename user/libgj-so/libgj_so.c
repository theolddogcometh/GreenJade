 ...
 *
 * Soft deepen surface (Wave 105 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 105 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retquadraticangle=1 retcubicangle=1 continuum_toward=24700 soft_ne_product=1 wave=105";
...
/*
 * Soft honesty line (Wave 105 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retquadraticangle / retcubicangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 105; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 105). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 105 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 105 stamp. Grep: libgj-so: soft wave= */
unsigned
