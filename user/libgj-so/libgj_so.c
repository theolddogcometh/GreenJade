 ...
 *
 * Soft deepen surface (Wave 97 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 97 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retradiusangle=1 retdiameterangle=1 continuum_toward=23900 soft_ne_product=1 wave=97";
...
/*
 * Soft honesty line (Wave 97 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retradiusangle / retdiameterangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 97; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 97). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 97 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 97 stamp. Grep: libgj-so: soft wave= */
unsigned
