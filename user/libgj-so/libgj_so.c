 ...
 *
 * Soft deepen surface (Wave 123 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 123 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retlayerangle=1 retcanvasangle=1 continuum_toward=26500 soft_ne_product=1 wave=123";
/*
...
/*
 * Soft honesty line (Wave 123 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retlayerangle / retcanvasangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 123). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 123 exclusive). Grep: libgj-so: soft honesty
 */
const char *
