 ...
 *
 * Soft deepen surface (Wave 90 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 90 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retcrestangle=1 rettokenangle=1 continuum_toward=23200";
...
/*
 * Soft honesty line (Wave 90 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retcrestangle / rettokenangle (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retcrestangle=1 rettokenangle=1 continuum_toward=23200 soft_ne_product=1";
...
/*
 * Cold soft deepen stamp (Wave 90). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 90 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 90 stamp. Grep: libgj-so: soft wave= */
unsigned
