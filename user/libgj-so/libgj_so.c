 ...
 *
 * Soft deepen surface (Wave 107 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 107 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retsplineangle=1 retbezierangle=1 continuum_toward=24900 soft_ne_product=1 wave=107";
...
/*
 * Soft honesty line (Wave 107 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retsplineangle / retbezierangle (CREATE-ONLY soft ≠ product)
 */
...
/*
 * Cold soft deepen stamp (Wave 107). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 107 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 107 stamp. Grep: libgj-so: soft wave= */
unsigned
