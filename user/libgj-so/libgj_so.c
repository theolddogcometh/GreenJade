 ...
 *
 * Soft deepen surface (Wave 106 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 106 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retquarticangle=1 retquinticangle=1 continuum_toward=24800 soft_ne_product=1 wave=106";
...
/*
 * Soft honesty line (Wave 106 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retquarticangle / retquinticangle (CREATE-ONLY soft ≠ product)
 */
...
/* Soft area name catalog (Wave 106; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 106). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 106 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 106 stamp. Grep: libgj-so: soft wave= */
unsigned
