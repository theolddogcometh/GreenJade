 ...
 *
 * Soft deepen surface (Wave 80 exclusive; extra dynsyms enrich DT_HASH
...
/* Wave 80 soft inventory stamp (source greppable; not a smoke contract). */
...
static const char g_szSoSoftDeepen[] =
    ...
    "retcitadelangle=1 retbastionkeep=1 continuum_toward=22200";
...
/*
 * Soft honesty line (Wave 80 exclusive).
 * Grep: libgj-so: soft honesty
 * Grep: libgj-so: soft retcitadelangle / retbastionkeep (CREATE-ONLY soft ≠ product)
 */
static const char g_szSoSoftHonesty[] =
    ...
    "retcitadelangle=1 retbastionkeep=1 continuum_toward=22200 soft_ne_product=1";

/* Soft area name catalog (Wave 80; cold only). */
...
/*
 * Cold soft deepen stamp (Wave 80). Grep: libgj-so: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 80 exclusive). Grep: libgj-so: soft honesty
 */
const char *
...
/* Cold soft inventory: Wave 80 stamp. Grep: libgj-so: soft wave= */
unsigned
