 ...
 *   gj_so_batch1_soft_wave   — Wave 23 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=23
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     23u

/* greppable: libgj-so: soft batch1 wave=23 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=23 areas=9 "
...
/* Cold soft inventory: Wave 23 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
