 ...
 *
 * Soft surface (unwired; Wave 50 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 50 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=50
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 50u

/* greppable: libgj-so: soft batch1 wave=50 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=50 areas=9 "
...
/* Cold soft inventory: Wave 50 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
