 ...
 *   gj_so_batch1_soft_wave   — Wave 52 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=52
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 52u

/* greppable: libgj-so: soft batch1 wave=52 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=52 areas=9 "
...
/* Cold soft inventory: Wave 52 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
