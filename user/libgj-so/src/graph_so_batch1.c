 ...
 *
 * Soft surface (unwired; Wave 102 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 102 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=70
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 70u

/* greppable: libgj-so: soft batch1 wave=70 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=70 areas=9 "
...
/* Cold soft inventory: Wave 102 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
