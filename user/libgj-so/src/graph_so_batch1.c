 ...
 *
 * Soft surface (unwired; Wave 44 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 44 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=44
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=44 areas=9 "
...
/* Cold soft inventory: Wave 44 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
