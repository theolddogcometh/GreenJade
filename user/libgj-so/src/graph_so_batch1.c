 ...
 *
 * Soft surface (unwired; Wave 36 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 36 stamp (36)
 ...
 * greppable: libgj-so: soft batch1 wave=36
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     36u

/* greppable: libgj-so: soft batch1 wave=36 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=36 areas=9 "
...
/* Cold soft inventory: Wave 36 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
