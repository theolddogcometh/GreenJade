 ...
 *
 * Soft surface (unwired; Wave 21 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 21 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=21
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     21u

/* greppable: libgj-so: soft batch1 wave=21 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=21 areas=9 "
...
/* Cold soft inventory: Wave 21 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
