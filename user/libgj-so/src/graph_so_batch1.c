 ...
 *   gj_so_batch1_soft_wave   — Wave 38 stamp (37)
 ...
 * greppable: libgj-so: soft batch1 wave=38
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=38 areas=9 "
...
/* Cold soft inventory: Wave 38 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
