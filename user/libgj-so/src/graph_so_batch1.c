 ...
 *
 * Soft surface (unwired; Wave 32 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 32 stamp (32)
 ...
 * greppable: libgj-so: soft batch1 wave=32
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     32u

/* greppable: libgj-so: soft batch1 wave=32 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=32 areas=9 "
...
/* Cold soft inventory: Wave 32 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
