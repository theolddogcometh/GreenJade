 ...
 *   gj_so_batch1_soft_wave   — Wave 35 stamp (32)
 ...
 * greppable: libgj-so: soft batch1 wave=35
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=35 areas=9 "
...
/* Cold soft inventory: Wave 35 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
