 ...
 *   gj_so_batch1_soft_wave   — Wave 63 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=63
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 63u

/* greppable: libgj-so: soft batch1 wave=63 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=63 areas=9 "
...
/* Cold soft inventory: Wave 63 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
