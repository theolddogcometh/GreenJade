 ...
 *   gj_so_batch1_soft_wave   — Wave 39 stamp (39)
 ...
 * greppable: libgj-so: soft batch1 wave=39
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     39u

/* greppable: libgj-so: soft batch1 wave=39 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=39 areas=9 "
...
/* Cold soft inventory: Wave 39 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
