 ...
 *
 * Soft surface (unwired; Wave 41 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 41 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=41
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=41 areas=9 "
...
/* Cold soft inventory: Wave 41 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
