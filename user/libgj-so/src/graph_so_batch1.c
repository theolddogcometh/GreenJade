 ...
 *   gj_so_batch1_soft_wave   — Wave 37 stamp (37)
 ...
 * greppable: libgj-so: soft batch1 wave=37
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     37u

/* greppable: libgj-so: soft batch1 wave=37 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=37 areas=9 "
...
/* Cold soft inventory: Wave 37 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
