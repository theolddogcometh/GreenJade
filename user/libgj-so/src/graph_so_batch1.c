 ...
 *
 * Soft surface (unwired; Wave 43 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 43 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=43
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     40u

/* greppable: libgj-so: soft batch1 wave=43 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=43 areas=9 "
...
/* Cold soft inventory: Wave 43 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
