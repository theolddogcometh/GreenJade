 ...
 *
 * Soft surface (unwired; Wave 18 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 18 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=18
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     18u

/* greppable: libgj-so: soft batch1 wave=18 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=18 areas=9 "
...
/* Cold soft inventory: Wave 18 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
