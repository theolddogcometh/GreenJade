 ...
 *
 * Soft surface (unwired; Wave 61 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 61 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=61
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 61u

/* greppable: libgj-so: soft batch1 wave=61 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=61 areas=9 "
...
/* Cold soft inventory: Wave 61 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
