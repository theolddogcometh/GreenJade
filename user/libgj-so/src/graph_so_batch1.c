 ...
 *
 * Soft surface (unwired; Wave 65 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 65 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=65
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 65u

/* greppable: libgj-so: soft batch1 wave=65 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=65 areas=9 "
...
/* Cold soft inventory: Wave 65 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
