 ...
 *
 * Soft surface (unwired; Wave 100 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 100 stamp (40)
...
/* Cold soft inventory: Wave 100 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
