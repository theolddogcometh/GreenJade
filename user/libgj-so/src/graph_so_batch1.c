 ...
 *   gj_so_batch1_soft_wave   — Wave 20 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=20
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=20 areas=9 "
...
/* Cold soft inventory: Wave 20 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
