 ...
 *
 * Soft surface (unwired; Wave 26 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 26 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=26
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     25u

/* greppable: libgj-so: soft batch1 wave=26 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=26 areas=9 "
...
/* Cold soft inventory: Wave 26 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
