 ...
 *
 * Soft surface (unwired; Wave 22 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 22 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=22
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     22u

/* greppable: libgj-so: soft batch1 wave=22 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=22 areas=9 "
...
/* Cold soft inventory: Wave 22 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
