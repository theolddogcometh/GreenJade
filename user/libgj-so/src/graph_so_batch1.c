 ...
 *   gj_so_batch1_soft_wave   — Wave 48 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=48
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 48u

/* greppable: libgj-so: soft batch1 wave=48 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=48 areas=9 "
...
/* Cold soft inventory: Wave 48 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
