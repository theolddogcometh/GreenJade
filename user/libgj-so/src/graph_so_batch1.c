 ...
 *
 * Soft surface (unwired; Wave 17 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 17 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=17
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     17u

/* greppable: libgj-so: soft batch1 wave=17 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=17 areas=9 "
...
/* Cold soft inventory: Wave 17 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
