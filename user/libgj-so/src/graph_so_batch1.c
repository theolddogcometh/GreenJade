 ...
 *
 * Soft surface (unwired; Wave 54 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 54 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=54
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 54u

/* greppable: libgj-so: soft batch1 wave=54 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=54 areas=9 "
...
/* Cold soft inventory: Wave 54 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
