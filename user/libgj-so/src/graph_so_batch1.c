 ...
 *   gj_so_batch1_soft_wave   — Wave 27 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=27
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=27 areas=9 "
...
/* Cold soft inventory: Wave 27 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
