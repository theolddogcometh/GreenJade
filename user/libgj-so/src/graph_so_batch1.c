 ...
 *   gj_so_batch1_soft_wave   — Wave 67 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=67
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 67u

/* greppable: libgj-so: soft batch1 wave=67 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=67 areas=9 "
...
/* Cold soft inventory: Wave 67 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
