 ...
 *
 * Soft surface (unwired; Wave 42 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 42 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=42
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=42 areas=9 "
...
/* Cold soft inventory: Wave 42 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
