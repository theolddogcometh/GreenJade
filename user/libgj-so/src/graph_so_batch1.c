 ...
 *   gj_so_batch1_soft_wave   — Wave 30 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=30
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     30u

/* greppable: libgj-so: soft batch1 wave=30 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=30 areas=9 "
...
/* Cold soft inventory: Wave 30 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
