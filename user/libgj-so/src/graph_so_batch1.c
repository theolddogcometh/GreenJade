 ...
 *   gj_so_batch1_soft_wave   — Wave 40 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=40
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=40 areas=9 "
...
/* Cold soft inventory: Wave 40 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
