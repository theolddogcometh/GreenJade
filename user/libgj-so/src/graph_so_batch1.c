 ...
 *
 * Soft surface (unwired; Wave 62 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 62 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=62
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 62u

/* greppable: libgj-so: soft batch1 wave=62 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=62 areas=9 "
...
/* Cold soft inventory: Wave 62 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
