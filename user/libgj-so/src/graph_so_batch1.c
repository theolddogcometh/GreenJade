 ...
 *   gj_so_batch1_soft_wave   — Wave 68 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=68
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 68u

/* greppable: libgj-so: soft batch1 wave=68 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=68 areas=9 "
...
/* Cold soft inventory: Wave 68 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
