 ...
 *
 * Soft surface (unwired; Wave 101 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 101 stamp (40)
...
/* Cold soft inventory: Wave 101 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
