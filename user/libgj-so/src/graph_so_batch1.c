 ...
 *
 * Soft surface (unwired; Wave 56 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 56 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=56
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 55u

/* greppable: libgj-so: soft batch1 wave=56 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=56 areas=9 "
...
/* Cold soft inventory: Wave 56 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
