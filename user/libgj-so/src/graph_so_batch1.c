 ...
 *
 * Soft surface (unwired; Wave 31 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 31 stamp (17)
 ...
 * greppable: libgj-so: soft batch1 wave=31
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     31u

/* greppable: libgj-so: soft batch1 wave=31 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=31 areas=9 "
...
/* Cold soft inventory: Wave 31 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
