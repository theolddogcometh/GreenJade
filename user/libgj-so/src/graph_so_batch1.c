 ...
 *
 * Soft surface (unwired; Wave 53 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 53 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=53
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 53u

/* greppable: libgj-so: soft batch1 wave=53 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=53 areas=9 "
...
/* Cold soft inventory: Wave 53 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
