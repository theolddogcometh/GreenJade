 ...
 *   gj_so_batch1_soft_wave   — Wave 55 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=55
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=55 areas=9 "
...
/* Cold soft inventory: Wave 55 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
