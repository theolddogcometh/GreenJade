 ...
 *
 * Soft surface (unwired; Wave 60 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 60 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=60
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 60u

/* greppable: libgj-so: soft batch1 wave=60 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=60 areas=9 "
...
/* Cold soft inventory: Wave 60 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
