 ...
 *
 * Soft surface (unwired; Wave 34 exclusive deepen):
 ...
 *   gj_so_batch1_soft_wave   — Wave 34 stamp (32)
 ...
 * greppable: libgj-so: soft batch1 wave=34
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE     33u

/* greppable: libgj-so: soft batch1 wave=34 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=34 areas=9 "
...
/* Cold soft inventory: Wave 34 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
