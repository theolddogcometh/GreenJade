 ...
 *   gj_so_batch1_soft_wave   — Wave 51 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=51
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 51u

/* greppable: libgj-so: soft batch1 wave=51 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=51 areas=9 "
...
/* Cold soft inventory: Wave 51 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
