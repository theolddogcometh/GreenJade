 ...
 *   gj_so_batch1_soft_wave   — Wave 69 stamp (40)
 ...
 * greppable: libgj-so: soft batch1 wave=69
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH1_SOFT_WAVE 69u

/* greppable: libgj-so: soft batch1 wave=69 */
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=69 areas=9 "
...
/* Cold soft inventory: Wave 69 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
