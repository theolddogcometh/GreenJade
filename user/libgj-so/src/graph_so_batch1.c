 ...
 *   gj_so_batch1_soft_wave   — Wave 33 stamp (32)
 ...
 * greppable: libgj-so: soft batch1 wave=33
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch1SoftInventory[] =
	"libgj-so: soft batch1 wave=33 areas=9 "
...
/* Cold soft inventory: Wave 33 stamp. Grep: libgj-so: soft batch1 wave= */
unsigned
