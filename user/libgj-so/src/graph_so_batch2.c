 ...
 *   gj_so_batch2_soft_wave     — Wave 47 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=47
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 47u

/* greppable: libgj-so: soft batch2 wave=47 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=47 areas=9 "
...
/* Cold soft inventory: Wave 47 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
