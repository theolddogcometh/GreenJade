 ...
 *   gj_so_batch2_soft_wave     — Wave 26 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=26
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=26 areas=9 "
...
/* Cold soft inventory: Wave 26 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
