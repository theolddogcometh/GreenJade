 ...
 *
 * Soft surface (unwired; Wave 64 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 64 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=64
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 64u

/* greppable: libgj-so: soft batch2 wave=64 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=64 areas=9 "
...
/* Cold soft inventory: Wave 64 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
