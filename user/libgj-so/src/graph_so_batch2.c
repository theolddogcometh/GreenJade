 ...
 *   gj_so_batch2_soft_wave     — Wave 15 stamp (15)
 ...
 * greppable: libgj-so: soft batch2 wave=15
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       15u

/* greppable: libgj-so: soft batch2 wave=15 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=15 areas=9 "
	"export_a,export_b,stamp,init,id,chain_next,chain_find,get,probe "
	"marker_a=0x422 marker_b=0x423 stamp=B2s2 freestanding=1 bar3=0";
...
/* Cold soft inventory: Wave 15 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
