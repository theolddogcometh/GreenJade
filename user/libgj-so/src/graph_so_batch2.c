 ...
 *   gj_so_batch2_soft_wave     — Wave 31 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=31
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       31u

/* greppable: libgj-so: soft batch2 wave=31 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=31 areas=9 "
...
/* Cold soft inventory: Wave 31 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
