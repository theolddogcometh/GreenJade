 ...
 *   gj_so_batch2_soft_wave     — Wave 54 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=54
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 54u

/* greppable: libgj-so: soft batch2 wave=54 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=54 areas=9 "
...
/* Cold soft inventory: Wave 54 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
