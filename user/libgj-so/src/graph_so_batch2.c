 ...
 *   gj_so_batch2_soft_wave     — Wave 59 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=59
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 59u

/* greppable: libgj-so: soft batch2 wave=59 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=59 areas=9 "
...
/* Cold soft inventory: Wave 59 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
