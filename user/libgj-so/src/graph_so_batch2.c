 ...
 *   gj_so_batch2_soft_wave     — Wave 62 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=62
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 62u

/* greppable: libgj-so: soft batch2 wave=62 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=62 areas=9 "
...
/* Cold soft inventory: Wave 62 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
