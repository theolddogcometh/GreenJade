 ...
 *
 * Soft surface (unwired; Wave 52 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 52 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=52
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 52u

/* greppable: libgj-so: soft batch2 wave=52 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=52 areas=9 "
...
/* Cold soft inventory: Wave 52 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
