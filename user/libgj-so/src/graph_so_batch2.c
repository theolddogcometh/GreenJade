 ...
 *   gj_so_batch2_soft_wave     — Wave 53 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=53
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 53u

/* greppable: libgj-so: soft batch2 wave=53 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=53 areas=9 "
...
/* Cold soft inventory: Wave 53 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
