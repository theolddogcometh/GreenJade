 ...
 *
 * Soft surface (unwired; Wave 35 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 35 stamp (32)
 ...
 * greppable: libgj-so: soft batch2 wave=35
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=35 areas=9 "
...
/* Cold soft inventory: Wave 35 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
