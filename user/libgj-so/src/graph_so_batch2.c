 ...
 *   gj_so_batch2_soft_wave     — Wave 56 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=56
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=56 areas=9 "
...
/* Cold soft inventory: Wave 56 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
