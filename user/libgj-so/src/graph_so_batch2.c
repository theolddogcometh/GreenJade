 ...
 *
 * Soft surface (unwired; Wave 68 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 68 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=68
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 68u

/* greppable: libgj-so: soft batch2 wave=68 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=68 areas=9 "
...
/* Cold soft inventory: Wave 68 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
