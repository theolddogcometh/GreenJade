 ...
 *   gj_so_batch2_soft_wave     — Wave 102 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=70
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 70u
...
/* Cold soft inventory: Wave 102 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
