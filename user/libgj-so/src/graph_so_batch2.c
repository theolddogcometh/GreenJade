 ...
 *
 * Soft surface (unwired; Wave 67 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 67 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=67
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 67u

/* greppable: libgj-so: soft batch2 wave=67 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=67 areas=9 "
...
/* Cold soft inventory: Wave 67 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
