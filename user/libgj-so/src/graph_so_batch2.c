 ...
 *
 * Soft surface (unwired; Wave 37 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 37 stamp (37)
 ...
 * greppable: libgj-so: soft batch2 wave=37
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=37 areas=9 "
...
/* Cold soft inventory: Wave 37 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
