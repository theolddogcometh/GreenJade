 ...
 *
 * Soft surface (unwired; Wave 49 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 49 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=49
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=49 areas=9 "
...
/* Cold soft inventory: Wave 49 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
