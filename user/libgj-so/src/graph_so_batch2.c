 ...
 *
 * Soft surface (unwired; Wave 51 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 51 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=51
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 51u

/* greppable: libgj-so: soft batch2 wave=51 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=51 areas=9 "
...
/* Cold soft inventory: Wave 51 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
