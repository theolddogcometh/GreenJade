 ...
 *
 * Soft surface (unwired; Wave 69 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 69 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=69
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 69u

/* greppable: libgj-so: soft batch2 wave=69 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=69 areas=9 "
...
/* Cold soft inventory: Wave 69 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
