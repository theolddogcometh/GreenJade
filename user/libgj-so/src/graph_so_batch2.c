 ...
 *
 * Soft surface (unwired; Wave 57 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 57 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=57
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 55u

/* greppable: libgj-so: soft batch2 wave=57 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=57 areas=9 "
...
/* Cold soft inventory: Wave 57 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
