 ...
 *
 * Soft surface (unwired; Wave 20 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 20 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=20
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       19u

/* greppable: libgj-so: soft batch2 wave=20 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=20 areas=9 "
...
/* Cold soft inventory: Wave 20 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
