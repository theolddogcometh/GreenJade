 ...
 *   gj_so_batch2_soft_wave     — Wave 21 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=21
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       21u

/* greppable: libgj-so: soft batch2 wave=21 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=21 areas=9 "
...
/* Cold soft inventory: Wave 21 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
