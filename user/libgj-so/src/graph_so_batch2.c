 ...
 *   gj_so_batch2_soft_wave     — Wave 25 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=25
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=25 areas=9 "
...
/* Cold soft inventory: Wave 25 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
