 ...
 *   gj_so_batch2_soft_wave     — Wave 60 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=60
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 60u

/* greppable: libgj-so: soft batch2 wave=60 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=60 areas=9 "
...
/* Cold soft inventory: Wave 60 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
