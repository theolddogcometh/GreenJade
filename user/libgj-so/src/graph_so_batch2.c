 ...
 *   gj_so_batch2_soft_wave     — Wave 58 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=58
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 58u

/* greppable: libgj-so: soft batch2 wave=58 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=58 areas=9 "
...
/* Cold soft inventory: Wave 58 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
