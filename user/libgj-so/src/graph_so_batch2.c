 ...
 *   gj_so_batch2_soft_wave     — Wave 19 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=19
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=19 areas=9 "
...
/* Cold soft inventory: Wave 19 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
