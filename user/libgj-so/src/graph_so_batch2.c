 ...
 *
 * Soft surface (unwired; Wave 48 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 48 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=48
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 48u

/* greppable: libgj-so: soft batch2 wave=48 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=48 areas=9 "
...
/* Cold soft inventory: Wave 48 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
