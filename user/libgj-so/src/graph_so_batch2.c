 ...
 *
 * Soft surface (unwired; Wave 33 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 33 stamp (32)
 ...
 * greppable: libgj-so: soft batch2 wave=33
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=33 areas=9 "
...
/* Cold soft inventory: Wave 33 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
