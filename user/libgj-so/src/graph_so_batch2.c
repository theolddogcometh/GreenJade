 ...
 *
 * Soft surface (unwired; Wave 29 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 29 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=29
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       25u

/* greppable: libgj-so: soft batch2 wave=29 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=29 areas=9 "
...
/* Cold soft inventory: Wave 29 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
