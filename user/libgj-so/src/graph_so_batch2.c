 ...
 *
 * Soft surface (unwired; Wave 30 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 30 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=30
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       30u

/* greppable: libgj-so: soft batch2 wave=30 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=30 areas=9 "
...
/* Cold soft inventory: Wave 30 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
