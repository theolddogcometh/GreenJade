 ...
 *   gj_so_batch2_soft_wave     — Wave 18 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=18
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       18u

/* greppable: libgj-so: soft batch2 wave=18 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=18 areas=9 "
...
/* Cold soft inventory: Wave 18 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
