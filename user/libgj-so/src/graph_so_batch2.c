 ...
 *
 * Soft surface (unwired; Wave 63 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 63 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=63
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 63u

/* greppable: libgj-so: soft batch2 wave=63 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=63 areas=9 "
...
/* Cold soft inventory: Wave 63 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
