 ...
 *
 * Soft surface (unwired; Wave 16 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 16 stamp (16)
 ...
 * greppable: libgj-so: soft batch2 wave=16
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       16u

/* greppable: libgj-so: soft batch2 wave=16 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=16 areas=9 "
...
/* Cold soft inventory: Wave 16 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
