 ...
 *   gj_so_batch2_soft_wave     — Wave 24 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=24
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       24u

/* greppable: libgj-so: soft batch2 wave=24 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=24 areas=9 "
...
/* Cold soft inventory: Wave 24 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
