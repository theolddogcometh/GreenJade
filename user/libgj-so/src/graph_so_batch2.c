 ...
 *
 * Soft surface (unwired; Wave 27 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 27 stamp (17)
 ...
 * greppable: libgj-so: soft batch2 wave=27
 */
#include <stddef.h>
#include <stdint.h>
...
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=27 areas=9 "
...
/* Cold soft inventory: Wave 27 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
