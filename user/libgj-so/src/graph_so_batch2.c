 ...
 *
 * Soft surface (unwired; Wave 38 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 38 stamp (37)
 ...
 * greppable: libgj-so: soft batch2 wave=38
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE       37u

/* greppable: libgj-so: soft batch2 wave=38 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=38 areas=9 "
...
/* Cold soft inventory: Wave 38 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
