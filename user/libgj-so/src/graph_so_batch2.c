 ...
 *
 * Soft surface (unwired; Wave 66 exclusive deepen):
 ...
 *   gj_so_batch2_soft_wave     — Wave 66 stamp (40)
 ...
 * greppable: libgj-so: soft batch2 wave=66
 */
#include <stddef.h>
#include <stdint.h>
...
#define GJ_SO_BATCH2_SOFT_WAVE 66u

/* greppable: libgj-so: soft batch2 wave=66 */
static const char g_szSoBatch2SoftInventory[] =
	"libgj-so: soft batch2 wave=66 areas=9 "
...
/* Cold soft inventory: Wave 66 stamp. Grep: libgj-so: soft batch2 wave= */
unsigned
