 ...
 *
 * Soft freestanding helpers inventory (Wave 107 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 107 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 107 soft deepen stamp (rodata companion).
...
/*
 * Wave 107 honesty path line (static route labels).
...
/*
 * Wave 107 exclusive honesty line (static).
...
/*
 * Wave 107 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 107). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 107 exclusive). Grep: libgj: soft honesty
