 ...
 *
 * Soft freestanding helpers inventory (Wave 95 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 95 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 95 soft deepen stamp (rodata companion).
...
/*
 * Wave 95 honesty path line (static route labels).
...
/*
 * Wave 95 exclusive honesty line (static).
...
/*
 * Wave 95 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 95). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 95 exclusive). Grep: libgj: soft honesty
