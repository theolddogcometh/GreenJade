 ...
 *
 * Soft freestanding helpers inventory (Wave 73 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 73 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 73 soft deepen stamp (rodata companion).
...
/*
 * Wave 73 honesty path line (static route labels).
...
/*
 * Wave 73 exclusive honesty line (static).
...
/*
 * Wave 73 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 73). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 73 exclusive). Grep: libgj: soft honesty
