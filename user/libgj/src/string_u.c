 ...
 *
 * Soft freestanding helpers inventory (Wave 104 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 104 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 104 soft deepen stamp (rodata companion).
...
/*
 * Wave 104 honesty path line (static route labels).
...
/*
 * Wave 104 exclusive honesty line (static).
...
/*
 * Wave 104 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 104). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 104 exclusive). Grep: libgj: soft honesty
