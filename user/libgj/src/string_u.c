 ...
 *
 * Soft freestanding helpers inventory (Wave 96 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 96 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 96 soft deepen stamp (rodata companion).
...
/*
 * Wave 96 honesty path line (static route labels).
...
/*
 * Wave 96 exclusive honesty line (static).
...
/*
 * Wave 96 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 96). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 96 exclusive). Grep: libgj: soft honesty
