 ...
 *
 * Soft freestanding helpers inventory (Wave 86 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 86 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 86 soft deepen stamp (rodata companion).
...
/*
 * Wave 86 honesty path line (static route labels).
...
/*
 * Wave 86 exclusive honesty line (static).
...
/*
 * Wave 86 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 86). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 86 exclusive). Grep: libgj: soft honesty
