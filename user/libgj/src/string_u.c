 ...
 *
 * Soft freestanding helpers inventory (Wave 26 exclusive deepen; greppable;
 * hot path clean):
 *   libgj: soft inventory helpers=42 groups=10 wave=26 areas=16
 ...
 *   libgj: soft deepen  wave=26 areas=inventory,groups,names,policy,path,counts,areas,accessors,honesty
 *   libgj: soft path    freestanding=1 pure_c=1 no_heap=1 counts=none bar3=0
 *   libgj: soft honesty multi_server=0 confine=0 bar3=0 exclusive=1 soft=1 product_kernel=OPEN wave=26
 *
...
/*
 * Wave 26 soft deepen stamp (rodata companion).
 * Grep: libgj: soft deepen
 */
static const char g_szLibgjSoftDeepen[] =
    "libgj: soft deepen wave=26 areas=16 "
...
/*
 * Wave 26 honesty path line (static route labels).
...
/*
 * Wave 26 exclusive honesty line (static).
...
static const char g_szLibgjSoftHonesty[] =
    ...
    "soft=1 product_kernel=OPEN wave=26 userland=1";
...
/*
 * Wave 26 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 26). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 26 exclusive). Grep: libgj: soft honesty
