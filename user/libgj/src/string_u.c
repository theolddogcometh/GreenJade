 ...
 *
 * Soft freestanding helpers inventory (Wave 101 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 101 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 101 soft deepen stamp (rodata companion).
...
/*
 * Wave 101 honesty path line (static route labels).
...
/*
 * Wave 101 exclusive honesty line (static).
...
/*
 * Wave 101 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 101). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 101 exclusive). Grep: libgj: soft honesty
