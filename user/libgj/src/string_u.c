 ...
 *
 * Soft freestanding helpers inventory (Wave 23 exclusive deepen; greppable;
 * hot path clean):
 *   libgj: soft inventory helpers=42 groups=10 wave=23 areas=16
 ...
 *   libgj: soft deepen  wave=23 areas=inventory,groups,names,policy,path,counts,areas,accessors,honesty
 *   libgj: soft path    freestanding=1 pure_c=1 no_heap=1 counts=none bar3=0
 *   libgj: soft honesty multi_server=0 confine=0 bar3=0 exclusive=1 soft=1 product_kernel=OPEN wave=23
 *
...
/*
 * Wave 23 soft deepen stamp (rodata companion).
 * Grep: libgj: soft deepen
 */
static const char g_szLibgjSoftDeepen[] =
    "libgj: soft deepen wave=23 areas=16 "
...
/*
 * Wave 23 honesty path line (static route labels).
...
/*
 * Wave 23 exclusive honesty line (static).
...
static const char g_szLibgjSoftHonesty[] =
    ...
    "soft=1 product_kernel=OPEN wave=23 userland=1";
...
/*
 * Wave 23 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 23). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 23 exclusive). Grep: libgj: soft honesty
