 ...
 *
 * Soft freestanding helpers inventory (Wave 75 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 75 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 75 soft deepen stamp (rodata companion).
...
/*
 * Wave 75 honesty path line (static route labels).
...
/*
 * Wave 75 exclusive honesty line (static).
...
/*
 * Wave 75 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 75). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 75 exclusive). Grep: libgj: soft honesty
