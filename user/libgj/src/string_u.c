 ...
 *
 * Soft freestanding helpers inventory (Wave 76 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 76 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 76 soft deepen stamp (rodata companion).
...
/*
 * Wave 76 honesty path line (static route labels).
...
/*
 * Wave 76 exclusive honesty line (static).
...
/*
 * Wave 76 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 76). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 76 exclusive). Grep: libgj: soft honesty
