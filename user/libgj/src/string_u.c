 ...
 *
 * Soft freestanding helpers inventory (Wave 97 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 97 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 97 soft deepen stamp (rodata companion).
...
/*
 * Wave 97 honesty path line (static route labels).
...
/*
 * Wave 97 exclusive honesty line (static).
...
/*
 * Wave 97 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 97). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 97 exclusive). Grep: libgj: soft honesty
