 ...
 *
 * Soft freestanding helpers inventory (Wave 98 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 98 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 98 soft deepen stamp (rodata companion).
...
/*
 * Wave 98 honesty path line (static route labels).
...
/*
 * Wave 98 exclusive honesty line (static).
...
/*
 * Wave 98 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 98). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 98 exclusive). Grep: libgj: soft honesty
