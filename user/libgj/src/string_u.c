 ...
 *
 * Soft freestanding helpers inventory (Wave 106 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 106 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 106 soft deepen stamp (rodata companion).
...
/*
 * Wave 106 honesty path line (static route labels).
...
/*
 * Wave 106 exclusive honesty line (static).
...
/*
 * Wave 106 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 106). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 106 exclusive). Grep: libgj: soft honesty
