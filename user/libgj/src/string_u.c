 ...
 *
 * Soft freestanding helpers inventory (Wave 116 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 116 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 116 soft deepen stamp (rodata companion).
...
/*
 * Wave 116 exclusive honesty line (static).
...
/*
 * Cold soft deepen stamp (Wave 116). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 116 exclusive). Grep: libgj: soft honesty
