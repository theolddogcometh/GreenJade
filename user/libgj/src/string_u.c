 ...
 *
 * Soft freestanding helpers inventory (Wave 70 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 70 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 70 soft deepen stamp (rodata companion).
...
/*
 * Wave 70 honesty path line (static route labels).
...
/*
 * Wave 70 exclusive honesty line (static).
...
/*
 * Wave 70 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 70). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 70 exclusive). Grep: libgj: soft honesty
