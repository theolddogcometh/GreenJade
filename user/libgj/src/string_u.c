 ...
 *
 * Soft freestanding helpers inventory (Wave 105 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 105 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 105 soft deepen stamp (rodata companion).
...
/*
 * Wave 105 honesty path line (static route labels).
...
/*
 * Wave 105 exclusive honesty line (static).
...
/*
 * Wave 105 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 105). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 105 exclusive). Grep: libgj: soft honesty
