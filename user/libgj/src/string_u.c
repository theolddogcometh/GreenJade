 ...
 *
 * Soft freestanding helpers inventory (Wave 103 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 103 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 103 soft deepen stamp (rodata companion).
...
/*
 * Wave 103 honesty path line (static route labels).
...
/*
 * Wave 103 exclusive honesty line (static).
...
/*
 * Wave 103 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 103). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 103 exclusive). Grep: libgj: soft honesty
