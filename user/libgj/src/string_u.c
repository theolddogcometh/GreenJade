 ...
 *
 * Soft freestanding helpers inventory (Wave 77 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 77 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 77 soft deepen stamp (rodata companion).
...
/*
 * Wave 77 honesty path line (static route labels).
...
/*
 * Wave 77 exclusive honesty line (static).
...
/*
 * Wave 77 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 77). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 77 exclusive). Grep: libgj: soft honesty
