 ...
 *
 * Soft freestanding helpers inventory (Wave 110 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 110 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 110 soft deepen stamp (rodata companion).
...
/*
 * Wave 110 honesty path line (static route labels).
...
/*
 * Wave 110 exclusive honesty line (static).
...
/*
 * Wave 110 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 110). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 110 exclusive). Grep: libgj: soft honesty
