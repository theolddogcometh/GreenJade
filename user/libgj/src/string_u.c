 ...
 *
 * Soft freestanding helpers inventory (Wave 71 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 71 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 71 soft deepen stamp (rodata companion).
...
/*
 * Wave 71 honesty path line (static route labels).
...
/*
 * Wave 71 exclusive honesty line (static).
...
/*
 * Wave 71 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 71). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 71 exclusive). Grep: libgj: soft honesty
