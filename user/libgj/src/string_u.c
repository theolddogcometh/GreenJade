 ...
 *
 * Soft freestanding helpers inventory (Wave 109 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 109 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 109 soft deepen stamp (rodata companion).
...
/*
 * Wave 109 honesty path line (static route labels).
...
/*
 * Wave 109 exclusive honesty line (static).
...
/*
 * Wave 109 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 109). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 109 exclusive). Grep: libgj: soft honesty
