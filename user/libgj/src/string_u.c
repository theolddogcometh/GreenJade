 ...
 *
 * Soft freestanding helpers inventory (Wave 100 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 100 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 100 soft deepen stamp (rodata companion).
...
/*
 * Wave 100 honesty path line (static route labels).
...
/*
 * Wave 100 exclusive honesty line (static).
...
/*
 * Wave 100 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 100). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 100 exclusive). Grep: libgj: soft honesty
