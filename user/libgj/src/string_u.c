 ...
 *
 * Soft freestanding helpers inventory (Wave 113 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 113 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 113 soft deepen stamp (rodata companion).
...
/*
 * Wave 113 exclusive honesty line (static).
...
/*
 * Cold soft deepen stamp (Wave 113). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 113 exclusive). Grep: libgj: soft honesty
