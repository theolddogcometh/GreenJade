 ...
 *
 * Soft freestanding helpers inventory (Wave 92 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 92 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 92 soft deepen stamp (rodata companion).
...
/*
 * Wave 92 honesty path line (static route labels).
...
/*
 * Wave 92 exclusive honesty line (static).
...
/*
 * Wave 92 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 92). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 92 exclusive). Grep: libgj: soft honesty
