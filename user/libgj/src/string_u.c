 ...
 *
 * Soft freestanding helpers inventory (Wave 84 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 84 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 84 soft deepen stamp (rodata companion).
...
/*
 * Wave 84 honesty path line (static route labels).
...
/*
 * Wave 84 exclusive honesty line (static).
...
/*
 * Wave 84 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 84). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 84 exclusive). Grep: libgj: soft honesty
