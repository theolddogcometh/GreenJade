 ...
 *
 * Soft freestanding helpers inventory (Wave 122 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 122 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 122 soft deepen stamp (rodata companion).
...
/*
 * Wave 122 exclusive honesty line (static).
...
/*
 * Cold soft deepen stamp (Wave 122). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 122 exclusive). Grep: libgj: soft honesty
