 ...
 *
 * Soft freestanding helpers inventory (Wave 108 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 108 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 108 soft deepen stamp (rodata companion).
...
/*
 * Wave 108 honesty path line (static route labels).
...
/*
 * Wave 108 exclusive honesty line (static).
...
/*
 * Wave 108 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 108). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 108 exclusive). Grep: libgj: soft honesty
