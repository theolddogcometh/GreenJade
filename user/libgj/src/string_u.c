 ...
 *
 * Soft freestanding helpers inventory (Wave 88 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 88 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 88 soft deepen stamp (rodata companion).
...
/*
 * Wave 88 honesty path line (static route labels).
...
/*
 * Wave 88 exclusive honesty line (static).
...
/*
 * Wave 88 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 88). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 88 exclusive). Grep: libgj: soft honesty
