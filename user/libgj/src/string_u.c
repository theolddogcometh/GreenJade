 ...
 *
 * Soft freestanding helpers inventory (Wave 91 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 91 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 91 soft deepen stamp (rodata companion).
...
/*
 * Wave 91 honesty path line (static route labels).
...
/*
 * Wave 91 exclusive honesty line (static).
...
/*
 * Wave 91 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 91). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 91 exclusive). Grep: libgj: soft honesty
