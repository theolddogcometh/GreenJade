 ...
 *
 * Soft freestanding helpers inventory (Wave 85 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 85 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 85 soft deepen stamp (rodata companion).
...
/*
 * Wave 85 honesty path line (static route labels).
...
/*
 * Wave 85 exclusive honesty line (static).
...
/*
 * Wave 85 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 85). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 85 exclusive). Grep: libgj: soft honesty
