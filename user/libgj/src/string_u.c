 ...
 *
 * Soft freestanding helpers inventory (Wave 125 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 125 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 125 soft deepen stamp (rodata companion).
...
/*
 * Wave 125 exclusive honesty line (static).
...
/*
 * Cold soft deepen stamp (Wave 125). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 125 exclusive). Grep: libgj: soft honesty
