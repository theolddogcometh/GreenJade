 ...
 *
 * Soft freestanding helpers inventory (Wave 74 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 74 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 74 soft deepen stamp (rodata companion).
...
/*
 * Wave 74 honesty path line (static route labels).
...
/*
 * Wave 74 exclusive honesty line (static).
...
/*
 * Wave 74 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 74). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 74 exclusive). Grep: libgj: soft honesty
