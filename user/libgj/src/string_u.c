 ...
 *
 * Soft freestanding helpers inventory (Wave 78 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 78 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 78 soft deepen stamp (rodata companion).
...
/*
 * Wave 78 honesty path line (static route labels).
...
/*
 * Wave 78 exclusive honesty line (static).
...
/*
 * Wave 78 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 78). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 78 exclusive). Grep: libgj: soft honesty
