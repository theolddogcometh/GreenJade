 ...
 *
 * Soft freestanding helpers inventory (Wave 81 exclusive deepen; greppable;
 * hot path clean):
...
/* Wave 81 exclusive soft deepen stamp (greppable wave=70). */
...
/*
 * Wave 81 soft deepen stamp (rodata companion).
...
/*
 * Wave 81 honesty path line (static route labels).
...
/*
 * Wave 81 exclusive honesty line (static).
...
/*
 * Wave 81 greppable area catalog (logical inventory surfaces; cold only).
...
/*
 * Cold soft deepen stamp (Wave 81). Grep: libgj: soft deepen
 */
const char *
...
/*
 * Cold soft honesty line (Wave 81 exclusive). Grep: libgj: soft honesty
