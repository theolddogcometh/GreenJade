 ...
 *
 * Soft inventory (Wave 116 exclusive deepen; this unit only) — greppable:
 *   "protonrt: soft …"
 *   "cold_linux: soft …"
...
/*
 * Soft product inventory (Wave 116 exclusive deepen). Enter-only tallies.
 ...
 * Twin prefixes so either agent grep works (Wave 116 exclusive deepen):
 *   protonrt: soft inventory|fd|io|fd_alloc|stat|namei|id|time|poll|sock|
 *             proc|uring|enosys|query|path|groups|last|open|deepen|wave …
 *   cold_linux: soft inventory|fd|io|fd_alloc|stat|namei|id|time|poll|sock|
 *               proc|uring|enosys|query|path|groups|last|open|deepen|wave …
 ...
 */
    ...
    /*
     * Grep: protonrt: soft honesty (Wave 116 exclusive deepen).
    ...
    /* Grep: cold_linux: soft honesty (Wave 116 exclusive deepen) */
...
proton_rt_query(struct proton_rt_info *pOut)
{
    ...
    /* Wave 111: one-shot greppable soft inventory after first query. */
    soft_inventory_maybe_once();
    return 0;
}
                    ...
                    uint64_t a3, uint64_t a4, uint64_t a5)
{
    ...
    /* Wave 116 soft enter — never rewrites ret. greppable: protonrt: soft */
