 ...
 * Soft inventory (Wave 123 exclusive deepen — greppable "netstackd-gj: soft …"):
...
/* Wave stamp for greppable soft inventory lines (Wave 123 exclusive). */
...
soft_inventory_log(const struct soft_ctx *pSoft)
{
    ...
    /*
     * Grep: netstackd-gj: soft honesty (Wave 123 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
_start(void)
{
    ...
    /* Final Wave 123 soft inventory rollup (includes free_rel / free bits). */
