 ...
 * Soft inventory (Wave 114 exclusive deepen — greppable "netstackd-gj: soft …"):
...
/* Wave stamp for greppable soft inventory lines (Wave 114 exclusive). */
...
soft_inventory_log(const struct soft_ctx *pSoft)
{
    ...
    /*
     * Grep: netstackd-gj: soft honesty (Wave 114 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
_start(void)
{
    ...
    /* Final Wave 114 soft inventory rollup (includes free_rel / free bits). */
