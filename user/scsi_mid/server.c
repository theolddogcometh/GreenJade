 ...
 *   soft inventory (Wave 78) → stats
 *
 * Soft inventory (Wave 78 exclusive deepen — greppable):
...
/* Wave 78 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 78 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 78 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 78 exclusive deepen) */
