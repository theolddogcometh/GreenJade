 ...
 *   soft inventory (Wave 59) → stats
 *
 * Soft inventory (Wave 59 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=59 …
...
/* Wave 59 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 59 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 59 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 59 exclusive deepen) */
