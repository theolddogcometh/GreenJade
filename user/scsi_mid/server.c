 ...
 *   soft inventory (Wave 19) → stats
 *
 * Soft inventory (Wave 19 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=19 …
...
/* Wave 19 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 19 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 19 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 19 exclusive deepen) */
