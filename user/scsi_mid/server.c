 ...
 *   soft inventory (Wave 45) → stats
 *
 * Soft inventory (Wave 45 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=45 …
...
/* Wave 45 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 45 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 45 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 45 exclusive deepen) */
