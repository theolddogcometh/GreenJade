 ...
 *   soft inventory (Wave 95) → stats
 *
 * Soft inventory (Wave 95 exclusive deepen — greppable):
...
/* Wave 95 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 95 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 95 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 95 exclusive deepen) */
