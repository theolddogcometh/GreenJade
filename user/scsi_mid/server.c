 ...
 *   soft inventory (Wave 115) → stats
 *
 * Soft inventory (Wave 115 exclusive deepen — greppable):
...
/* Wave 115 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /* Wave 115 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 115 exclusive deepen) */
