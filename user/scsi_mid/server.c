 ...
 *   soft inventory (Wave 27) → stats
 *
 * Soft inventory (Wave 27 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=27 …
...
/* Wave 27 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 27 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 27 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 27 exclusive deepen) */
