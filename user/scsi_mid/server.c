 ...
 *   soft inventory (Wave 47) → stats
 *
 * Soft inventory (Wave 47 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=47 …
...
/* Wave 47 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 47 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 47 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 47 exclusive deepen) */
