 ...
 *   soft inventory (Wave 122) → stats
 *
 * Soft inventory (Wave 122 exclusive deepen — greppable):
...
/* Wave 122 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /* Wave 122 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 122 exclusive deepen) */
