 ...
 *   soft inventory (Wave 58) → stats
 *
 * Soft inventory (Wave 58 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=58 …
...
/* Wave 58 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 58 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 58 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 58 exclusive deepen) */
