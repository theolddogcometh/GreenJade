 ...
 *   soft inventory (Wave 91) → stats
 *
 * Soft inventory (Wave 91 exclusive deepen — greppable):
...
/* Wave 91 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 91 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 91 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 91 exclusive deepen) */
