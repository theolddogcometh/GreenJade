 ...
 *   soft inventory (Wave 20) → stats
 *
 * Soft inventory (Wave 20 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=20 …
...
/* Wave 20 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 20 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 20 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 20 exclusive deepen) */
