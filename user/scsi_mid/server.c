 ...
 *   soft inventory (Wave 96) → stats
 *
 * Soft inventory (Wave 96 exclusive deepen — greppable):
...
/* Wave 96 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 96 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 96 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 96 exclusive deepen) */
