 ...
 *   soft inventory (Wave 66) → stats
 *
 * Soft inventory (Wave 66 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=66 …
...
/* Wave 66 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 66 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 66 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 66 exclusive deepen) */
