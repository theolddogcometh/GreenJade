 ...
 *   soft inventory (Wave 111) → stats
 *
 * Soft inventory (Wave 111 exclusive deepen — greppable):
...
/* Wave 111 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /* Wave 111 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 111 exclusive deepen) */
