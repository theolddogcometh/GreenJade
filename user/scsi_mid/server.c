 ...
 *   soft inventory (Wave 25) → stats
 *
 * Soft inventory (Wave 25 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=25 …
...
/* Wave 25 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 25 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 25 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 25 exclusive deepen) */
