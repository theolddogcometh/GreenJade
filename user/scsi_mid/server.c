 ...
 *   soft inventory (Wave 18) → stats
 *
 * Soft inventory (Wave 18 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=18 …
...
/* Wave 18 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 18 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 18 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 18 exclusive deepen) */
