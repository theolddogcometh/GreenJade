 ...
 *   soft inventory (Wave 67) → stats
 *
 * Soft inventory (Wave 67 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=67 …
...
/* Wave 67 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 67 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 67 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 67 exclusive deepen) */
