 ...
 *   soft inventory (Wave 123) → stats
 *
 * Soft inventory (Wave 123 exclusive deepen — greppable):
...
/* Wave 123 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /* Wave 123 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 123 exclusive deepen) */
