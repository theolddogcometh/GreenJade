 ...
 *   soft inventory (Wave 84) → stats
 *
 * Soft inventory (Wave 84 exclusive deepen — greppable):
...
/* Wave 84 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 84 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 84 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 84 exclusive deepen) */
