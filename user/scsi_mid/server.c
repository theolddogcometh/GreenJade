 ...
 *   soft inventory (Wave 21) → stats
 *
 * Soft inventory (Wave 21 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=21 …
...
/* Wave 21 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 21 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 21 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 21 exclusive deepen) */
