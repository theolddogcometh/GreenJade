 ...
 *   soft inventory (Wave 125) → stats
 *
 * Soft inventory (Wave 125 exclusive deepen — greppable):
...
/* Wave 125 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /* Wave 125 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 125 exclusive deepen) */
