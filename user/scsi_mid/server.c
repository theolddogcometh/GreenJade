 ...
 *   soft inventory (Wave 55) → stats
 *
 * Soft inventory (Wave 55 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=55 …
...
/* Wave 55 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 55 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 55 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 55 exclusive deepen) */
