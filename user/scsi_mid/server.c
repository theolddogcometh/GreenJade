 ...
 *   soft inventory (Wave 87) → stats
 *
 * Soft inventory (Wave 87 exclusive deepen — greppable):
...
/* Wave 87 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 87 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 87 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 87 exclusive deepen) */
