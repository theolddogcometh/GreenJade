 ...
 *   soft inventory (Wave 106) → stats
 *
 * Soft inventory (Wave 106 exclusive deepen — greppable):
...
/* Wave 106 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 106 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 106 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 106 exclusive deepen) */
