 ...
 *   soft inventory (Wave 118) → stats
 *
 * Soft inventory (Wave 118 exclusive deepen — greppable):
...
/* Wave 118 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /* Wave 118 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 118 exclusive deepen) */
