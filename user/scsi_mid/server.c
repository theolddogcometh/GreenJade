 ...
 *   soft inventory (Wave 37) → stats
 *
 * Soft inventory (Wave 37 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=37 …
...
/* Wave 37 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 37 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 37 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 37 exclusive deepen) */
