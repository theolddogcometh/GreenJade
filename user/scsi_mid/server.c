 ...
 *   soft inventory (Wave 70) → stats
 *
 * Soft inventory (Wave 70 exclusive deepen — greppable):
...
/* Wave 70 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 70 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 70 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 70 exclusive deepen) */
