 ...
 *   soft inventory (Wave 124) → stats
 *
 * Soft inventory (Wave 124 exclusive deepen — greppable):
...
/* Wave 124 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /* Wave 124 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 124 exclusive deepen) */
