 ...
 *   soft inventory (Wave 74) → stats
 *
 * Soft inventory (Wave 74 exclusive deepen — greppable):
...
/* Wave 74 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 74 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 74 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 74 exclusive deepen) */
