 ...
 *   soft inventory (Wave 104) → stats
 *
 * Soft inventory (Wave 104 exclusive deepen — greppable):
...
/* Wave 104 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 104 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 104 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 104 exclusive deepen) */
