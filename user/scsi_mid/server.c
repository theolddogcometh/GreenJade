 ...
 *   soft inventory (Wave 88) → stats
 *
 * Soft inventory (Wave 88 exclusive deepen — greppable):
...
/* Wave 88 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 88 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 88 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 88 exclusive deepen) */
