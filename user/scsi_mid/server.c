 ...
 *   soft inventory (Wave 100) → stats
 *
 * Soft inventory (Wave 100 exclusive deepen — greppable):
...
/* Wave 100 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 100 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 100 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 100 exclusive deepen) */
