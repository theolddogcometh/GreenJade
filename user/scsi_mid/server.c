 ...
 *   soft inventory (Wave 69) → stats
 *
 * Soft inventory (Wave 69 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=69 …
...
/* Wave 69 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 69 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 69 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 69 exclusive deepen) */
