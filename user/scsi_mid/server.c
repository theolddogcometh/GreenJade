 ...
 *   soft inventory (Wave 75) → stats
 *
 * Soft inventory (Wave 75 exclusive deepen — greppable):
...
/* Wave 75 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 75 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 75 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 75 exclusive deepen) */
