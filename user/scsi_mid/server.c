 ...
 *   soft inventory (Wave 83) → stats
 *
 * Soft inventory (Wave 83 exclusive deepen — greppable):
...
/* Wave 83 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 83 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 83 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 83 exclusive deepen) */
