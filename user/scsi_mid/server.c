 ...
 *   soft inventory (Wave 26) → stats
 *
 * Soft inventory (Wave 26 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=26 …
...
/* Wave 26 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 26 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 26 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 26 exclusive deepen) */
