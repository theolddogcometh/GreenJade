 ...
 *   soft inventory (Wave 108) → stats
 *
 * Soft inventory (Wave 108 exclusive deepen — greppable):
...
/* Wave 108 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 108 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 108 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 108 exclusive deepen) */
