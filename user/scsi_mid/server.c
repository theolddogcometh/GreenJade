 ...
 *   soft inventory (Wave 116) → stats
 *
 * Soft inventory (Wave 116 exclusive deepen — greppable):
...
/* Wave 116 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /* Wave 116 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 116 exclusive deepen) */
