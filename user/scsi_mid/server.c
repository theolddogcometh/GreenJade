 ...
 *   soft inventory (Wave 68) → stats
 *
 * Soft inventory (Wave 68 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=68 …
...
/* Wave 68 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 68 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 68 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 68 exclusive deepen) */
