 ...
 *   soft inventory (Wave 92) → stats
 *
 * Soft inventory (Wave 92 exclusive deepen — greppable):
...
/* Wave 92 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 92 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 92 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 92 exclusive deepen) */
