 ...
 *   soft inventory (Wave 65) → stats
 *
 * Soft inventory (Wave 65 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=65 …
...
/* Wave 65 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 65 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 65 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 65 exclusive deepen) */
