 ...
 *   soft inventory (Wave 17) → stats
 *
 * Soft inventory (Wave 17 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=17 …
...
/* Wave 17 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 17 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 17 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 17 exclusive deepen) */
