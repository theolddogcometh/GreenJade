 ...
 *   soft inventory (Wave 36) → stats
 *
 * Soft inventory (Wave 36 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=36 …
...
/* Wave 36 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 36 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 36 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 36 exclusive deepen) */
