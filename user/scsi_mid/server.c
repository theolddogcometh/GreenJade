 ...
 *   soft inventory (Wave 71) → stats
 *
 * Soft inventory (Wave 71 exclusive deepen — greppable):
...
/* Wave 71 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 71 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 71 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 71 exclusive deepen) */
