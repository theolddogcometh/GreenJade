 ...
 *   soft inventory (Wave 72) → stats
 *
 * Soft inventory (Wave 72 exclusive deepen — greppable):
...
/* Wave 72 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 72 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 72 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 72 exclusive deepen) */
