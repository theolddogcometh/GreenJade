 ...
 *   soft inventory (Wave 56) → stats
 *
 * Soft inventory (Wave 56 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=56 …
...
/* Wave 56 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 56 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 56 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 56 exclusive deepen) */
