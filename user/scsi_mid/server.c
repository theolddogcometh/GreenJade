 ...
 *   soft inventory (Wave 77) → stats
 *
 * Soft inventory (Wave 77 exclusive deepen — greppable):
...
/* Wave 77 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 77 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 77 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 77 exclusive deepen) */
