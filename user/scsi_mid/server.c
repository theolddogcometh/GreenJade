 ...
 *   soft inventory (Wave 41) → stats
 *
 * Soft inventory (Wave 41 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=41 …
...
/* Wave 41 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 41 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 41 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 41 exclusive deepen) */
