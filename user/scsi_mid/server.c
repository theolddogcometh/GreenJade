 ...
 *   soft inventory (Wave 81) → stats
 *
 * Soft inventory (Wave 81 exclusive deepen — greppable):
...
/* Wave 81 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 81 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 81 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 81 exclusive deepen) */
