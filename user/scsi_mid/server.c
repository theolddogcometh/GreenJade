 ...
 *   soft inventory (Wave 105) → stats
 *
 * Soft inventory (Wave 105 exclusive deepen — greppable):
...
/* Wave 105 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 105 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 105 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 105 exclusive deepen) */
