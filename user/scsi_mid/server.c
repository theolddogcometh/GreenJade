 ...
 *   soft inventory (Wave 114) → stats
 *
 * Soft inventory (Wave 114 exclusive deepen — greppable):
...
/* Wave 114 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 111 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 114 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 114 exclusive deepen) */
