 ...
 *   soft inventory (Wave 44) → stats
 *
 * Soft inventory (Wave 44 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=44 …
...
/* Wave 44 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 44 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 44 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 44 exclusive deepen) */
