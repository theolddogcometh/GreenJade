 ...
 *   soft inventory (Wave 107) → stats
 *
 * Soft inventory (Wave 107 exclusive deepen — greppable):
...
/* Wave 107 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 107 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 107 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 107 exclusive deepen) */
