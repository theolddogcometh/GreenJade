 ...
 *   soft inventory (Wave 35) → stats
 *
 * Soft inventory (Wave 35 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=35 …
...
/* Wave 35 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 35 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 35 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 35 exclusive deepen) */
