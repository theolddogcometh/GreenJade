 ...
 *   soft inventory (Wave 76) → stats
 *
 * Soft inventory (Wave 76 exclusive deepen — greppable):
...
/* Wave 76 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 76 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 76 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 76 exclusive deepen) */
