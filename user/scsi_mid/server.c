 ...
 *   soft inventory (Wave 57) → stats
 *
 * Soft inventory (Wave 57 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=57 …
...
/* Wave 57 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 57 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 57 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 57 exclusive deepen) */
