 ...
 *   soft inventory (Wave 73) → stats
 *
 * Soft inventory (Wave 73 exclusive deepen — greppable):
...
/* Wave 73 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 73 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 73 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 73 exclusive deepen) */
