 ...
 *   soft inventory (Wave 34) → stats
 *
 * Soft inventory (Wave 34 exclusive deepen — greppable):
 *   scsi_mid-server: soft inventory …
 *   scsi_mid-server: soft deepen wave=34 …
...
/* Wave 34 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 34 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 34 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 34 exclusive deepen) */
