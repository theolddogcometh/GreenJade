 ...
 *   soft inventory (Wave 80) → stats
 *
 * Soft inventory (Wave 80 exclusive deepen — greppable):
...
/* Wave 80 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 80 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 80 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 80 exclusive deepen) */
