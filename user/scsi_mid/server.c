 ...
 *   soft inventory (Wave 79) → stats
 *
 * Soft inventory (Wave 79 exclusive deepen — greppable):
...
/* Wave 79 soft inventory surface from cdb.c (no public header change). */
...
main(void)
{
    ...
    /*
     * Wave 79 deepen probes (always soft for inventory; hard fail host smoke
    ...
    /* Wave 79 soft inventory — library + host skeleton surfaces. */
    ...
    /* Grep: scsi_mid-server: soft honesty (Wave 79 exclusive deepen) */
