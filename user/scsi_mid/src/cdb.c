...
/*
 * Soft product inventory (Wave 92 exclusive deepen). File-local tallies.
...
/*
 * Wave 92 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 92 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 92 exclusive deepen) */
