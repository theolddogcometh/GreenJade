...
/*
 * Soft product inventory (Wave 85 exclusive deepen). File-local tallies.
...
/*
 * Wave 85 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 85 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 85 exclusive deepen) */
