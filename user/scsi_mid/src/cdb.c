...
/*
 * Soft product inventory (Wave 73 exclusive deepen). File-local tallies.
...
/*
 * Wave 73 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 73 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 73 exclusive deepen) */
