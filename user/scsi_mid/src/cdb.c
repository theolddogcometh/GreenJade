...
/*
 * Soft product inventory (Wave 88 exclusive deepen). File-local tallies.
...
/*
 * Wave 88 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 88 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 88 exclusive deepen) */
