...
/*
 * Soft product inventory (Wave 78 exclusive deepen). File-local tallies.
...
/*
 * Wave 78 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 78 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 78 exclusive deepen) */
