...
/*
 * Soft product inventory (Wave 122 exclusive deepen). File-local tallies.
...
/*
 * Wave 122 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 122 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 122 exclusive deepen) */
