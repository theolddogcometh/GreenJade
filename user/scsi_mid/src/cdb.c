...
/*
 * Wave 46 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 46 exclusive; host server declares).
 */
void
...
#define MID_INV_EMIT()                                                         \
    ...
    (void)gj_debug_log(
        ...
        "lun_honest=soft multi_server=0 confine=0 wave=46 "
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 46 exclusive deepen) */
