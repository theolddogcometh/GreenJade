...
/*
 * Soft product inventory (Wave 83 exclusive deepen). File-local tallies.
...
/*
 * Wave 83 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 83 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 83 exclusive deepen) */
