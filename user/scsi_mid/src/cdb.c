...
/*
 * Soft product inventory (Wave 80 exclusive deepen). File-local tallies.
...
/*
 * Wave 80 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 80 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 80 exclusive deepen) */
