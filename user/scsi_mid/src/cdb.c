...
/*
 * Soft product inventory (Wave 106 exclusive deepen). File-local tallies.
...
/*
 * Wave 106 exclusive soft inventory dump (product library path).
 ...
 *
 * Exported without header change (Wave 106 exclusive; host server declares).
 */
void
...
#undef MID_INV_EMIT
    ...
    /* Grep: scsi_mid: soft honesty (Wave 106 exclusive deepen) */
