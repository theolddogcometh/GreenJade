 ...
 *
 * Soft inventory (Wave 83 exclusive deepen — greppable "scsi_mid-gj: soft …"):
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: scsi_mid-gj: soft honesty (Wave 83 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
/**
 * Wave 83 deepen probes on the soft LUN (multi-block, illegal LBA, EVPD).
...
run_soft_path(void)
{
    ...
    /* 8. Wave 83 deepen probes (multi / LBA / EVPD) — always soft. */
    soft_deepen_probes();
