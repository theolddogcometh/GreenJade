 ...
 *   session-compositor: soft deepen wave=26 …
...
main(void)
{
    ...
    /* Grep: session-compositor: soft deepen (Wave 26 exclusive) */
    printf("session-compositor: soft deepen wave=26 areas=1 "
           "multi_server=0 confine=0 bar3=0 exclusive=1\n");
    printf("session-compositor: soft honesty multi_server=0 confine=0 "
           "bar3=0 exclusive=1 soft=1 product_kernel=OPEN wave=26\n");
    return 0;
}
