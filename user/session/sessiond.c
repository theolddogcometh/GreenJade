 ...
 * Freestanding live path: sessiond_gj.c (Wave 71 soft inventory exclusive).
 * Host A1 here is libc soft-shape only — soft ≠ product multi-server confine.
 * Soft honesty: multi_server=0 confine=0 bar3=0 (Wave 71 exclusive deepen).
 *
...
main(void)
{
    ...
    /*
     * Grep: sessiond: soft deepen / soft honesty (Wave 71 exclusive).
