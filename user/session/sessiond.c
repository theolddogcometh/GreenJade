 ...
 * Freestanding live path: sessiond_gj.c (Wave 32 soft inventory exclusive).
 * Host A1 here is libc soft-shape only — soft ≠ product multi-server confine.
 * Soft honesty: multi_server=0 confine=0 bar3=0 (Wave 32 exclusive deepen).
 *
...
main(void)
{
    ...
    /*
     * Grep: sessiond: soft deepen / soft honesty (Wave 32 exclusive).
     * Host A1 soft inventory only — soft ≠ product multi-server confine.
     */
    printf("sessiond: soft deepen product_kernel=OPEN wave=32 areas=1 multi_server=0 "
