 ...
 *   soft free → soft inventory (Wave 123) → ownership path PASS
 ...
 *
 * Soft inventory (Wave 123 exclusive deepen — greppable "sessiond-gj: soft …"):
...
/* Wave 123 soft inventory area count (fixed greppable categories). */
#define SOFT_INV_AREAS  12u
/* Soft inventory wave stamp (Wave 123 exclusive deepen). */
...
/*
 * Soft inventory tallies (Wave 123 exclusive deepen).
...
/* Soft: refresh display-vs-map geometry match lamp (Wave 123). */
static void
...
/*
 * Soft inventory dump (Wave 123 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: sessiond-gj: soft geom (Wave 123) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft present (Wave 123) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft input (Wave 123) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft reclaim (Wave 123) */
    o = 0u;
    ...
    /*
     * Grep: sessiond-gj: soft honesty (Wave 123 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
 ...
 * Tallies Wave 123 soft flag inventory (sessiond-gj: soft flags …).
 ...
 * Tallies Wave 123 soft inventory (sessiond-gj: soft …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 123 soft free inventory (sessiond-gj: soft free …).
     */
    {
        unsigned long u64Va = 0;
        unsigned aInfo[3];
    ...
    /*
     * Wave 123 exclusive soft inventory rollup (greppable "sessiond-gj: soft …").
