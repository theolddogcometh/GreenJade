 ...
 *   soft free → soft inventory (Wave 124) → ownership path PASS
 ...
 *
 * Soft inventory (Wave 124 exclusive deepen — greppable "sessiond-gj: soft …"):
...
/* Wave 124 soft inventory area count (fixed greppable categories). */
#define SOFT_INV_AREAS  12u
/* Soft inventory wave stamp (Wave 124 exclusive deepen). */
...
/*
 * Soft inventory tallies (Wave 124 exclusive deepen).
...
/* Soft: refresh display-vs-map geometry match lamp (Wave 124). */
static void
...
/*
 * Soft inventory dump (Wave 124 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: sessiond-gj: soft geom (Wave 124) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft present (Wave 124) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft input (Wave 124) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft reclaim (Wave 124) */
    o = 0u;
    ...
    /*
     * Grep: sessiond-gj: soft honesty (Wave 124 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
 ...
 * Tallies Wave 124 soft flag inventory (sessiond-gj: soft flags …).
 ...
 * Tallies Wave 124 soft inventory (sessiond-gj: soft …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 124 soft free inventory (sessiond-gj: soft free …).
     */
    {
        unsigned long u64Va = 0;
        unsigned aInfo[3];
    ...
    /*
     * Wave 124 exclusive soft inventory rollup (greppable "sessiond-gj: soft …").
