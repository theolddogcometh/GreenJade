 ...
 *   soft free → soft inventory (Wave 126) → ownership path PASS
 ...
 *
 * Soft inventory (Wave 126 exclusive deepen — greppable "sessiond-gj: soft …"):
...
/* Wave 126 soft inventory area count (fixed greppable categories). */
...
/* Soft: refresh display-vs-map geometry match lamp (Wave 126). */
static void
...
soft_inventory_log(void)
{
    ...
    /* Grep: sessiond-gj: soft geom (Wave 126) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft present (Wave 126) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft input (Wave 126) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft reclaim (Wave 126) */
    o = 0u;
 ...
 * Tallies Wave 126 soft flag inventory (sessiond-gj: soft flags …).
 ...
 * Tallies Wave 126 soft inventory (sessiond-gj: soft …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 126 soft free inventory (sessiond-gj: soft free …).
     */
    {
        unsigned long u64Va = 0;
        unsigned aInfo[3];
    ...
    /*
     * Wave 126 exclusive soft inventory rollup (greppable "sessiond-gj: soft …").
