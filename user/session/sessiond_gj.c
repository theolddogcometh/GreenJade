 ...
 *   soft free → soft inventory (Wave 112) → ownership path PASS
 ...
 *
 * Soft inventory (Wave 112 exclusive deepen — greppable "sessiond-gj: soft …"):
...
/* Wave 112 soft inventory area count (fixed greppable categories). */
...
/*
 * Soft inventory tallies (Wave 112 exclusive deepen).
...
/* Soft: refresh display-vs-map geometry match lamp (Wave 112). */
static void
...
soft_inventory_log(void)
{
    ...
    /* Grep: sessiond-gj: soft geom (Wave 112) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft present (Wave 112) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft input (Wave 112) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft reclaim (Wave 112) */
    o = 0u;
    ...
    /*
     * Grep: sessiond-gj: soft honesty (Wave 112 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
 ...
 * Tallies Wave 112 soft flag inventory (sessiond-gj: soft flags …).
 ...
 * Tallies Wave 112 soft inventory (sessiond-gj: soft …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 112 soft free inventory (sessiond-gj: soft free …).
     */
    {
        unsigned long u64Va = 0;
        unsigned aInfo[3];
    ...
    /*
     * Wave 112 exclusive soft inventory rollup (greppable "sessiond-gj: soft …").
