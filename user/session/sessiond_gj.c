 ...
 *   soft free → soft inventory (Wave 111) → ownership path PASS
 ...
 *
 * Soft inventory (Wave 111 exclusive deepen — greppable "sessiond-gj: soft …"):
...
/* Wave 111 soft inventory area count (fixed greppable categories). */
...
/*
 * Soft inventory tallies (Wave 111 exclusive deepen).
...
/* Soft: refresh display-vs-map geometry match lamp (Wave 111). */
static void
...
soft_inventory_log(void)
{
    ...
    /* Grep: sessiond-gj: soft geom (Wave 111) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft present (Wave 111) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft input (Wave 111) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft reclaim (Wave 111) */
    o = 0u;
    ...
    /*
     * Grep: sessiond-gj: soft honesty (Wave 111 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
 ...
 * Tallies Wave 111 soft flag inventory (sessiond-gj: soft flags …).
 ...
 * Tallies Wave 111 soft inventory (sessiond-gj: soft …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 111 soft free inventory (sessiond-gj: soft free …).
     */
    {
        unsigned long u64Va = 0;
        unsigned aInfo[3];
    ...
    /*
     * Wave 111 exclusive soft inventory rollup (greppable "sessiond-gj: soft …").
