 ...
 *   soft free → soft inventory (Wave 115) → ownership path PASS
 ...
 *
 * Soft inventory (Wave 115 exclusive deepen — greppable "sessiond-gj: soft …"):
...
/* Wave 115 soft inventory area count (fixed greppable categories). */
#define SOFT_INV_AREAS  12u
/* Soft inventory wave stamp (Wave 115 exclusive deepen). */
...
/*
 * Soft inventory tallies (Wave 115 exclusive deepen).
...
/* Soft: refresh display-vs-map geometry match lamp (Wave 115). */
static void
...
/*
 * Soft inventory dump (Wave 115 exclusive deepen).
...
soft_inventory_log(void)
{
    ...
    /* Grep: sessiond-gj: soft geom (Wave 115) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft present (Wave 115) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft input (Wave 115) */
    o = 0u;
    ...
    /* Grep: sessiond-gj: soft reclaim (Wave 115) */
    o = 0u;
    ...
    /*
     * Grep: sessiond-gj: soft honesty (Wave 115 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
 ...
 * Tallies Wave 115 soft flag inventory (sessiond-gj: soft flags …).
 ...
 * Tallies Wave 115 soft inventory (sessiond-gj: soft …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 115 soft free inventory (sessiond-gj: soft free …).
     */
    {
        unsigned long u64Va = 0;
        unsigned aInfo[3];
    ...
    /*
     * Wave 115 exclusive soft inventory rollup (greppable "sessiond-gj: soft …").
