 ...
 *
 * Soft inventory (Wave 104 exclusive deepen — greppable when hostkey init runs
...
/* Wave 104 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 104): keep greppable strings live. */
