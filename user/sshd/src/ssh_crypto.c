 ...
 *
 * Soft inventory (Wave 105 exclusive deepen — greppable when hostkey init runs
...
/* Wave 105 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 105): keep greppable strings live. */
