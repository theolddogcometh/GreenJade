 ...
 *
 * Soft inventory (Wave 91 exclusive deepen — greppable when hostkey init runs
...
/* Wave 91 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 91): keep greppable strings live. */
