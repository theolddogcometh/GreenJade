 ...
 *
 * Soft inventory (Wave 74 exclusive deepen — greppable when hostkey init runs
...
/* Wave 74 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 74): keep greppable strings live. */
