 ...
 *
 * Soft inventory (Wave 103 exclusive deepen — greppable when hostkey init runs
...
/* Wave 103 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 103): keep greppable strings live. */
