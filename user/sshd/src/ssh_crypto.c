 ...
 *
 * Soft inventory (Wave 101 exclusive deepen — greppable when hostkey init runs
...
/* Wave 101 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 101): keep greppable strings live. */
