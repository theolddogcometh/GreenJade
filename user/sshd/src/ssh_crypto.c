 ...
 *
 * Soft inventory (Wave 73 exclusive deepen — greppable when hostkey init runs
...
/* Wave 73 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 73): keep greppable strings live. */
