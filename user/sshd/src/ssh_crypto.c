 ...
 *
 * Soft inventory (Wave 92 exclusive deepen — greppable when hostkey init runs
...
/* Wave 92 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 92): keep greppable strings live. */
