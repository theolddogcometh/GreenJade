 ...
 *
 * Soft inventory (Wave 80 exclusive deepen — greppable when hostkey init runs
...
/* Wave 80 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 80): keep greppable strings live. */
