 ...
 *
 * Soft inventory (Wave 124 exclusive deepen — greppable when hostkey init runs
...
/* Wave 124 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 124): keep greppable strings live. */
