 ...
 *
 * Soft inventory (Wave 86 exclusive deepen — greppable when hostkey init runs
...
/* Wave 86 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 86): keep greppable strings live. */
