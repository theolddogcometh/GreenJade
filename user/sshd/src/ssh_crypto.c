 ...
 *
 * Soft inventory (Wave 123 exclusive deepen — greppable when hostkey init runs
...
/* Wave 123 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 123): keep greppable strings live. */
