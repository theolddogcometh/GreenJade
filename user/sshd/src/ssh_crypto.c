 ...
 *
 * Soft inventory (Wave 85 exclusive deepen — greppable when hostkey init runs
...
/* Wave 85 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 85): keep greppable strings live. */
