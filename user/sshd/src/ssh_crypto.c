 ...
 *
 * Soft inventory (Wave 106 exclusive deepen — greppable when hostkey init runs
...
/* Wave 106 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 106): keep greppable strings live. */
