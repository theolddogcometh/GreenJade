 ...
 *
 * Soft inventory (Wave 71 exclusive deepen — greppable when hostkey init runs
...
/* Wave 71 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 71): keep greppable strings live. */
