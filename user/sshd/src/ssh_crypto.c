 ...
 *
 * Soft inventory (Wave 120 exclusive deepen — greppable when hostkey init runs
...
/* Wave 120 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 120): keep greppable strings live. */
