 ...
 *
 * Soft inventory (Wave 125 exclusive deepen — greppable when hostkey init runs
...
/* Wave 125 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 125): keep greppable strings live. */
