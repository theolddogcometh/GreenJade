 ...
 *
 * Soft inventory (Wave 98 exclusive deepen — greppable when hostkey init runs
...
/* Wave 98 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 98): keep greppable strings live. */
