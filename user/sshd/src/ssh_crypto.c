 ...
 *
 * Soft inventory (Wave 87 exclusive deepen — greppable when hostkey init runs
...
/* Wave 87 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 87): keep greppable strings live. */
