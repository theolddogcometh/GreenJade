 ...
 *
 * Soft inventory (Wave 122 exclusive deepen — greppable when hostkey init runs
...
/* Wave 122 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 122): keep greppable strings live. */
