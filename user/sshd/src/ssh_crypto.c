 ...
 *
 * Soft inventory (Wave 107 exclusive deepen — greppable when hostkey init runs
...
/* Wave 107 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 107): keep greppable strings live. */
