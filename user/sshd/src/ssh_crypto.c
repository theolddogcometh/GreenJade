 ...
 *
 * Soft inventory (Wave 77 exclusive deepen — greppable when hostkey init runs
...
/* Wave 77 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 77): keep greppable strings live. */
