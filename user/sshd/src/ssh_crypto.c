 ...
 *
 * Soft inventory (Wave 108 exclusive deepen — greppable when hostkey init runs
...
/* Wave 108 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 108): keep greppable strings live. */
