 ...
 *
 * Soft inventory (Wave 78 exclusive deepen — greppable when hostkey init runs
...
/* Wave 78 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 78): keep greppable strings live. */
