 ...
 *
 * Soft inventory (Wave 112 exclusive deepen — greppable when hostkey init runs
...
/* Wave 112 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 112): keep greppable strings live. */
