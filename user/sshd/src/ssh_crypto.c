 ...
 *
 * Soft inventory (Wave 84 exclusive deepen — greppable when hostkey init runs
...
/* Wave 84 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 84): keep greppable strings live. */
