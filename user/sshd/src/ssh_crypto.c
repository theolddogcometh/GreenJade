 ...
 *
 * Soft inventory (Wave 100 exclusive deepen — greppable when hostkey init runs
...
/* Wave 100 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 100): keep greppable strings live. */
