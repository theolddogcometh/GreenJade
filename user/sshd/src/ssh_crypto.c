 ...
 *
 * Soft inventory (Wave 111 exclusive deepen — greppable when hostkey init runs
...
/* Wave 111 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 111): keep greppable strings live. */
