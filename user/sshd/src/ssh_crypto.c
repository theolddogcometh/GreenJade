 ...
 *
 * Soft inventory (Wave 72 exclusive deepen — greppable when hostkey init runs
...
/* Wave 72 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 72): keep greppable strings live. */
