 ...
 *
 * Soft inventory (Wave 88 exclusive deepen — greppable when hostkey init runs
...
/* Wave 88 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 88): keep greppable strings live. */
