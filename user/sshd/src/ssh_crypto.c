 ...
 *
 * Soft inventory (Wave 81 exclusive deepen — greppable when hostkey init runs
...
/* Wave 81 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 81): keep greppable strings live. */
