 ...
 *
 * Soft inventory (Wave 82 exclusive deepen — greppable when hostkey init runs
...
/* Wave 82 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 82): keep greppable strings live. */
