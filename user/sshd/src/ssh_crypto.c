 ...
 *
 * Soft inventory (Wave 116 exclusive deepen — greppable when hostkey init runs
...
/* Wave 116 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 116): keep greppable strings live. */
