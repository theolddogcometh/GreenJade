 ...
 *
 * Soft inventory (Wave 83 exclusive deepen — greppable when hostkey init runs
...
/* Wave 83 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 83): keep greppable strings live. */
