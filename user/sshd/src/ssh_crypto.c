 ...
 *
 * Soft inventory (Wave 90 exclusive deepen — greppable when hostkey init runs
...
/* Wave 90 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 90): keep greppable strings live. */
