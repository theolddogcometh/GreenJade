 ...
 *
 * Soft inventory (Wave 109 exclusive deepen — greppable when hostkey init runs
...
/* Wave 109 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 109): keep greppable strings live. */
