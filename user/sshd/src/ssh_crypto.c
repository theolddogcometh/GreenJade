 ...
 *
 * Soft inventory (Wave 115 exclusive deepen — greppable when hostkey init runs
...
/* Wave 115 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 115): keep greppable strings live. */
