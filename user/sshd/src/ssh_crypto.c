 ...
 *
 * Soft inventory (Wave 79 exclusive deepen — greppable when hostkey init runs
...
/* Wave 79 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 79): keep greppable strings live. */
