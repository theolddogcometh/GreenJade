 ...
 *
 * Soft inventory (Wave 119 exclusive deepen — greppable when hostkey init runs
...
/* Wave 119 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 119): keep greppable strings live. */
