 ...
 *
 * Soft inventory (Wave 110 exclusive deepen — greppable when hostkey init runs
...
/* Wave 110 exclusive soft inventory stamp (observability; never hard-gates). */
...
gj_ssh_poly1305_selfcheck(void)
{
	...
	/* Soft inventory touch (Wave 110): keep greppable strings live. */
