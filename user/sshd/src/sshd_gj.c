 ...
 *
 * Soft inventory (Wave 45 exclusive deepen) — honesty, not product SSH.
 ...
 * Soft inventory / path / stats (Wave 45; greppable "sshd-gj: soft …"):
...
/*
 * Soft product inventory (Wave 45). Cumulative milestone lamps + suite tallies.
...
/* Offline soft-suite bit lamps (Wave 45; never hard-gate). */
...
/*
 * Greppable soft inventory + honesty (Wave 45 exclusive deepen).
 *   sshd-gj: soft honesty not-product-ssh …
 *   sshd-gj: soft inventory …
 *   sshd-gj: soft seq …
 *   sshd-gj: soft crypto …
...
soft_inventory_log(void)
{
	...
	/* Grep: sshd-gj: soft crypto (Wave 45 offline suite lamps) */
	o = 0;
	...
	/* Grep: sshd-gj: soft crypto (Wave 45 deepen legs continued) */
	o = 0;
	...
	/* Grep: sshd-gj: soft kex (live-path KEX lamps, Wave 45) */
	o = 0;
	...
	/* Grep: sshd-gj: soft channel (post-NEWKEYS session lamps, Wave 45) */
	o = 0;
	...
	/* Grep: sshd-gj: soft deepen wave (Wave 45 stamp) */
	o = 0;
	append_s(aLine, sizeof(aLine), &o, "sshd-gj: soft deepen wave=45 areas=");
	...
	/*
	 * Grep: sshd-gj: soft exclusive (Wave 45 exclusive deepen).
	 * Soft inventory ≠ product multi-server confine.
	 */
 ...
 * Wave 45 deepen: freestanding crypto/shape surface beyond the TCP smoke alone.
 * greppable: sshd-gj: soft …
 */
static void
soft_suite(void)
...
_start(void)
{
	...
	/*
	 * Wave 45 soft inventory: offline suite + honesty / path / stats.
