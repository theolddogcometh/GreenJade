 ...
 *
 * Soft inventory (Wave 105 exclusive deepen) — honesty, not product SSH.
 ...
 * Soft inventory / path / stats (Wave 105; greppable "sshd-gj: soft …"):
...
/*
 * Soft product inventory (Wave 105). Cumulative milestone lamps + suite tallies.
...
/* Offline soft-suite bit lamps (Wave 105; never hard-gate). */
...
/*
 * Greppable soft inventory + honesty (Wave 105 exclusive deepen).
 *   sshd-gj: soft honesty not-product-ssh …
 *   sshd-gj: soft inventory …
 *   sshd-gj: soft seq …
 *   sshd-gj: soft crypto …
...
soft_inventory_log(void)
{
	...
	/* Grep: sshd-gj: soft crypto (Wave 105 offline suite lamps) */
	o = 0;
	...
	/* Grep: sshd-gj: soft crypto (Wave 105 deepen legs continued) */
	o = 0;
	...
	/* Grep: sshd-gj: soft kex (live-path KEX lamps, Wave 105) */
	o = 0;
	...
	/* Grep: sshd-gj: soft channel (post-NEWKEYS session lamps, Wave 105) */
	o = 0;
	...
	/* Grep: sshd-gj: soft deepen wave (Wave 105 stamp) */
	o = 0;
	...
	/*
	 * Grep: sshd-gj: soft exclusive (Wave 105 exclusive deepen).
	 * Soft inventory ≠ product multi-server confine.
	 */
 ...
 * Wave 105 deepen: freestanding crypto/shape surface beyond the TCP smoke alone.
 * greppable: sshd-gj: soft …
 */
static void
soft_suite(void)
...
_start(void)
{
	...
	/*
	 * Wave 105 soft inventory: offline suite + honesty / path / stats.
