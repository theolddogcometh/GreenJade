 ...
 *
 * Soft inventory (Wave 124 exclusive deepen) — honesty, not product SSH.
...
/*
 * Soft product inventory (Wave 124). Cumulative milestone lamps + suite tallies.
...
/*
 * Greppable soft inventory + honesty (Wave 124 exclusive deepen).
 *   sshd-gj: soft honesty not-product-ssh …
 *   sshd-gj: soft inventory …
 *   sshd-gj: soft seq …
 *   sshd-gj: soft crypto …
...
soft_inventory_log(void)
{
	...
	/* Grep: sshd-gj: soft kex (live-path KEX lamps, Wave 124) */
	o = 0;
	...
	/* Grep: sshd-gj: soft channel (post-NEWKEYS session lamps, Wave 124) */
	o = 0;
	...
	/*
	 * Grep: sshd-gj: soft exclusive (Wave 124 exclusive deepen).
	 * Soft inventory ≠ product multi-server confine.
	 */
...
_start(void)
{
	...
	/*
	 * Wave 124 soft inventory: offline suite + honesty / path / stats.
