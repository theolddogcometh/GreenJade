 ...
 *
 * Soft inventory (Wave 123 exclusive deepen) — honesty, not product SSH.
...
/*
 * Soft product inventory (Wave 123). Cumulative milestone lamps + suite tallies.
...
/*
 * Greppable soft inventory + honesty (Wave 123 exclusive deepen).
 *   sshd-gj: soft honesty not-product-ssh …
 *   sshd-gj: soft inventory …
 *   sshd-gj: soft seq …
 *   sshd-gj: soft crypto …
...
soft_inventory_log(void)
{
	...
	/* Grep: sshd-gj: soft kex (live-path KEX lamps, Wave 123) */
	o = 0;
	...
	/* Grep: sshd-gj: soft channel (post-NEWKEYS session lamps, Wave 123) */
	o = 0;
	...
	/*
	 * Grep: sshd-gj: soft exclusive (Wave 123 exclusive deepen).
	 * Soft inventory ≠ product multi-server confine.
	 */
...
_start(void)
{
	...
	/*
	 * Wave 123 soft inventory: offline suite + honesty / path / stats.
