 ...
 *   soft inventory (Wave 82) → live path PASS
 *
 ...
 *
 * Soft inventory (Wave 82 exclusive deepen — greppable "storaged-gj: soft …"):
...
soft_inventory_log(void)
{
    ...
    /* Grep: storaged-gj: soft deepen wave (Wave 82 stamp) */
    o = 0u;
    ...
    /*
     * Grep: storaged-gj: soft honesty (Wave 82 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
/* Note one soft door sub-step outcome into Wave 82 inventory counters. */
static void
...
/* Note one soft free sub-step outcome into Wave 82 inventory counters. */
static void
...
/* Note one soft ring sub-step outcome into Wave 82 inventory counters. */
static void
...
/* Snapshot virtq export fields for Wave 82 soft export / ring lines. */
static void
 ...
 * Tallies Wave 82 soft inventory (storaged-gj: soft …).
 */
static unsigned
soft_door_path(void)
{
...
_start(void)
{
    ...
    /*
     * Wave 82 exclusive soft inventory rollup (greppable "storaged-gj: soft …").
