 ...
 *   soft inventory (Wave 122) → live path PASS
 *
 ...
 *
 * Soft inventory (Wave 122 exclusive deepen — greppable "storaged-gj: soft …"):
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: storaged-gj: soft honesty (Wave 122 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
/* Snapshot virtq export fields for Wave 122 soft export / ring lines. */
static void
 ...
 * Tallies Wave 122 soft inventory (storaged-gj: soft …).
 */
static unsigned
soft_door_path(void)
{
...
_start(void)
{
    ...
    /*
     * Wave 122 exclusive soft inventory rollup (greppable "storaged-gj: soft …").
