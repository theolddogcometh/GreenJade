 ...
 *   soft inventory (Wave 111) → live path PASS
 *
 ...
 *
 * Soft inventory (Wave 111 exclusive deepen — greppable "storaged-gj: soft …"):
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: storaged-gj: soft honesty (Wave 111 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
/* Snapshot virtq export fields for Wave 111 soft export / ring lines. */
static void
 ...
 * Tallies Wave 111 soft inventory (storaged-gj: soft …).
 */
static unsigned
soft_door_path(void)
{
...
_start(void)
{
    ...
    /*
     * Wave 111 exclusive soft inventory rollup (greppable "storaged-gj: soft …").
