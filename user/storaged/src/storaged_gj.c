 ...
 *   soft inventory (Wave 50) → live path PASS
 *
 ...
 *
 * Soft inventory (Wave 50 exclusive deepen — greppable "storaged-gj: soft …"):
 *   storaged-gj: soft inventory door_ok=… door_skip=… free_ok=… free_skip=…
 *                ring_ok=… ring_skip=… ok=… skip=… wave=50 log_n=…
 ...
 *   storaged-gj: soft deepen wave=50 areas=… ok=… skip=…
...
soft_inventory_log(void)
{
    ...
    /* Grep: storaged-gj: soft deepen wave (Wave 50 stamp) */
    o = 0u;
    ...
    /*
     * Grep: storaged-gj: soft honesty (Wave 50 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
/* Note one soft door sub-step outcome into Wave 50 inventory counters. */
static void
...
/* Note one soft free sub-step outcome into Wave 50 inventory counters. */
static void
...
/* Note one soft ring sub-step outcome into Wave 50 inventory counters. */
static void
...
/* Snapshot virtq export fields for Wave 50 soft export / ring lines. */
static void
 ...
 * Tallies Wave 50 soft inventory (storaged-gj: soft …).
 */
static unsigned
soft_door_path(void)
{
...
_start(void)
{
    ...
    /*
     * Wave 50 exclusive soft inventory rollup (greppable "storaged-gj: soft …").
