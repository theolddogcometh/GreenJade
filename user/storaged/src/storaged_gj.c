 ...
 *
 * Soft inventory (Wave 126 exclusive deepen — greppable "storaged-gj: soft …"):
...
/* Snapshot virtq export fields for Wave 126 soft export / ring lines. */
static void
 ...
 * Tallies Wave 126 soft inventory (storaged-gj: soft …).
 */
static unsigned
soft_door_path(void)
{
