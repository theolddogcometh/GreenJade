 ...
 *   soft inventory (Wave 70) → live path PASS
 *
 ...
 *
 * Soft inventory (Wave 70 exclusive deepen — greppable "storaged-gj: soft …"):
...
soft_inventory_log(void)
{
    ...
    /* Grep: storaged-gj: soft deepen wave (Wave 70 stamp) */
    o = 0u;
    ...
    /*
     * Grep: storaged-gj: soft honesty (Wave 70 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
/* Note one soft door sub-step outcome into Wave 70 inventory counters. */
static void
...
/* Note one soft free sub-step outcome into Wave 70 inventory counters. */
static void
...
/* Note one soft ring sub-step outcome into Wave 70 inventory counters. */
static void
...
/* Snapshot virtq export fields for Wave 70 soft export / ring lines. */
static void
 ...
 * Tallies Wave 70 soft inventory (storaged-gj: soft …).
 */
static unsigned
soft_door_path(void)
{
...
_start(void)
{
    ...
    /*
     * Wave 70 exclusive soft inventory rollup (greppable "storaged-gj: soft …").
