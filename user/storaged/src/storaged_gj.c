 ...
 *   soft inventory (Wave 56) → live path PASS
 *
 ...
 *
 * Soft inventory (Wave 56 exclusive deepen — greppable "storaged-gj: soft …"):
 *   storaged-gj: soft inventory door_ok=… door_skip=… free_ok=… free_skip=…
 *                ring_ok=… ring_skip=… ok=… skip=… wave=56 log_n=…
 ...
 *   storaged-gj: soft deepen wave=56 areas=… ok=… skip=…
...
soft_inventory_log(void)
{
    ...
    /* Grep: storaged-gj: soft deepen wave (Wave 56 stamp) */
    o = 0u;
    ...
    /*
     * Grep: storaged-gj: soft honesty (Wave 56 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
...
/* Note one soft door sub-step outcome into Wave 56 inventory counters. */
static void
...
/* Note one soft free sub-step outcome into Wave 56 inventory counters. */
static void
...
/* Note one soft ring sub-step outcome into Wave 56 inventory counters. */
static void
...
/* Snapshot virtq export fields for Wave 56 soft export / ring lines. */
static void
 ...
 * Tallies Wave 56 soft inventory (storaged-gj: soft …).
 */
static unsigned
soft_door_path(void)
{
...
_start(void)
{
    ...
    /*
     * Wave 56 exclusive soft inventory rollup (greppable "storaged-gj: soft …").
