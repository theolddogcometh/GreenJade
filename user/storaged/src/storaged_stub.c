 ...
 *
 * Soft inventory (Wave 30 exclusive deepen — greppable "storaged: soft …"):
 *   storaged: soft inventory … / soft deepen wave=30 …
...
main(void)
{
    ...
    /* Grep: storaged: soft inventory (Wave 30 exclusive deepen) */
    printf("storaged: soft inventory soft_steps=%u sectors=%u io=%u "
           "wave=30 multi_server=0 confine=0\n",
           cSoft, (unsigned)GJ_STORE_SECTS, (unsigned)g_u32Io);
    printf("storaged: soft deepen product_kernel=OPEN wave=30 areas=1 multi_server=0 "
           "confine=0 bar3=0\n");
