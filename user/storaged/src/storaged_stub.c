 ...
 *
 * Soft inventory (Wave 68 exclusive deepen — greppable "storaged: soft …"):
 *   storaged: soft inventory … / soft deepen wave=68 …
...
main(void)
{
    ...
    /* Grep: storaged: soft inventory (Wave 68 exclusive deepen) */
 ...
 */
    ...
    printf("storaged: soft inventory soft_steps=%u sectors=%u io=%u "
           "wave=68 multi_server=0 confine=0\n",
           cSoft, (unsigned)GJ_STORE_SECTS, (unsigned)g_u32Io);
    printf("storaged: soft deepen product_kernel=OPEN wave=68 areas=1 multi_server=0 "
           "confine=0 bar3=0\n");
