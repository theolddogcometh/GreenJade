 ...
 *
 * Soft inventory (Wave 18 exclusive deepen — greppable "storaged: soft …"):
 *   storaged: soft inventory … / soft deepen wave=18 …
...
main(void)
{
    ...
    /* Grep: storaged: soft inventory (Wave 18 exclusive deepen) */
    printf("storaged: soft inventory soft_steps=%u sectors=%u io=%u "
           "wave=18 multi_server=0 confine=0\n",
           cSoft, (unsigned)GJ_STORE_SECTS, (unsigned)g_u32Io);
    printf("storaged: soft deepen product_kernel=OPEN wave=18 areas=1 multi_server=0 "
           "confine=0 bar3=0\n");
