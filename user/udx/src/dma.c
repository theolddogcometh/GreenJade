...
#define UDX_DMA_SOFT_WAVE 30u

/*
 * Soft DMA product inventory (Wave 30 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 30 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 30 exclusive deepen).
