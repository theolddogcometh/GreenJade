...
#define UDX_DMA_SOFT_WAVE 33u

/*
 * Soft DMA product inventory (Wave 33 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 33 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 33 exclusive deepen).
