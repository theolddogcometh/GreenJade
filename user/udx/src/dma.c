...
/*
 * Soft DMA product inventory (Wave 111 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 111 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 111 exclusive deepen).
