...
/*
 * Soft DMA product inventory (Wave 109 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 109 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 109 exclusive deepen).
