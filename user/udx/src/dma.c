...
#define UDX_DMA_SOFT_WAVE 31u

/*
 * Soft DMA product inventory (Wave 31 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 31 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 31 exclusive deepen).
