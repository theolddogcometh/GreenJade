...
#define UDX_DMA_SOFT_WAVE 23u

/*
 * Soft DMA product inventory (Wave 23 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 23 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 23 exclusive deepen).
