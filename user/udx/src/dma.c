...
/*
 * Soft DMA product inventory (Wave 85 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 85 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 85 exclusive deepen).
