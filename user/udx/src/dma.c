...
/*
 * Soft DMA product inventory (Wave 119 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 119 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 119 exclusive deepen).
