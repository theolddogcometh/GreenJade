...
/*
 * Soft DMA product inventory (Wave 86 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 86 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 86 exclusive deepen).
