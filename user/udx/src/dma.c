...
#define UDX_DMA_SOFT_WAVE 19u

/*
 * Soft DMA product inventory (Wave 19 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 19 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 19 exclusive deepen).
