...
/*
 * Soft DMA product inventory (Wave 115 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 115 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 115 exclusive deepen).
