...
/*
 * Soft DMA product inventory (Wave 74 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 74 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 74 exclusive deepen).
