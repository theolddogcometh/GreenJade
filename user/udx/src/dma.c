...
#define UDX_DMA_SOFT_WAVE 37u

/*
 * Soft DMA product inventory (Wave 44 exclusive deepen). Cumulative for
...
/**
 * Greppable soft DMA inventory (Wave 44 exclusive deepen).
...
dma_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: dma soft honesty (Wave 44 exclusive deepen).
