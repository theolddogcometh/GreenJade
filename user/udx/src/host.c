...
/*
 * Soft host window / BAR inventory (Wave 105 exclusive deepen).
...
/**
 * Greppable soft host inventory (Wave 105 exclusive deepen).
...
host_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: host soft honesty (Wave 105 exclusive deepen).
