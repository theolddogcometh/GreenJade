...
/*
 * Soft host window / BAR inventory (Wave 71 exclusive deepen).
...
/**
 * Greppable soft host inventory (Wave 71 exclusive deepen).
...
host_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: host soft honesty (Wave 71 exclusive deepen).
