...
/*
 * Soft host window / BAR inventory (Wave 46 exclusive deepen).
...
/**
 * Greppable soft host inventory (Wave 46 exclusive deepen).
...
host_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: host soft honesty (Wave 46 exclusive deepen).
