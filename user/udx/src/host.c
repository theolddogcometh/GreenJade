...
/*
 * Soft host window / BAR inventory (Wave 73 exclusive deepen).
...
/**
 * Greppable soft host inventory (Wave 73 exclusive deepen).
...
host_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: host soft honesty (Wave 73 exclusive deepen).
