 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 20 exclusive deepen)
 ...
 *
 * Honesty (Wave 20): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 20 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   19u
 ...
 *   udx: notify soft deepen        — wave=20 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 20).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 20 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 20 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 20 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 20 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 20 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 20 exclusive deepen).
