 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 103 exclusive deepen)
 ...
 *
 * Honesty (Wave 103): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 103 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 103).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 103 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 103 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 103 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 103 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 103 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 103 exclusive deepen).
