 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 17 exclusive deepen)
 ...
 *
 * Honesty (Wave 17): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 17 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   17u
 ...
 *   udx: notify soft deepen        — wave=17 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 17).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 17 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 17 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 17 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 17 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 17 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 17 exclusive deepen).
