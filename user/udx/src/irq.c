 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 32 exclusive deepen)
 ...
 *
 * Honesty (Wave 32): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 32 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   32u
 ...
 *   udx: notify soft deepen        — wave=32 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 32).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 32 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 32 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 32 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 32 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 32 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 32 exclusive deepen).
