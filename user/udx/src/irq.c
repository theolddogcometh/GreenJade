 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 65 exclusive deepen)
 ...
 *
 * Honesty (Wave 65): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 65 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 65u
 ...
 *   udx: notify soft deepen        — wave=65 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 65).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 65 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 65 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 65 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 65 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 65 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 65 exclusive deepen).
