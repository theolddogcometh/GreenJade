 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 109 exclusive deepen)
 ...
 *
 * Honesty (Wave 109): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 109 exclusive deepen). */
 ...
 *   udx: notify soft deepen        — wave=70 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 109).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 109 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 109 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 109 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 109 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 109 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 109 exclusive deepen).
