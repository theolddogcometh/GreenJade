 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 26 exclusive deepen)
 ...
 *
 * Honesty (Wave 26): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 26 exclusive deepen). */
 ...
 *   udx: notify soft deepen        — wave=26 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 26).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 26 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 26 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 26 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 26 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 26 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 26 exclusive deepen).
