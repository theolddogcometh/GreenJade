 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 120 exclusive deepen)
 ...
 *
 * Honesty (Wave 120): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 120 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 120).
...
notify_soft_log(void)
{
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 120 exclusive deepen).
