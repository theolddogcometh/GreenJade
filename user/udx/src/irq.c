 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 46 exclusive deepen)
 ...
 *
 * Honesty (Wave 46): UDX kernel notify product remains OPEN. Soft deepen
...
#define UDX_NOTIFY_SOFT_WAVE 46u
 ...
 *   udx: notify soft deepen        — wave=46 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 46).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 46 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 46 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 46 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 46 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 46 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 46 exclusive deepen).
