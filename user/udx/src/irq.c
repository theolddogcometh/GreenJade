 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 68 exclusive deepen)
 ...
 *
 * Honesty (Wave 68): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 68 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 68u
 ...
 *   udx: notify soft deepen        — wave=68 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 68).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 68 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 68 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 68 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 68 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 68 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 68 exclusive deepen).
