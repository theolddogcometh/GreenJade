 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 43 exclusive deepen)
 ...
 *
 * Honesty (Wave 43): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 43 exclusive deepen). */
 ...
 *   udx: notify soft deepen        — wave=43 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 43).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 43 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 43 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 43 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 43 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 43 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 43 exclusive deepen).
