 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 45 exclusive deepen)
 ...
 *
 * Honesty (Wave 45): UDX kernel notify product remains OPEN. Soft deepen
 ...
 *   udx: notify soft deepen        — wave=45 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 45).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 45 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 45 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 45 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 45 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 45 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 45 exclusive deepen).
