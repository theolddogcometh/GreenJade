 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 34 exclusive deepen)
 ...
 *
 * Honesty (Wave 34): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 34 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   33u
 ...
 *   udx: notify soft deepen        — wave=34 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 34).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 34 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 34 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 34 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 34 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 34 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 34 exclusive deepen).
