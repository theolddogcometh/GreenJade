 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 115 exclusive deepen)
 ...
 *
 * Honesty (Wave 115): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 115 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 115).
...
notify_soft_log(void)
{
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 115 exclusive deepen).
