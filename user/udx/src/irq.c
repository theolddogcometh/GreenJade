 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 125 exclusive deepen)
 ...
 *
 * Honesty (Wave 125): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 125 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 125).
...
notify_soft_log(void)
{
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 125 exclusive deepen).
