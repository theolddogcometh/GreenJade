 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 53 exclusive deepen)
 ...
 *
 * Honesty (Wave 53): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 53 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 53u
 ...
 *   udx: notify soft deepen        — wave=53 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 53).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 53 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 53 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 53 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 53 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 53 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 53 exclusive deepen).
