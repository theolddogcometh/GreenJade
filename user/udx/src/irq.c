 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 30 exclusive deepen)
 ...
 *
 * Honesty (Wave 30): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 30 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   30u
 ...
 *   udx: notify soft deepen        — wave=30 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 30).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 30 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 30 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 30 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 30 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 30 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 30 exclusive deepen).
