 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 44 exclusive deepen)
 ...
 *
 * Honesty (Wave 44): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 44 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE   37u
 ...
 *   udx: notify soft deepen        — wave=44 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 44).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 44 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 44 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 44 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 44 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 44 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 44 exclusive deepen).
