 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 116 exclusive deepen)
 ...
 *
 * Honesty (Wave 116): UDX kernel notify product remains OPEN. Soft deepen
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 116).
...
notify_soft_log(void)
{
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 116 exclusive deepen).
