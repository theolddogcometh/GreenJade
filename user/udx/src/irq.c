 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 16 exclusive deepen)
 ...
 *
 * Honesty (Wave 16): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 16 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   16u
 ...
 *   udx: notify soft deepen        — wave=16 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 16).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 16 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 16 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 16 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 16 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 16 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 16 exclusive deepen).
