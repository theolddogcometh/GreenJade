 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 48 exclusive deepen)
 ...
 *
 * Honesty (Wave 48): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 48 exclusive deepen). */
 ...
 *   udx: notify soft deepen        — wave=48 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 48).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 48 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 48 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 48 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 48 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 48 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 48 exclusive deepen).
