 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 110 exclusive deepen)
 ...
 *
 * Honesty (Wave 110): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 110 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 110).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 110 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 110 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 110 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 110 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 110 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 110 exclusive deepen).
