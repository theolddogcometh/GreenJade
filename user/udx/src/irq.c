 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 80 exclusive deepen)
 ...
 *
 * Honesty (Wave 80): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 80 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 80).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 80 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 80 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 80 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 80 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 80 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 80 exclusive deepen).
