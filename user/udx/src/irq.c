 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 61 exclusive deepen)
 ...
 *
 * Honesty (Wave 61): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 61 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 61u
 ...
 *   udx: notify soft deepen        — wave=61 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 61).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 61 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 61 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 61 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 61 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 61 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 61 exclusive deepen).
