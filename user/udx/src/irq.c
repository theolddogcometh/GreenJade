 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 101 exclusive deepen)
 ...
 *
 * Honesty (Wave 101): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 101 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 101).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 101 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 101 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 101 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 101 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 101 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 101 exclusive deepen).
