 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 114 exclusive deepen)
 ...
 *
 * Honesty (Wave 114): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 114 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 114).
...
notify_soft_log(void)
{
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 114 exclusive deepen).
