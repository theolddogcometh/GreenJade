 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 100 exclusive deepen)
 ...
 *
 * Honesty (Wave 100): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 100 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 100).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 100 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 100 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 100 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 100 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 100 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 100 exclusive deepen).
