 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 62 exclusive deepen)
 ...
 *
 * Honesty (Wave 62): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 62 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 62u
 ...
 *   udx: notify soft deepen        — wave=62 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 62).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 62 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 62 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 62 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 62 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 62 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 62 exclusive deepen).
