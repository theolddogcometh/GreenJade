 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 123 exclusive deepen)
 ...
 *
 * Honesty (Wave 123): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 123 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 123).
...
notify_soft_log(void)
{
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 123 exclusive deepen).
