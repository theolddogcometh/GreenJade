 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 84 exclusive deepen)
 ...
 *
 * Honesty (Wave 84): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 84 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 84).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 84 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 84 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 84 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 84 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 84 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 84 exclusive deepen).
