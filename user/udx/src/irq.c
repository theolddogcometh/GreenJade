 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 18 exclusive deepen)
 ...
 *
 * Honesty (Wave 18): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 18 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   18u
 ...
 *   udx: notify soft deepen        — wave=18 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 18).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 18 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 18 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 18 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 18 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 18 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 18 exclusive deepen).
