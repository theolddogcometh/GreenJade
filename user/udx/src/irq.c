 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 111 exclusive deepen)
 ...
 *
 * Honesty (Wave 111): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 111 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 111).
...
notify_soft_log(void)
{
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 111 exclusive deepen).
