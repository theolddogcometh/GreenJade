 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 24 exclusive deepen)
 ...
 *
 * Honesty (Wave 24): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 24 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   24u
 ...
 *   udx: notify soft deepen        — wave=24 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 24).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 24 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 24 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 24 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 24 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 24 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 24 exclusive deepen).
