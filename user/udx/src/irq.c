 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 124 exclusive deepen)
 ...
 *
 * Honesty (Wave 124): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 124 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 124).
...
notify_soft_log(void)
{
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 124 exclusive deepen).
