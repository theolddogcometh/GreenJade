 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 40 exclusive deepen)
 ...
 *
 * Honesty (Wave 40): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 40 exclusive deepen). */
 ...
 *   udx: notify soft deepen        — wave=40 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 40).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 40 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 40 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 40 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 40 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 40 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 40 exclusive deepen).
