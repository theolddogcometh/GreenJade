 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 52 exclusive deepen)
 ...
 *
 * Honesty (Wave 52): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 52 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 52u
 ...
 *   udx: notify soft deepen        — wave=52 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 52).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 52 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 52 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 52 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 52 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 52 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 52 exclusive deepen).
