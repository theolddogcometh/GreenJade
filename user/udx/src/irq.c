 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 104 exclusive deepen)
 ...
 *
 * Honesty (Wave 104): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 104 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 104).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 104 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 104 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 104 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 104 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 104 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 104 exclusive deepen).
