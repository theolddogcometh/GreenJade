 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 31 exclusive deepen)
 ...
 *
 * Honesty (Wave 31): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 31 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   31u
 ...
 *   udx: notify soft deepen        — wave=31 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 31).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 31 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 31 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 31 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 31 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 31 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 31 exclusive deepen).
