 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 47 exclusive deepen)
 ...
 *
 * Honesty (Wave 47): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 47 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 47u
 ...
 *   udx: notify soft deepen        — wave=47 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 47).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 47 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 47 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 47 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 47 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 47 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 47 exclusive deepen).
