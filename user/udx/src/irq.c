 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 15 exclusive deepen)
 ...
 *
 * Honesty (Wave 15): UDX kernel notify product remains OPEN. Soft deepen
...
#define UDX_NOTIFY_SOFT_WAVE   15u
 ...
 *   udx: notify soft deepen        — wave=15 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 15).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 15 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 15 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 15 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 15 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 15 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 15 exclusive deepen).
