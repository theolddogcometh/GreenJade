 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 60 exclusive deepen)
 ...
 *
 * Honesty (Wave 60): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 60 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 60u
 ...
 *   udx: notify soft deepen        — wave=60 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 60).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 60 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 60 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 60 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 60 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 60 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 60 exclusive deepen).
