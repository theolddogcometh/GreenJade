 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 113 exclusive deepen)
 ...
 *
 * Honesty (Wave 113): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 113 exclusive deepen). */
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 113).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft sync (Wave 111 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 113 exclusive deepen).
