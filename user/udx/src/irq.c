 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 54 exclusive deepen)
 ...
 *
 * Honesty (Wave 54): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 54 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 54u
 ...
 *   udx: notify soft deepen        — wave=54 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 54).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 54 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 54 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 54 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 54 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 54 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 54 exclusive deepen).
