 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 63 exclusive deepen)
 ...
 *
 * Honesty (Wave 63): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 63 exclusive deepen). */
...
#define UDX_NOTIFY_SOFT_WAVE 63u
 ...
 *   udx: notify soft deepen        — wave=63 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 63).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 63 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 63 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 63 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 63 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 63 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 63 exclusive deepen).
