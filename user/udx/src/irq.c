 ...
 *
 * -------------------------------------------------------------------------
 * Soft notify path → real Notification (gap doc; Wave 36 exclusive deepen)
 ...
 *
 * Honesty (Wave 36): UDX kernel notify product remains OPEN. Soft deepen
...
/* Soft wave stamp + greppable area count (Wave 36 exclusive deepen). */
#define UDX_NOTIFY_SOFT_WAVE   36u
 ...
 *   udx: notify soft deepen        — wave=36 stamp + area count
...
/*
 * Greppable soft notify inventory (toward real Notification; Wave 36).
...
notify_soft_log(void)
{
    ...
    /* Grep: udx: notify soft mask (Wave 36 deepen) */
    ...
    /* Grep: udx: notify soft table (Wave 36 deepen) */
    ...
    /* Grep: udx: notify soft badge (Wave 36 deepen) */
    ...
    /* Grep: udx: notify soft deepen wave (Wave 36 stamp) */
    ...
    /* Grep: udx: notify soft sync (Wave 36 deepen) */
    ...
    /*
     * Grep: udx: notify soft honesty (Wave 36 exclusive deepen).
