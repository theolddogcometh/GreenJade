...
/*
 * Soft MMIO product inventory (Wave 37 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 37 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 37 exclusive deepen).
