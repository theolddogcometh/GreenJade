...
/*
 * Soft MMIO product inventory (Wave 92 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 92 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 92 exclusive deepen).
