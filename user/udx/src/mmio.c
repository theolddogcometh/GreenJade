...
/*
 * Soft MMIO product inventory (Wave 98 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 98 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 98 exclusive deepen).
