...
#define UDX_MMIO_SOFT_WAVE 68u

/*
 * Soft MMIO product inventory (Wave 68 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 68 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 68 exclusive deepen).
