...
#define UDX_MMIO_SOFT_WAVE 15u

/*
 * Soft MMIO product inventory (Wave 15 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 15 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 15 exclusive deepen).
