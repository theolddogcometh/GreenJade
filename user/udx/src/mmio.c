...
#define UDX_MMIO_SOFT_WAVE 50u

/*
 * Soft MMIO product inventory (Wave 50 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 50 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 50 exclusive deepen).
