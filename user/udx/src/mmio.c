...
#define UDX_MMIO_SOFT_WAVE 14u

/*
 * Soft MMIO product inventory (Wave 14 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 14 exclusive deepen).
