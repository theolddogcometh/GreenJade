...
/*
 * Soft MMIO product inventory (Wave 70 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 70 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 70 exclusive deepen).
