...
#define UDX_MMIO_SOFT_WAVE 53u

/*
 * Soft MMIO product inventory (Wave 53 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 53 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 53 exclusive deepen).
