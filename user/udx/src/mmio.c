...
#define UDX_MMIO_SOFT_WAVE 67u

/*
 * Soft MMIO product inventory (Wave 67 exclusive deepen). Cumulative for
...
/**
 * Greppable soft MMIO inventory (Wave 67 exclusive deepen).
...
mmio_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: mmio soft honesty (Wave 67 exclusive deepen).
