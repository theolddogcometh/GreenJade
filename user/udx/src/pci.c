...
/*
 * Soft PCI product inventory (Wave 80 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 80 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 80 exclusive deepen).
