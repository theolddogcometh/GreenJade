...
/*
 * Soft PCI product inventory (Wave 92 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 92 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 92 exclusive deepen).
