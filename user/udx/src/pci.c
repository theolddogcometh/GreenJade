...
/*
 * Soft PCI product inventory (Wave 49 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 49 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 49 exclusive deepen).
