...
/*
 * Soft PCI product inventory (Wave 100 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 100 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 100 exclusive deepen).
