...
/*
 * Soft PCI product inventory (Wave 65 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 65 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 65 exclusive deepen).
