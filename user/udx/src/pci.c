...
/*
 * Soft PCI product inventory (Wave 112 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 112 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 112 exclusive deepen).
