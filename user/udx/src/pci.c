...
/*
 * Soft PCI product inventory (Wave 87 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 87 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 87 exclusive deepen).
