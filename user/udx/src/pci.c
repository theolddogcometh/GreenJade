...
/*
 * Soft PCI product inventory (Wave 84 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 84 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 84 exclusive deepen).
