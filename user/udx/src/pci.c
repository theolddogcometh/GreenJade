...
/*
 * Soft PCI product inventory (Wave 73 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 73 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 73 exclusive deepen).
