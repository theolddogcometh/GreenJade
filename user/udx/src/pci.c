...
/*
 * Soft PCI product inventory (Wave 114 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 114 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 114 exclusive deepen).
