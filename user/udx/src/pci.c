...
/*
 * Soft PCI product inventory (Wave 72 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 72 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 72 exclusive deepen).
