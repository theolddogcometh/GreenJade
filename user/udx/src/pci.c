...
/*
 * Soft PCI product inventory (Wave 119 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 119 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 119 exclusive deepen).
