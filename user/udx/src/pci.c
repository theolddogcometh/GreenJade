...
/*
 * Soft PCI product inventory (Wave 30 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 30 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 30 exclusive deepen).
