...
/*
 * Soft PCI product inventory (Wave 37 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 37 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 37 exclusive deepen).
