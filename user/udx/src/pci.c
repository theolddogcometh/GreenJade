...
/*
 * Soft PCI product inventory (Wave 83 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 83 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 83 exclusive deepen).
