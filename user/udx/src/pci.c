...
/*
 * Soft PCI product inventory (Wave 16 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 16 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 16 exclusive deepen).
