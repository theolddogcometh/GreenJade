...
/*
 * Soft PCI product inventory (Wave 63 exclusive deepen).
...
/**
 * Greppable soft PCI inventory (Wave 63 exclusive deepen).
...
pci_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: pci soft honesty (Wave 63 exclusive deepen).
