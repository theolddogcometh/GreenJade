 ...
 *
 * Soft SPSC ownership protocol (Wave 39 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 39): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 39 deepen).
 ...
 *   udx: spsc soft deepen    — wave=39 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 39 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 39 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 39 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 39 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 39 exclusive deepen).
