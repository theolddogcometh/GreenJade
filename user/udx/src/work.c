 ...
 *
 * Soft SPSC ownership protocol (Wave 65 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 65): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 65 deepen).
 ...
 *   udx: spsc soft deepen    — wave=65 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 65 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 65 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 65 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 65 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 65 exclusive deepen).
