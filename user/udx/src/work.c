 ...
 *
 * Soft SPSC ownership protocol (Wave 25 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 25): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 25 deepen).
 ...
 *   udx: spsc soft deepen    — wave=25 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 25 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 25 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 25 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 25 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 25 exclusive deepen).
