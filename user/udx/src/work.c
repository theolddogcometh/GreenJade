 ...
 *
 * Soft SPSC ownership protocol (Wave 22 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 22): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 22 deepen).
 ...
 *   udx: spsc soft deepen    — wave=22 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 22 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 22 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 22 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 22 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 22 exclusive deepen).
