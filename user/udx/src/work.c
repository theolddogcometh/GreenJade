 ...
 *
 * Soft SPSC ownership protocol (Wave 80 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 80): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 80 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 80 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 80 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 80 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 80 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 80 exclusive deepen).
