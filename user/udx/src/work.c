 ...
 *
 * Soft SPSC ownership protocol (Wave 32 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 32): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 32 deepen).
 ...
 *   udx: spsc soft deepen    — wave=32 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 32 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 32 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 32 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 32 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 32 exclusive deepen).
