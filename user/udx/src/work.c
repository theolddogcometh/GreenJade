 ...
 *
 * Soft SPSC ownership protocol (Wave 30 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 30): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 30 deepen).
 ...
 *   udx: spsc soft deepen    — wave=30 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 30 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 30 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 30 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 30 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 30 exclusive deepen).
