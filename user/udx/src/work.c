 ...
 *
 * Soft SPSC ownership protocol (Wave 103 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 103): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 103 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 103 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 103 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 103 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 103 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 103 exclusive deepen).
