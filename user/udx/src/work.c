 ...
 *
 * Soft SPSC ownership protocol (Wave 43 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 43): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 43 deepen).
 ...
 *   udx: spsc soft deepen    — wave=43 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 43 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 43 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 43 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 43 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 43 exclusive deepen).
