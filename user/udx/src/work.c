 ...
 *
 * Soft SPSC ownership protocol (Wave 123 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 123): soft observation only — multi-process driver-host
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 123 exclusive deepen).
