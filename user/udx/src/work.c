 ...
 *
 * Soft SPSC ownership protocol (Wave 23 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 23): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 23 deepen).
 ...
 *   udx: spsc soft deepen    — wave=23 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 23 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 23 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 23 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 23 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 23 exclusive deepen).
