 ...
 *
 * Soft SPSC ownership protocol (Wave 44 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 44): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 44 deepen).
 ...
 *   udx: spsc soft deepen    — wave=44 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 44 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 44 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 44 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 44 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 44 exclusive deepen).
