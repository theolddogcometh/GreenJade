 ...
 *
 * Soft SPSC ownership protocol (Wave 41 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 41): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 41 deepen).
 ...
 *   udx: spsc soft deepen    — wave=41 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 41 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 41 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 41 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 41 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 41 exclusive deepen).
