 ...
 *
 * Soft SPSC ownership protocol (Wave 107 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 107): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 107 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 107 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 107 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 107 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 107 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 107 exclusive deepen).
