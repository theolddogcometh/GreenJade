 ...
 *
 * Soft SPSC ownership protocol (Wave 109 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 109): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 109 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 109 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 109 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 109 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 109 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 109 exclusive deepen).
