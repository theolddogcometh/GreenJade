 ...
 *
 * Soft SPSC ownership protocol (Wave 24 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 24): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 24 deepen).
 ...
 *   udx: spsc soft deepen    — wave=24 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 24 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 24 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 24 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 24 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 24 exclusive deepen).
