 ...
 *
 * Soft SPSC ownership protocol (Wave 31 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 31): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 31 deepen).
 ...
 *   udx: spsc soft deepen    — wave=31 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 31 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 31 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 31 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 31 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 31 exclusive deepen).
