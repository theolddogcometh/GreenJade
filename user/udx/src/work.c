 ...
 *
 * Soft SPSC ownership protocol (Wave 57 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 57): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 57 deepen).
 ...
 *   udx: spsc soft deepen    — wave=57 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 57 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 57 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 57 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 57 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 57 exclusive deepen).
