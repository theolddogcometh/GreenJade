 ...
 *
 * Soft SPSC ownership protocol (Wave 54 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 54): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 54 deepen).
 ...
 *   udx: spsc soft deepen    — wave=54 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 54 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 54 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 54 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 54 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 54 exclusive deepen).
