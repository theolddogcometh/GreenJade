 ...
 *
 * Soft SPSC ownership protocol (Wave 87 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 87): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 87 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 87 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 87 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 87 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 87 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 87 exclusive deepen).
