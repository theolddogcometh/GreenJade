 ...
 *
 * Soft SPSC ownership protocol (Wave 60 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 60): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 60 deepen).
 ...
 *   udx: spsc soft deepen    — wave=60 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 60 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 60 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 60 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 60 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 60 exclusive deepen).
