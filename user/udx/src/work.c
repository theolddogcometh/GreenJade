 ...
 *
 * Soft SPSC ownership protocol (Wave 42 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 42): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 42 deepen).
 ...
 *   udx: spsc soft deepen    — wave=42 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 42 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 42 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 42 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 42 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 42 exclusive deepen).
