 ...
 *
 * Soft SPSC ownership protocol (Wave 97 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 97): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 97 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 97 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 97 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 97 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 97 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 97 exclusive deepen).
