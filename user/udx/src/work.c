 ...
 *
 * Soft SPSC ownership protocol (Wave 96 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 96): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 96 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 96 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 96 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 96 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 96 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 96 exclusive deepen).
