 ...
 *
 * Soft SPSC ownership protocol (Wave 59 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 59): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 59 deepen).
 ...
 *   udx: spsc soft deepen    — wave=59 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 59 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 59 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 59 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 59 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 59 exclusive deepen).
