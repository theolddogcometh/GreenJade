 ...
 *
 * Soft SPSC ownership protocol (Wave 27 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 27): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 27 deepen).
 ...
 *   udx: spsc soft deepen    — wave=27 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 27 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 27 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 27 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 27 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 27 exclusive deepen).
