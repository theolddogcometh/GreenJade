 ...
 *
 * Soft SPSC ownership protocol (Wave 61 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 61): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 61 deepen).
 ...
 *   udx: spsc soft deepen    — wave=61 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 61 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 61 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 61 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 61 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 61 exclusive deepen).
