 ...
 *
 * Soft SPSC ownership protocol (Wave 49 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 49): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 49 deepen).
 ...
 *   udx: spsc soft deepen    — wave=49 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 49 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 49 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 49 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 49 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 49 exclusive deepen).
