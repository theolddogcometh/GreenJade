 ...
 *
 * Soft SPSC ownership protocol (Wave 90 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 90): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 90 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 90 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 90 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 90 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 90 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 90 exclusive deepen).
