 ...
 *
 * Soft SPSC ownership protocol (Wave 98 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 98): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 98 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 98 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 98 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 98 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 98 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 98 exclusive deepen).
