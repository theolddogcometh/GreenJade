 ...
 *
 * Soft SPSC ownership protocol (Wave 79 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 79): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 79 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 79 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 79 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 79 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 79 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 79 exclusive deepen).
