 ...
 *
 * Soft SPSC ownership protocol (Wave 48 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 48): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 48 deepen).
 ...
 *   udx: spsc soft deepen    — wave=48 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 48 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 48 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 48 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 48 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 48 exclusive deepen).
