 ...
 *
 * Soft SPSC ownership protocol (Wave 18 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 18): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 18 deepen).
 ...
 *   udx: spsc soft deepen    — wave=18 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 18 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 18 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 18 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 18 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 18 exclusive deepen).
