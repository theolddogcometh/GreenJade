 ...
 *
 * Soft SPSC ownership protocol (Wave 50 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 50): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 50 deepen).
 ...
 *   udx: spsc soft deepen    — wave=50 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 50 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 50 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 50 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 50 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 50 exclusive deepen).
