 ...
 *
 * Soft SPSC ownership protocol (Wave 101 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 101): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 101 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 101 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 101 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 101 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 101 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 101 exclusive deepen).
