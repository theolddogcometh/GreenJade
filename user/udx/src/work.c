 ...
 *
 * Soft SPSC ownership protocol (Wave 29 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 29): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 29 deepen).
 ...
 *   udx: spsc soft deepen    — wave=29 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 29 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 29 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 29 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 29 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 29 exclusive deepen).
