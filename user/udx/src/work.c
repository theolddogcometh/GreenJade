 ...
 *
 * Soft SPSC ownership protocol (Wave 66 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 66): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 66 deepen).
 ...
 *   udx: spsc soft deepen    — wave=66 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 66 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 66 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 66 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 66 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 66 exclusive deepen).
