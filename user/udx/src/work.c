 ...
 *
 * Soft SPSC ownership protocol (Wave 26 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 26): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 26 deepen).
 ...
 *   udx: spsc soft deepen    — wave=26 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 26 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 26 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 26 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 26 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 26 exclusive deepen).
