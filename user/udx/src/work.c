 ...
 *
 * Soft SPSC ownership protocol (Wave 63 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 63): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 63 deepen).
 ...
 *   udx: spsc soft deepen    — wave=63 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 63 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 63 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 63 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 63 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 63 exclusive deepen).
