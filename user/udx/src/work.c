 ...
 *
 * Soft SPSC ownership protocol (Wave 106 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 106): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 106 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 106 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 106 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 106 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 106 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 106 exclusive deepen).
