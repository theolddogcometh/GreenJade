 ...
 *
 * Soft SPSC ownership protocol (Wave 74 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 74): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 74 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 74 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 74 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 74 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 74 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 74 exclusive deepen).
