 ...
 *
 * Soft SPSC ownership protocol (Wave 126 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 126): soft observation only — multi-process driver-host
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 126 exclusive deepen).
