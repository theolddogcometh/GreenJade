 ...
 *
 * Soft SPSC ownership protocol (Wave 92 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 92): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 92 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 92 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 92 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 92 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 92 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 92 exclusive deepen).
