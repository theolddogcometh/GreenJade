 ...
 *
 * Soft SPSC ownership protocol (Wave 85 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 85): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 85 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 85 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 85 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 85 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 85 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 85 exclusive deepen).
