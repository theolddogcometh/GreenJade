 ...
 *
 * Soft SPSC ownership protocol (Wave 86 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 86): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 86 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 86 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 86 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 86 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 86 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 86 exclusive deepen).
