 ...
 *
 * Soft SPSC ownership protocol (Wave 105 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 105): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 105 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 105 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 105 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 105 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 105 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 105 exclusive deepen).
