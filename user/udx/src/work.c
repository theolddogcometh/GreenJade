 ...
 *
 * Soft SPSC ownership protocol (Wave 64 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 64): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 64 deepen).
 ...
 *   udx: spsc soft deepen    — wave=64 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 64 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 64 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 64 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 64 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 64 exclusive deepen).
