 ...
 *
 * Soft SPSC ownership protocol (Wave 28 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 28): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 28 deepen).
 ...
 *   udx: spsc soft deepen    — wave=28 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 28 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 28 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 28 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 28 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 28 exclusive deepen).
