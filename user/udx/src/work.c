 ...
 *
 * Soft SPSC ownership protocol (Wave 36 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 36): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 36 deepen).
 ...
 *   udx: spsc soft deepen    — wave=36 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 36 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 36 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 36 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 36 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 36 exclusive deepen).
