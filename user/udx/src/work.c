 ...
 *
 * Soft SPSC ownership protocol (Wave 37 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 37): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 37 deepen).
 ...
 *   udx: spsc soft deepen    — wave=37 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 37 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 37 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 37 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 37 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 37 exclusive deepen).
