 ...
 *
 * Soft SPSC ownership protocol (Wave 40 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 40): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 40 deepen).
 ...
 *   udx: spsc soft deepen    — wave=40 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 40 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 40 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 40 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 40 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 40 exclusive deepen).
