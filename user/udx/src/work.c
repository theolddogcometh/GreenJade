 ...
 *
 * Soft SPSC ownership protocol (Wave 104 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 104): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 104 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 104 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 104 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 104 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 104 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 104 exclusive deepen).
