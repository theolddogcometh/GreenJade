 ...
 *
 * Soft SPSC ownership protocol (Wave 55 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 55): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 55 deepen).
 ...
 *   udx: spsc soft deepen    — wave=55 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 55 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 55 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 55 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 55 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 55 exclusive deepen).
