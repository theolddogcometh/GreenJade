 ...
 *
 * Soft SPSC ownership protocol (Wave 20 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 20): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 20 deepen).
 ...
 *   udx: spsc soft deepen    — wave=20 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 20 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 20 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 20 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 20 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 20 exclusive deepen).
