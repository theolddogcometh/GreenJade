 ...
 *
 * Soft SPSC ownership protocol (Wave 58 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 58): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 58 deepen).
 ...
 *   udx: spsc soft deepen    — wave=58 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 58 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 58 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 58 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 58 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 58 exclusive deepen).
