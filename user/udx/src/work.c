 ...
 *
 * Soft SPSC ownership protocol (Wave 69 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 69): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 69 deepen).
 ...
 *   udx: spsc soft deepen    — wave=69 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 69 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 69 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 69 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 69 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 69 exclusive deepen).
