 ...
 *
 * Soft SPSC ownership protocol (Wave 19 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 19): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 19 deepen).
 ...
 *   udx: spsc soft deepen    — wave=19 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 19 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 19 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 19 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 19 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 19 exclusive deepen).
