 ...
 *
 * Soft SPSC ownership protocol (Wave 35 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 35): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 35 deepen).
 ...
 *   udx: spsc soft deepen    — wave=35 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 35 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 35 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 35 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 35 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 35 exclusive deepen).
