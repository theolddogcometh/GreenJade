 ...
 *
 * Soft SPSC ownership protocol (Wave 38 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 38): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 38 deepen).
 ...
 *   udx: spsc soft deepen    — wave=38 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 38 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 38 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 38 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 38 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 38 exclusive deepen).
