 ...
 *
 * Soft SPSC ownership protocol (Wave 100 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 100): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 100 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 100 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 100 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 100 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 100 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 100 exclusive deepen).
