 ...
 *
 * Soft SPSC ownership protocol (Wave 56 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 56): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 56 deepen).
 ...
 *   udx: spsc soft deepen    — wave=56 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 56 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 56 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 56 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 56 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 56 exclusive deepen).
