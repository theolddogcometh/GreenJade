 ...
 *
 * Soft SPSC ownership protocol (Wave 62 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 62): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 62 deepen).
 ...
 *   udx: spsc soft deepen    — wave=62 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 62 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 62 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 62 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 62 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 62 exclusive deepen).
