 ...
 *
 * Soft SPSC ownership protocol (Wave 82 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 82): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 82 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 82 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 82 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 82 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 82 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 82 exclusive deepen).
