 ...
 *
 * Soft SPSC ownership protocol (Wave 21 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 21): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 21 deepen).
 ...
 *   udx: spsc soft deepen    — wave=21 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 21 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 21 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 21 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 21 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 21 exclusive deepen).
