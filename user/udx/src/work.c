 ...
 *
 * Soft SPSC ownership protocol (Wave 34 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 34): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 34 deepen).
 ...
 *   udx: spsc soft deepen    — wave=34 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 34 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 34 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 34 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 34 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 34 exclusive deepen).
