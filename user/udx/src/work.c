 ...
 *
 * Soft SPSC ownership protocol (Wave 111 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 111): soft observation only — multi-process driver-host
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 111 exclusive deepen).
