 ...
 *
 * Soft SPSC ownership protocol (Wave 51 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 51): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 51 deepen).
 ...
 *   udx: spsc soft deepen    — wave=51 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 51 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 51 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 51 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 51 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 51 exclusive deepen).
