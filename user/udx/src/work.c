 ...
 *
 * Soft SPSC ownership protocol (Wave 33 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 33): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 33 deepen).
 ...
 *   udx: spsc soft deepen    — wave=33 stamp + area count
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 33 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 33 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 33 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 33 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 33 exclusive deepen).
