 ...
 *
 * Soft SPSC ownership protocol (Wave 110 exclusive deepen; this unit only):
 ...
 *
 * Honesty (Wave 110): soft observation only — multi-process driver-host
...
/**
 * Greppable soft SPSC ownership + ring handoff inventory (Wave 110 deepen).
...
spsc_soft_inventory_log(void)
{
    ...
    /*
     * Owner-phase tallies (Wave 110 deepen).
    ...
    /* Grep: udx: spsc soft cancel (Wave 110 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft pending (Wave 110 deepen) */
    spsc_soft_emit(
    ...
    /* Grep: udx: spsc soft deepen wave (Wave 110 stamp) */
    spsc_soft_emit(
    ...
    /*
     * Grep: udx: spsc soft honesty (Wave 110 exclusive deepen).
