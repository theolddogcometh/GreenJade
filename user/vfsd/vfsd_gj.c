 ...
 *
 * Soft inventory (Wave 114 exclusive deepen — greppable "vfsd-gj: soft …"):
...
/*
 * Wave 114 soft inventory tallies (file-local; wrap OK).
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: vfsd-gj: soft honesty (Wave 114 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
    ...
    /*
     * Grep: vfsd-gj: soft exclusive (Wave 114 exclusive deepen).
 ...
 * Tallies Wave 114 soft inventory (vfsd-gj: soft …).
 ...
 * Tallies Wave 114 soft store inventory (vfsd-gj: soft store …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 114 soft free inventory.
     */
    ...
    /*
     * Wave 114 soft inventory dump — greppable "vfsd-gj: soft …".
