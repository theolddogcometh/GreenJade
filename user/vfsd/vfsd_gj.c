 ...
 *
 * Soft inventory (Wave 125 exclusive deepen — greppable "vfsd-gj: soft …"):
...
/*
 * Wave 125 soft inventory tallies (file-local; wrap OK).
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: vfsd-gj: soft honesty (Wave 125 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
    ...
    /*
     * Grep: vfsd-gj: soft exclusive (Wave 125 exclusive deepen).
 ...
 * Tallies Wave 125 soft inventory (vfsd-gj: soft …).
 ...
 * Tallies Wave 125 soft store inventory (vfsd-gj: soft store …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 125 soft free inventory.
     */
    ...
    /*
     * Wave 125 soft inventory dump — greppable "vfsd-gj: soft …".
