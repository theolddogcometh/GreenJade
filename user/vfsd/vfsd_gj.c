 ...
 *
 * Soft inventory (Wave 120 exclusive deepen — greppable "vfsd-gj: soft …"):
...
/*
 * Wave 120 soft inventory tallies (file-local; wrap OK).
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: vfsd-gj: soft honesty (Wave 120 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
    ...
    /*
     * Grep: vfsd-gj: soft exclusive (Wave 120 exclusive deepen).
 ...
 * Tallies Wave 120 soft inventory (vfsd-gj: soft …).
 ...
 * Tallies Wave 120 soft store inventory (vfsd-gj: soft store …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 120 soft free inventory.
     */
    ...
    /*
     * Wave 120 soft inventory dump — greppable "vfsd-gj: soft …".
