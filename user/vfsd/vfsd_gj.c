 ...
 *
 * Soft inventory (Wave 113 exclusive deepen — greppable "vfsd-gj: soft …"):
...
/*
 * Wave 113 soft inventory tallies (file-local; wrap OK).
...
soft_inventory_log(void)
{
    ...
    /*
     * Grep: vfsd-gj: soft honesty (Wave 113 exclusive deepen).
     * Soft inventory ≠ product multi-server confine.
     */
    ...
    /*
     * Grep: vfsd-gj: soft exclusive (Wave 113 exclusive deepen).
 ...
 * Tallies Wave 113 soft inventory (vfsd-gj: soft …).
 ...
 * Tallies Wave 113 soft store inventory (vfsd-gj: soft store …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 113 soft free inventory.
     */
    ...
    /*
     * Wave 113 soft inventory dump — greppable "vfsd-gj: soft …".
