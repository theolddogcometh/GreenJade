 ...
 *
 * Soft inventory (Wave 126 exclusive deepen — greppable "vfsd-gj: soft …"):
...
/*
 * Wave 126 soft inventory tallies (file-local; wrap OK).
 ...
 * Tallies Wave 126 soft inventory (vfsd-gj: soft …).
 ...
 * Tallies Wave 126 soft store inventory (vfsd-gj: soft store …).
 */
static void
...
_start(void)
{
     ...
     * Tallies Wave 126 soft free inventory.
     */
    ...
    /*
     * Wave 126 soft inventory dump — greppable "vfsd-gj: soft …".
