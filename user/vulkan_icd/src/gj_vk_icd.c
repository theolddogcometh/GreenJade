 ...
 *   gj_vk_icd: soft inventory wave=28 surfaces=16 pools=inst,dev,sc
 *   gj_vk_icd: soft deepen wave=28 areas=display,present,instance,device,
...
#define GJ_VK_ICD_SOFT_WAVE      25u
...
/*
 * Soft inventory blob (Wave 28). Shared host-stub + kernel smoke.
 * Grep: gj_vk_icd: soft inventory
 */
static const char g_szGjVkIcdSoftInventory[] =
    "gj_vk_icd: soft inventory wave=28 surfaces=16 areas=14 "
...
static const char g_szGjVkIcdSoftDeepen[] =
    "gj_vk_icd: soft deepen wave=28 areas=14 "
...
/*
 * Cold soft honesty line (Wave 28 exclusive). Grep: gj_vk_icd: soft honesty
 */
const char *
