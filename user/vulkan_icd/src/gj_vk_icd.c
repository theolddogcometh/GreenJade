 ...
 *   gj_vk_icd: soft inventory wave=31 surfaces=16 pools=inst,dev,sc
 *   gj_vk_icd: soft deepen wave=31 areas=display,present,instance,device,
...
#define GJ_VK_ICD_SOFT_WAVE      31u
...
/*
 * Soft inventory blob (Wave 31). Shared host-stub + kernel smoke.
 * Grep: gj_vk_icd: soft inventory
 */
static const char g_szGjVkIcdSoftInventory[] =
    "gj_vk_icd: soft inventory wave=31 surfaces=16 areas=14 "
...
static const char g_szGjVkIcdSoftDeepen[] =
    "gj_vk_icd: soft deepen wave=31 areas=14 "
...
/*
 * Cold soft honesty line (Wave 31 exclusive). Grep: gj_vk_icd: soft honesty
 */
const char *
