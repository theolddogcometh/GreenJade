 ...
 *   gj_vk_icd: soft inventory wave=36 surfaces=16 pools=inst,dev,sc
 *   gj_vk_icd: soft deepen wave=36 areas=display,present,instance,device,
...
#define GJ_VK_ICD_SOFT_WAVE      36u
...
/*
 * Soft inventory blob (Wave 36). Shared host-stub + kernel smoke.
 * Grep: gj_vk_icd: soft inventory
 */
static const char g_szGjVkIcdSoftInventory[] =
    "gj_vk_icd: soft inventory wave=36 surfaces=16 areas=14 "
...
static const char g_szGjVkIcdSoftDeepen[] =
    "gj_vk_icd: soft deepen wave=36 areas=14 "
...
/*
 * Cold soft honesty line (Wave 36 exclusive). Grep: gj_vk_icd: soft honesty
 */
const char *
...
/*
 * Soft wave stamp (36). Grep: gj_vk_icd: soft wave=
 */
uint32_t
