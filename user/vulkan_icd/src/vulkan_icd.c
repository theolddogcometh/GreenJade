...
/*
 * Wave 124 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 124). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 124 exclusive). Grep: vk_icd: soft honesty
 */
const char *
