 ...
 *
 * Soft inventory (Wave 81 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 81 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 81). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 81 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 81 deepen). Grep: vk_icd: soft crc
 */
uint32_t
