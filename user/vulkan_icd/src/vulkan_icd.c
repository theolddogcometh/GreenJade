 ...
 *
 * Soft inventory (Wave 52 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=52 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=52 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 52 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
#define VK_ICD_SOFT_WAVE 52u
...
/*
 * Soft inventory blob (Wave 52). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=52 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=52 areas=14 "
...
/*
 * Cold soft honesty line (Wave 52 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 52 deepen). Grep: vk_icd: soft crc
 */
uint32_t
