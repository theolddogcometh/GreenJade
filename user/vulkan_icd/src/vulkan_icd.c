...
/*
 * Wave 123 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 123). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 123 exclusive). Grep: vk_icd: soft honesty
 */
const char *
