 ...
 *
 * Soft inventory (Wave 76 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 76 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 76). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 76 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 76 deepen). Grep: vk_icd: soft crc
 */
uint32_t
