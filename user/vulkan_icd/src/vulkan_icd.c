 ...
 *
 * Soft inventory (Wave 89 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 89 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 89). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 89 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 89 deepen). Grep: vk_icd: soft crc
 */
uint32_t
