 ...
 *
 * Soft inventory (Wave 106 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 106 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 106). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 106 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 106 deepen). Grep: vk_icd: soft crc
 */
uint32_t
