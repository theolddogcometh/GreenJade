 ...
 *
 * Soft inventory (Wave 71 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 71 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 71). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 71 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 71 deepen). Grep: vk_icd: soft crc
 */
uint32_t
