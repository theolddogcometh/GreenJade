 ...
 *
 * Soft inventory (Wave 92 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 92 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 92). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 92 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 92 deepen). Grep: vk_icd: soft crc
 */
uint32_t
