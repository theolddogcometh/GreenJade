 ...
 *
 * Soft inventory (Wave 66 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=66 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=66 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 66 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
#define VK_ICD_SOFT_WAVE 66u
...
/*
 * Soft inventory blob (Wave 66). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=66 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=66 areas=14 "
...
/*
 * Cold soft honesty line (Wave 66 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 66 deepen). Grep: vk_icd: soft crc
 */
uint32_t
