 ...
 *
 * Soft inventory (Wave 109 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 109 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 109). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 109 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 109 deepen). Grep: vk_icd: soft crc
 */
uint32_t
