...
/*
 * Wave 91 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 91). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 91 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 91 deepen). Grep: vk_icd: soft crc
 */
uint32_t
