 ...
 *
 * Soft inventory (Wave 18 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=18 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=18 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 18 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
#define VK_ICD_SOFT_WAVE     18u
...
/*
 * Soft inventory blob (Wave 18). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=18 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=18 areas=14 "
...
/*
 * Cold soft honesty line (Wave 18 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 18 deepen). Grep: vk_icd: soft crc
 */
uint32_t
