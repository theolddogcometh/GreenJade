 ...
 *
 * Soft inventory (Wave 24 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=24 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=24 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 24 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
#define VK_ICD_SOFT_WAVE     24u
...
/*
 * Soft inventory blob (Wave 24). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=24 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=24 areas=14 "
...
/*
 * Cold soft honesty line (Wave 24 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 24 deepen). Grep: vk_icd: soft crc
 */
uint32_t
