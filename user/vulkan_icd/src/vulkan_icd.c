 ...
 *
 * Soft inventory (Wave 38 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=38 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=38 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 38 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 38). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=38 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=38 areas=14 "
...
/*
 * Cold soft honesty line (Wave 38 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 38 deepen). Grep: vk_icd: soft crc
 */
uint32_t
