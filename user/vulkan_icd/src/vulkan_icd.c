...
/*
 * Wave 90 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 90). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 90 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 90 deepen). Grep: vk_icd: soft crc
 */
uint32_t
