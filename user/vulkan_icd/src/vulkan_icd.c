 ...
 *
 * Soft inventory (Wave 53 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=53 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=53 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 53 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
#define VK_ICD_SOFT_WAVE 53u
...
/*
 * Soft inventory blob (Wave 53). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=53 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=53 areas=14 "
...
/*
 * Cold soft honesty line (Wave 53 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 53 deepen). Grep: vk_icd: soft crc
 */
uint32_t
