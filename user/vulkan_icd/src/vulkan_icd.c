 ...
 *
 * Soft inventory (Wave 98 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 98 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 98). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 98 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 98 deepen). Grep: vk_icd: soft crc
 */
uint32_t
