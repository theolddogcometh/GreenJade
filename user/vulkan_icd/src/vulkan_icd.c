 ...
 *
 * Soft inventory (Wave 111 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 111 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 111). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 111 exclusive). Grep: vk_icd: soft honesty
 */
const char *
