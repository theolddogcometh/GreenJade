 ...
 *
 * Soft inventory (Wave 25 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=25 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=25 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 25 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 25). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=25 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=25 areas=14 "
...
/*
 * Cold soft honesty line (Wave 25 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 25 deepen). Grep: vk_icd: soft crc
 */
uint32_t
