 ...
 *
 * Soft inventory (Wave 86 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 86 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 86). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 86 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 86 deepen). Grep: vk_icd: soft crc
 */
uint32_t
