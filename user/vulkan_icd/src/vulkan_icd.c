 ...
 *
 * Soft inventory (Wave 44 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=44 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=44 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 44 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 44). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=44 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=44 areas=14 "
...
/*
 * Cold soft honesty line (Wave 44 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 44 deepen). Grep: vk_icd: soft crc
 */
uint32_t
