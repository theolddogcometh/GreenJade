 ...
 *
 * Soft inventory (Wave 27 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=27 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=27 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 27 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 27). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=27 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=27 areas=14 "
...
/*
 * Cold soft honesty line (Wave 27 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 27 deepen). Grep: vk_icd: soft crc
 */
uint32_t
