 ...
 *
 * Soft inventory (Wave 21 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=21 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=21 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 21 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
#define VK_ICD_SOFT_WAVE     21u
...
/*
 * Soft inventory blob (Wave 21). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=21 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=21 areas=14 "
...
/*
 * Cold soft honesty line (Wave 21 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 21 deepen). Grep: vk_icd: soft crc
 */
uint32_t
