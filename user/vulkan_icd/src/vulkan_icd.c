 ...
 *
 * Soft inventory (Wave 114 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 114 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 114). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 114 exclusive). Grep: vk_icd: soft honesty
 */
const char *
