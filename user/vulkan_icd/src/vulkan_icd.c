 ...
 *
 * Soft inventory (Wave 97 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 97 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 97). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 97 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 97 deepen). Grep: vk_icd: soft crc
 */
uint32_t
