 ...
 *
 * Soft inventory (Wave 103 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 103 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 103). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 103 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 103 deepen). Grep: vk_icd: soft crc
 */
uint32_t
