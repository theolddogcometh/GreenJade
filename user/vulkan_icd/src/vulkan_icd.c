 ...
 *
 * Soft inventory (Wave 75 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 75 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 75). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 75 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 75 deepen). Grep: vk_icd: soft crc
 */
uint32_t
