 ...
 *
 * Soft inventory (Wave 35 exclusive deepen; greppable; not bar3 GPU):
 *   vk_icd: soft inventory wave=35 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=35 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 35 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
#define VK_ICD_SOFT_WAVE     33u
...
/*
 * Soft inventory blob (Wave 35). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=35 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=35 areas=14 "
...
/*
 * Cold soft honesty line (Wave 35 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft wave stamp (32). Grep: vk_icd: soft wave=
 */
uint32_t
...
/*
 * Soft host present CRC note (Wave 35 deepen). Grep: vk_icd: soft crc
 */
uint32_t
