 ...
 *
 * Soft inventory (Wave 101 exclusive deepen; greppable; not bar3 GPU):
...
/*
 * Wave 101 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 101). Grep: vk_icd: soft inventory
 */
...
/*
 * Cold soft honesty line (Wave 101 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 101 deepen). Grep: vk_icd: soft crc
 */
uint32_t
