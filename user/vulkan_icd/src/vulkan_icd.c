 ...
 *   vk_icd: soft inventory wave=33 negotiate=… present=… submit=… acquire=…
 *   vk_icd: soft deepen wave=33 areas=negotiate,instance,device,swapchain,
...
/*
 * Wave 33 soft inventory counters (file-local; wrap OK; never hard-gate).
 * Grep: vk_icd: soft
 */
...
/*
 * Soft inventory blob (Wave 33). Grep: vk_icd: soft inventory
 */
static const char g_szVkIcdSoftInventory[] =
    "vk_icd: soft inventory wave=33 surfaces=10 areas=14 "
...
static const char g_szVkIcdSoftDeepen[] =
    "vk_icd: soft deepen wave=33 areas=14 "
...
/*
 * Cold soft honesty line (Wave 33 exclusive). Grep: vk_icd: soft honesty
 */
const char *
...
/*
 * Soft host present CRC note (Wave 33 deepen). Grep: vk_icd: soft crc
 */
uint32_t
